...
## <a name="download-ssms-180-ga"></a>SSMS 18.0 (allgemein verfügbare Version) herunterladen

**Das SSMS 18.0 General Availability-Release (GA) ist jetzt verfügbar und ist die neueste Generation von *SQL Server Management Studio* mit Unterstützung für [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)].**

**[![Download](../ssdt/media/download.png) SQL Server Management Studio 18.0 (GA) herunterladen](https://go.microsoft.com/fwlink/?linkid=2088649)**

SSMS 18.0 befindet sich nicht mehr in der Vorschauversion und ist die erste Version der allgemeinen Verfügbarkeit (GA) von SSMS 18.0. Deinstallieren Sie die Vorschauversion von SSMS 18.0 vor der Installation von SSMS 18.0 GA.

**Versionsinformationen**

- Releasenummer: 18.0 (GA)<br>
...
## <a name="available-languages-ssms-180-ga"></a>Verfügbare Sprachen (SSMS 18.0 GA)
...
Zurzeit ist keine Upgradeoption verfügbar. Wenn Sie eine ältere Version von SSMS 18.0 Preview installiert haben, deinstallieren Sie diese, bevor Sie SSMS 18.0 GA installieren.
...
## <a name="new-in-this-release-ssms-180-ga"></a>Neues in diesem Release (SSMS 18.0 GA)

SSMS 18.0 (GA) ist die neueste Version von SQL Server Management Studio. Die Generation 18.x von SSMS bietet Unterstützung für beinahe alle Featurebereiche unter SQL Server 2008 bis SQL Server 2019 Preview.
...
## <a name="supported-sql-offerings-ssms-180-ga"></a>Unterstützte SQL-Angebote (SSMS 18.0 GA)
...
## <a name="supported-operating-systems-ssms-180-ga"></a>Unterstützte Betriebssysteme (SSMS 18.0 GA)
...
## <a name="release-notes-ssms-180-ga"></a>Versionshinweise (SSMS 18.0 GA)

- Der **Assistent zum Erstellen einer SSIS Integration Runtime** zeigt nur SQL-Datenbanken unter einem Mandanten an, wenn das Kundenkonto mehr als einem Mandanten gehört.
