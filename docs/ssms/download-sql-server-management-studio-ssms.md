...
SSMS 18.5 ist die neueste, allgemein verfügbare Version von SSMS. Wenn Sie eine frühere allgemein verfügbare Version von SSMS 18 installiert haben, wird für diese durch die Installation von SSMS 18.5 ein Upgrade auf Version 18.5 durchgeführt.
...
Es sind ein paar [Probleme](release-notes-ssms.md#known-issues-185) für dieses Release bekannt.
...
## <a name="supported-sql-offerings-ssms-185"></a>Unterstützte SQL-Angebote (SSMS 18.5)
...
## <a name="supported-operating-systems-ssms-185"></a>Unterstützte Betriebssysteme (SSMS 18.5)
