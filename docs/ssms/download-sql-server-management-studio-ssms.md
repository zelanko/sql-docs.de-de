...
> [!NOTE]
> Das SQL Server PowerShell-Modul ist eine separate Installation über den PowerShell-Katalog. Weitere Informationen finden Sie unter [Herunterladen des SQL Server PowerShell-Moduls](download-sql-server-ps-module.md).
