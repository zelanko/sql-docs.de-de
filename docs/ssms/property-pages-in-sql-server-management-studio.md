...
Die Dialogfelder für Eigenschaftenseiten in [!INCLUDE[msCoName](../includes/msconame_md.md)] [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] verwenden ein einheitliches Format, in dem Informationen mit erweiterten und reduzierten Kategorien angezeigt werden. Die angezeigten Felder hängen von der jeweiligen Eigenschaft ab. Die in Grau angezeigten Eigenschaften sind schreibgeschützt. Die Schaltflächen Nach Kategorien und Alphabetisch befinden sich oben auf den einzelnen Eigenschaftenseiten.  
