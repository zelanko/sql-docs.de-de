...
ms.locfileid: "56662764"
---
# <a name="tutorial-using-templates-in-sql-server-management-studio"></a>Lernprogramm: Verwenden von Vorlagen in SQL Server Management Studio
