---
description: Allgemeine Benutzeroberflächenelemente
...
ms.locfileid: "88371086"
---
# <a name="general-user-interface-elements"></a>Allgemeine Benutzeroberflächenelemente
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
Der **Editor**, das Fenster **Eigenschaften** und die **Toolbox** zählen zu den grundlegenden Elementen von [!INCLUDE[msCoName](../includes/msconame_md.md)] [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)].  
