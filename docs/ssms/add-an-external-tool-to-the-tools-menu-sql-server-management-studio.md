...
Sie können eine beliebige [!INCLUDE[msCoName](../includes/msconame_md.md)] Windows- oder [!INCLUDE[msCoName](../includes/msconame_md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort_md.md)]-Anwendung von [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] aus starten. Externe Anwendungen können dem Menü **Extras** hinzugefügt und über dieses Menü ausgeführt werden.  
