---
title: Hinzufügen eines externen Tools zum Menü „Extras“
...
Sie können eine beliebige [!INCLUDE[msCoName](../includes/msconame_md.md)] Windows- oder [!INCLUDE[msCoName](../includes/msconame_md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort_md.md)]-Anwendung über [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] starten. Externe Anwendungen können dem Menü **Extras** hinzugefügt und über dieses Menü ausgeführt werden.  
