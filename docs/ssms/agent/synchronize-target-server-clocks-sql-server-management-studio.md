...
ms.locfileid: "33044867"
---
# <a name="synchronize-target-server-clocks-sql-server-management-studio"></a>Synchronisieren der Zielserveruhren (SQL Server Management Studio)
