---
description: Angeben von Auftragsantworten
...
|BESCHREIBUNG|Thema|  
|-|-|  
|Beschreibt, wie ein Operator über den Auftragsstatus benachrichtigt wird.|[Notify an Operator of Job Status](../../ssms/agent/notify-an-operator-of-job-status.md)|  
