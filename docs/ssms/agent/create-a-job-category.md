---
description: Erstellen einer Auftragskategorie
...
Weitere Informationen finden Sie unter [sp_add_category (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-add-category-transact-sql.md).  
