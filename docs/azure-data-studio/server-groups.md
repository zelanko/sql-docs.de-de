...
description: Informationen zu Servergruppen in Azure Data Studio
ms.prod: sql
...
---
# <a name="server-groups-in-name-sos"></a>Servergruppen in [!INCLUDE[name-sos](../includes/name-sos-short.md)]
