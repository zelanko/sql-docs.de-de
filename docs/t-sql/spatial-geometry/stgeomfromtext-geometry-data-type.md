---
description: STGeomFromText (geometry-Datentyp)
...
## <a name="examples"></a>Beispiele  
 Im folgenden Beispiel wird `STGeomFromText()` verwendet, um eine `geometry`-Instanz zu erstellen.  
