...
### <a name="example-1-two-dimension-geometry-wkt"></a>Beispiel 1: WKT mit zweidimensionaler Geometrie
```  
DECLARE @g geometry;  
...
### <a name="example-2-three-dimension-geometry-wkt"></a>Beispiel 2: WKT mit dreidimensionaler Geometrie
```  
DECLARE @g geometry;  
...
### <a name="example-3-two-dimension-measured-geometry-wkt"></a>Beispiel 3: WKT mit zweidimensional gemessener Geometrie
```  
DECLARE @g geometry;  
...
### <a name="example-4-three-dimension-measured-geometry-wkt"></a>Beispiel 4: WKT mit dreidimensional gemessener Geometrie
```  
DECLARE @g geometry;  
