...
Beim Erstellen der Tabelle (außerhalb der üblichen Warnung darüber, dass die maximale Zeilengröße das zulässige Maximum von 8.060 Byte überschreitet) oder beim Einfügen der Daten wird kein spezieller Fehler ausgegeben. Diese große Zeilengröße kann während einiger normaler Vorgänge Fehler (z. B. Fehler 512, Aktualisieren des Schlüssels des gruppierten Indexes oder Sortieren des vollständigen Spaltensatzes) verursachen, die Benutzer bis zum Ausführen eines Vorgangs nur ahnen können.
