...
- Mehrere Objekte können mit einer einzigen `ADD SENSITIVITY CLASSIFICTION`-Anweisung klassifiziert werden.
...
[Berechtigungen (Datenbank-Engine)](https://docs.microsoft.com/en-us/sql/relational-databases/security/permissions-database-engine)
