...
Auf SQL Server ist die `ALTER ANY EVENT SESSION`-Berechtigung erforderlich. In der SQL-Datenbank ist die `ALTER ANY DATABASE EVENT SESSION`-Berechtigung für die Datenbank erforderlich.
