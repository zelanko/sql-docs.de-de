...
> |||||
> |---|---|---|---|
> |**_\* SQL Server \*_** &nbsp;|[SQL-Datenbank<br />Singleton/Pool für elastische Datenbanken](pick-a-product-template.md?view=azuresqldb-current)|[SQL-Datenbank<br />verwaltete Instanz](pick-a-product-template.md?view=azuresqldb-mi-current)|[Azure Synapse<br />Analytics](pick-a-product-template.md?view=azure-sqldw-latest)|||
