...
> [!IMPORTANT]
> In einer verwalteten Azure SQL-Datenbank-Instanz funktioniert die SQL-Überwachung auf der Serverebene. Als Speicherorte ist nur `URL` oder `EXTERNAL_MONITOR` möglich.
