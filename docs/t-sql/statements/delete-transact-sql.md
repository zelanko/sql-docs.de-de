...
#### <a name="j-using-output-with-from_table_name-in-a-delete-statement"></a>J. Verwenden von OUTPUT mit <from_table_name> in einer DELETE-Anweisung  
...
### <a name="p-delete-based-on-the-result-of-joining-with-another-table"></a>P. Die Löschung basiert auf dem Ergebnis der Verknüpfung mit einer anderen Tabelle.

In diesem Beispiel wird gezeigt, wie Daten basierend auf dem Ergebnis durch das Verknüpfen einer anderen Tabelle aus einer Tabelle gelöscht werden.
