...
Erfordert die Berechtigung ALTER ANY DATABASE SCOPE CONFIGURATION für die Datenbank. Diese Berechtigung kann von einem Benutzer mit CONTROL-Berechtigung für eine Datenbank erteilt werden.
