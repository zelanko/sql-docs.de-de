...
###  <a name="restore-mi-database"></a> A. Stellen Sie die Datenbank aus vier Sicherungsmedien wieder her.   
```sql
...
### <a name="restore-mi-database-progress"></a> C. Verfolgen Sie den Fortschritt der RESTORE-Anweisung nach. 
