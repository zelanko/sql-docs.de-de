 ...
 *permission*  
 ...
 { FROM | TO } \<server_principal> Gibt den [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Anmeldenamen oder die Serverrolle an, für den bzw. die die Berechtigung aufgehoben wird.  
