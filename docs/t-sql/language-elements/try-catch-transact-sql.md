...
```  
 ...
 Die ERROR\_\*-Funktionen können auch in einem `CATCH`-Block in einer [nativ kompilierten gespeicherten Prozedur](../../relational-databases/in-memory-oltp/a-guide-to-query-processing-for-memory-optimized-tables.md) ausgeführt werden.  
