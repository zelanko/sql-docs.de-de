...
[!INCLUDE[tsql](../../includes/tsql-md.md)]-Anweisungen können auf eine beliebige Position von CURRENT_TIMESTAMP verweisen, die auf einen **datetime**-Ausdruck verweisen kann.
