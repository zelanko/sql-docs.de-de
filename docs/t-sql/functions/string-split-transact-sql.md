...
description: Transact-SQL-Referenz für die STRING_SPLIT-Funktion Diese Tabellenwertfunktion teilt Zeichenfolgen anhand von Trennzeichen in Teilzeichenfolgen auf.
ms.date: 11/28/2018
ms.prod: sql
