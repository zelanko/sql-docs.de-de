---
title: VARP (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/13/2017
ms.prod: sql
...
### <a name="a-using-varp"></a>A: Verwenden von VARP  
...
### <a name="c-using-varp-with-over"></a>C. Verwenden von VARP mit OVER  
