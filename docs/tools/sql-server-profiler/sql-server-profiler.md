...
> [!IMPORTANT]
> SQL-Ablaufverfolgung und [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] sind veraltet. Der *Microsoft.SqlServer.Management.Trace* -Namespace, der die Objekte für die Microsoft SQL Server-Ablaufverfolgung und -Wiedergabe enthält, ist ebenfalls veraltet. 
> [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)] 
> Verwenden Sie stattdessen erweiterte Ereignisse. Weitere Informationen zu [Extended Events](../../relational-databases/extended-events/extended-events.md), finden Sie unter [Schnellstart: Erweiterte Ereignisse in SQL Server](../../relational-databases/extended-events/quick-start-extended-events-in-sql-server.md) und [SSMS XEvent Profiler](../../relational-databases/extended-events/use-the-ssms-xe-profiler.md).

> [!NOTE]
> [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] für die Analysis Services-arbeitsauslastungen nicht veraltet ist, und werden weiterhin unterstützt werden.
...
|**Ablaufverfolgungssammlung**|[Erweiterte Ereignisse](../../relational-databases/extended-events/extended-events.md) in grafische Benutzeroberfläche [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]|[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]|  
...
> [!NOTE]
> Grundlegendes zur SQL-Ablaufverfolgung ist sehr nützlich, bei der Arbeit mit [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]. Weitere Informationen finden Sie unter [SQL Trace](../../relational-databases/sql-trace/sql-trace.md).  
...
-   [!INCLUDE[tsql](../../includes/tsql-md.md)] `SELECT`-, `INSERT`, `UPDATE`- und `DELETE`--Anweisungen.    
...
|Beschreibt das Ausführen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Profiler.|[Erforderliche Berechtigungen zum Ausführen von SQL Server Profiler](../../tools/sql-server-profiler/permissions-required-to-run-sql-server-profiler.md)|  
...
|Beschreibt, wie Sie die Wiedergabe einer [!INCLUDE[tsql](../../includes/tsql-md.md)] Skript.|[Wiedergeben eines Transact-SQL-Skripts &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/replay-a-transact-sql-script-sql-server-profiler.md)|  
...
|Beschreibt das Erstellen einer [!INCLUDE[tsql](../../includes/tsql-md.md)] Skript zum Ausführen einer Ablaufverfolgung.|[Erstellen eines Transact-SQL-Skripts zum Ausführen einer Ablaufverfolgung &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/create-a-transact-sql-script-for-running-a-trace-sql-server-profiler.md)|  
...
|Beschreibt das Starten von [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].|[Starten des SQL Server Profilers](../../tools/sql-server-profiler/start-sql-server-profiler.md)|  
...
|Beschreibt, wie Sie anzeigen und Analysieren von ablaufverfolgungen mit [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].|[Anzeigen und Analysieren von Ablaufverfolgungen mit SQL Server Profiler](../../tools/sql-server-profiler/view-and-analyze-traces-with-sql-server-profiler.md)|  
|Beschreibt, wie zum Analysieren von Deadlocks mit [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].|[Analysieren von Deadlocks mit SQL Server Profiler](../../tools/sql-server-profiler/analyze-deadlocks-with-sql-server-profiler.md)|  
...
|Beschreibt, wie so filtern Sie ablaufverfolgungen mit [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].|[Filtern von Ablaufverfolgungen mit SQL Server Profiler](../../tools/sql-server-profiler/filter-traces-with-sql-server-profiler.md)|  
...
|Listet die kontextbezogenen Hilfethemen für [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].|[SQL Server Profiler (F1-Hilfe)](../../tools/sql-server-profiler/sql-server-profiler-f1-help.md)|  
