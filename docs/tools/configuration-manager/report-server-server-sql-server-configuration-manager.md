---
title: Berichtsserver-&lt;Server&gt; (SQL Server-Konfigurations-Manager)
description: Hier erfahren Sie, wie Sie den SQL Server-Konfigurations-Manager zum Anzeigen der Eigenschaften des Softwaresystems der SQL Server Reporting Services verwenden.
