...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]
 ...
 Der WMI-Anbieter ist eine Windows-Komponente. Informationen zum Überprüfen von Berechtigungen für den WMI-Anbieter finden Sie unter „Vorgehensweise: Konfigurieren von WMI zum Anzeigen des Serverstatus in SQL Server-Tools“ in der SQL Server-Onlinedokumentation.  
