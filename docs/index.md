                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4>SQL</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="https://docs.microsoft.com/azure/sql-database/">Azure SQL-Datenbank</a></li>
                                                    ...
                                                    <li><a class="barLink" href="https://docs.microsoft.com/en-us/previous-versions/sql/">Vorherige Versionen von SQL Server (2005–2012)</a></li>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/sql/relational-databases/security">SQL-Sicherheit</a></li>
                                                </ul>
                                                <h4>Tools</h4>
                                                <ul class="noBullet">
                                                ...
                                                <h4>Beispiele</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="https://github.com/Microsoft/sql-server-samples/tree/master/samples">Codebeispiele bei GitHub</a></li>
                                                    <li><a class="barLink" href="https://docs.microsoft.com/en-us/sql/samples/wide-world-importers-what-is?view=sql-server-2017">Wide World Importers DB (Wide World Importers-DB)</a></li>
