...
description: Verwenden Sie diesen Referenzartikel, um die SQL-Befehle (insbesondere die vielen BDC-Befehle) im azdata-Tool zu verstehen.
author: MikeRayMSFT
ms.author: mikeray
