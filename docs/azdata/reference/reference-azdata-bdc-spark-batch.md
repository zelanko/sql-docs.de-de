...
description: Verwenden Sie diesen Referenzartikel, um die SQL-Befehle (insbesondere die „bdc spark batch“-Befehle) im azdata-Tool zu verstehen.
author: MikeRayMSFT
ms.author: mikeray
