...
description: Verwenden Sie diesen Referenzartikel, um die SQL-Befehle (insbesondere die „bdc spark statement“-Befehle) im azdata-Tool zu verstehen.
author: MikeRayMSFT
ms.author: mikeray
