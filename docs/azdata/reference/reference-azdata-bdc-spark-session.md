...
description: Verwenden Sie diesen Referenzartikel, um die SQL-Befehle (insbesondere den „bdc spark session“-Befehl) im azdata-Tool zu verstehen.
author: MikeRayMSFT
ms.author: mikeray
