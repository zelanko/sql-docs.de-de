...
|Steuerelementname|BESCHREIBUNG|  
|------------------|-----------------|  
|**E-Mail-Adresse**|Geben Sie den Namen der E-Mail-Adresse für das Konto ein. Dies ist die E-Mail-Adresse, von der e-Mail gesendet wird, und sie muss im Format *email_name*@*domain_name*vorliegen. Ein Beispiel für eine E-Mail-Adresse ist sales@contoso.com.|  
...
|**Für diesen Server ist eine sichere Verbindung (SSL) erforderlich**|Verschlüsselt die Kommunikation mithilfe von Transport Layer Security (TLS), früher bekannt als SSL (Secure Sockets Layer).|  
...
|Steuerelementname|BESCHREIBUNG|  
|------------------|-----------------|  
|**Windows-Authentifizierung mithilfe der Anmeldeinformationen des Datenbank-Engine-Diensts**|Geben Sie an, dass Database [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)] Mail die Anmeldeinformationen des Windows-Dienstkontos für die Authentifizierung auf dem SMTP-Server verwenden soll.|  
...
## <a name="see-also"></a>Weitere Informationen  
 [Datenbankkonfigurationsseite &#40;Master Data Services Configuration Manager&#41;](../master-data-services/database-configuration-page-master-data-services-configuration-manager.md)   
