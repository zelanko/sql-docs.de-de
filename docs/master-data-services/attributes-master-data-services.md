---
title: Attribute
description: Erfahren Sie mehr über Attribute, die Objekte in Master Data Services Entitäten sind. Attributwerte beschreiben die Elemente der Entität.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.prod_service: mds
