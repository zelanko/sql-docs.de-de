---
title: Neuerungen
description: Informieren Sie sich über die Änderungen, Verbesserungen und Updates in der 2019 SQL Server-Version von Master Data Services.
ms.custom: ''
ms.date: 07/08/2016
ms.prod: sql
ms.prod_service: mds
...
-   Die folgenden neuen Aufträge des SQL Server-Agents übernehmen die Index- und Protokollverwaltung.  
 ...
 Weitere Informationen finden Sie in diesem Beitrag zum Master Data Services-Blog [Verbesserung der Leistung und Skalierung in SQL Server 2016](https://techcommunity.microsoft.com/t5/sql-server-integration-services/performance-and-scale-improvement-in-sql-server-2016/ba-p/388225).  
