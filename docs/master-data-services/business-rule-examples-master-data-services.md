...
description: Überprüfen Sie diese Beispiele von Geschäftsregeln für Master Data Services. Diese Beispiele sind in Beispiel Modellen enthalten, die in Ihrer Installation von Master Data Services enthalten sind.
ms.custom: ''
ms.date: 01/05/2017
ms.prod: sql
ms.prod_service: mds
