...
+  [Schnellstart: Erstellen, Trainieren und Verwenden eines Python-Modells mit gespeicherten Prozeduren in SQL Server](quickstart-python-train-score-model.md)
