...
+ [MicrosoftML-Paket für R](/machine-learning-server/r-reference/microsoftml/microsoftml-package)
+ [microsoftml-Paket für Python](/machine-learning-server/python-reference/microsoftml/microsoftml-package)
