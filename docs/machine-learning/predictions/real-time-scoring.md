...
Weitere Hintergrundinformationen zur Bewertung in SQL Server finden Sie unter [Generieren von Vorhersagen in SQL Server-Machine Learning](how-to-do-realtime-scoring.md).
