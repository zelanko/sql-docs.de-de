...
-   [Beispiel für Handlereigenschaft](./handler-property-example-vc.md)  
  
-   [Beispiel für InternetTimeout-Eigenschaft](./internettimeout-property-example-vc.md)