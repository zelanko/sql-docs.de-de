...
ms.locfileid: "51606710"
---
# <a name="filtercolumn-property-rds"></a>FilterColumn-Eigenschaft (RDS)
Gibt die Spalte auf dem die Filterkriterien ausgewertet werden soll.  
