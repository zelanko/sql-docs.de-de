...
## <a name="remarks"></a>Hinweise  
 ...
 Die [Append](../../../ado/reference/adox-api/append-method-adox-users.md) -Methode für eine **Benutzer** Auflistung für ADOX eindeutig ist. Sie haben folgende Möglichkeiten:  
