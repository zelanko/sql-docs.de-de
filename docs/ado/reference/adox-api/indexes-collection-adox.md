...
## <a name="remarks"></a>Hinweise  
 Die [Append](../../../ado/reference/adox-api/append-method-adox-indexes.md) -Methode für ein **Indizes** Auflistung für ADOX eindeutig ist. Sie haben folgende Möglichkeiten:  
