---
description: Create-Methode – Beispiel (VC++)
title: Create Method-Beispiel (VC + +) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "88984821"
---
# <a name="create-method-example-vc"></a>Create-Methode – Beispiel (VC++)
