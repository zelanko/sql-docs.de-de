---
title: Zeigt die Auflistung (ADOX) | Microsoft-Dokumentation
ms.prod: sql
...
## <a name="remarks"></a>Hinweise  
 Die [Append](../../../ado/reference/adox-api/append-method-adox-views.md) -Methode für eine **Ansichten** Auflistung für ADOX eindeutig ist. Sie haben folgende Möglichkeiten:  
...
-   Zugriff auf eine Ansicht in der Auflistung mit den [Element](../../../ado/reference/ado-api/item-property-ado.md) Eigenschaft.  
