---
title: Type-Eigenschaft (Schlüssel) (ADOX) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "47779368"
---
# <a name="type-property-key-adox"></a>Type-Eigenschaft (Schlüssel) (ADOX)
Gibt den Typ des Schlüssels.  
  
## <a name="settings-and-return-values"></a>Einstellungen und Rückgabewerte  
 Legt fest oder gibt einen **lange** -Wert, der möglich die [diesen zurück](../../../ado/reference/adox-api/keytypeenum.md) Konstanten. Der Standardwert ist **AdKeyPrimary**.  
