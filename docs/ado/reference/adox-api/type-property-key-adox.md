...
ms.locfileid: "67965044"
---
# <a name="type-property-key-adox"></a>Type-Eigenschaft (Schlüssel) (ADOX)
Gibt den Typ des Schlüssels an.  
  
## <a name="settings-and-return-values"></a>Einstellungen und Rückgabewerte  
 Legt einen **Long** -Wert fest, der eine der [keytypeenum](../../../ado/reference/adox-api/keytypeenum.md) -Konstanten sein kann, oder gibt ihn zurück. Der Standardwert ist " **adkeyprimary**".  
