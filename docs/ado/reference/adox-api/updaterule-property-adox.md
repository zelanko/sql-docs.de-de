...
ms.locfileid: "88439402"
---
# <a name="updaterule-property-adox"></a>UpdateRule-Eigenschaft (ADOX)
Gibt die Aktion an, die ausgeführt wird, wenn ein primär [Schlüssel](../../../ado/reference/adox-api/key-object-adox.md) aktualisiert wird.  
...
## <a name="remarks"></a>Bemerkungen  
 Diese Eigenschaft ist bei [Schlüssel](../../../ado/reference/adox-api/key-object-adox.md) Objekten, die bereits an die Auflistung angehängt wurden, schreibgeschützt.  
