 ...
 *Table*  
 Ein **Variant** -Wert enthält einen Verweis auf die **Tabelle** angefügt oder den Namen der Tabelle zu erstellen und anfügen.  
  
## <a name="remarks"></a>Hinweise  
 Wenn der Anbieter das Erstellen von Tabellen nicht unterstützt wird, tritt ein Fehler auf.  
