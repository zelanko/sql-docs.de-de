---
title: Befehl "und" CommandText-Eigenschaft-Beispiel (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "35285319"
---
# <a name="command-and-commandtext-properties-example-vb"></a>Befehl "und" CommandText-Eigenschaft-Beispiel (VB)
