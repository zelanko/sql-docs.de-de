...
|[Gruppen](../../../ado/reference/adox-api/groups-collection-adox.md)|Enthält alle gespeicherten **Gruppe** Objekte eines Katalogs oder Benutzer.|  
...
|[Benutzer](../../../ado/reference/adox-api/users-collection-adox.md)|Enthält alle gespeicherten **Benutzer** Objekte des Katalogs oder einer Gruppe.|  
