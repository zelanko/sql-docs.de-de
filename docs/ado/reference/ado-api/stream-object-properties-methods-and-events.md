---
title: Stream-Objekt – Eigenschaften, Methoden und Ereignisse | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "63181023"
---
# <a name="stream-object-properties-methods-and-events"></a>Stream-Objekt – Eigenschaften, Methoden und Ereignisse
## <a name="properties"></a>Eigenschaften  
 ...
 [LineSeparator-Eigenschaft](../../../ado/reference/ado-api/lineseparator-property-ado.md)  
  
 [Mode-Eigenschaft](../../../ado/reference/ado-api/mode-property-ado.md)  
  
 [Eigenschaft "Position"](../../../ado/reference/ado-api/position-property-ado.md)  
