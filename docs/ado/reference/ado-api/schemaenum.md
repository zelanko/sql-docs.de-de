...
|**adSchemaHierarchies**|34|Gibt Informationen zu den Hierarchien, die in einer Dimension zurück.<br /><br /> (Rowset HIERARCHIEN)|CATALOG_NAME SCHEMA_NAME CUBE_NAME DIMENSION_UNIQUE_NAME HIERARCHY_NAME HIERARCHY_UNIQUE_NAME|  
|**adSchemaIndexes**|12|Gibt die im Katalog definierten Indizes, die von einem bestimmten Benutzer gehören.<br /><br /> (INDIZES Rowset)|TABLE_CATALOG TABLE_SCHEMA INDEX_NAME TYPE TABLE_NAME|  
...
|**adSchemaUsagePrivileges**|15|Gibt die USAGE-Berechtigungen für Objekte, die im Katalog definierten, die zur oder von einem bestimmten Benutzer erteilt werden.<br /><br /> (USAGE_PRIVILEGES Rowset)|OBJECT_CATALOG OBJECT_SCHEMA OBJECT_NAME OBJECT_TYPE GRANTOR GRANTEE|  
|**adSchemaViewColumnUsage**|24|Gibt die Spalten für die Tabellen angezeigt, im Katalog definierten und einen bestimmten Benutzer gehören hängen.<br /><br /> (VIEW_COLUMN_USAGE Rowset)|VIEW_CATALOG VIEW_SCHEMA VIEW_NAME|  
