---
description: OriginalValue-und UnderlyingValue-Eigenschaften (Beispiel) (VB)
title: OriginalValue-und UnderlyingValue-Eigenschaften (Beispiel) (VB) | Microsoft-Dokumentation
ms.prod: sql
