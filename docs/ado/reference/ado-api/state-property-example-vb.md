...
ms.locfileid: "88777339"
---
# <a name="state-property-example-vb"></a>State-Eigenschaft – Beispiel (VB)
In diesem Beispiel wird die [State](./state-property-ado.md) -Eigenschaft verwendet, um eine Meldung anzuzeigen, während asynchrone Verbindungen geöffnet werden und asynchrone Befehle ausgeführt werden.  
