---
title: ActualSize und DefinedSize – Beispiel (VB) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "67921486"
---
# <a name="actualsize-and-definedsize-properties-example-vb"></a>ActualSize und DefinedSize – Beispiel (VB)
