---
description: Beispiel für ActualSize und DefinedSize-Eigenschaften (VB)
title: Beispiel für ActualSize und DefinedSize-Eigenschaften (VB) | Microsoft-Dokumentation
ms.prod: sql
