---
description: Resync-Methode – Beispiel (VC++)
title: Resync-Methode (Beispiel) (VC + +) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "88989471"
---
# <a name="resync-method-example-vc"></a>Resync-Methode – Beispiel (VC++)
In diesem Beispiel wird die Verwendung der [Resync](./resync-method.md) -Methode zum Aktualisieren von Daten in einem statischen Recordset veranschaulicht.  
