---
description: Command (ADO für Visual C++-Syntax)
title: Command (ADO für Visual C++-Syntax) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "88776179"
---
# <a name="command-ado-for-visual-c-syntax"></a>Command (ADO für Visual C++-Syntax)
