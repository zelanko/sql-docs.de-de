---
title: Hierarchies-Auflistung (ADO MD) | Microsoft-Dokumentation
ms.prod: sql
 ...
 **Hierarchien** ist eine standard-ADO-Auflistung. Mit den Eigenschaften und Methoden einer Sammlung können Sie Folgendes tun:  
