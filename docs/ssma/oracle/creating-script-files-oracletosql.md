...
7.  **Vorgang zum Beenden:** während des Mid-Vorgangs, wenn der Benutzer klicken Sie dann den Vorgang beenden möchte **"STRG + C"** Hotkey kann verwendet werden. SSMA für Oracle-Konsole nach Abschluss des Vorgangs warten und beendet die Ausführung der Verwaltungskonsole.  
...
Zum Beispiel folgt eine typische Datenmigration von einer bestimmten Tabelle in einer Oracle-Datenbank die Hierarchie der: Schema -&gt; Tabelle.  
