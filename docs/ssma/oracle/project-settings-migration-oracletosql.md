...
Die Seite Migration des Dialog Felds **Projekteinstellungen** enthält Einstellungen, die anpassen, wie SSMA Daten von Oracle zu [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]migriert.  
