...
2. Kopieren Sie **SSMA für das Oracle-Erweiterungspaket.* n*.Install.exe** (wobei *n* für die Buildnummer steht) für den Computer, auf dem ausgeführt wird [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
  
3. Doppelklicken Sie auf **SSMA for Oracle Extension Pack.* n*.Install.exe**.  
...
9. Wählen Sie die Instanz von aus, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] zu der Sie Oracle-Schemas migrieren möchten, und klicken Sie dann auf **weiter**.  
...
12. Um die Hilfsprogramme für eine andere Instanz von zu installieren [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , wählen Sie **Ja**aus, und klicken Sie dann auf **weiter**, oder klicken Sie auf **Nein**, um den Assistenten zu beenden.  
  
13. [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]Führen Sie in oder mit dem Hilfsprogramm sqlcmd das folgende Skript aus, um CLR zu aktivieren:  
