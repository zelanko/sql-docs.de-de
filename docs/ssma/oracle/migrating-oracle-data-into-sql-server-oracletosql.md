...
ms.locfileid: "38983402"
---
# <a name="migrating-oracle-data-into-sql-server-oracletosql"></a>Migrieren von Oracle-Daten in SQLServer (OracleToSQL)
Nachdem Sie die konvertierten Objekte mit erfolgreich synchronisiert haben [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], können Sie Daten aus Oracle in migrieren [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].  
...
-   Während der Datenmigration von Server-Seite befindet sich das Modul in der Zieldatenbank ein. Er wird über das Pack für die Erweiterung installiert. Weitere Informationen zum Installieren der Erweiterung Pack finden Sie unter [Installation von Server-Komponenten auf SQL Server](http://msdn.microsoft.com/33070e5f-4e39-4b70-ae81-b8af6e4983c5)  
...
3.  Zum Migrieren von Daten auftreten, zwei Fälle:  
    ...
    **Datenmigration für Server-Seite:**  
    ...
    -   Bevor Sie die Migration von Daten auf dem Server durchführen, stellen Sie Folgendes sicher:  
        ...
        1.  SSMA für Oracle-Erweiterungspaket wird installiert, auf der Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].  
