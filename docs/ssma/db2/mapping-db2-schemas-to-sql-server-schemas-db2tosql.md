...
2.  Klicken Sie im rechten Bereich auf die **Zuordnen von Schemas** Registerkarte.  
    ...
    Sie sehen eine Liste aller DB2-Schemas, gefolgt von einem Zielwert. Dieses Ziel wird in einer zweiteiligen-Notation angegeben (*database.schema*) in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , in denen Ihre Objekte und Daten migriert werden.  
...
Wenn Sie die Zuordnung zwischen einem DB2-Schema anpassen und ein [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Schema, Sie können die Zuordnung zurück auf die Standardwerte zurücksetzen.  
