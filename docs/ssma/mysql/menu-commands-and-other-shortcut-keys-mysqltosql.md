---
title: Menübefehle und andere Tastenkombinationen (MySQLToSQL)) | Microsoft-Dokumentation
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|Zeigen Sie die Verbindung oder erneutes Verbinden mit MySQL-Dialogfeld.|ALT + F + T|  
...
|ZU DIESEM ZWECK|DRÜCKEN SIE|  
|--------------|---------|  
|Zeigen Sie über SSMA für MySQL (Dialogfeld an).|ALT + H + A|  
...
[Tastenkombinationen für den &#40;MySQLToSQL&#41;](../../ssma/mysql/shortcut-keys-mysqltosql.md)  
