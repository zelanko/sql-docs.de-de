...
[!INCLUDE[msCoName](../../includes/msconame_md.md)] @ no__t-1 Migration Assistant (SSMA) für MySQL ist ein Tool zum Migrieren von MySQL-Datenbanken zu [!INCLUDE[msCoName](../../includes/msconame_md.md)] @ no__t-3 2012, [!INCLUDE[msCoName](../../includes/msconame_md.md)] @ no__t-5 2014, [!INCLUDE[msCoName](../../includes/msconame_md.md)] @ no__t-7 2016, [!INCLUDE[msCoName](../../includes/msconame_md.md)] @ no__t-9 2017 unter Windows und Linux, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]0 @ no__t-11 2019 unter Windows und Linux. oder Azure 2-Datenbank. SSMA für MySQL konvertiert MySQL-Datenbankobjekte in SQL Server Datenbankobjekte, erstellt diese Objekte in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] und migriert dann Daten von MySQL zu [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
|-----------|---------------|
|[Neues in SSMA für MySQL](https://msdn.microsoft.com/1451a0b0-6713-4d0c-954f-ea3d8fce1d31)|Neuerungen in dieser Version von SSMA für MySQL|  
...
|[Arbeiten mit SSMA für MySQL-Konsole](working-with-ssma-for-mysql-console-mysqltosql.md)|Enthält Dokumentation in der SSMA-Konsolenanwendung|  
