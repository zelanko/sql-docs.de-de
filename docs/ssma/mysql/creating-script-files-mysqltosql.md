...
7.  **Der Beendigungsvorgang:** während des Mid-Vorgangs, ob der Benutzer möchte, klicken Sie dann den Vorgang Abbrechen **"STRG + C"** Hotkey verwendet werden kann. SSMA für die MySQL-Konsole zum Abschließen des Vorgangs wartet, und beendet die Ausführung der Konsole.  
...
Eine typische Datenmigration, der eine bestimmte Tabelle in einer MySQL-Datenbank folgt z. B. die Hierarchie der: Datenbank -&gt; Tabelle.  
  
Wenn alle Befehle in der Skriptdatei erfolgreich ausgeführt werden, wird die SSMA-Konsolenanwendung beendet und das Steuerelement an den Benutzer zurückgegeben. Den Inhalt einer Skriptdatei sind mehr oder weniger statisch mit Variableninformationen enthalten entweder in einem [Variable Wertdateien](http://msdn.microsoft.com/en-us/1dc56a7b-8e3a-4576-ad4f-47050bf7e28a) oder in einem separaten Abschnitt innerhalb der Skriptdatei für Variable Werte.  
