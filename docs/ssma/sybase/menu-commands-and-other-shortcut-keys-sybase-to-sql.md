---
title: Menübefehle und andere Tastenkombinationen (Sybase To SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
|Zeigen Sie die Verbindung herstellen oder erneutes Verbinden mit der Sybase-Dialogfeld.|ALT + F + T|  
...
|Zugriff auf die sicherungsverwaltung Untermenü Sybase.|ALT + S + B|  
|Anzeigen der Sicherung für Sybase-Dialogfeld Tabellen hinzugefügt.|ALT + S + B + B|  
|Wiederherstellen von Tabellen aus einer Sicherung für den Sybase-Dialog angezeigt.|ALT + S + B + R|  
|Anzeigen verwalten Sicherungsinhalt für Sybase-Dialog.|ALT + S + B + C|  
...
|ZU DIESEM ZWECK|DRÜCKEN SIE|  
|--------------|---------|  
|Zeigen Sie über SSMA für Sybase (Dialogfeld an).|ALT + H + A|  
...
[Tastenkombinationen für den&#40;Sybase zu SQL&#41;](../../ssma/sybase/shortcut-keys-sybase-to-sql.md)  
