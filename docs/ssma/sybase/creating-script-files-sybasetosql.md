...
7.  **Beenden Sie Vorgang:** Während des Mid-Vorgangs, wenn der Benutzer klicken Sie dann den Vorgang beenden möchte **"STRG + C"** Hotkey kann verwendet werden. SSMA für Sybase-Konsole nach Abschluss des Vorgangs warten und beendet die Ausführung der Verwaltungskonsole.  
...
So folgt beispielsweise eine typische Datenmigration von einer bestimmten Tabelle in einer Sybase-Datenbank, die Hierarchie der: Datenbank -&gt;Schema -&gt;Tabelle.  
