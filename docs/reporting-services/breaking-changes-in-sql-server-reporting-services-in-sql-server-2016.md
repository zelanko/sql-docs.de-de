...
description: In diesem Artikel erhalten Sie Informationen zu Änderungen bei den Reporting Services, die zu Fehlern bei Anwendungen, Skripts oder Funktionen führen könnten, die auf früheren Versionen von SQL Server basieren.
ms.date: 07/02/2017
