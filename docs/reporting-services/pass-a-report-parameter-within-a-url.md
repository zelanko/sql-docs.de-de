...
description: Hier erfahren Sie, wie Sie Berichtsparameter direkt an die Berichtsverarbeitungs-Engine übergeben, indem Sie sie in eine Berichts-URL einschließen.
ms.date: 03/01/2017
