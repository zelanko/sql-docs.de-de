...
description: Hier erfahren Sie, wie Sie die Benutzeroberfläche des Abfrage-Designers von Hyperion Essbase verwenden, um Daten abzurufen, wenn ein Bericht verarbeitet wird.
ms.date: 03/01/2017
