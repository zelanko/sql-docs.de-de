...
description: In diesem Artikel erfahren Sie, wie Sie Gruppierungen und Gesamtwerte zu Ihrem Reporting Services-Bericht hinzufügen, um Ihre Daten zu organisieren und zusammenzufassen.
ms.date: 04/18/2019
