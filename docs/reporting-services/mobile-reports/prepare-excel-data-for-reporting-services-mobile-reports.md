...
description: Mobile Reporting Services-Berichte können Daten aus Excel-Dateien verwenden. Befolgen Sie diese Tipps, um Excel-Dateien und-Arbeitsblätter für einen einfachen Import vorzubereiten.
ms.date: 02/08/2016
