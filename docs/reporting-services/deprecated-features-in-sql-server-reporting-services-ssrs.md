---
title: Veraltete Funktionen in SQL Server 2016 Reporting Services | Microsoft-Dokumentation
ms.date: 07/02/2017
...
ms.locfileid: "74317949"
---
# <a name="deprecated-features-in-sql-server-2016-reporting-services"></a>Veraltete Funktionen in SQL Server 2016 Reporting Services

[!INCLUDE [ssrs-appliesto](../includes/ssrs-appliesto.md)] [!INCLUDE [ssrs-appliesto-2016](../includes/ssrs-appliesto-2016.md)] [!INCLUDE [ssrs-appliesto-not-2017](../includes/ssrs-appliesto-not-2017.md)] [!INCLUDE [ssrs-appliesto-not-pbirs](../includes/ssrs-appliesto-not-pbirs.md)]

[!INCLUDE [ssrs-previous-versions](../includes/ssrs-previous-versions.md)]

In diesem Artikel werden die als veraltet markierten Funktionen von SQL Server 2016 Reporting Services beschrieben. Die Funktionen sind immer noch in der Version verfügbar, in der sie veraltet sind. Es ist jedoch geplant, die Funktionen in einer zukünftigen Version von [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]zu entfernen. Verwenden Sie keine veralteten Funktionen in neuen Anwendungen.
...
|Category|Als veraltet markierte Funktion|
|--------------|------------------------| 
...
Als veraltet markierte Funktionen in SQL Server 2014 Reporting Services
...
## <a name="next-steps"></a>Nächste Schritte
 ...
 [Neuigkeiten bei Reporting Services](../reporting-services/what-s-new-in-sql-server-reporting-services-ssrs.md) [Abwärtskompatibilität von Reporting Services](../reporting-services/reporting-services-backward-compatibility.md)   
