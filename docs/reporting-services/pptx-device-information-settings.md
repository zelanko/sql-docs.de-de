...
description: In diesem Artikel erfahren Sie mehr über die Geräteinformationseinstellungen für das Rendering von Reporting Services-Berichten im PPTX-Format.
ms.date: 09/11/2015
