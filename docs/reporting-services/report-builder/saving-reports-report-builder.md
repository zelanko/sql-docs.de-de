...
description: Im Berichts-Generator können Sie die Definition eines Berichts speichern. Dazu gehört das Layout, jedoch nicht die Daten selbst. Die Daten werden jedes Mal aktualisiert, wenn Sie den Bericht ausführen.
ms.date: 03/01/2017
...
##  <a name="saving-reports-to-a-report-server"></a><a name="SavingReportDefinitions"></a> Speichern von Berichten auf einem Berichtsserver  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Installieren Sie den Berichts-Generator](../install-windows/install-report-builder.md)   
