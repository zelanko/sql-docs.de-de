---
description: 'EditionID-Eigenschaft (WMI: MSReportServer_Instance)'
...
ms.locfileid: "92258032"
---
# <a name="msreportserver_instance-properties---editionid"></a>MSReportServer_Instance-Eigenschaften: Edition ID
