...
|||  
|-|-|  
|[EditionID](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-properties-editionid.md)|Gibt die Edition des Berichtsservers zurück.|  
|[EditionName](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-properties-editionname.md)|Gibt den lesbaren Namen der Edition des Berichtsservers zurück|  
...
|||  
|-|-|  
|[GetReportServerUrls-Methode &#40;WMI: MSReportServer_Instance&#41;](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-methods-getreportserverurls.md)|Listet die URLs auf, über die Benutzer auf den Berichtsserver und den Berichts-Manager zugreifen können|  
