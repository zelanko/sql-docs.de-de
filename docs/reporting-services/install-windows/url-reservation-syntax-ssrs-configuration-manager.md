---
description: URL-Reservierungssyntax (Berichtsserver-Konfigurations-Manager)
...
ms.locfileid: "91934133"
---
# <a name="url-reservation-syntax--report-server-configuration-manager"></a>URL-Reservierungssyntax (Berichtsserver-Konfigurations-Manager)
