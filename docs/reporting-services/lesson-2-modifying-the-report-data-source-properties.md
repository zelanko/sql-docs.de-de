...
description: Hier erfahren Sie, wie Sie das Webportal verwenden, um einen Bericht auszuwählen, der an Empfänger übermittelt wird, und wie Sie die Eigenschaften der Berichtsdatenquelle ändern.
ms.date: 05/23/2016
...
## <a name="to-modify-the-data-source-to-use-stored-credentials"></a><a name="bkmk_modify_datasource"></a>So ändern Sie eine Datenquelle zur Verwendung von gespeicherten Anmeldeinformationen  
 ...
 **Hinweis:** Die *Webportal*-URL ist „Reports“, nicht die URL des *Berichtsservers* „Berichtsserver“.  
...
## <a name="to-modify-the-adventureworksdataset"></a><a name="bkmk_modify_dataset"></a>So ändern Sie den AdventureWorksDataset  
...
## <a name="to-add-a-report-parameter-and-republish-the-report"></a><a name="bkmk_add_reportparameter"></a>So fügen Sie einen Berichtsparameter hinzu und veröffentlichen den Bericht erneut  
...
## <a name="re-deploy-the-report"></a><a name="bkmk_redeploy"></a>Bericht erneut bereitstellen  
