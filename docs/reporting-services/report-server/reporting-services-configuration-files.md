...
|Web.config für den Berichts-Manager.|Enthält nur die Einstellungen, die ggf. für die SSRS-Version für ASP.NET erforderlich sind.|\<Installationsverzeichnis>\Reporting Services\ReportManager|  
