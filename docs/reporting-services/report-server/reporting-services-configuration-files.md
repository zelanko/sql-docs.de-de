...
|Web.config für den Berichts-Manager.|Enthält nur Einstellungen, die für ASP.NET erforderlich und für die SSRS-Version verfügbar sind.|\<Installationsverzeichnis>\Reporting Services\ReportManager|  
