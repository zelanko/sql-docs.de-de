...
description: PowerShell-Cmdlets werden installiert, um den SharePoint-Modus von SQL Server Reporting Services zu unterstützen (einschließlich Installation, Feature und Anwendungsverwaltung).
ms.date: 09/25/2017
