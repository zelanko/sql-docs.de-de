...
description: In diesem Artikel erhalten Sie Informationen zu SharePoint-Websitesammlungsfeatures, die im SharePoint-Modus von SQL Server Reporting Services zur Verfügung stehen.
ms.date: 09/25/2017
