...
description: Mit der Lookup-Funktion können Sie den ersten übereinstimmenden Wert für den angegebenen Namen aus einem Dataset zurückgeben, das Namens- oder Wert-Paare enthält.
ms.date: 03/07/2017
