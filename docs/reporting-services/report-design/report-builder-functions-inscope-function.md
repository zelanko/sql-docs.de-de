---
title: InScope-Funktion (Berichts-Generator) | Microsoft-Dokumentation
description: Die InScope-Funktion gibt an, ob sich die aktuelle Instanz eines Elements im Berichts-Generator im angegebenen Bereich befindet.
ms.date: 03/08/2017
