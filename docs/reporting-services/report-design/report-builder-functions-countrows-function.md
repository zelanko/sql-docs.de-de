...
description: In diesem Artikel erhalten Sie Informationen zur CountRows-Funktion, die die Anzahl der Zeilen in einem angegebenen Bereich einschließlich der Zeilen mit NULL-Werten zurückgibt.
ms.date: 03/07/2017
