...
description: Zeigt Zeilengruppen und Spaltengruppen für einen aktuell ausgewählten Tablix-Datenbereich an Weitere Informationen über den Gruppierungsbereich im Berichts-Generator
ms.date: 08/17/2018
