...
description: Hier erfahren Sie mehr über diese Funktion, die die Vereinigung aller numerischen Werte ungleich NULL zurückgibt, die durch einen Ausdruck angegeben werden.
ms.date: 03/07/2017
