---
title: Ändern von Indikatorsymbolen und Indikatorsätzen (Berichts-Generator) | Microsoft-Dokumentation
description: Hier erfahren Sie, wie Sie die Indikatorsymbole und Indikatoren so ändern, dass sie andere, mehr oder weniger Indikatorsymbole enthalten, damit Sie Daten besser im Berichts-Generator darstellen können.
ms.date: 03/01/2017
...
3.  Klicken Sie in der Spalte **Farbe** neben dem Symbol, das geändert werden soll, auf den Nach-unten-Pfeil, und wählen Sie dann die gewünschte Farbe, **Keine Farbe**oder **Weitere Farben**.  
     ...
     Wenn Sie auf **Weitere Farben**geklickt haben, wird das Dialogfeld **Farbe auswählen** geöffnet, in dem Sie zwischen vielen verschiedenen Farben auswählen können. Weitere Informationen zu den zugehörigen Optionen finden Sie unter [Farbe auswählen (Dialogfeld) (Berichts-Generator und SSRS)](./formatting-lines-colors-and-images-report-builder-and-ssrs.md). Klicken Sie auf **OK** , um das Dialogfeld **Farbe auswählen** zu schließen.  
