...
description: In diesem Artikel erfahren Sie, wie Sie die RowNumber-Funktion im Berichts-Generator verwenden, um die aktuelle Anzahl aller Zeilen in einem bestimmten Bereich abzurufen.
ms.date: 03/07/2017
