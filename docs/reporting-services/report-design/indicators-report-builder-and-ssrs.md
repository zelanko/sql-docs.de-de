...
##  <a name="choosing-the-indicator-type-to-use"></a><a name="ChoosingIndicatorTypes"></a> Auswählen des zu verwendenden Indikatortyps  
...
##  <a name="sizing-indicators-to-maximize-visual-impact"></a><a name="SizingIndicatators"></a> Anpassen der Größe von Indikatoren für eine maximale visuelle Wirkung  
...
##  <a name="including-indicators-and-gauges-in-gauge-panels"></a><a name="IncludingIndicatorsInGauges"></a> Aufnehmen von Indikatoren und Messgeräten in Messgerätbereiche  
...
##  <a name="sequence-of-indicator-states"></a><a name="SequenceIndicatorStates"></a> Sequenz der Indikatorstatus  
