---
title: Previous-Funktion (Berichts-Generator) | Microsoft-Dokumentation
description: Die Previous-Funktion im Berichts-Generator gibt den Wert oder angegebenen Aggregatwert für die vorherige Instanz eines Elements zurück.
ms.date: 03/07/2017
