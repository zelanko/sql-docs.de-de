...
description: Hier erfahren Sie, wie Sie die Designansicht im Reporting Services-Berichts-Designer verwenden, um Berichtselemente in einem Bericht anzuordnen.
ms.date: 05/31/2016
