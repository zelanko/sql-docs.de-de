...
description: Geben Sie in der RSReportServer-Konfigurationsdatei Parameter für Renderingerweiterungen an, um das Standardrenderverhalten von Berichten für Reporting Services-Berichte zu überschreiben.
ms.date: 03/20/2017
