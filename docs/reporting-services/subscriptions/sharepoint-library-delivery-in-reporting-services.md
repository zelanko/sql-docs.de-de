...
description: Hier erfahren Sie mehr über die Verwendung der Erweiterung für die SharePoint-Bibliotheksübermittlung in Reporting Services, indem Sie ein Abonnement von einer Anwendungsseite auf einer SharePoint-Website verwenden.
ms.date: 03/14/2017
