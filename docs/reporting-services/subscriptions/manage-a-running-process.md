...
description: Erfahren Sie, wie Sie einen laufenden Prozess wie einen Benutzerauftrag oder einen Systemauftrag verwalten. Sie können einen Auftrag anzeigen, abbrechen oder programmgesteuert verwalten.
ms.date: 03/20/2017
