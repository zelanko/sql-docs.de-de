...
description: In diesem Artikel erfahren Sie mehr über das Einrichten der Übermittlungserweiterung für Dateifreigaben, mit der Sie einen Bericht an einen Ordner übermitteln können.
ms.date: 03/01/2017
