...
description: In dieser Übersicht wird die Verwendung von freigegebenen und berichtsspezifischen Zeitplänen zum Steuern der Verarbeitung und Verteilung von Berichten erläutert.
ms.date: 07/01/2016
