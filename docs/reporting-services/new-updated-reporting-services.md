...
1. [Änderungsprotokoll für SQL Server Reporting Services](#TitleNum_1)
...
### <a name="1-nbsp-change-log-for-sql-server-reporting-serviceschange-log-sql-server-reporting-servicesmd"></a>1. &nbsp; [Änderungsprotokoll für SQL Server Reporting Services](change-log-sql-server-reporting-services.md)

*Aktualisiert: 27.04.2018* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ([Weiter](#TitleNum_2))
...
*Aktualisiert: 10.04.2018* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ([Zurück](#TitleNum_1))
