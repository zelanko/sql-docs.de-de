...
description: T-SQL-Anweisungen für das Analytics Platform System (APS) SQL Server parallel Data Warehouse (PDW).
author: mzaman1
ms.prod: sql
...
* [externe Tabelle erstellen](../t-sql/statements/create-external-table-transact-sql.md)
* [Create-Funktion](../t-sql/statements/create-function-sql-data-warehouse.md)
* [CREATE INDEX](../t-sql/statements/create-index-transact-sql.md)
* [CREATE PROCEDURE](../t-sql/statements/create-procedure-transact-sql.md)
* [Schema erstellen](../t-sql/statements/create-schema-transact-sql.md)
* [Erstellen von Statistiken](../t-sql/statements/create-statistics-transact-sql.md)
* [CREATE TABLE](../t-sql/statements/create-table-azure-sql-data-warehouse.md)
* [CREATE TABLE als SELECT](../t-sql/statements/create-table-as-select-azure-sql-data-warehouse.md)
* [CREATE VIEW](../t-sql/statements/create-view-transact-sql.md)
* [externe Datenquelle löschen](../t-sql/statements/drop-external-data-source-transact-sql.md)
* [externes Datei Format ablegen](../t-sql/statements/drop-external-file-format-transact-sql.md)
* [externe Tabelle löschen](../t-sql/statements/drop-external-table-transact-sql.md)
...
* [Tabelle löschen](../t-sql/statements/drop-table-transact-sql.md)
* [Schema löschen](../t-sql/statements/drop-schema-transact-sql.md)
* [Ablage Ansicht](../t-sql/statements/drop-view-transact-sql.md)
...
* [Andere](../t-sql/queries/option-clause-transact-sql.md)
...
* [Such Bedingung](../t-sql/queries/search-condition-transact-sql.md)
...
* Berechtigungen: [GRANT](../t-sql/statements/grant-transact-sql.md), [DENY](../t-sql/statements/deny-transact-sql.md), [REVOKE](../t-sql/statements/revoke-transact-sql.md)
* [ALTER AUTHORIZATION](../t-sql/statements/alter-authorization-transact-sql.md)
* [Zertifikat ändern](../t-sql/statements/alter-certificate-transact-sql.md)
* [Alter Database-Verschlüsselungsschlüssel](../t-sql/statements/alter-database-encryption-key-transact-sql.md)
* [ALTER LOGIN](../t-sql/statements/alter-login-transact-sql.md)
* [Alter Master Key](../t-sql/statements/alter-master-key-transact-sql.md)
* [Rolle ändern](../t-sql/statements/alter-role-transact-sql.md)
* [Benutzer ändern](../t-sql/statements/alter-user-transact-sql.md)
...
* [Verschlüsselungsschlüssel für Datenbank löschen](../t-sql/statements/drop-database-encryption-key-transact-sql.md)
* [DROP LOGIN](../t-sql/statements/drop-login-transact-sql.md)
* [DROP MASTER KEY](../t-sql/statements/drop-master-key-transact-sql.md)
* [Rolle löschen](../t-sql/statements/drop-role-transact-sql.md)
* [Benutzer löschen](../t-sql/statements/drop-user-transact-sql.md)
* [OPEN MASTER KEY](../t-sql/statements/open-master-key-transact-sql.md)

## <a name="next-steps"></a>Nächste Schritte
Weitere Referenzinformationen finden Sie unter [t-SQL-Sprachelemente](tsql-language-elements.md) und [t-SQL-System Sichten](tsql-system-views.md).
