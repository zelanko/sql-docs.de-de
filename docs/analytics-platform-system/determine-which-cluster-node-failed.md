...
## <a name="admin-console-solution"></a><a name="AdminConsoleSolution"></a>Verwaltungs Konsolen Lösung  
...
## <a name="system-view-solution"></a><a name="SystemView"></a>System Ansichts Lösung  
