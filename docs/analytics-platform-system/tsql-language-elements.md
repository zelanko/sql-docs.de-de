...
description: T-SQL-Sprachelemente für das Analytics Platform System (APS) SQL Server parallel Data Warehouse (PDW).
author: mzaman1
ms.prod: sql
...
* [Auszuführen](../t-sql/language-elements/execute-transact-sql.md)
* [Eindrücke](../t-sql/language-elements/expressions-transact-sql.md)
* [Abge](../t-sql/language-elements/kill-transact-sql.md)
* [Problem Umgehung der Identitäts Eigenschaft](../t-sql/statements/create-table-transact-sql-identity-property.md)
* [Gedruck](../t-sql/language-elements/print-transact-sql.md)
* [Konsum](../t-sql/language-elements/use-transact-sql.md)

## <a name="batches-control-of-flow-and-variables"></a>Batches, Ablaufsteuerung und Variablen
* [Anfang... Schließlich](../t-sql/language-elements/begin-end-transact-sql.md)
* [Umbruch](../t-sql/language-elements/break-transact-sql.md)
* [Deklariert@local_variable](../t-sql/language-elements/declare-local-variable-transact-sql.md)
* [Wenn... Woanders](../t-sql/language-elements/if-else-transact-sql.md)
* [RAISERROR](../t-sql/language-elements/raiserror-transact-sql.md)
* [SET@local_variable](../t-sql/language-elements/set-local-variable-transact-sql.md)
* [Schale](../t-sql/language-elements/throw-transact-sql.md)
* [Try... Quote](../t-sql/language-elements/try-catch-transact-sql.md)
* [Als](../t-sql/language-elements/while-transact-sql.md)

## <a name="operators"></a>Operatoren
* [+ (Hinzufügen)](../t-sql/language-elements/add-transact-sql.md)
* [+ (Zeichen folgen Verkettung)](../t-sql/language-elements/string-concatenation-transact-sql.md)
...
* [= (Ist Gleichheits)](../t-sql/language-elements/equals-transact-sql.md)
...
* [Immer](../t-sql/language-elements/and-transact-sql.md)
* [BETWEEN](../t-sql/language-elements/between-transact-sql.md)
* [Gebe](../t-sql/language-elements/exists-transact-sql.md)
* [IN](../t-sql/language-elements/in-transact-sql.md)
* [ist nicht](../t-sql/queries/is-null-transact-sql.md)
* [mögen](../t-sql/language-elements/like-transact-sql.md)
* [NOT](../t-sql/language-elements/not-transact-sql.md)
* [Noch](../t-sql/language-elements/or-transact-sql.md)
...
* [Stäbchen](../t-sql/functions/abs-transact-sql.md)
...
* [Erzeugnissen](../t-sql/functions/cos-transact-sql.md)
* [Bauch](../t-sql/functions/cot-transact-sql.md)
* [Countdown](../t-sql/functions/count-transact-sql.md)
...
* [Ertag](../t-sql/functions/day-transact-sql.md)
* [DB_ID](../t-sql/functions/db-id-transact-sql.md)
* [DB_NAME](../t-sql/functions/db-name-transact-sql.md)
* [Schwierigkeits](../t-sql/functions/degrees-transact-sql.md)
* [DENSE_RANK](../t-sql/functions/dense-rank-transact-sql.md)
* [Unterschied](../t-sql/functions/difference-transact-sql.md)
...
* [Steh](../t-sql/functions/floor-transact-sql.md)
...
* [Führen](../t-sql/functions/lead-transact-sql.md)
* [LEFT](../t-sql/functions/left-transact-sql.md)
* [LEN](../t-sql/functions/len-transact-sql.md)
* [Angezeigt](../t-sql/functions/log-transact-sql.md)
* [LOG10](../t-sql/functions/log10-transact-sql.md)
* [Günstigere](../t-sql/functions/lower-transact-sql.md)
* [LTRIM](../t-sql/functions/ltrim-transact-sql.md)
* [Max](../t-sql/functions/max-transact-sql.md)
* [Man](../t-sql/functions/min-transact-sql.md)
* [Ges](../t-sql/functions/month-transact-sql.md)
...
* [PiS](../t-sql/functions/pi-transact-sql.md)
* [POWER](../t-sql/functions/power-transact-sql.md)
* [QUOTENAME](../t-sql/functions/quotename-transact-sql.md)
* [Bogenmaß](../t-sql/functions/radians-transact-sql.md)
* [RAND](../t-sql/functions/rand-transact-sql.md)
* [Gehören](../t-sql/functions/rank-transact-sql.md)
* [Stelle](../t-sql/functions/replace-transact-sql.md)
* [REPLICATE](../t-sql/functions/replicate-transact-sql.md)
* [Umgekehr](../t-sql/functions/reverse-transact-sql.md)
* [RIGHT](../t-sql/functions/right-transact-sql.md)
* [Umgekehrt](../t-sql/functions/round-transact-sql.md)
...
* [Gebärden](../t-sql/functions/sign-transact-sql.md)
* [Tod](../t-sql/functions/sin-transact-sql.md)
...
* [BRaum](../t-sql/functions/space-transact-sql.md)
...
* [SRT](../t-sql/functions/str-transact-sql.md)
* [Sachen](../t-sql/functions/stuff-transact-sql.md)
* [SUBSTRING](../t-sql/functions/substring-transact-sql.md)
* [Pauschalen](../t-sql/functions/sum-transact-sql.md)
...
* [Ungs](../t-sql/functions/tan-transact-sql.md)
...
* [Weite](../t-sql/functions/upper-transact-sql.md)
* [Bedienungs](../t-sql/functions/user-transact-sql.md)
...
* [Jährigen](../t-sql/functions/year-transact-sql.md)
...
* [Diagnose Sitzung erstellen](../t-sql/language-elements/create-diagnostics-session-transact-sql.md)
...
* [ANSI_NULL_DFLT_ON festlegen](../t-sql/statements/set-ansi-null-dflt-on-transact-sql.md)
* [ANSI_NULLS festlegen](../t-sql/statements/set-ansi-nulls-transact-sql.md)
* [ANSI_PADDING festlegen](../t-sql/statements/set-ansi-padding-transact-sql.md)
* [ANSI_WARNINGS festlegen](../t-sql/statements/set-ansi-warnings-transact-sql.md)
...
* [QUOTED_IDENTIFIER festlegen](../t-sql/statements/set-quoted-identifier-transact-sql.md)
...
* [Transaktions Isolationsstufe festlegen](../t-sql/statements/set-transaction-isolation-level-transact-sql.md)
