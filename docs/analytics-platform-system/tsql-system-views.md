...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>Parallele Data Warehouse dynamischer Verwaltungs Sichten (DMVs)
...
* [sys. Assemblys](https://msdn.microsoft.com/library/ms189790.aspx)
...
* [sys. Zertifikate](https://msdn.microsoft.com/library/ms189774.aspx)
...
* [sys. Anmelde Informationen](../relational-databases/system-catalog-views/sys-credentials-transact-sql.md)
...
* [sys.-Datenbanken](https://msdn.microsoft.com/library/ms178534.aspx)
...
* [sys. File Groups](https://msdn.microsoft.com/library/ms187782.aspx)
...
* [sys. Prozeduren](https://msdn.microsoft.com/library/ms188737.aspx)
...
* [sys. Synonyme](../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md)
* [sys. syscharsets](../relational-databases/system-compatibility-views/sys-syscharsets-transact-sql.md)
* [sys. syscolumschlag](../relational-databases/system-compatibility-views/sys-syscolumns-transact-sql.md)
* [sys. sysdatenbanken](../relational-databases/system-compatibility-views/sys-sysdatabases-transact-sql.md)
...
* [Spalten](../relational-databases/system-information-schema-views/columns-transact-sql.md)
* [PARAMETER](../relational-databases/system-information-schema-views/parameters-transact-sql.md)
* [Routinier](../relational-databases/system-information-schema-views/routines-transact-sql.md)
* [Schemas](../relational-databases/system-information-schema-views/schemata-transact-sql.md)
* [Spielern](../relational-databases/system-information-schema-views/tables-transact-sql.md)
...
* [Ansichten](../relational-databases/system-information-schema-views/views-transact-sql.md)
