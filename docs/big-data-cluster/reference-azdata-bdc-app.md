---
title: Referenz zur azdata BDC-App
titleSuffix: SQL Server big data clusters
description: Referenz Artikel für azdata BDC-App-Befehle.
author: MikeRayMSFT
ms.author: mikeray
...
|     |     |
| --- | --- |
[Status der azdata-BDC-App](reference-azdata-bdc-app-status.md) | App Service-Status Befehle.
