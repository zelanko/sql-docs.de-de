...
| **CLUSTER_COMPUTE_POOL_REPLICAS** | Nein | 1 | Die Anzahl der Compute-Pool Replikate zu erstellen. In CTP 2.4 nur Wert zulässig ist 1. |
...
| **DOCKER_EMAIL** | Ja | Nicht zutreffend | Ihre e-Mail-Adresse. |
