...
Wenn Sie ACS verwenden, müssen Sie den folgenden Befehl zum Abrufen der IP-Adresse Ausführen der `mgmtproxy-svc-external` Dienst mit dem folgenden Befehl in einem nachfolgenden bash- oder Cmd-Fenster:
