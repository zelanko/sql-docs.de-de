...
> [!NOTE]
> Die `<cluster name>` ist hier der Name des Clusters, den Sie in der Konfigurationsdatei der Bereitstellung angegeben. Der Standardname lautet `mssql-cluster`.
