...
Um die Datei unter **hdfs:///airlinedata** aufzulisten, verwenden Sie den folgenden curl-Befehl:
...
Um die neue Datei **test.csv** aus dem lokalen Verzeichnis im Verzeichnis „airlinedata“ abzulegen, verwenden Sie den folgenden curl-Befehl (der **Content-Type**-Parameter ist erforderlich):
