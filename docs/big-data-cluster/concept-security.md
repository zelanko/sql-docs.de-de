...
## <a name="intra-cluster-authentication"></a>Interne clusterauthentifizierung
...
> [!NOTE]
> In CTP2. 0 wird nur Standardauthentifizierung unterstützt. Differenzierte Zugriffssteuerung auf Objekte von HDFS und SQL big Data-Cluster COMPUTE- und Pools ist noch nicht verfügbar.
