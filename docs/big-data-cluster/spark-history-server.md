...
* [Erste Schritte mit Big Data-Clustern unter SQL Server](https://docs.microsoft.com/sql/big-data-cluster/deploy-get-started?view=sqlallproducts-allversions)
