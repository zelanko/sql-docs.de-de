...
description: Hier lernen Sie die Serversicherheitseinstellungen in SQL Server kennen. Sie erhalten Informationen über Optionen, die die Serverauthentifizierung, Proxykonten und andere Features steuern.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
