...
description: Hier erfahren Sie, wie Sie die Option „index create memory“ verwenden, um den maximalen Arbeitsspeicher festzulegen, den SQL Server Sortiervorgängen beim Erstellen von Indizes zuweist.
ms.custom: ''
ms.date: 11/24/2017
ms.prod: sql
