...
description: Informieren Sie sich über die Option „Standardablaufverfolgung aktiviert“. Finden Sie heraus, wie die Standardablaufverfolgung bei der Problembehandlung helfen kann.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
