...
description: In diesem Artikel lernen Sie die in SQL Server verfügbaren Dienste kennen. Sie erfahren, wie Sie den SQL Server-Konfigurations-Manager starten, den Sie zum Verwalten verschiedener Dienste verwenden können.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
