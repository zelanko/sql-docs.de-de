...
description: In diesem Artikel erfahren Sie, wie Sie eine SQL Server-Datenbank für die Datenbankspiegelung vorbereiten.
...
##  <a name="FollowUp"></a>Nächster Schritt: Nach der Vorbereitung einer Spiegeldatenbank  
