...
- Laden Sie [SQL Server 2016](https://www.microsoft.com/en-us/evalcenter/evaluate-sql-server-2016) herunter.
...
-   [Verbesserungen im Hinblick auf hohe Verfügbarkeit](#high-availability-enhancements)
