...
Sehen Sie sich für [!INCLUDE[sssqlv14-md](../includes/sssqlv14-md.md)] die [Als veraltet markierte Funktionen der Datenbank-Engine in SQL Server 2017](../database-engine/deprecated-database-engine-features-in-sql-server-2017.md) an.
...
|TextPointer|WRITETEXT<br /><br /> UPDATETEXT<br /><br /> READTEXT|None|UPDATETEXT oder WRITETEXT<br /><br /> READTEXT|115<br /><br /> 114|  
...
|[!INCLUDE[tsql](../includes/tsql-md.md)]|Nicht beendete [!INCLUDE[tsql](../includes/tsql-md.md)] -Anweisungen mit einem Semikolon|Beenden Sie [!INCLUDE[tsql](../includes/tsql-md.md)] -Anweisungen mit einem Semikolon ( ; ).|None|None|  
