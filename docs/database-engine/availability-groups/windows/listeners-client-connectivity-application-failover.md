...
description: Dieser Artikel enthält Informationen zum Herstellen einer Verbindung mit einem Always On-Verfügbarkeitsgruppenlistener vor und nach einem Failover.
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
