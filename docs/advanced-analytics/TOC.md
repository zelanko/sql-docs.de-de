...
### [Eingebettete R-Pakete in gespeicherten Prozeduren und Funktionen](tutorials/sqldev-in-database-r-for-sql-developers.md)
...
#### [3: Visualisieren von Daten mithilfe von R in gespeicherten Prozeduren](tutorials/sqldev-explore-and-visualize-the-data.md)
#### [4: Erstellen von Datenfeatures mit R in T-SQL-Funktionen](tutorials/sqldev-create-data-features-using-t-sql.md)
