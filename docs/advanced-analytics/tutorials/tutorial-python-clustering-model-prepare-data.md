---
title: 'Tutorial: Vorbereiten von Daten für die Durchführung von Clustering in python'
...
ms.locfileid: "70211964"
---
# <a name="tutorial-prepare-data-to-perform-clustering-in-python-with-sql-server-machine-learning-services"></a>Tutorial: Vorbereiten von Daten für die Durchführung von Clustering in Python mit SQL Server Machine Learning Services

Im Teil 2 dieser vierteiligen tutorialreihe importieren und bereiten Sie die Daten aus einer SQL-Datenbank mithilfe von Python. Später in dieser Reihe verwenden Sie diese Daten zum trainieren und Bereitstellen eines Clusteringmodells in Python mit SQL Server Machine Learning Services.
...
* In Teil 2 dieses Tutorials wird davon ausgegangen, dass Sie die Voraussetzungen von [**Teil 1**](tutorial-python-clustering-model.md)erfüllt haben.
...
> [Tutorial: Erstellen eines Vorhersagemodells in Python mit SQL Server Machine Learning Services](tutorial-python-clustering-model-build.md)
