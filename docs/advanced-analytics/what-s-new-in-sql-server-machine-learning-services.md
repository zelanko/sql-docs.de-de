---
title: Neues
description: Ankündigungen neuer Funktionen für die verschiedenen Versionen von SQL Server 2016 R Services, R Server und SQL Server Machine Learning Services.
ms.date: 11/04/2019
ms.topic: conceptual
author: dphansen
ms.author: davidph
...
Zu den neuen Funktionen für R zählen die [**Paketverwaltung**](r/install-additional-r-packages-on-sql-server.md) mit den folgenden Highlights: 
...
+ [RevoScaleR](r/use-revoscaler-to-manage-r-packages.md)-Funktionen helfen bei der Installation, Entfernung oder Auflistung von Paketen, die sich im Besitz von Benutzern befinden. Weitere Informationen finden Sie unter [Verwenden von RevoScaleR-Funktionen zum Suchen oder Installieren von R-Paketen unter SQL Server](r/use-revoscaler-to-manage-r-packages.md).
...
+ [Tutorials und Beispiele für maschinelles Lernen](tutorials/machine-learning-services-tutorials.md)
