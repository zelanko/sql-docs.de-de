---
title: 'Gewusst wie: Verwenden der RevoScaleR-Funktionen zum Suchen oder installieren R-Pakete auf SQL Server | Microsoft-Dokumentation'
ms.prod: sql
