...
Das **RevoScaleR** -Paket enthält die Implementierung einiger der beliebtesten R-Funktionen, die umgestaltet wurden, um die Parallelität und Skalierung bereitzustellen. Weitere Informationen finden Sie unter [Distributed-Computing mithilfe von RevoScaleR](https://msdn.microsoft.com/microsoft-r/scaler-distributed-computing).
...
+  [-Datenanalyse mithilfe von Microsoft R](https://msdn.microsoft.com/microsoft-r/data-analysis-in-microsoft-r)
