...
Erfahren Sie, wie Sie mit [SQL Server Machine Learning Services](../what-is-sql-server-machine-learning.md) Python- und R-Skripts in einem Notebook in [Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/what-is) ausführen. Azure Data Studio ist ein plattformübergreifendes Datenbanktool.
