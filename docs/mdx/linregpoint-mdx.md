...
# <a name="linregpoint-mdx"></a>LinRegPoint (MDX)
  ...
  Berechnet die lineare Regression einer Menge und gibt den Wert des *y-Abfang* Werts in der Regressions Zeile y = ax + b für einen bestimmten Wert von x zurück.  
