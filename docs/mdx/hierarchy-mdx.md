---
title: Hierarchy (MDX) | Microsoft-Dokumentation
ms.date: 06/04/2018
ms.prod: sql
...
### <a name="examples"></a>Beispiele  
 Im folgenden Beispiel wird der Name der Kalender Hierarchie in der Date-Dimension im AdventureWorks-Cube zurückgegeben.  
