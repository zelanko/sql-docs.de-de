---
title: DISTINCT Keyword-Beschränkungen | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81303471"
---
# <a name="distinct-keyword-limitations"></a>Einschränkungen des DISTINCT-Schlüsselworts
Nicht unterstützt für Long Text-Felder (Microsoft Access) oder Memo-Felder (dBASE).
