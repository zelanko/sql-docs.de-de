---
title: SQLGetInfo zurückgegebene Werte für dBASE | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (Der Qualifizierer wird in gemischtem Fall zurückgegeben, damit Windows NT das Verzeichnis finden kann.)|  
