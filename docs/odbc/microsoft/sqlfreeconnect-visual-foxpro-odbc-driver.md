...
>  Dieses Thema enthält Visual FoxPro ODBC-Treiberspezifische Informationen. Allgemeine Informationen zu dieser Funktion finden Sie im entsprechenden Thema unter [ODBC-API-Referenz](../../odbc/reference/syntax/odbc-api-reference.md).  
 ...
 Gibt ein Verbindungshandle frei und gibt den gesamten für das Handle reservierten Speicher frei.  
  
 Weitere Informationen finden Sie unter [SQLFreeConnect](../../odbc/reference/syntax/sqlfreeconnect-function.md) in der *ODBC-Programmiererreferenz*.
