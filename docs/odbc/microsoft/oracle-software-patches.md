...
ms.locfileid: "88340686"
---
# <a name="oracle-software-patches"></a>Oracle-Software-Patches
> [!IMPORTANT]  
>  Diese Funktion wird in einer zukünftigen Version von Windows entfernt. Nutzen Sie diese Funktionen bei Neuentwicklungen nicht mehr, und planen Sie die Änderung von Anwendungen, die diese Funktion zurzeit verwenden. Verwenden Sie stattdessen den von Oracle bereitgestellten ODBC-Treiber.  
  
 Für die ordnungsgemäße Funktionsweise mehrerer Microsoft-Produkte und-Technologien, einschließlich des Microsoft ODBC-Treibers für Oracle, der Microsoft OLE DB-Anbieter für Oracle, Internetinformationsdienste (IIS), Komponenten Dienste (oder Microsoft Transaction Server, wenn Sie Windows NT verwenden), sind Patches für die Oracle-Server Produkte und die zugehörigen Client Komponenten erforderlich.  
