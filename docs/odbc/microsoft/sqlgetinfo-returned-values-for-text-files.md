---
title: SQLGetInfo zurückgegebene Werte für Textdateien | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
In der folgenden Tabelle sind die C-Sprache #defines für das *fInfoType-Argument* und die entsprechenden Werte aufgeführt, die von **SQLGetInfo**zurückgegeben werden. Diese Informationen können abgerufen werden, indem sie die aufgelistete C-Sprache #defines im *FInfoType-Argument* an **SQLGetInfo** übergeben. Weitere Informationen zu den von **SQLGetInfo**zurückgegebenen Werten finden Sie in der [ODBC-Programmiererreferenz](../../odbc/reference/odbc-programmer-s-reference.md).  
