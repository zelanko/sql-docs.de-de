...
ms.locfileid: "47758968"
---
# <a name="odbc-escape-sequences"></a>ODBC-Escapesequenzen
Die folgenden Escapesequenzen werden in ODBC verwendet. Die Grammatik in diesem Abschnitt wird verwendet, einige Elemente, die in definierten [Elemente verwendet wird, in SQL-Anweisungen](../../../odbc/reference/appendixes/elements-used-in-sql-statements.md).  
