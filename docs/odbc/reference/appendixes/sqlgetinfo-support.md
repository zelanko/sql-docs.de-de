...
|SQL_ODBC_API_CONFORMANCE (ODBC 1.0)|Ein SQLSMALLINT-Wert, der die ODBC-Übereinstimmung angibt.<br /><br /> SQL_OAC_NONE = keine<br /><br /> SQL_OAC_LEVEL1 = Ebene-1 unterstützt<br /><br /> SQL_OAC_LEVEL2 = Ebene-2 unterstützt|  
