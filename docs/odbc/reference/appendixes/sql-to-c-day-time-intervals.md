---
title: 'SQL in C: Tag-Zeitintervalle | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
...
---
# <a name="sql-to-c-day-time-intervals"></a>SQL in C: Tag-Uhrzeit-Intervalle

Der Bezeichner für die Tag-Zeitintervall ODBC-SQL-Datentypen sind die folgenden:
