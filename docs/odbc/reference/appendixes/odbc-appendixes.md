---
title: ODBC-Appendixes | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81299840"
---
# <a name="odbc-appendixes"></a>ODBC-Anhänge
Technische Details im Zusammenhang mit der Microsoft ODBC-Schnittstelle sind in den folgenden Appendixes enthalten:  
  
-   [Anhang A: ODBC-Fehlercodes](../../../odbc/reference/appendixes/appendix-a-odbc-error-codes.md)  
  
-   [Anhang B: ODBC-Statusübergangstabellen](../../../odbc/reference/appendixes/appendix-b-odbc-state-transition-tables.md)  
...
-   [Anhang G: Treiber-Richtlinien für die Abwärtskompatibilität](../../../odbc/reference/appendixes/appendix-g-driver-guidelines-for-backward-compatibility.md)
