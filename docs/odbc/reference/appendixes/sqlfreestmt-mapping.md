...
Wenn eine Anwendung **SQLFreeStmt** mit dem *Option-Argument* SQL_DROP über einen ODBC *3.x-Treiber* aufruft,  
...
```  
 ...
 mit *Handle* dem Handle-Argument, das auf den Wert in *hstmt*festgelegt ist.
