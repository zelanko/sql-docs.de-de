 ...
 *fRemoveDSN*  
 ...
 "True": Entfernen von DSNs im Zusammenhang mit dem Treiber, die im angegebenen *LpszDriver*. "False": Entfernen Sie nicht verknüpft ist, mit dem Treiber, die im angegebenen DSNs *LpszDriver*.  
