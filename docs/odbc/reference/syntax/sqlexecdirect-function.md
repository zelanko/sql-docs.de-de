...
|22025|Ungültige Escapesequenz|\**StatementText* enthielt eine SQL­Anweisung, die enthaltenen "**wie** *Musterwert* **ESCAPE** *Escapezeichen* "in der **, in denen** -Klausel und das Zeichen, die das Escapezeichen im Musterwert war keiner der"%"oder"_".|  
