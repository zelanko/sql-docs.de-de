...
|SQL_ATTR_ASYNC_DBC_EVENT|Sie können das|  
|SQL_ATTR_ASYNC_DBC_FUNCTIONS_ENABLE|Entweder [4]|  
|SQL_ATTR_ASYNC_DBC_PCALLBACK|Sie können das|  
|SQL_ATTR_ASYNC_DBC_PCONTEXT|Sie können das|  
|SQL_ATTR_ASYNC_ENABLE|Entweder [2]|  
|SQL_ATTR_AUTO_IPD|Sie können das|  
|SQL_ATTR_AUTOCOMMIT|Entweder [5]|  
|SQL_ATTR_CONNECTION_DEAD|Nachher|  
|SQL_ATTR_CONNECTION_TIMEOUT|Sie können das|  
|SQL_ATTR_CURRENT_CATALOG|Entweder [1]|  
|SQL_ATTR_DBC_INFO_TOKEN|Nachher|  
|SQL_ATTR_ENLIST_IN_DTC|Nachher|  
|SQL_ATTR_LOGIN_TIMEOUT|Vorher|  
|SQL_ATTR_METADATA_ID|Sie können das|  
|SQL_ATTR_ODBC_CURSORS|Vorher|  
|SQL_ATTR_PACKET_SIZE|Vorher|  
|SQL_ATTR_QUIET_MODE|Sie können das|  
|SQL_ATTR_TRACE|Sie können das|  
|SQL_ATTR_TRACEFILE|Sie können das|  
|SQL_ATTR_TRANSLATE_LIB|Nachher|  
|SQL_ATTR_TRANSLATE_OPTION|Nachher|  
