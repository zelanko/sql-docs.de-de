...
|HY010|Funktions Sequenz Fehler|(DM) ein Verbindungs Handle wurde auf Environment- *THandle*zugeordnet.<br /><br /> (DM) **SQL_ATTR_ODBC_VERSION** wurde nicht mit **SQLSetEnvAttr** festgelegt, und das *Attribut* ist nicht gleich **SQL_ATTR_ODBC_VERSION**. Sie müssen **SQL_ATTR_ODBC_VERSION** nicht explizit festlegen, wenn Sie **sqlzuzugchandlestd**verwenden.|  
...
|HYC00|Optionales Feature nicht implementiert|Der für das Argument- *Attribut* angegebene Wert war ein gültiges ODBC-Umgebungs Attribut für die Version von ODBC, die vom Treiber unterstützt wird, jedoch nicht vom Treiber unterstützt wurde.<br /><br /> (DM) das *Attribut* Argument lautete SQL_ATTR_OUTPUT_NTS, und *ValuePtr* war SQL_FALSE.|  
