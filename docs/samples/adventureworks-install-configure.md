...
description: Befolgen Sie diese Anweisungen, um AdventureWorks-Beispiel Datenbanken mit SQL Server Management Studio oder in Azure SQL-Datenbank herunterzuladen und zu installieren.
ms.prod: sql
ms.prod_service: sql
