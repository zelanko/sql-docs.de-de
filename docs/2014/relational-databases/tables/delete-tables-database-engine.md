...
-   Wenn Sie eine Tabelle löschen, enthält eine `varbinary (max)` Spalte mit dem FILESTREAM-Attribut im Dateisystem gespeicherten Daten werden nicht entfernt werden.  
