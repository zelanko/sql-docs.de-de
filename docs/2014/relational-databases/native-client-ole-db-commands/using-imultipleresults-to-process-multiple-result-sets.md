...
```  
 ...
 Der Consumer kann den Befehl entweder mit Abbrechen [issabort:: Abort](../native-client-ole-db-interfaces/issabort-abort-ole-db.md) oder alle Verweise auf das Befehlsobjekt und das abgeleitete Rowset freigibt.  
