...
|Meldungstext|Tabellenfehler: Die verwaiste Datei 'FILE' wurde im Filestream-Verzeichnis für Objekt-ID O_ID, Index-ID I_ID, Partitions-ID PN_ID, Spalten-ID C_ID gefunden werden.|  
