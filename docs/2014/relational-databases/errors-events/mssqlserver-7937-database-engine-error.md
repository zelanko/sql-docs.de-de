...
|Meldungstext|Tabellenfehler: FileStream-Verzeichnis für die Spalten-ID C_ID der Objekt-ID O_ID, Index-ID I_ID, Partitions-ID PN_ID ist nicht gefunden.|  
