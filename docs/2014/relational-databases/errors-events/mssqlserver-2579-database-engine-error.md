...
|Meldungstext|Tabellenfehler: Der Block P_ID in Objekt-ID O_ID, Index-ID I_ID, Partitions-ID PN_ID, ist die zuordnungseinheits-ID A_ID (Typ TYPE) außerhalb des Gültigkeitsbereichs dieser Datenbank.|  
