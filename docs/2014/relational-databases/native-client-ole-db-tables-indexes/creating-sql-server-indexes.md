...
# <a name="creating-sql-server-indexes"></a>Erstellen von SQL Server-Indizes
 ...
 Die *pIndexID* Parameter kann NULL sein, und wenn es sich handelt, die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter erstellt einen eindeutigen Namen für den Index. Der Consumer kann den Namen des Indexes erfassen, indem Sie einen gültigen Zeiger auf eine DBID im Angeben der *PpIndexID* Parameter.  
  
 Der Consumer kann den Indexnamen als Unicode-Zeichenfolge im Angeben der *PwszName* Mitglied der *uName* -Vereinigung des der *pIndexID* Parameter. Die *eKind* Mitglied *pIndexID* muss DBKIND_NAME sein.  
  
 Der Consumer gibt die Spalte oder die Spalten an, die namentlich in den Index einbezogen werden. Für jede DBINDEXCOLUMNDESC-Struktur, die in verwendete **CreateIndex**, *eKind* Mitglied der *pColumnID* muss DBKIND_NAME sein. Der Name der Spalte wird angegeben, als Unicode-Zeichenfolge in die *PwszName* Mitglied der *uName* -Vereinigung der *pColumnID*.  
...
|-----------------|-----------------|  
|DBPROP_INDEX_AUTOUPDATE|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
...
|DBPROP_INDEX_INITIALIZE|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
|DBPROP_INDEX_NULLCOLLATION|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
|DBPROP_INDEX_NULLS|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
...
|DBPROP_INDEX_SORTBOOKMARKS|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
|DBPROP_INDEX_TEMPINDEX|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
|DBPROP_INDEX_TYPE|R/w: Lesen/Schreiben<br /><br /> Standardwert: keiner<br /><br /> Beschreibung: Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter diese Eigenschaft nicht unterstützt. Versucht, die Eigenschaft festgelegt wird, im **CreateIndex** verursachen einen DB_S_ERRORSOCCURRED-Rückgabewert. Die *DwStatus* Member der Eigenschaftsstruktur gibt dbpropstatus_badvalue an.|  
