...
## <a name="dbcolumndesc-usage"></a>DBCOLUMNDESC-Verwendung  
 ...
 Wenn die *PwszTypeName* Member, der Consumer gibt den Datentyp mit [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Datentypnamen. Gültige Datentypnamen sind die, die in der Spalte TYPE_NAME des PROVIDER_TYPES-Schemarowsets zurückgegeben werden.  
