...
## <a name="download-only-articles"></a>Nur herunterladbare Artikel  
 ...
 Informationen zum Angeben eines herunterladbaren Artikels finden Sie unter [Specify That a Merge Table Article is Download-Only](../publish/specify-that-a-merge-table-article-is-download-only.md).  
