...
# <a name="log-reader-agent-security"></a>Sicherheit für den Protokolllese-Agent
  Im Dialogfeld **Protokolllese-Agent Sicherheit** können Sie Folgendes angeben:  
  
-   Das [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows-Konto, unter dem der Protokolllese-Agent auf dem Verteiler ausgeführt wird. Das Windows-Konto wird auch als *Prozess Konto*bezeichnet, da der Agentprozess unter diesem Konto ausgeführt wird.  
