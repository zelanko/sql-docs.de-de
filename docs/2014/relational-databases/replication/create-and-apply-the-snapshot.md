...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]: [Geben Sie den standardmäßigen Momentaufnahmespeicherort](snapshot-options.md#snapshot-folder-locations)
