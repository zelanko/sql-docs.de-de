...
4.  Ansicht verstrichene Zeit für das Überwachungstoken in den folgenden Spalten: **Verleger zu Verteiler**, **Verteiler zu Abonnent**, **Gesamtlatenzzeit**. Mit dem Wert **Ausstehend** wird angegeben, dass das Token noch nicht den Bestimmungspunkt erreicht hat.  
...
3.  Führen Sie auf dem Verleger für die Veröffentlichungsdatenbank [sp_posttracertoken &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-posttracertoken-transact-sql) aus und geben Sie **@publication** an. Beachten Sie den Wert des **@tracer_token_id** -Ausgabeparameters.  
