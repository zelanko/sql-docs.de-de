...
-   Das Dialogfeld **Abonnement Eigenschaften- \<Publisher> : \<PublicationDatabase> ** , das in verfügbar ist [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] .  
