...
-   Die Mergereplikation unterstützt die folgenden Typen von Artikelkonfliktlösern:  
    ...
    -   Ein COM-basierter Standard Konflikt Löser, der in enthalten ist [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] .  
...
3.  Klicken Sie auf der Seite **Artikeleigenschaften- \<Article> ** auf die Registerkarte Konflikt **Löser** .  
