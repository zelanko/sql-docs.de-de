...
|SQL_COPT_SS_CONNECTION_DEAD|Nachher|  
|SQL_COPT_SS_ENCRYPT|Vorher|  
|SQL_COPT_SS_ENLIST_IN_DTC|Nachher|  
|SQL_COPT_SS_ENLIST_IN_XA|Nachher|  
...
|SQL_COPT_SS_PERF_DATA|Nachher|  
|SQL_COPT_SS_PERF_DATA_LOG|Nachher|  
|SQL_COPT_SS_PERF_DATA_LOG_NOW|Nachher|  
|SQL_COPT_SS_PERF_QUERY|Nachher|  
|SQL_COPT_SS_PERF_QUERY_INTERVAL|Nachher|  
|SQL_COPT_SS_PERF_QUERY_LOG|Nachher|  
|SQL_COPT_SS_PRESERVE_CURSORS|Vorher|  
|SQL_COPT_SS_QUOTED_IDENT|Sie können das|  
|SQL_COPT_SS_TRANSLATE|Sie können das|  
|SQL_COPT_SS_TRUST_SERVER_CERTIFICATE|Vorher|  
|SQL_COPT_SS_TXN_ISOLATION|Sie können das|  
|SQL_COPT_SS_USE_PROC_FOR_PREP|Sie können das|  
|SQL_COPT_SS_USER_DATA|Sie können das|  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_AD_ON|Default. Die Verbindung verwendet das ANSI-Standardverhalten für die Behandlung von NULL-Vergleichen, für das Auffüllen, für Warnungen sowie für NULL-Verkettungen.|  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_BCP_OFF|Default. Funktionen zum Massenkopieren sind für die Verbindung nicht verfügbar.|  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_MORE_INFO_NO|Default. Gibt eine Serverliste zurück.|  
...
|NULL|Default. **Sqlbrowseconnetct** gibt Informationen für alle Server in der Domäne zurück.|  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_CN_ON|Default. Beim Verketten von Zeichenfolgen verwendet die Verbindung das ISO-Standardverhalten zum Behandeln von NULL-Werten.|  
...
## <a name="sql_copt_ss_enlist_in_xa"></a>SQL_COPT_SS_ENLIST_IN_XA  
 Um eine XA-Transaktion mit einem XA-kompatiblen Transaktionsprozessor (TP) zu starten, ruft der Client die Open Group **tx_begin** -Funktion auf. Die Anwendung ruft `SQLSetConnectAttr` dann mit dem SQL_COPT_SS_ENLIST_IN_XA-Parameter true auf, um die XA-Transaktion der ODBC-Verbindung zuzuordnen. Alle entsprechenden Datenbankaktivitäten werden unter dem Schutz der XA-Transaktion durchgeführt. Um eine XA-Zuordnung mit einer ODBC-Verbindung zu beenden, muss `SQLSetConnectAttr` der Client mit dem SQL_COPT_SS_ENLIST_IN_XA-Parameter false aufrufen. Weitere Informationen finden Sie in der Dokumentation zu Microsoft Distributed Transaction Coordinator.  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_IS_OFF|Default. Zum Überprüfen von Benutzer-ID und Kennwort bei der Anmeldung wird die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Authentifizierung.|  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_MARS_ENABLED_NO|Default. MARS (Multiple Active Result Sets) ist deaktiviert.|  
...
|-----------|-----------------|  
|SQL_IS_ON|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ermöglicht im Falle eines Failovers eine schnellere Wiederverbindung.|  
|SQL_IS_OFF|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client stellt im Falle eines Failovers keine schnellere Wiederverbindung bereit.|  
...
## <a name="sql_copt_ss_oldpwd"></a>SQL_COPT_SS_OLDPWD  
 ...
 Weitere Informationen finden Sie unter [Programm](../native-client/features/changing-passwords-programmatically.md)gesteuertes ändern von Kenn Wörtern.  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_PC_OFF|Default. Cursor werden geschlossen, wenn für die Transaktion ein Commit oder Rollback mit **SQLEndTran**ausgeführt wird.|  
...
|SQL_QI_ON|Default. Die Verbindung lässt Bezeichner in Anführungszeichen in gesendetem [!INCLUDE[tsql](../../includes/tsql-md.md)] zu.|  
  
## <a name="sql_copt_ss_translate"></a>SQL_COPT_SS_TRANSLATE  
 SQL_COPT_SS_TRANSLATE bewirkt, dass der Treiber beim Austausch von MBCS-Daten Zeichen zwischen den Client- und Servercodeseiten übersetzt. Das-Attribut wirkt sich nur auf [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Daten aus, die in den Spalten **char**, **varchar**und **Text** gespeichert sind.  
...
|value|BESCHREIBUNG|  
|-----------|-----------------|  
|SQL_TRUST_SERVER_CERTIFICATE_NO|Default. Verschlüsselung ohne Zertifikatüberprüfung wird nicht aktiviert.|  
