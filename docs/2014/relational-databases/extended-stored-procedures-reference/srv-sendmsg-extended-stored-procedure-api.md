...
## <a name="remarks"></a>Hinweise  
 ...
 Weitere Informationen finden Sie unter [Unicode Data and Server Code Pages](../extended-stored-procedures-programming/unicode-data-and-server-code-pages.md).  
