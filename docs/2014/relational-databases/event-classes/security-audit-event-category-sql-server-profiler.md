...
# <a name="security-audit-event-category-sql-server-profiler"></a>Sicherheitsüberwachung-Ereigniskategorie (SQL Server Profiler)
  Die **Security Audit** -Ereignis Kategorie enthält Sicherheits Überwachungs Ereignisse.  
...
|[Audit Database Scope GDR (Ereignisklasse)](audit-database-scope-gdr-event-class.md)|Gibt an, dass ein Benutzer in [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]eine Grant-, Widerruf-oder DENY-Anweisung für eine Anweisungs Berechtigung ausgegeben hat.|  
