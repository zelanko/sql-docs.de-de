...
|DatabaseID|`int`|Die ID der Datenbank, die durch die USE *database* -Anweisung angegeben wurde, bzw. die ID der Standarddatenbank, wenn für eine bestimmte Instanz keine USE *database* -Anweisung ausgegeben wurde. [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] Zeigt den Namen der Datenbank, wenn die `ServerName` -Datenspalte in der Ablaufverfolgung aufgezeichnet wird und der Server verfügbar ist. Der Wert für eine Datenbank kann mithilfe der DB_ID-Funktion ermittelt werden.|3|Benutzerkontensteuerung|  
...
|ObjectID|`int`|Die ID der veralteten Funktion.|22|Benutzerkontensteuerung|  
|ObjectName|`nvarchar`|Der Name der veralteten Funktion.|34|Benutzerkontensteuerung|  
...
|SqlHandle|`image`|Binäres Handle, mit dem SQL-Batches oder gespeicherte Prozeduren identifiziert werden können.|63|Benutzerkontensteuerung|  
