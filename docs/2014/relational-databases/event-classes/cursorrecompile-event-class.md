...
ms.locfileid: "62663228"
---
# <a name="cursorrecompile-event-class"></a>CursorRecompile-Ereignisklasse
  Die **CursorRecompile** -Ereignisklasse beschreibt Cursor neukompilierungs Ereignisse, die in API-Cursorn (Application Programming Interface) auftreten. Cursor neukompilierungs Ereignisse treten auf [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] , wenn der einen Transact-SQL-Cursor aufgrund einer Schema Änderung erneut kompiliert.  
