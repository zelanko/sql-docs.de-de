...
|EventSubClass|`int`|Typ der Ereignisunterklasse.<br /><br /> 1 = Ausführungskontext-Zugriff: Im Plancache wurde ein freier Ausführungsplan gefunden.<br /><br /> 2 = Compplan drücken: Im Plancache wurde ein kompilierter Plan gefunden.|21|Ja|  
