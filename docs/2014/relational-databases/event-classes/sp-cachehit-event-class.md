...
|EventSubClass|`int`|Typ der Ereignisunterklasse.<br /><br /> 1=Ausführungskontext-Zugriff: Im Plancache wurde ein freier Ausführungsplan gefunden.<br /><br /> 2=Compplan-Zugriff: Im Plancache wurde ein kompilierter Plan gefunden.|21|Benutzerkontensteuerung|  
...
|ObjectID|`int`|Die vom System zugewiesene ID der gespeicherten Prozedur im Cache.|22|Benutzerkontensteuerung|  
|ObjectName|`nvarchar`|Name des Objekts im Cache. Wenn ObjectName aufgefüllt wird, dann wird TextData nicht aufgefüllt.|34|Benutzerkontensteuerung|  
...
|TextData|`ntext`|Text des SQL-Codes im Cache. Wenn TextData aufgefüllt wird, dann wird ObjectName nicht aufgefüllt.|1|Benutzerkontensteuerung|  
