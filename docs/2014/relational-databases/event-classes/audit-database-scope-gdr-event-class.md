...
ms.locfileid: "62938949"
---
# <a name="audit-database-scope-gdr-event-class"></a>Audit Database Scope GDR (Ereignisklasse)
  Die **Audit Database Scope** -Ereignisklasse tritt immer dann auf, wenn ein Benutzer in [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] für ausschließlich Daten Bank Aktionen (z. b. das Erteilen von Berechtigungen für eine Datenbank) eine Grant-, Widerruf-oder DENY-Anweisung für eine Anweisungs Berechtigung ausgibt.  
