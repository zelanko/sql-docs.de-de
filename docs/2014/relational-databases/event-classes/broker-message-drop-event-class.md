...
|**EventSubClass**|`nvarchar`|Gibt an, ob die unzustellbare Nachricht eine sequenzierte Nachricht war. Einer von zwei Werten:<br /><br /> **Sequenzierte Nachricht**. Die unzustellbare Nachricht war eine sequenzierte Nachricht.<br /><br /> **Nicht sequenzierte Nachricht**. Die unzustellbare Nachricht war keine sequenzierte Nachricht.|21|Ja|  
