...
|**Handle**|**int**|Handle der Ereignisklasse.|33|Benutzerkontensteuerung|  
...
|**RequestID**|**int**|ID der Anforderung, die den Cursor vorbereitet hat.|49|Benutzerkontensteuerung|  
