...
ms.locfileid: "62663384"
---
# <a name="cursorprepare-event-class"></a>CursorPrepare-Ereignisklasse
  Die **CursorPrepare** -Ereignisklasse beschreibt Cursor Vorbereitungs Ereignisse, die in API-Cursorn (Application Programming Interface) auftreten. Cursor Vorbereitungs Ereignisse treten auf, [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] wenn eine einem Cursor zugeordnete SELECT-Anweisung in einen Ausführungsplan kompiliert, jedoch den Cursor nicht erstellt.  
...
|**Bewältigen**|**int**|Handle der Ereignisklasse.|33|Ja|  
