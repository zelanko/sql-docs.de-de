...
# <a name="audit-login-change-property-event-class"></a>Audit Login Change Property (Ereignisklasse)
  Die **Audit Login Change Property** -Ereignisklasse tritt auf, wenn Sie die gespeicherte Prozedur **sp_defaultdb** , die gespeicherte Prozedur **sp_defaultlanguage** oder die ALTER LOGIN-Anweisung verwenden, um eine Eigenschaft eines Anmelde namens zu ändern.  
