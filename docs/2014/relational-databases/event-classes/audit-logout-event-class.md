...
|**CPU**|**int**|CPU-Zeit (in Millisekunden), die vom Benutzer während der Verbindung verwendet wurde.|18|Benutzerkontensteuerung|  
...
|**Dauer**|**bigint**|Die ungefähre Dauer seit der Anmeldung des Benutzers.|13|Benutzerkontensteuerung|  
|**EndTime**|**datetime**|Beendigungszeit der Abmeldung.|15|Benutzerkontensteuerung|  
...
|**Reads**|**bigint**|Anzahl der logischen Lesevorgänge, die vom Benutzer bei bestehender Verbindung ausgestellt wurden.|16|Benutzerkontensteuerung|  
...
|**Writes**|**bigint**|Anzahl der logischen Schreibvorgänge, die vom Benutzer bei bestehender Verbindung ausgestellt wurden.|17|Benutzerkontensteuerung|  
