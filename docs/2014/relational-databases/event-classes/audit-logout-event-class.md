...
ms.locfileid: "63012573"
---
# <a name="audit-logout-event-class"></a>Audit Logout (Ereignisklasse)
  Die **Audit Logout** -Ereignisklasse zeigt an, dass sich ein Benutzer von abgemeldet hat [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)](abgemeldet). Ereignisse in dieser Klasse werden durch neue Verbindungen oder durch Verbindungen ausgelöst, die aus einem Verbindungspool wiederverwendet werden.  
...
|**Lesevorgänge**|**BIGINT**|Anzahl der logischen Lesevorgänge, die vom Benutzer bei bestehender Verbindung ausgestellt wurden.|16|Ja|  
...
|**Schreibvorgänge**|**BIGINT**|Anzahl der logischen Schreibvorgänge, die vom Benutzer bei bestehender Verbindung ausgestellt wurden.|17|Ja|  
