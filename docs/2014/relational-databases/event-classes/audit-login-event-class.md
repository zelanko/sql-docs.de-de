...
ms.locfileid: "63000627"
---
# <a name="audit-login-event-class"></a>Audit Login-Ereignisklasse
  Die **Audit Login** -Ereignisklasse zeigt an, dass sich [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]ein Benutzer erfolgreich bei angemeldet hat. Ereignisse in dieser Klasse werden durch neue Verbindungen oder durch Verbindungen ausgelöst, die aus einem Verbindungspool wiederverwendet werden.  
...
|**BinaryData**|**Klang**|Einstellungen auf Sitzungsebene, z. B. ANSI-Nullen, ANSI-Auffüllung, Schließen des Cursors nach dem Commit, NULL-Verkettung und Bezeichner in Anführungszeichen.|2|Ja|  
