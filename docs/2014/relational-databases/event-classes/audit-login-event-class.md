...
|**BinaryData**|**image**|Einstellungen auf Sitzungsebene, z. B. ANSI-Nullen, ANSI-Auffüllung, Schließen des Cursors nach dem Commit, NULL-Verkettung und Bezeichner in Anführungszeichen.|2|Benutzerkontensteuerung|  
...
|**IntegerData**|**int**|Die verwendete Netzwerkpaketgröße.|25|Benutzerkontensteuerung|  
...
|**Success**|**int**|1 = Erfolg 0 = Fehler. Dieses Ereignis wird immer einen Erfolg anzeigen.|23|Benutzerkontensteuerung|  
|**TextData**|**ntext**|Eine durch Semikolons getrennte Liste aller festgelegten Optionen.|1|Benutzerkontensteuerung|  
