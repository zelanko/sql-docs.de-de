...
|**EventSubClass**|`nvarchar`|Der Verbindungsstatus dieser Verbindung. Für dieses Ereignis hat die Unterklasse einen der folgenden Werte.<br /><br /> **Verbindung**wird hergestellt. 
