...
|**EventSubClass**|`int`|Die Ursache der Sperrenausweitung:<br /><br /> **0-LOCK_THRESHOLD** gibt an, dass die Anweisung den Sperr Schwellenwert überschreitet.<br /><br /> **1-MEMORY_THRESHOLD** gibt an, dass die Anweisung den Speicher Schwellenwert überschreitet.|21|Ja|  
