...
|SessionLoginName|`nvarchar`|Anmeldename des Benutzers, der die Sitzung geöffnet hat. Angenommen, Herstellen einer Verbindung [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] mithilfe von Login1 herstellen und eine Anweisung als Login2 ausführen, `SessionLoginName` Login1 an und `LoginName` zeigt Login2 an. In dieser Spalte werden sowohl der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] - als auch der Windows-Anmeldename angezeigt.|64|ja|  
