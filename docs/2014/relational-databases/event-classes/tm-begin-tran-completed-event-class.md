...
ms.locfileid: "63061228"
---
# <a name="tm-begin-tran-completed-event-class"></a>TM: Begin Tran Completed (Ereignisklasse)
  Die TM: BEGIN Tran Completed-Ereignisklasse gibt an, dass eine BEGIN TRANSACTION-Anforderung abgeschlossen wurde. Die Anforderung wurde vom Client über die Schnittstelle zur Transaktionsverwaltung gesendet.  
  
## <a name="tm-begin-tran-completed-event-class-data-columns"></a>TM: BEGIN TRANSACTION abgeschlossen Ereignisklassen-Datenspalten  
