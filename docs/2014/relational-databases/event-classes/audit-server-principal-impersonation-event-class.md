...
ms.locfileid: "85030944"
---
# <a name="audit-server-principal-impersonation-event-class"></a>Audit Server Principal Impersonation-Ereignisklasse
  Die **Audit Server Principal** -Identitätswechsel-Ereignisklasse tritt auf, wenn es einen Identitätswechsel im Server Bereich gibt (z. b. EXECUTE AS) \<*login*> .  
