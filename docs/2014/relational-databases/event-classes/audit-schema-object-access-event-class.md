...
ms.locfileid: "63017162"
---
# <a name="audit-schema-object-access-event-class"></a>Audit Schema Object Access (Ereignisklasse)
  Die **Audit Schema Object Access** -Ereignisklasse tritt auf, wenn eine Objekt Berechtigung (z. b. Select) verwendet wird.  
...
|**Collectionobjekt**|**int**|Gibt an, ob eine Spaltenberechtigung festgelegt wurde. Analysieren Sie den Text der Anweisung, um zu ermitteln, welche Berechtigungen angewendet wurden. 1=Ja, 0=Nein.|44|Ja|  
