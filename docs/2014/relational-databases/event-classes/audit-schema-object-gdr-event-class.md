...
ms.locfileid: "63012193"
---
# <a name="audit-schema-object-gdr-event-class"></a>Audit Schema Object GDR-Ereignisklasse
  Die **Audit Schema Object DDR** -Ereignisklasse tritt auf, wenn ein Benutzer in [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]eine Grant-, Widerruf-oder DENY-Anweisung für eine Schema Objekt Berechtigung ausgibt.  
...
|**Collectionobjekt**|**int**|Zeigt an, ob eine Spaltenberechtigung festgelegt wurde. Analysieren Sie den Text der Anweisung, um genau zu ermitteln, welche Berechtigungen auf welche Spalten angewendet wurden. 1=Ja, 0=Nein.|44|Ja|  
