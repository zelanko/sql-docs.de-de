...
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Erstellen<br /><br /> 2 = Ändern<br /><br /> 3 = Löschen<br /><br /> 4 = Sichern<br /><br /> 11 = Laden|21|Benutzerkontensteuerung|  
...
|**ObjectType**|**int**|Der Wert, der den Typ des am Ereignis beteiligten Objekts darstellt. Dieser Wert entspricht der type-Spalte in der **sysobjects** -Tabelle. Weitere Werte finden Sie unter [ObjectType (Spalte für Ablaufverfolgungsereignisse)](objecttype-trace-event-column.md).|28|Benutzerkontensteuerung|  
...
|**Success**|**int**|1 = Erfolg 0 = Fehler. Beispielsweise gibt der Wert 1 den Erfolg einer Berechtigungsüberprüfung und 0 einen Fehler bei dieser Überprüfung an.|23|Benutzerkontensteuerung|  
