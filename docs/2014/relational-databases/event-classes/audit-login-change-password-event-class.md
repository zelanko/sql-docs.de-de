...
ms.locfileid: "62938880"
---
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password-Ereignisklasse
  Die **Audit Login Change Password** -Ereignisklasse tritt auf, wenn ein [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Benutzer sein Anmelde Kennwort ändert.  
