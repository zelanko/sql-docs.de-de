...
ms.locfileid: "63012511"
---
# <a name="audit-server-alter-trace-event-class"></a>Audit Server Alter Trace-Ereignisklasse
  Die **Audit Server Alter Trace** -Ereignisklasse tritt für alle Anweisungen auf, die die Alter Trace-Berechtigung überprüfen. Zu diesen Anweisungen gehören diejenigen, mit denen eine Ablaufverfolgung erstellt oder konfiguriert oder ein Filter für eine Ablaufverfolgung festgelegt wird.  
