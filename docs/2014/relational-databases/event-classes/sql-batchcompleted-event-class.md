...
|CPU|`int`|CPU-Zeit (in Millisekunden), die vom Batch benötigt wird.|18|Benutzerkontensteuerung|  
...
|Fehler|`int`|Die Fehlernummer des Ereignisses.<br /><br /> 0 = OK<br /><br /> 1 = Fehler<br /><br /> 2 = Abbruch|31|Benutzerkontensteuerung|  
...
|Reads|`bigint`|Anzahl der Lesevorgänge, die durch den Batch verursacht wurden.|16|Benutzerkontensteuerung|  
...
|TextData|`ntext`|Text des Batches.|1|Benutzerkontensteuerung|  
|TransactionID|`bigint`|Die vom System zugewiesene ID der Transaktion.|4|Benutzerkontensteuerung|  
|Writes|`bigint`|Anzahl der Schreibvorgänge, die durch den Batch verursacht wurden.|17|Benutzerkontensteuerung|  
