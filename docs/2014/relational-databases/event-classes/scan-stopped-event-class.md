...
|IndexID|`int`|Der Index, der gescannt wird.|24|Benutzerkontensteuerung|  
...
|ObjectID|`int`|Die vom System zugewiesene ID des Objekts, das gescannt wird.|22|Benutzerkontensteuerung|  
|Reads|`bigint`|Die Anzahl von gelesenen Seiten (logisch).|16|Benutzerkontensteuerung|  
