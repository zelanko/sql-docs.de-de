...
ms.locfileid: "62867344"
---
# <a name="audit-add-role-event-class"></a>Audit Add Role (Ereignisklasse)
  Die **Audit Add Role** -Ereignisklasse tritt auf, wenn eine Daten Bank Rolle einer Datenbank hinzugefügt oder daraus entfernt wird. Diese Ereignisklasse wird von den gespeicherten Prozeduren **sp_addrole** und **sp_droprole** verwendet.  
  
 Diese Ereignisklasse kann aus einer zukünftigen Version von [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]entfernt werden. Es wird empfohlen, stattdessen die **Audit Database Principal Management** -Ereignisklasse zu verwenden.  
