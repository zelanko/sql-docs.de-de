...
# <a name="audit-login-failed-event-class"></a>Audit Login Failed-Ereignisklasse
  Die **Audit Login Failed** -Ereignisklasse zeigt an, dass ein Benutzer versucht hat [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , sich bei anzumelden und fehlgeschlagen ist. Ereignisse in dieser Klasse werden durch neue Verbindungen oder durch Verbindungen ausgelöst, die aus einem Verbindungspool wiederverwendet werden.  
