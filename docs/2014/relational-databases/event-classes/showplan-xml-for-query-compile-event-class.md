...
# <a name="showplan-xml-for-query-compile-event-class"></a>Showplan XML For Query Compile (Ereignisklasse)
  Die Showplan XML for Query Compile-Ereignisklasse tritt [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] auf, wenn eine SQL-Anweisung kompiliert. Fügen Sie die thisvent-Klasse ein, um die [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Show Plan Operatoren in zu identifizieren  
