...
|Dauer|`bigint`|Wartezeit der Abfrage (in Millisekunden) bis zur Verfügbarkeit des erforderlichen Arbeitsspeichers. Dies gilt nur, wenn EventSubClass = 1 (Abfragewartezeit).|13|Benutzerkontensteuerung|  
