...
ms.locfileid: "63050926"
---
# <a name="spcachemiss-event-class"></a>SP:CacheMiss-Ereignisklasse
  Von der SP:CacheMiss-Ereignisklasse wird angegeben, dass die Prozedur nicht im Cache gefunden wurde. Wenn die SP: CacheMiss-Ereignisklasse häufig auftritt, kann Sie angeben, dass mehr Arbeitsspeicher für verfügbar [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]gemacht werden soll, um die Größe des Prozedur Caches zu erhöhen.  
