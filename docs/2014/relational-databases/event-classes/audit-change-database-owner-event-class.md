...
|**SPID**|**int**|ID der Sitzung, bei der das Ereignis aufgetreten ist.|12|Benutzerkontensteuerung|  
...
|**TargetLoginName**|**nvarchar**|Für Aktionen, die eine Anmeldung betreffen, der Anmeldename.|42|Benutzerkontensteuerung|  
|**TargetLoginSid**|**image**|Für Aktionen, die eine Anmeldung betreffen, die Sicherheits-ID (SID) der entsprechenden Anmeldung.|43|Benutzerkontensteuerung|  
|**TargetUserName**|**nvarchar**|Für Aktionen, die auf einen Datenbankbenutzer abzielen (z. B. das Erteilen von Berechtigungen für einen Benutzer), der Name des Benutzers.|39|Benutzerkontensteuerung|  
