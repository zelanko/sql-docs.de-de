...
ms.locfileid: "52823204"
---
# <a name="tm-promote-tran-completed-event-class"></a>TM: Promote Tran Completed (Ereignisklasse)
  Die TM: Promote Tran Completed-Ereignisklasse gibt an, dass eine PROMOTE TRANSACTION-Anforderung abgeschlossen wurde. Die Anforderung wird vom Client über die Schnittstelle für die Transaktionsverwaltung gesendet.  
  
## <a name="tm-promote-tran-completed-event-class-data-columns"></a>TM: Promote Tran abgeschlossen Ereignisklassen-Datenspalten  
