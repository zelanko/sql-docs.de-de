...
|**BinaryData**|**image**|Anzahl der CPUs, die zum Abschließen des Prozesses auf der Grundlage der folgenden Werte verwendet werden:<br /><br /> 0 x 00000000: Gibt einen seriellen Plan, der in Serie ausgeführt wird.<br /><br /> 0 x 01000000 gibt an, einen parallelen Plan, der in Serie ausgeführt wird.<br /><br /> > = 0x02000000: Gibt einen parallelen Plan, die parallel ausgeführt.|2|nein|  
...
|**Ganzzahlige Daten**|**int**|Der "Arbeitsbereichsspeicher" in KB, der der Abfrage zugeteilt wurde, um Hashing, Sortier- oder Indexerstellungsvorgänge auszuführen. Der Arbeitsspeicher wird während der Ausführung nach Bedarf zugeordnet.|25|Benutzerkontensteuerung|  
...
|**LoginName**|**nvarchar**|Anmeldename des Benutzers (Anmeldung der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Sicherheit oder Windows-Anmeldeinformationen im Format „DOMAIN\\*username*).|11|Benutzerkontensteuerung|  
...
|**RequestID**|**int**|Die Anforderungs-ID, mit der die Volltextabfrage initiiert wurde.|49|Benutzerkontensteuerung|  
