...
# <a name="audit-server-object-gdr-event-class"></a>Audit Server Object GDR-Ereignisklasse
  Die **Audit Server Object DDR** -Ereignisklasse tritt auf, wenn ein Benutzer in Microsoft SQL Server eine Grant-, Widerruf-oder DENY-Anweisung für eine Server Objekt Berechtigung ausgibt.  
