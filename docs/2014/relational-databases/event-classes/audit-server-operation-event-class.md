...
ms.locfileid: "63012432"
---
# <a name="audit-server-operation-event-class"></a>Audit Server Operation-Ereignisklasse
  Die **Audit Server Operation** -Ereignisklasse tritt auf, wenn Sicherheits Überwachungsvorgänge verwendet werden, z. b. das Ändern von Einstellungen, Ressourcen, externer Zugriff oder Autorisierung.  
