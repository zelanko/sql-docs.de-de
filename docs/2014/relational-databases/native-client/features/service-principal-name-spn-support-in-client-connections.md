...
|*MachineName-Domäne*$@*Domain*|Ein Computerkonto wird direkt angegeben.<br /><br /> (Wenn der Server, mit dem Sie eine Verbindung herstellen, unter LOCAL `ServerSPN` SYSTEM- oder NETWORK SERVICE-Konten ausgeführt wird, kann die Sendeart im *Format MachineName*$@*Domain* vorliegen, um die Kerberos-Authentifizierung abzurufen.)|  
