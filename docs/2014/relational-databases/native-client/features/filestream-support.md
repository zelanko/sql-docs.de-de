...
## <a name="querying-for-filestream-columns"></a>Abfragen von FILESTREAM-Spalten  
 ...
 Um FILESTREAM-Spalten zu erstellen oder zu erkennen, welche der vorhandenen Spalten FILESTREAM-Spalten sind, können Sie die `is_filestream` Spalte die [sys.columns](/sql/relational-databases/system-catalog-views/sys-columns-transact-sql) -Katalogsicht angezeigt.  
...
## <a name="down-level-compatibility"></a>Kompabilität mit früheren Versionen  
 ...
 Für Clients, die SQLOLEDB oder andere Anbieter, die vor veröffentlicht wurden die [!INCLUDE[ssVersion2005](../../../includes/ssnoversion-md.md)] Native Client `varbinary(max)` zugeordnet, Image.  
