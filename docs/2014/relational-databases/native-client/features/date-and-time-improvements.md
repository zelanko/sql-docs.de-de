...
# <a name="date-and-time-improvements"></a>Datum und Uhrzeit-Verbesserungen
 ...
 Weitere Informationen zu den Datum/Uhrzeit-Verbesserungen finden Sie unter [Datum und Uhrzeit-Verbesserungen &#40;OLE DB-&#41; ](../../native-client-ole-db-date-time/date-and-time-improvements-ole-db.md) und [Datum und Uhrzeit-Verbesserungen &#40;ODBC&#41;](../../native-client-odbc-date-time/date-and-time-improvements-odbc.md).  
