...
-   MDAC-Verbindungszeichenfolgen ermöglichen einen booleschen Wert (`true`) für die **Trusted_Connection** Schlüsselwort. Ein [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client-Verbindungszeichenfolge muss verwenden `yes` oder **keine**.  
