...
-   `DataTypeCompatibility=80`  
 ...
 Weitere Informationen zu den in [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client unterstützten ADO-Verbindungs Zeichenfolgen-Schlüsselwörtern finden Sie unter Verwenden von [Schlüssel SQL Server Native Client Wörtern für Verbindungs Zeichenfolgen](using-connection-string-keywords-with-sql-server-native-client.md)  
