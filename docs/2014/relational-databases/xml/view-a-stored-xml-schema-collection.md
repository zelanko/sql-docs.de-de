...
```  
 ...
 Wenn nur ein Schema aus der XML-schemaauflistung angezeigt werden sollen, können Sie angeben, dass XQuery-Abfrage für die `xml` Geben Sie dazu, dass der zurückgegebene `xml_schema_namespace`.  
