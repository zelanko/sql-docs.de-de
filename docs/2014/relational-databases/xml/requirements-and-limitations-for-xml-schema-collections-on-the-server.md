...
|**\<xsd:choice>**|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]weist Schemas zurück, die ein **\<xsd:choice>** Partikel ohne untergeordnete Elemente aufweisen, es sei denn, der Partikel ist mit einem **minvorkommen** -Attribut Wert von NULL definiert.|  
...
|**xs: QName**|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]unterstützt keine von **xs: QName** abgeleiteten Typen, die ein Element für eine XML-Schema Einschränkung verwenden.<br /><br /> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]unterstützt keine Union-Typen mit **xs: QName** als Member-Element.<br /><br /> Weitere Informationen finden Sie unter [Der xs:QName-Typ](the-xs-qname-type.md).|  
...
|[Das &#60;xsd:redefine&#62;-Element](the-xsd-redefine-element.md)|Erläutert die Einschränkung der Verwendung des \<xsd:redefine> -Elements und beschreibt eine Problem Umgehung.|  
|[Der xs:QName-Typ](the-xs-qname-type.md)|Beschreibt die Einschränkung hinsichtlich des xs:QName-Typs.|  
|[Werte für &#60;xsd:simpleType&#62;-Deklarationen](values-for-xsd-simpletype-declarations.md)|Beschreibt die Einschränkungen, die auf- \<xsd:simpleType> Deklarationen angewendet werden.|  
...
|[Nicht deterministische Inhalts Modelle](non-deterministic-content-models.md)|Beschreibt die Einschränkungen hinsichtlich nicht deterministischer Inhaltsmodelle.|  
  
## <a name="see-also"></a>Weitere Informationen  
 [SQL Server der XML-Daten &#40;&#41;](xml-data-sql-server.md)   
 [Vergleichen von typisiertem XML mit nicht typisiertem XML](compare-typed-xml-to-untyped-xml.md)   
 [Erteilen von Berechtigungen für eine XML-Schema Auflistung](grant-permissions-on-an-xml-schema-collection.md)   
 [Einschränkung für eindeutige Partikel Zuordnung](unique-particle-attribution-constraint.md)   
