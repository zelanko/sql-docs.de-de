...
## <a name="see-also"></a>Siehe auch  
 [Codezugriffssicherheit für CLR-Integration](../clr-integration/security/clr-integration-code-access-security.md)   
