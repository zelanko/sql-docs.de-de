...
-   **Zum Erstellen einer Arbeitsauslastungsgruppe zu gruppieren, verwenden:**  [SQL Server Management Studio](#CreWGProp), [Transact-SQL](#CreWGTSQL)  
