...
> [!NOTE]  
>  Informationen der Editionen von [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] sicherungskomprimierung unterstützen, finden Sie unter [von den Editionen von SQL Server 2014 unterstützte Funktionen](../../getting-started/features-supported-by-the-editions-of-sql-server-2014.md). Jede Edition von [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] und höhere Versionen können eine komprimierte Sicherung wiederherstellen.  
