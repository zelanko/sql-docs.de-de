...
-   [Datenbanksicherungen unter dem einfachen Wiederherstellungs Modell](#DbBuRMs)  
  
-   [Datenbanksicherungen unter dem vollständigen Wiederherstellungs Modell](#DbBuRMf)  
  
-   [Verwenden einer vollständigen Datenbanksicherung zum Wiederherstellen der Datenbank](#RestoreDbBu)  
  
-   [Verwandte Aufgaben](#RelatedTasks)  
  
##  <a name="DbBuRMs"></a>Datenbanksicherungen unter dem einfachen Wiederherstellungs Modell  
 ...
 ![Zeigt den Datenverlust zwischen Datenbanksicherungen an](../../database-engine/media/bnr-rmsimple-1-fulldb-backups.gif "Zeigt den Datenverlust zwischen Datenbanksicherungen an")  
...
##  <a name="DbBuRMf"></a>Datenbanksicherungen unter dem vollständigen Wiederherstellungs Modell  
