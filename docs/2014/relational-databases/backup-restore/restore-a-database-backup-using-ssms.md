...
9. Zum Anzeigen oder Auswählen der erweiterten Optionen können Sie auf der Seite **Optionen** im Bereich **Wiederherstellungsoptionen** die folgenden für Ihre Situation zutreffenden Optionen auswählen:  
    ...
    1.  
  `WITH`-Optionen (nicht erforderlich):  
    ...
    3.  Erstellen Sie die Sicherung des Protokoll Fragments, **bevor die Wiederherstellung** ausgewählt wird, wenn dies für den ausgewählten Zeitpunkt erforderlich ist. Sie müssen diese Einstellung nicht ändern, können das Protokollfragment jedoch sichern, auch wenn es nicht erforderlich ist. Dateiname hier? Wenn sich der erste Sicherungs Satz auf der Seite **Allgemein** in Azure befindet, wird das Protokoll Fragment ebenfalls im gleichen Speicher Container gesichert.  
