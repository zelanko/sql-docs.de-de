...
> [!NOTE]  
>  Wenn Sie [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]einen Wiederherstellungs Task mithilfe von angeben, können Sie das entsprechende [!INCLUDE[tsql](../../includes/tsql-md.md)] [Wiederherstellungs](/sql/t-sql/statements/restore-statements-transact-sql) Skript generieren, indem Sie auf **Skript** klicken und anschließend ein Ziel für das Skript auswählen.  
