...
# <a name="bulk-copy-data-using-irowsetfastload-ole-db"></a>Massenkopieren von Daten mithilfe von IRowsetFastLoad (OLE DB)
 ...
 Es ist ein vollständiges Beispiel verfügbar, das die Verwendung von `IRowsetFastLoad` zum Massenkopieren der Datensätze in eine Tabelle veranschaulicht. In diesem Beispiel werden der Tabelle 10 Datensätze hinzugefügt **IRFLTable**. Sie müssen zum Erstellen der Tabelle **IRFLTable** in der Datenbank.  
