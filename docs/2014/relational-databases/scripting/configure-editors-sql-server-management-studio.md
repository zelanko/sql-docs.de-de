...
2.  Nur- **Text** : mit diesem Knoten festgelegte Optionen gelten für die MDX-, DMX-und Text-Editoren.  
  
3.  **Transact-SQL** -Optionen, die mit diesem Knoten festgelegt werden, gelten für den Datenbank-Engine Abfrage-Editor.  
  
4.  **XML** -Optionen, die mit diesem Knoten festgelegt werden, gelten für den XML for Analysis-Editor.  
...
|Beschreibt die Anpassung von Schriftarten für eine bessere Lesbarkeit von Code und Text.|[Ändern von Schriftfarbe, Schrift Grad und Stil](change-font-color-size-and-style.md)|  
|Beschreibt das Vorgehen zur Anzeige von Eigenschaften|[Verwenden Sie das Eigenschaften Fenster in Management Studio](use-the-properties-window-in-management-studio.md)|  
|Speicherort der F1-Hilfeseiten zu den Dialogfeldern für Editoroptionen.|[Abfrage Options Seiten (F1-Hilfe)](../../database-engine/query-options-pages-f1-help.md)|  
