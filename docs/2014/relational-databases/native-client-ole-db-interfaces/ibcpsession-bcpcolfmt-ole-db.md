...
> [!NOTE]  
>  Die [ibcpsession:: BCPColumns](ibcpsession-bcpcolumns-ole-db.md) -Methode muss aufgerufen werden, bevor Aufrufe **BCPColFmt**. Sie müssen **BCPColFmt** einmal für jede Spalte in der Benutzerdatei aufrufen. Wird **BCPColFmt** mehr als einmal für eine Benutzerdateispalte aufgerufen, tritt ein Fehler auf.  
 ...
 **Hinweis** der [Bcpwritefmt](ibcpsession-bcpwritefmt-ole-db.md) Funktion kann verwendet werden, um über Formatspezifikation persistent zu speichern **BCPColFmt**.  
