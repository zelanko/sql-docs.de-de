...
##  <a name="sql-server-agent-performance-objects"></a><a name="SQLServerAgentPOs"></a>SQL Server-Agent von Leistungs Objekten  
...
##  <a name="service-broker-performance-objects"></a><a name="ServiceBrokerPOs"></a>Service Broker von Leistungs Objekten  
...
##  <a name="sql-server-performance-objects"></a><a name="SQLServerPOs"></a>SQL Server von Leistungs Objekten  
...
##  <a name="ssis-pipeline-counters"></a><a name="SsisPipelineCounters"></a>SSIS-Pipeline-Leistungsindikatoren  
...
## <a name="see-also"></a>Weitere Informationen  
 [Verwenden von Leistungs Objekten](../../ssms/agent/use-performance-objects.md)   
