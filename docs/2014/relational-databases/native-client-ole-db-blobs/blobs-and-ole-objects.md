...
# <a name="blobs-and-ole-objects"></a>BLOBs und OLE-Objekte
 ...
 Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter macht die **varchar(max)**, **varbinary(max)** und **nvarchar(max)** Typen als DBTYPE_STR, DBTYPE_BYTES bzw. DBTYPE_ WSTR bzw.  
