...
# <a name="spatial-data-types-overview"></a>Übersicht über räumliche Datentypen
 ...
 Darüber hinaus [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] unterstützt die `geography` -Datentyp, der speichert ellipsenähnliche (Erdkugel-) Daten, z. B. GPS-Koordinaten in Breiten- und Längengrad.  
