...
3.  Bearbeiten Sie die Dialogfenster des Assistenten:  
    ...
    -   [Wählen Sie die Seite "DAC-Paket"](#Select_dac_package)  
  
    -   [Seite "Richtlinie überprüfen"](#Review_policy)  
  
    -   [Aktualisieren Sie die Seite "Konfiguration"](#Update_configuration)  
...
##  <a name="Select_dac_package"></a> Wählen Sie die Seite "DAC-Paket"  
...
##  <a name="Update_configuration"></a> Aktualisieren Sie die Seite "Konfiguration"  
 ...
 **Zur Bereitstellung einer DAC mithilfe der Install()-Methode in einem Powershellskript**  
