...
ms.locfileid: "36048474"
---
# <a name="sqllimit-field-and-sqllimit-value-sqlxml-40"></a>'sql:limit-field' und 'sql:limit-value' (SQLXML 4.0)
  Beim XML-Massenladen werden `sql:limit-field`- und `sql:limit-value`-Anmerkungen nach der jeweiligen Definition verarbeitet. Weitere Informationen finden Sie unter [Werte Filtern mithilfe von ' SQL: Limit-Feld und ' SQL: Limit-Wert &#40;SQLXML 4.0&#41;](annotation-interpretation-sql-limit-field-and-sql-limit-value.md).  
