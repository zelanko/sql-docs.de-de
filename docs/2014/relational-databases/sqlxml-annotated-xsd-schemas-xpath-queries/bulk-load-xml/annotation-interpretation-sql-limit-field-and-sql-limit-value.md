...
ms.locfileid: "62717793"
---
# <a name="sqllimit-field-and-sqllimit-value-sqlxml-40"></a>'sql:limit-field' und 'sql:limit-value' (SQLXML 4.0)
  Beim XML-Massenladen werden `sql:limit-field`- und `sql:limit-value`-Anmerkungen nach der jeweiligen Definition verarbeitet. Weitere Informationen finden Sie unter [Filtern von Werten mithilfe von ' SQL: Limit-Field und ' SQL: Limit-Wert &#40;SQLXML 4.0&#41;](annotation-interpretation-sql-limit-field-and-sql-limit-value.md).  
