---
title: Verwenden von SQL Server Profiler zum Erstellen eines Sammlungssatzes von SQL-Ablaufverfolgung (SQL Server Management Studio) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
