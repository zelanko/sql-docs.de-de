...
ms.locfileid: "85037675"
---
# <a name="transparent-data-encryption-with-azure-sql-database"></a>Transparente Datenverschlüsselung in Azure SQL-Datenbank
Weitere Informationen finden Sie [unter transparent Data Encryption mit Azure SQL-Datenbank](../../database-engine/transparent-data-encryption-with-azure-sql-database.md).
