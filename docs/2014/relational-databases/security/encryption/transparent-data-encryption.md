...
## <a name="see-also"></a>Siehe auch  
 [Verschieben Sie eine TDE-geschützten Datenbank auf einen anderen SQLServer](move-a-tde-protected-database-to-another-sql-server.md)   
