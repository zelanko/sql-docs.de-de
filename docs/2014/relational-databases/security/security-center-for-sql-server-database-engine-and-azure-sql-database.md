...
|Authentifizierung: Wer sind Sie?|Autorisierung: Was können Sie tun?|Verschlüsselung: Speichern von geheimen Daten|Verbindungssicherheit: Einschränken und Sichern|Überwachung: Aufzeichnen des Zugriffs|  
|----------------------------------|-------------------------------------|-------------------------------------|---------------------------------------------------|--------------------------------|  
