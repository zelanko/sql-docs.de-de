...
|SERVER_PRINCIPAL_IMPERSONATION_GROUP|Dieses Ereignis wird ausgelöst, wenn ein Identitätswechsel im Serverbereich vorhanden ist, z. b \<login> . EXECUTE AS. Entspricht der [Audit Server Principal Impersonation Event Class](../../event-classes/audit-server-principal-impersonation-event-class.md).|  
