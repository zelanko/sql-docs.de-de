...
## <a name="remarks"></a>Hinweise  
 Diese Funktion kopiert Daten aus einer Benutzerdatei in eine Datenbanktabelle oder umgekehrt, abhängig vom Wert der *eDirection* Parameter im [Bcp_init](bcp-init.md).  
