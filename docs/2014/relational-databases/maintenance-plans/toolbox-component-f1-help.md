...
**Toolbox** zeigt eine Vielzahl von Elementen zur Verwendung in [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] -Projekten an. Die **Toolbox** können Sie über das Menü **Ansicht** öffnen. Bei Bedarf können Sie das Fenster der Toolbox verankern. Eine verankerte **Toolbox** kann in geöffnetem Zustand fixiert werden oder für die Zeit, in der sie nicht verwendet wird, auf **Automatisch ausblenden** gesetzt werden.  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Toolbox Elemente &#40;Seite "Wartungs Tasks" auswählen&#41;](../../ssms/menu-help/choose-toolbox-items-maintenance-tasks-page.md)  
