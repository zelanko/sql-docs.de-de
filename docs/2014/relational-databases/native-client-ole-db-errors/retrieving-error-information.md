...
ms.locfileid: "63186120"
---
# <a name="retrieving-error-information"></a>Abrufen von Fehlerinformationen
  In diesem Beispiel ruft Informationen aus den verschiedenen fehlerschnittstellen verfügbar gemacht werden, indem die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB-Anbieter.  
