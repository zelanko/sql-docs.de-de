...
ms.locfileid: "63137317"
---
# <a name="serversettings-class"></a>ServerSettings-Klasse
  [ServerSettings-Klasse] Serversettings-class.md) stellt servereinstellungen in einer Instanz von [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
  
 [ServerSettings-Klasse] Serversettings-class.md) können Sie die folgenden Aufgaben ausführen:  
