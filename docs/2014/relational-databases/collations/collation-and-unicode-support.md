...
###  <a name="locale"></a><a name="Locale_Defn"></a>Konfigurations  
...
|Beschreibt, wie die Sprache von Fehlermeldungen und die bevorzugte Verwendungs- und Anzeigeweise von Datums-, Zeit-, und Währungsdaten geändert werden.|[Festlegen einer Sitzungs Sprache](set-a-session-language.md)|  
...
## <a name="see-also"></a>Weitere Informationen  
 [Enthaltene Daten Bank Sortierungen](../databases/contained-database-collations.md)   
 [Auswählen einer Sprache beim Erstellen eines voll Text Indexes](../search/choose-a-language-when-creating-a-full-text-index.md)   
