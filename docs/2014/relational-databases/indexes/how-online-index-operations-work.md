...
## <a name="online-index-activities"></a>Onlineindexaktivitäten  
 ...
 ![Während eines Onlineindexvorgangs ausgeführte Aktionen](../../database-engine/media/online-index.gif "Activities performed during online index operation")  
