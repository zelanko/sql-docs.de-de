---
title: 'Lektion 2: Erstellen eines Planungserstellungsszenarios (Datamining-Lernprogramm für fortgeschrittene) | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
-   Im zweiten Teil wird die Erstellung eines allgemeinen Zeitreihenmodells erläutert, das auf allen Regionen basiert. Dieses allgemeine Modell kann für *Kreuzvorhersagen*verwendet werden.  
 ...
 Um die Aufgaben in dieser Lektion wird unten aufgeführt sind, verwenden Sie die [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] -Datenquelle, die Sie erstellt [Lektion 1: Erstellen der Intermediate Data Mining-Lösung &#40;Mining-Lernprogramm für fortgeschrittene Data&#41; ](../../2014/tutorials/lesson-1-create-solution-intermediate-data-mining-tutorial.md).  
