---
title: Lernprogramme für SQLServer 2014 | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   Zum Herunterladen [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] -Beispiele für die Verwendung in den Lernprogrammen, wechseln Sie zu [Beispiele für SQL Server](http://social.technet.microsoft.com/wiki/contents/articles/3735.sql-server-samples-readme.aspx#About_Crescent_Sample_Images) auf CodePlex.  
  
-   Zum Herunterladen einer [!INCLUDE[ssGemini](../includes/ssgemini-md.md)] Arbeitsmappe und [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] -Berichte zur Verwendung mit [!INCLUDE[ssCrescent](../includes/sscrescent-md.md)] -Lernprogrammen unter [Image Files for HelloWorldPicnic Sample Model in PowerPivot and Power View](http://www.microsoft.com/download/details.aspx?id=26719).  
...
-   Um eine Liste der finden Sie unter [!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)] -Lernprogrammen unter [Lernprogramme](http://msdn.microsoft.com/library/ms167593.aspx) in der MSDN Library.  
