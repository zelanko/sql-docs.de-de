...
4.  Geben Sie im Feld **Name** einen Namen für das Projekt ein. Geben Sie den `GetPropertiesSample`Namen ein.  
...
6.  [!INCLUDE[clickOK](../includes/clickok-md.md)]Eine reduzierte Ansicht des Projekts wird in Projektmappen-Explorer angezeigt.  
     ...
     Erweitern Sie den Projektknoten im Projektmappen-Explorer. Dem Projekt wurde eine Datei mit dem Standardnamen Program.cs (Module1. [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]VB für) hinzugefügt.  
