---
title: 'Aufgabe 4: Erstellen eines SSIS-Projekts mit SQL Server Data Tools | Microsoft Docs'
ms.custom: ''
ms.date: 04/27/2017
...
# <a name="task-4-creating-an-ssis-project-using-sql-server-data-tools"></a>Aufgabe 4: Erstellen eines SSIS-Projekts mit SQL Server Data Tools
  In dieser Aufgabe erstellen Sie ein SSIS-Projekt mit **SQL Server Data Tools** um Bereinigung und Abgleich von Lieferantendaten zu automatisieren.  
...
3.  Erweitern Sie **Business Intelligence** in der **installierte Vorlagen** , und wählen **Integration Services**.  
  
     ![Visual Studio - Dialogfeld Neues Projekt](../../2014/tutorials/media/et-creatinganssisprojectusingsqlsdt-01.jpg "Visual Studio – neues Projekt (Dialogfeld)")  
  
4.  Wählen Sie **Integration Services-Projekts** in der **Liste der Projekttypen**.  
