...
-   **Distributed Replay Clients**: Eine oder mehrere Computer (physisch oder virtuell) Ausführen des Windows-Diensts mit dem Namen [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Distributed Replay Client. Die Distributed Replay Clients simulieren gemeinsam Arbeitsauslastungen auf einer Instanz von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]. In jeder Distributed Replay-Umgebung kann sich mindestens ein Client befinden.  
  
-   **Zielserver**: Eine Instanz von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] , dass der Distributed Replay Clients Ablaufverfolgungsdaten wiedergeben verwenden können. Es wird empfohlen, den Zielserver in einer Testumgebung zu platzieren.  
