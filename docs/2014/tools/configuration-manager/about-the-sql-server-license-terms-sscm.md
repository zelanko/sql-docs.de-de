...
## <a name="sql-server-licensing-options"></a>SQL Server-Lizenzierungsoptionen  
 Weitere Informationen zu [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Preis- und Lizenzierungsoptionen, finden Sie unter den [Microsoft SQL Server](http://go.microsoft.com/fwlink/?LinkId=190955) Website.  
