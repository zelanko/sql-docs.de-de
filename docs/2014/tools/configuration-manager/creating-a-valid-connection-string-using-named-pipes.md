...
> [!NOTE]  
>  Angeben des Netzwerkprotokolls als einen **Sqlcmd** Parameter finden Sie unter "Vorgehensweise: Herstellen einer Verbindung mit der Datenbank-Engine, die mithilfe von sqlcmd.exe"in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Onlinedokumentation.  
