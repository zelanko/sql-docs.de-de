...
-   [Einschränkungen für integrierte Felder, Auflistungen und Aggregatfunktionen](#Restrictions)  
  
-   [Einschränkungen für die zusammengefügten Aggregate](#NestedRestrictions)  
  
-   [Berechnen von laufenden Werten](#CalculatingRunningValues)  
  
-   [Abrufen von Zeilen Anzahlen](#RetrievingRowCounts)  
  
-   [Nachschlagen von Werten aus einem anderen Dataset](#LookupFunctions)  
  
-   [Abrufen von Sortierungs abhängigen Werten](#RetrievingPostsortValues)  
  
-   [Abrufen von Server Aggregaten](#RetrievingServerAggregates)  
  
-   [Abrufen der rekursiven Ebene](#RetrievingRecursiveLevel)  
  
-   [Testen für den Bereich](#TestingforScope)  
...
|[Countdown](report-builder-functions-count-function.md)|Gibt die Anzahl der Werte ungleich NULL aus dem angegebenen Ausdruck im Kontext des festgelegten Bereichs ausgewertet zurück.|  
...
|[Man](report-builder-functions-min-function.md)|Gibt den Minimalwert aller numerischen Werte ungleich NULL aus dem angegebenen Ausdruck im Kontext des angegebenen Bereichs zurück. Sie können diese Funktion verwenden, um einen Diagrammachsen-Mindestwert zur Steuerung der Skala anzugeben.|  
...
|[Pauschalen](report-builder-functions-sum-function.md)|Gibt die Summe aller numerischen Werte ungleich NULL aus dem angegebenen Ausdruck im Kontext des festgelegten Bereichs ausgewertet zurück.|  
...
|[Kreis](report-builder-functions-var-function.md)|Gibt die Varianz aller numerischen Werte ungleich NULL aus dem angegebenen Ausdruck im Kontext des festgelegten Bereichs ausgewertet zurück.|  
...
##  <a name="Restrictions"></a>Einschränkungen für integrierte Felder, Auflistungen und Aggregatfunktionen  
...
-   **Notiz 8.** Der Datentyp für alle Aggregate außer Count und CountDistinct muss für alle Werte der gleiche Datentyp oder NULL sein.  
  
##  <a name="NestedRestrictions"></a>Einschränkungen für die zusammengefügten Aggregate  
...
|Kontext|RunningValue|RowNumber|First (Erster)<br /><br /> Last (Letzter)|Zurück|Sum und andere Vorsortierungsfunktionen|ReportItem-Aggregate|Suchfunktionen|Aggregatfunktion|  
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
...
|Zurück|Ja|Ja|Ja|Nein |Ja|Nein |Ja|Nein|  
...
##  <a name="CalculatingRunningValues"></a>Berechnen von laufenden Werten  
 Die folgenden integrierten Funktionen berechnen ausgeführte Werte für einen Satz von Daten. 
  `RowNumber` gleicht `RunningValue` darin, dass der ausgeführte Wert für eine Anzahl zurückgegeben wird, die für jede Zeile innerhalb des enthaltenen Bereichs inkrementiert wird. Der Bereichsparameter für diese Funktionen muss einen enthaltenden Bereich angeben, der steuert, wann der Zähler neu gestartet wird.  
...
##  <a name="RetrievingRowCounts"></a>Abrufen von Zeilen Anzahlen  
...
##  <a name="RetrievingPostsortValues"></a>Abrufen von Sortierungs abhängigen Werten  
...
|**Funktion**|**Beschreibung**|  
|------------------|---------------------|  
|[Erstes](report-builder-functions-first-function.md)|Gibt den ersten Wert im festgelegten Bereich des angegebenen Ausdrucks zurück.|  
...
##  <a name="RetrievingServerAggregates"></a>Abrufen von Server Aggregaten  
...
|**Funktion**|**Beschreibung**|  
|------------------|---------------------|  
|[End](report-builder-functions-aggregate-function.md)|Gibt ein benutzerdefiniertes Aggregat des angegebenen Ausdrucks gemäß der Definition durch den Datenanbieter zurück.|  
  
##  <a name="TestingforScope"></a>Testen für den Bereich  
...
##  <a name="RetrievingRecursiveLevel"></a>Abrufen der rekursiven Ebene  
