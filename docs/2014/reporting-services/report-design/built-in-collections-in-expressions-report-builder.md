...
##  <a name="Syntax"></a>Verwenden der Sammlungs Syntax in einem Ausdruck  
 Wenn Sie von einem Ausdruck auf eine Auflistung verweisen möchten, [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] verwenden Sie die Standard Syntax für ein Element in einer Auflistung. Die folgende Tabelle zeigt Beispiele für die Auflistungssyntax:  
