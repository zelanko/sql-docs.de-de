...
-   **Räumliche Daten.** Ein Feld aus der räumlichen Datenquelle, das Sätze von Koordinaten enthält, die Standorte angeben.  
...
-   **Übereinstimmungs Felder.** Übereinstimmungsfelder, die die Beziehung zwischen räumlichen Daten und analytischen Daten definieren, z. B. der Name eines Bereichs und einer Stadt als eindeutige Identifikation jeder Stadt.  
  
 Die folgenden Abschnitte enthalten Informationen zu Optionen, die Sie im Karten- und Kartenebenen-Assistenten angeben.  
  
##  <a name="BackToTop"></a>Seiten des Karten-Assistenten und des Karten Ebenen-Assistenten  
...
1.  [Wählen Sie eine Quelle räumlicher Daten aus](#SpatialDataSource). Räumliche Daten können aus dem Kartenkatalog, aus einer Shape-Datei des Environmental Systems Research Institute, Inc. (ESRI) oder aus räumlichen Daten in einer relationalen [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] -Datenbank stammen.  
    ...
    -   [Was ist eine SQL Server räumliche Abfrage?](#SqlServerSpatial)  
...
2.  [Optionen für räumliche Daten und Kartenansicht auswählen](#MapView). Legen Sie die Kartenansicht und die Kartenauflösung fest, und geben Sie an, ob räumliche Daten in den Bericht eingebettet werden sollen sowie ob ein Kachelhintergrund aus [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Bing-Kartenkacheln eingeschlossen werden soll.  
    ...
    -   [Was ist Karten Auflösung oder Optimierung?](#Resolution)  
  
    -   [Was ist das Einbetten von räumlichen Daten?](#Embed)  
  
    -   [Was ist ein Kachel Hintergrund von "dumaps"?](#Tiles)  
  
3.  [Wählen Sie Karten Visualisierung](#Visualization)aus. Wählen Sie den Typ der Karte aus, die erstellt werden soll.  
  
    -   [Worin besteht der Unterschied zwischen einer einfachen Karte, einer Blasen Diagramm Karte und einer analytischen Karte?](#MapType)  
...
4.  **Wählen Sie eine Verbindung mit einer Datenquelle**aus. Wählen Sie eine Datenquellenverbindung aus, oder erstellen Sie eine Verbindung zu einer externen Datenquelle mit analytischen Daten, die auf der Karte angezeigt werden sollen.  
...
7.  Geben Sie die Übereinstimmungs [Felder für räumliche und analytische Daten an](#SpecifyMatchFields). Erstellen Sie eine Beziehung zwischen den räumlichen Daten und den analytischen Daten, damit die Darstellung von Kartenelementen von den Daten abhängig gemacht werden kann.  
  
    -   [Was ist ein Übereinstimmungs Feld?](#MatchFields)  
...
###  <a name="Shapefile"></a>Was ist eine ESRI-Shape-Datei?  
 Eine ESRI-Shape-Datei ist ein Satz von Dateien mit Daten, die dem Shape-Dateiformat des Environmental Systems Research Institute, Inc. (ESRI) für räumliche Daten entsprechen. Der Satz von Dateien enthält in der Regel den * \<Dateinamen>*. SHP-Datei, die die räumlichen Daten enthält, und eine Unterstützungs Datei, * \<Dateiname>*. DBF.  
...
###  <a name="GetShapefiles"></a>Wo erhalte ich ESRI-Shape-Dateien?  
...
###  <a name="SqlServerSpatial"></a>Was ist eine SQL Server räumliche Abfrage?  
...
###  <a name="Resolution"></a>Was sind Karten Auflösung und Optimierung?  
...
###  <a name="Embed"></a>Was ist das Einbetten von räumlichen Daten?  
...
###  <a name="Tiles"></a>Was ist ein Hintergrund mit der Kachel "Karten Kachel"?  
...
-   **Raketen.** Zeigt nur ein Luftbild an. In diesem Modus wird kein Text angezeigt.  
...
##  <a name="Visualization"></a>Karten Visualisierung auswählen  
...
###  <a name="MapType"></a>Worin besteht der Unterschied zwischen einer einfachen Karte, einer Blasen Diagramm Karte und einer analytischen Karte?  
...
###  <a name="Diff"></a>Worin besteht der Unterschied zwischen räumlichen Daten und analytischen Daten?  
...
##  <a name="SpecifyMatchFields"></a>Angeben der Übereinstimmungs Felder  
 Erstellen Sie auf dieser Seite eine Beziehung zwischen den räumlichen Daten und analytischen Daten.  
  
###  <a name="MatchFields"></a>Was sind Übereinstimmungs Felder?  
...
###  <a name="Theme"></a>Was macht das Design?  
...
###  <a name="Legends"></a>Was sind die Legenden und Skalen in der Karten Vorschau?  
...
-   **Entfernungs Skala.** Die Entfernungsskala bietet eine Orientierungshilfe für die Längenmaßeinheiten auf der Karte. Längenmaßeinheiten werden automatisch auf der Grundlage der Kartenprojektion und der Zoomstufe bestimmt.  
