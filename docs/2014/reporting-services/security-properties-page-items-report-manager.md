---
title: Klicken Sie auf der Eigenschaftenseite Sicherheit auf die Elemente (Berichts-Manager) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Neue Rollenzuweisung**  
 Klicken Sie auf diese Schaltfläche, um die Seite Neue Rollenzuweisung zu öffnen. Auf dieser Seite können Sie weitere Rollenzuweisungen für das aktuelle Element erstellen. Weitere Informationen finden Sie unter [neue Rollenzuweisung: Bearbeiten Rollenseite Zuweisung &#40;Berichts-Manager&#41;](../../2014/reporting-services/new-role-assignment-edit-role-assignment-page-report-manager.md).  
