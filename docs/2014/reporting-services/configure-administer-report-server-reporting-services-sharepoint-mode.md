...
-   Menüoptionen in einer SharePoint-Dokumentbibliothek  
    ...
    -   [Erstellen und Verwalten von Abonnements für Berichts Server im SharePoint-Modus](subscriptions/create-and-manage-subscriptions-for-sharepoint-mode-report-servers.md)  
  
    -   [Aktualisieren von Anmelde Informationen in Berichtsdaten Quellen von einer SharePoint-Website](report-data/update-credentials-in-report-data-sources-from-a-sharepoint-site.md)  
    ...
    -   [Legen Sie Verarbeitungsoptionen &#40;Reporting Services im integrierten SharePoint-Modus fest&#41;](../../2014/reporting-services/set-processing-options-reporting-services-in-sharepoint-integrated-mode.md)  
  
    -   [Cache Aktualisierungs Optionen &#40;Berichts-Manager&#41;](../../2014/reporting-services/cache-refresh-options-report-manager.md)  
  
-   [Features der Reporting Services-Website Sammlung](../../2014/reporting-services/reporting-services-site-collection-features.md)  
