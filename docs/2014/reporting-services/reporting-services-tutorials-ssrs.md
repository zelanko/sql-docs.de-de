...
# <a name="reporting-services-tutorials-ssrs"></a>Reporting Services-Tutorials (SSRS)
 ...
 Führen Sie die Schritte in diesem Tutorial erfahren, wie Sie den Zugriff auf die [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] Webdienste aus einer Anwendung mit erstellt [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] oder [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[csprcs](../includes/csprcs-md.md)].  
  
 [Aktualisieren von Berichten mithilfe von Klassen, die aus dem RDL-Schema generiert &#40;SSRS-Tutorial&#41;](../tutorials/updating-reports-using-classes-generated-from-the-rdl-schema-ssrs-tutorial.md)  
 Führen Sie die Schritte in diesem Tutorial erfahren Sie, wie mit dem XML Schema Definition-Tool (Xsd.exe) Klassen generieren, mit denen Sie zum Serialisieren und Deserialisieren von Berichtsdefinitionsdateien (RDL- und RDLC) mit der [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)].  
  
 [Erstellen ein Drillthroughberichts &#40;RDLC&#41; Berichts mit Parametern mithilfe von ReportViewer &#40;SSRS-Tutorial&#41;](create-drillthrough-rdlc-report-with-parameters-reportviewer.md)  
