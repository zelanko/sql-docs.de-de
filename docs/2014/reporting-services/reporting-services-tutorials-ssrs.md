...
# <a name="reporting-services-tutorials-ssrs"></a>Reporting Services-Tutorials (SSRS)
 ...
 Führen Sie die Schritte in diesem Tutorial aus, um zu erfahren [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] , wie Sie von einer mit [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] oder [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[csprcs](../includes/csprcs-md.md)]erstellten Anwendung auf die Webdienste zugreifen.  
