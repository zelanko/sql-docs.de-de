...
||
|-|
|**[!INCLUDE[applies](../includes/applies-md.md)]**  [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]Im SharePoint- [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] Modus &#124; einheitlicher Modus|

 **In diesem Thema:**

-   [Berichts Server Konzepte](#bkmk_ReportServerConcepts)

-   [Konzepte für Berichte und verwandte Elemente](#bkmk_ReportsandRelatedItemConcepts)
 ...
 **Berichtsdaten Verbindungen und Datenquellen** In Berichten werden Datenverbindungen verwendet, um Daten für einen Bericht abzurufen, wenn eine Abfrage ausgeführt oder der Bericht verarbeitet wird. In einer Berichtsdefinition ist eine Datenverbindung mit einer Datenquelle identisch. Sie können aus einer Liste integrierter Datenverbindungstypen auswählen, um eine Verbindung mit einer relationalen Datenbank, einer mehrdimensionalen Datenbank, einem Webdienst oder einer anderen Datenquelle herzustellen. Beim Beschreiben von Datenverbindungen werden die folgenden Begriffe verwendet.
 ...
 **Kompilierter Bericht und Zwischenberichts Format** Der Bericht, der ausgewertete Ausdrücke, Parameter und Parameter Eigenschaften verwendet.

 **Momentaufnahme-oder Berichts Verlauf** Eine Momentaufnahme ist der Satz von Berichtsdaten zu einem bestimmten Zeitpunkt plus dem zwischen Format, das Berichtslayoutinformationen enthält. Weitere Informationen finden Sie unter [Leistung, Momentaufnahmen, Zwischenspeichern &#40;Reporting Services&#41;](report-server/performance-snapshots-caching-reporting-services.md).

 **Verarbeiteter Bericht** Ein vollständig verarbeiteter Bericht, der sowohl Daten als auch Layoutinformationen enthält.

 **Gerenderter Bericht** Ein vollständig verarbeiteter Bericht wird an einen Berichtsrenderer gesendet, um die Daten und das Layout auf jeder Seite des Ziel Renderingformats zu kombinieren Renderingerweiterungen können vom Benutzer angepasst und erweitert werden. Das Standardrenderingformat für einen Bericht ist HTML 4.0. Weitere Informationen finden Sie unter [Seitenlayout und Rendering (Berichts-Generator und SSRS)](report-design/page-layout-and-rendering-report-builder-and-ssrs.md) und [Erweiterungen (SSRS)](extensions-ssrs.md).

 **Exportierter Bericht** Ein exportierter Bericht ist ein vollständig auslagerter Bericht, der in einem bestimmten Dateiformat gespeichert ist. Exportformate hängen von installierten Renderingerweiterungen ab und können angepasst werden. Standardmäßig schließen Exportformate Excel, Word, XML, PDF, TIFF und CSV ein. Weitere Informationen finden Sie unter [Exportieren von Berichten &#40;Berichts-Generator und SSRS&#41;](report-builder/export-reports-report-builder-and-ssrs.md).
