...
ms.locfileid: "67046741"
---
# <a name="reporting-services-concepts-ssrs"></a>Konzepte von Reporting Services (SSRS)
  Dieses Thema enthält eine kurze Zusammenfassung [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] der Konzepte.  
...
##  <a name="bkmk_ReportServerConcepts"></a>Berichts Server Konzepte  
...
##  <a name="bkmk_ReportsandRelatedItemConcepts"></a>Konzepte für Berichte und verwandte Elemente  
...
##  <a name="bkmk_StagesofReports"></a>Phasen der Berichts Entwicklung  
 ...
 ![Berichts Verarbeitungs Diagramm](media/report-execution.gif "Berichts Verarbeitungs Diagramm")  
...
## <a name="see-also"></a>Weitere Informationen  
 [Reporting Services von Features und Aufgaben &#40;SSRS&#41;](reporting-services-features-and-tasks-ssrs.md)   
