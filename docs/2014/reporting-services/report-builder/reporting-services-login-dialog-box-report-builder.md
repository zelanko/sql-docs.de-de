 ...
 **Server**  
 Zeigt den Namen des Berichtsservers an. Beispielsweise `http://localhost/reportserver`. Für Berichtsserver, die einen anderen Port verwenden als Standardport 80, schließen Sie die Portnummer ein. Beispielsweise `http://localhost:8080/reportserver`.  
