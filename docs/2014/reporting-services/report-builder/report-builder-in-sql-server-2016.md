...
-   **Ändern Sie vorhandene Berichte.** Mithilfe Berichts-Generator können Sie Berichte anpassen und aktualisieren, die in [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]Berichts-Designer erstellt wurden.  
