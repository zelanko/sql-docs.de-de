...
### <a name="insert-tab"></a>Registerkarte Einfügen  
 ...
 Wenn Sie auf der Registerkarte Einfügen auf **Berichts Teile** klicken, wird der Berichts Teil Katalog geöffnet. Sie können Berichtsteile suchen, die auf einem Berichtsserver gespeichert sind. Weitere Informationen finden Sie unter [Berichtsteile &#40;Berichts-Generator und SSRS&#41;](../report-parts-report-builder-and-ssrs.md).  
...
##  <a name="RptDesignSurface"></a>Der Bericht Designoberfläche  
...
##  <a name="ReptDataPane"></a>Der Berichtsdaten Bereich  
...
##  <a name="ReptPartGallery"></a>Der Berichts Teil Katalog  
...
##  <a name="PropertiesPane"></a>Der Bereich "Eigenschaften" (Berichts-Generator)  
...
##  <a name="GroupPane"></a>Der Gruppierungs Bereich (Berichts-Generator)  
...
##  <a name="RunMode"></a>Anzeigen einer Vorschau des Berichts im Lauf Modus  
