...
-   [Konfigurieren Sie Berichts-Manager, um die Standard-URL zu verwenden.](#ConfigureRMURL)  
...
-   **Führen Sie Berichts-Manager von einem Remote Computer aus**. Abhängig von der Netzwerkkonfiguration müssen Sie auf Computern u. U. Port 80 aktivieren, damit Anforderungen vom Berichts-Manager zulässig sind.  
  
    > [!TIP]  
    >  Wenn Sie versuchen, auf den Berichts-Manager auf einem Remotecomputer zuzugreifen und im Browser Meldungen zu Verbindungsfehlern erhalten, sind häufig die Firewalleinstellungen dafür verantwortlich. Weitere Informationen finden Sie unter [Konfigurieren einer Firewall für den Zugriff auf den Berichts Server](configure-a-firewall-for-report-server-access.md).  
  
     Aktivieren Sie ggf. auf beiden Computern Port 80, um Anforderungen über diesen Port zuzulassen. Weitere Informationen finden Sie unter [Konfigurieren einer Firewall für den Zugriff auf den Berichts Server](configure-a-firewall-for-report-server-access.md).  
  
-   [Konfigurieren von Berichts-Manager für die Verwendung einer bestimmten Berichts Server-URL](#ConfigureSpecificURL)  
...
-   [Verweisen auf einen Remote Berichts Server Berichts-Manager](#ConfigureRemoteRS)  
...
-   [Anpassen von Stilen und Anwendungs Titeln](#ModifyTitle)  
...
##  <a name="ConfigureRMURL"></a>Konfigurieren Sie Berichts-Manager, um die Standard-URL zu verwenden.  
...
##  <a name="ConfigureSpecificURL"></a>Konfigurieren von Berichts-Manager für die Verwendung einer bestimmten Berichts Server-URL  
...
##  <a name="ConfigureRemoteRS"></a>Konfigurieren von Berichts-Manager für die Verwendung eines Remote Berichts Servers  
...
##  <a name="ModifyTitle"></a>Anpassen von Stilen oder Anwendungs Titeln  
...
##  <a name="DisableRM"></a>Berichts-Manager ausschalten  
