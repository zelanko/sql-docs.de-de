...
3.  Geben Sie die Berichts-Manager-URL ein. Standardmäßig ist dies http://\<**Your-Server-Name**>/Reports. Wenn Sie jedoch Reporting Services als benannte Instanz installiert haben, lautet die Standard-URL http://\<**Your-Server-Name**>/Reports\<**_instancename**>.  
