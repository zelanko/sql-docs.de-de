...
-   [Berichts Modell Abfrage-Designer](#Model)  
...
-   [Abfrage-Designer von Hyperion ESS Base](#Hyperion)  
...
##  <a name="Textbased"></a>Text basierter Abfrage-Designer  
...
##  <a name="Graphical"></a>Grafischer Abfrage-Designer  
 ...
 Sie können auf der Symbolleiste die Schaltfläche **Als Text bearbeiten** aktivieren oder deaktivieren, um zwischen dem textbasierten und dem grafischen Abfrage-Designer zu wechseln. Weitere Informationen finden Sie unter [Grafische Benutzeroberfläche des Abfrage-Designers](graphical-query-designer-user-interface.md).  
  
##  <a name="Model"></a>Berichts Modell Abfrage-Designer  
...
##  <a name="SAPBW"></a>Abfrage-Designer für SAP NetWeaver BI  
...
##  <a name="Hyperion"></a>Abfrage-Designer von Hyperion ESS Base  
