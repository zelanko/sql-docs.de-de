...
# <a name="technical-reference-ssrs"></a>Technische Referenz (SSRS)
  Die Tools und PowerShell-Referenz Dokumentation zum verwenden oder verwalten [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] von [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]finden Sie in.  
