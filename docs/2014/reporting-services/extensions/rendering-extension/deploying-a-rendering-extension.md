...
## <a name="configuration-file-rendering-extension-element"></a>Renderingerweiterungselement der Konfigurationsdatei  
 ...
 In der folgenden Tabelle werden die Attribute für `Extension` das-Element für Renderingerweiterungen beschrieben:  
