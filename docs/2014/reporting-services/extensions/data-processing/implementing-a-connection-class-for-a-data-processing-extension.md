...
> [!NOTE]  
>  **Verbindungs** Objekte sind häufig ressourcenintensiv, um dies zu vermeiden. Sie sollten daher die Verbindung von Verbindungen oder anderen Techniken in Erwägung ziehen, um dies zu mindern.  
 ...
 <xref:Microsoft.ReportingServices.Interfaces.IExtension>ermöglicht es dem **Verbindungs** Objekt auch, benutzerdefinierte Konfigurationsdaten abzurufen und zu verarbeiten, die in der Datei RSReportServer. config gespeichert sind. Weitere Informationen zur Verarbeitung benutzerdefinierter Konfigurationsdaten finden Sie in der Methode <xref:Microsoft.ReportingServices.Interfaces.IExtension.SetConfiguration%2A>.  
