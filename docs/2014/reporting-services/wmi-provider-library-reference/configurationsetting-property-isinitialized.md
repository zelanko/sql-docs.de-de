...
ms.locfileid: "66097638"
---
# <a name="isinitialized-property-wmi-msreportserver_configurationsetting"></a>IsInitialized-Eigenschaft (WMI: MSReportServer_ConfigurationSetting)
