...
|[DatabaseQueryTimeout](configurationsetting-property-databasequerytimeout.md)|Gibt die Anzahl der Sekunden an, die ververgehen müssen, bevor der Befehl fehlschlägt oder ein Timeout auftritt. Der Berichts Server verwendet die zeitliche Steuerung des Prozesses mit der Berichts Server-Datenbank und nicht mit einer Datenquelle für den Bericht.|  
...
|[Die ListInstalledSharePointVersions-Methode &#40;WMI-&#41;](configurationsetting-method-listinstalledsharepointversions.md)|Gibt einen Satz von Token zurück, die die Versionen [!INCLUDE[winSPServ](../../includes/winspserv-md.md)] [!INCLUDE[offSPServ](../../includes/offspserv-md.md)]von [!INCLUDE[SPF2010](../../includes/spf2010-md.md)], oder [!INCLUDE[SPS2010](../../includes/sps2010-md.md)] darstellen, die auf dem gleichen Computer wie der Berichts Server installiert sind.|  
