---
title: Neue Datenquelle (Seite) (Berichts-Manager) | Microsoft Docs
ms.custom: ''
ms.date: 03/07/2017
 ...
 **Datenquellentyp**  
 ...
 Weitere Informationen zur Unterstützung von Remotedatenquellen und nicht-SQL-Quelle finden Sie unter [von den SQL Server 2012-Editionen unterstützte Funktionen](http://go.microsoft.com/fwlink/?linkid=232473) (HYPERLINK "http://go.microsoft.com/fwlink/?linkid=232473" http://go.microsoft.com/fwlink/?linkid=232473) und [von Berichterstattung unterstützte Datenquellen Services &#40;SSRS&#41;](create-deploy-and-manage-mobile-and-paginated-reports.md).  
 ...
 **Verbindungszeichenfolge**  
 ...
 Das folgende Beispiel zeigt eine Verbindungszeichenfolge zur Verbindung mit der [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssSampleDBnormal](../includes/sssampledbnormal-md.md)] Datenbank:  
  
```  
data source=<a SQL Server instance>;initial catalog=AdventureWorks2012  
```  
  
 Weitere Beispiele und Informationen zu den unterschiedlichen Möglichkeiten zum Angeben einer Verbindungszeichenfolge finden Sie unter [Datenverbindungen, Datenquellen und Verbindungszeichenfolgen in Reporting Services](../../2014/reporting-services/data-connections-data-sources-and-connection-strings-in-reporting-services.md).  
 ...
 **Bereitgestellte Anmeldeinformationen vom der Benutzer den Bericht ausführt (Verbindung herstellen über)**  
