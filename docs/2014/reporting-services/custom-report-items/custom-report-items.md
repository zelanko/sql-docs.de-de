...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Beschreibt die Infrastrukturklassen benutzerdefinierter Bericht und die verwalteten Wrapperklassen im die `Microsoft.ReportDesigner` Namespace.  
