...
# <a name="extended-protection-for-authentication-with-reporting-services"></a>Erweiterter Schutz für die Authentifizierung mit Reporting Services
  Erweiterter Schutz ist eine Gruppe von Erweiterungen zu den letzten Versionen des [!INCLUDE[msCoName](../../includes/msconame-md.md)] -Windows-Betriebssystems. Erweiterter Schutz verbessert den Schutz der Anmeldeinformationen und der Authentifizierung durch Anwendungen. Die Funktion selbst bietet keinen Schutz gegen bestimmte Angriffe, z. B. Anmeldeinformationen weiterleiten, aber es bietet eine Infrastruktur für Anwendungen wie z. B. [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] , erweiterter Schutz für die Authentifizierung zu erzwingen.  
...
> -   SQL Server, die verwendet werden, als [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] Bericht Datenquellen sind keine aktivierten erweiterten Schutz oder versucht, die vom Berichtsserver für die Verbindung mit der Berichtsdatenquelle fehlschlagen und Authentifizierungsfehler zurückgegeben.  
>   
...
-   Aktualisieren einer [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] Server [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] fügt Konfigurationseinstellungen mit standartwerten der `rsreportserver.config` Datei. Wenn die Einstellungen bereits vorhanden ist, wurden der [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] Installation bleibt erhalten, in der `rsreportserver.config` Datei.  
  
-   Wenn die Konfigurationseinstellungen hinzugefügt werden die `rsreportserver.config` Konfigurationsdatei das Standardverhalten besteht, für die [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] -Schutzfunktion deaktiviert, und Sie müssen die Funktion aktivieren, wie in diesem Thema beschrieben werden. Weitere Informationen finden Sie im Abschnitt [Konfigurationseinstellungen](#ConfigurationSettings) in diesem Thema.  
...
-   [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] Der Upgrade Advisor überprüft nicht, ob das Betriebssystem oder der aktuellen Installation [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] erweiterte schutzunterstützung aktiviert hat.  
...
### <a name="what-reporting-services-extended-protection-does-not-cover"></a>Was der erweiterte Schutz der Reporting Services nicht abdeckt  
 Die folgenden Funktionsbereiche und die Szenarien werden nicht unterstützt, durch die [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] -Schutzfunktion:  
...
-   Drittanbieter-Komponenten hinzugefügt oder von verwendet eine [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] Installation muss aktualisiert werden, durch den Drittanbieter, um erweiterten Schutz unterstützen. Weitere Informationen erhalten Sie vom Drittanbieter.  
...
## <a name="configuring-reporting-rervices-extended-protection"></a>Konfigurieren des erweiterten Schutzes für Reporting Services  
 Die `rsreportserver.config` -Datei enthält die Konfigurationswerte, die steuern das Verhalten des [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] erweiterter Schutz.  
