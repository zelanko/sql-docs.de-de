...
-   [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] Upgrade Advisor überprüft nicht, ob das Betriebssystem oder die aktuelle Installation von [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] die erweiterte Schutzunterstützung aktiviert hat.  
