 ...
 **Typ**  
 Wählen Sie den Typ der verwendeten Datenquelle aus (wenn Sie z. b. eine [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Datenbank verwenden, wählen [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Sie) aus.  
