...
ms.locfileid: "66109237"
---
# <a name="enter-data-source-credentials-dialog-box"></a>Datenquellen-Anmeldeinformationen eingeben (Dialogfeld)
  Verwenden Sie das Dialogfeld **Datenquellen-Anmelde** Informationen eingeben [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] , um Ihre Anmelde Informationen anzugeben, damit Sie Daten aus der Datenquelle abrufen können.  
