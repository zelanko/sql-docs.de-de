...
## <a name="see-also"></a>Siehe auch  
 ...
 [Verwalten eines Berichtsservers von Reporting Services im einheitlichen Modus](../report-server/manage-a-reporting-services-native-mode-report-server.md)   
