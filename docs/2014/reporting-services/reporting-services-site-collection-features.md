...
|**Funktion für die Berichtsserverintegration**|Ermöglicht umfassende Berichterstellung [!INCLUDE[msCoName](../includes/msconame-md.md)] mithilfe von[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]<br /><br /> Diese Funktion ist standardmäßig aktiv.|  
