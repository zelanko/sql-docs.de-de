...
> [!NOTE]  
>  Falls gewünscht, ein Tool verwenden, das eine grafische Benutzeroberfläche verfügt, können Sie die Reporting Services-Konfigurations-Managers anstelle des `rsconfig` und `rskeymgmt`.  
