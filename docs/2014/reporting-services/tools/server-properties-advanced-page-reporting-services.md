 ...
 **EnableIntegratedSecurity**  
 Bestimmt, ob die integrierte Sicherheit von Windows für Berichtsdatenquellen-Verbindungen unterstützt wird. Die Standardeinstellung ist `True`. Die folgenden Werte sind gültig:  
