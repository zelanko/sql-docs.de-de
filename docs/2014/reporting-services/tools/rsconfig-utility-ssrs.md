...
|`-m`  *Computername*|Erforderlich, wenn Sie eine Remote-Berichtsserverinstanz konfigurieren.|Gibt den Namen des Computers an, der den Berichtsserver hostet. Wenn dieses Argument nicht angegeben ist, wird standardmäßig `localhost`.|  
