...
## <a name="tools-for-report-authoring"></a>Tools zur Berichtserstellung  
 In der folgenden Tabelle sind die verfügbaren Tools für die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]Berichterstellung in aufgeführt.  
...
## <a name="tools-for-report-content-management"></a>Tools für die Berichtsinhaltsverwaltung  
 Zum Verwalten von Inhalten in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]stehen eine Reihe grafischer Tools und Skript Erstellungs Tools zur Verfügung. Welche Tools Sie verwenden hängt vom Bereitstellungsmodus Ihres Berichtsservers ab.  
