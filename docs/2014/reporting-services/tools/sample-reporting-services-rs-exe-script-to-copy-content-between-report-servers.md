...
|Server C|SharePoint|  
 ...
 Weitere Informationen zur Verwendung Hilfsprogramms RS.exe finden Sie unter [RS.exe Utility &#40;SSRS&#41;](rs-exe-utility-ssrs.md).  
...
|Element oder Ressource|Source|Target|  
|----------------------|------------|------------|  
...
|Parameter|und Beschreibung|Erforderlich|  
|---------------|-----------------|--------------|  
|**-s** Quell_URL|URL des Quellberichtsservers|Benutzerkontensteuerung|  
