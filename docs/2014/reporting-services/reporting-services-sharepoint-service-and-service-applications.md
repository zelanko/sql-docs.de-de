...
-   [So erstellen Sie eine Reporting Services-Dienst Anwendung mithilfe von PowerShell](#bkmk_powershell_create_ssrs_serviceapp)  
  
-   [Verwandte Aufgaben](#bkmk_related)  
  
##  <a name="bkmk_createapp"></a>Erstellen einer Reporting Services-Dienst Anwendung  
...
##  <a name="bkmk_associations"></a>Ändern der Zuordnungen der Dienst Anwendung mit einer Proxy Gruppe  
...
##  <a name="bkmk_editserviceapplication"></a>Bearbeiten von Eigenschaften der Dienst Anwendung  
...
##  <a name="bkmk_powershell_create_ssrs_serviceapp"></a>So erstellen Sie eine Reporting Services-Dienst Anwendung mithilfe von PowerShell  
