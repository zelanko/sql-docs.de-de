...
-   Wenn beim Navigieren zu einem lokalen Berichtsserver aus, und Sie sehen, dass ähnliche Fehler wie den folgenden, finden Sie unter: [Konfigurieren eines Berichtsservers im einheitlichen Modus für die lokale Verwaltung &#40;SSRS&#41;](report-server/configure-a-native-mode-report-server-for-local-administration-ssrs.md)  
