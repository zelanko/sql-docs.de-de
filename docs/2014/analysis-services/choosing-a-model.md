---
title: Auswählen eines Modells | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
-   Sammlungen mit ähnlichen Elementen (aufgerufen *Cluster* oder *Segmente*) durch gemeinsame Merkmale und einen ähnlichkeitswert definiert sind.  
...
-   *Sequenzanalysealgorithmen*  
 ...
 Die von den SQL Server Data Mining-Add-Ins für Office verwendeten Algorithmen basieren auf den von [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] bereitgestellten Algorithmen. Algorithmen von Drittanbietern, die der OLE DB für Data Mining-Spezifikation erfüllen kann auch verwendet werden, wenn die Instanz von [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] mit der Sie verbunden sind zur Algorithmen von Drittanbietern zulassen konfiguriert wurde.  
...
-   In neuronalen Netzwerken und logistischen Regressionsmodellen werden die als Ergebnisse oder Eingabevariablen verwendeten Zahlen automatisch klassifiziert. Wenn Sie Zahlen nach anderen Kriterien gruppieren möchten, sollten Sie das Tool Neu bezeichnen verwenden, um vor der Modellierung die Gruppierungen zu erstellen. Beispielsweise sollten Sie zum Gruppieren von Werten in einer **Alter** Spalte nach Deciles (10 bis 20, 21-30 und so weiter), anstatt die vom (ein Beispiel hierfür wäre 35,6 bis 41,8 Jahre) Modell gefundenen statistisch signifikanten Gruppierungen.  
  
-   Für ein Zuordnungsmodell müssen Daten in Transaktionen gruppiert werden, wobei jede auf mehrere Elemente oder Zeilen verweist. Bei Verwendung der [Assistenten zum Zuordnen von &#40;Data Mining-Client für Excel&#41; ](associate-wizard-data-mining-client-for-excel.md) Assistenten oder die [Warenkorbanalyse &#40;Tabellenanalysetools für Excel&#41; ](shopping-basket-analysis-table-analysistools-for-excel.md) tool, das Daten dargestellte Layout aufweisen sollte die **zuordnen** der Beispielarbeitsmappe auf der Registerkarte.  
  
     Wenn Sie geschachtelte Tabellen in einer externen Datenquelle verwenden möchten, müssen Sie verwenden die [erweiterte Modellierung &#40;Data Mining-Add-ins für Excel&#41; ](advanced-modeling-data-mining-add-ins-for-excel.md) Modellierungsoptionen So erstellen eine Miningstruktur und ein Miningmodell, das auf dem Server gespeichert wird. Excel bietet keine Unterstützung für geschachtelte Tabellen.  
  
## <a name="feature-selection"></a>Funktionsauswahl  
 Je nach DataSet, der Algorithmus gelten möglicherweise *Funktionsauswahl*, um irrelevante Spalten auszusortieren und um zu bestimmen, welche Spalten der Daten in Bezug auf das Ergebnis statistisch signifikant sind.  
 ...
 In den Data Mining-Add-Ins für Excel wird die Funktionsauswahl unter Verwendung der für den jeweiligen Algorithmus geeigneten Bewertungsmethode automatisch angewendet. Wenn Sie die Ergebnisse der Funktionsauswahl beeinflussen möchten, verwenden Sie die Assistenten in der **Data Mining** im Menüband aus, und klicken Sie auf **erweitert** Festlegen von Parametern mithilfe von der **Algorithmusparameter**(Dialogfeld).  
  
 Eine Liste der Funktionsauswahl von jedem Algorithmus verwendete Methoden finden Sie im Thema auf [Funktionsauswahl &#40;Data Mining&#41; ](data-mining/feature-selection-data-mining.md) in SQL Server-Onlinedokumentation.  
...
|Microsoft Time Series|Analysiert zeitbezogene Daten mithilfe einer linearen Entscheidungsstruktur.<br /><br /> Muster können zur Vorhersage zukünftiger Werte in einer Zeitreihe verwendet werden.|[Prognose &#40;Tabellenanalysetools für Excel&#41;](forecast-table-analysis-tools-for-excel.md)<br /><br /> [Planungs-Assistent &#40;Data Mining-Add-ins für Excel&#41;](forecast-wizard-data-mining-add-ins-for-excel.md)|  
