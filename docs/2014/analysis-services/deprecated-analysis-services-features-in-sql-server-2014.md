...
|Sonstiges|Systeminterne Zelleneigenschaft CELL_EVALUATION_LIST|Stellte ursprünglich eine Liste ausgewerteter Formeln bereit, die für eine Zelle gelten. Sie ist in dieser Version von Analysis Services leer.  Die Lösungsreihenfolge wird jetzt im MDX-Skript angegeben. Weitere Informationen finden Sie Untergrund Legendes zu [Durchlauf-und Lösungs Reihenfolge &#40;MDX&#41;](multidimensional-models/mdx/mdx-data-manipulation-understanding-pass-order-and-solve-order.md)|  
|erzwingen|COM-Assemblys|COM-Assemblys können ein Sicherheitsrisiko darstellen. COM-Assemblys werden in einer zukünftigen Version nicht mehr unterstützt.|  
