---
title: Storage-Einstellungen (Dialogfeld) (Analysis Services – mehrdimensionale Daten) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   Klicken auf die Schaltfläche mit den Auslassungspunkten (**...** ) für die `ProactiveCaching` Eigenschaftswert, der eine Dimension, Cube, Measuregruppe oder Partition in der **Eigenschaften** Fenster [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)].  
