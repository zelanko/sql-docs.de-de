...
|Parametername|Verwendet für|BESCHREIBUNG|  
|--------------------|-------------|-----------------|  
...
|MINIMUM_SUPPORT|Microsoft Decision Trees-Algorithmus|Bestimmt die Mindestanzahl von Blattfällen, die zum Generieren einer Teilung in der Entscheidungsstruktur erforderlich sind.<br /><br /> (Standardwert: 10.)|  
|MINIMUM_SUPPORT|Microsoft Sequence Clustering-Algorithmus|Gibt die Mindestanzahl von Fällen in jedem Cluster an.<br /><br /> (Standardwert: 10.)|  
|MINIMUM_SUPPORT|Microsoft Time Series-Algorithmus|Gibt die Mindestanzahl von Zeitscheiben an, die erforderlich sind, um eine Teilung in jeder Zeitreihenstruktur zu generieren.<br /><br /> (Standardwert: 10.)|  
...
|MODELLING_CARDINALITY|Microsoft Clustering-Algorithmus|Gibt die Anzahl von Stichprobenmodellen an, die während des Clusterprozesses erstellt werden.<br /><br /> (Standardwert: 10.)|  
