---
title: Dialogfeld "Eigenschaften" (SSAS – tabellarisch) Tabelle | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
...
|**Zustand**|Zeigt den Verarbeitungsstatus der Tabelle an. Weitere Informationen zu den Werten für diese Eigenschaft finden Sie unter <xref:Microsoft.AnalysisServices.ProcessableMajorObject.State%2A>.|  
