...
|**Zielpartitionen**|Wählen Sie die Partitionen aus, denen Sie den Aggregationsentwurf zuweisen möchten. Das folgende Raster wird verwendet, um Zielpartitionen anzugeben:<br /><br /> \<Kontrollkästchen>: Aktivieren oder deaktivieren Sie das Kontrollkästchen in der Spaltenüberschrift, um alle aufgelisteten Partitionen als Ziel Partitionen einzuschließen oder auszuschließen. Aktivieren oder deaktivieren Sie das Kontrollkästchen neben einer Partition, um diese Partition als Zielpartition einzuschließen oder auszuschließen.<br /><br /> **Partition**: zeigt den Namen der Partition an.<br /><br /> **Quelle**: zeigt die Quell Tabelle oder Abfrage für die Partition an.<br /><br /> **Aggregations Entwurf**: zeigt den Namen des vorhandenen Aggregations Entwurfs für die Partition an.|  
