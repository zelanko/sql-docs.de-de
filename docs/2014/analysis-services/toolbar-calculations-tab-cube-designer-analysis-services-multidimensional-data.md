...
|**Raster**|Klicken Sie auf diese Option, um das Dialogfeld **Schriftart** anzuzeigen und einen gültigen Satz schriftartenspezifischer Zelleigenschaftswerte am Auswahlpunkt in das Cubeskript einzufügen. Diese Option ist nur in der Skriptansicht aktiviert.|  
|**Color**|Klicken Sie auf diese Option, um das Dialogfeld **Farbe** anzuzeigen und einen gültigen RGB-Wert (Rot-Grün-Blau) am Auswahlpunkt in das Cubeskript einzufügen. Diese Option ist nur in der Skriptansicht aktiviert.|  
