...
3.  Konfigurieren Sie die folgenden Eigenschafteneinstellungen:  
    ...
    |Eigenschaft|Standardeinstellung|BESCHREIBUNG|  
    |--------------|---------------------|-----------------|  
    |**Standard-Bereitstellungs Server**|localhost|Diese Einstellung gibt den Standardserver an, der beim Bereitstellen eines Modells verwendet werden soll. Sie können auf den Pfeil nach unten klicken, um nach verfügbaren lokalen Analysis Services-Netzwerkservern zu suchen, oder den Namen eines Remoteservers eingeben.|  
...
###  <a name="bkmk_conf_default"></a>So konfigurieren Sie die Eigenschaften Einstellungen der Standard Arbeitsbereichs Datenbank für neue Modellprojekte  
