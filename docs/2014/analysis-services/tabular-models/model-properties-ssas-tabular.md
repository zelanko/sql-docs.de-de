...
###  <a name="bkmk_conf"></a> So konfigurieren Sie eigenschafteneinstellungen für Modelle  
  
1.  In [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]im **Projektmappen-Explorer**, klicken Sie auf die **Model.bim** Datei.  
