---
title: MDSCHEMA_LEVELS-Rowset | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/06/2017
...
|`LEVEL_VISIBILITY`|`DBTYPE_UI2`|(Optional) Eine Bitmap mit einem der folgenden Werte:<br /><br /> -1-sichtbar<br />– 2 nicht sichtbar<br /><br /> Die Standardeinschränkung besitzt den Wert 1.|  
