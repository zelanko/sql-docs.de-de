...
-   [Analysis Services zugewiesene Datei System Berechtigungen](#bkmk_FilePermissions)  
  
-   [Erteilen zusätzlicher Berechtigungen für bestimmte Server Vorgänge](#bkmk_tasks)  
...
-   Führen Sie compmgmt. msc aus | **Lokale Benutzer und Gruppen** | **Gruppen** | `SQLServerMSASUser$`\<Servernamen>`$MSSQLSERVER` (für eine Standard Instanz).  
...
##  <a name="bkmk_winpriv"></a>Windows-Berechtigungen, die dem Analysis Services-Dienst Konto zugewiesen sind  
...
##  <a name="bkmk_FilePermissions"></a>Dem Analysis Services Dienst Konto zugewiesene Datei System Berechtigungen  
...
2.  Verwenden Sie **Computer-Manager** | **lokale Benutzer und Gruppen** | **Gruppen** , um die Mitgliedschaft von SQLServerMSASUser\<$ Servername>$\<instanceName> Sicherheitsgruppe zu überprüfen.  
...
> [!NOTE]  
>  SIDs sollten niemals entfernt oder geändert werden. Informationen zum Wiederherstellen einer pro-Dienst-SID, die versehentlich [https://support.microsoft.com/kb/2620201](https://support.microsoft.com/kb/2620201)gelöscht wurde, finden Sie unter.  
...
##  <a name="bkmk_tasks"></a>Erteilen zusätzlicher Analysis Services Berechtigungen für bestimmte Server Vorgänge  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Access Control Listen (Wikipedia)](http://en.wikipedia.org/wiki/Access_control_list)  
