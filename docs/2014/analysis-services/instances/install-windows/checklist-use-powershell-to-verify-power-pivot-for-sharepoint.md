...
|||  
|-|-|  
|![PowerShell-bezogener Inhalt](../../../reporting-services/media/rs-powershellicon.jpg "PowerShell-bezogener Inhalt")|Ein vollständiges PowerShell-Skript finden Sie am Ende des Themas. Verwenden Sie das vollständige Skript als Ausgangspunkt für die Erstellung eines benutzerdefinierten Skripts, das zur Überwachung der gesamten [!INCLUDE[ssGeminiShort](../../../includes/ssgeminishort-md.md)] -Bereitstellung eingesetzt wird.|  
 ...
 **Power Pivot und Excel-Dienst Anwendung (en)**  
...
```  
 ...
 ![Hinweis](../../../reporting-services/media/rs-fyinote.png "Nebenbei") Der Anwendungs Pool kann auch auf der Seite "zentral Administration" auf der Seite " **Dienst Anwendungen verwalten**" überprüft werden. Klicken Sie auf den Namen der Dienstanwendung und dann im Menüband auf **Eigenschaften** .  
  
 **Power Pivot und Excel-Dienst-Anwendungs Proxys**  
 ...
 **Windows-Ereignisprotokoll**  
 ...
 Mit dem folgenden Befehl wird das Windows-Ereignisprotokoll nach Ereignissen durchsucht, die sich auf die [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] -Instanz im SharePoint-Modus beziehen. Weitere Informationen zum Deaktivieren von Ereignissen oder Ändern der Ereignis Ebene finden Sie unter [Konfigurieren und Anzeigen von SharePoint-Protokolldateien &#40;und&#41;PowerPivot für SharePoint für die Diagnoseprotokollierung](../../power-pivot-sharepoint/configure-and-view-sharepoint-and-diagnostic-logging.md).  
