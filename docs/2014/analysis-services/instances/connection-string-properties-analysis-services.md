...
|`Optimize Response`|Eine Bitmaske, die angibt, welche der folgenden Optimierungen für Abfrageantworten aktiviert sind.<br /><br /> 0 x 01: Standard. Verwenden Sie die NormalTupleSet <br />0 x 02: Bei leeren Slicern verwendet|  
