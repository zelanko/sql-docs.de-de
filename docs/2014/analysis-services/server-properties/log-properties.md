...
> [!NOTE]  
>  Weitere Informationen zum Konfigurieren des Abfrageprotokolls finden Sie unter [Vorgänge in Analysis Services protokolliert](../instances/log-operations-in-analysis-services.md).  
