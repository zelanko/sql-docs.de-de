...
##  <a name="bkmk_related"></a> Abhängige oder verwandte Eigenschaften  
 ...
 Der Standardwert für `CoordinatorQueryMaxThreads` ist 16, was begrenzt die Anzahl der segmentaufträge, die für jede Partition parallel ausgeführt werden können.  
