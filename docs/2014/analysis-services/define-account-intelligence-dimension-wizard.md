...
> [!NOTE]  
>   Diese Seite wird nur angezeigt, wenn Sie **Standarddimension** auf der Seite **Dimensionstyp auswählen** ausgewählt haben und wenn Sie dem **Kontotyp** -Attributtyp auf der Seite **Dimensionstyp angeben** ein Dimensionsattribut zugeordnet haben.  
