---
title: Herstellen einer Verbindung mit einer Datamining-Server | Microsoft Docs
ms.custom: ''
ms.date: 12/29/2017
 ...
 **Warum muss ich zur Verbindung mit eines Servers?**  
...
3.  In der **Herstellen einer Verbindung mit Analysis Services** Dialogfeld Geben Sie einen Servernamen an.  
 ...
 **Ich erhalte eine Meldung darauf hingewiesen werden "Keine Verbindung gefunden."**  
  
 Wenn der Text im unteren Teil der Schaltfläche anzeigt **keine Verbindung**, bedeutet das, dass Sie eine Verbindung mit nicht erstellt haben eine [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Datenbank oder Verbindungsfehler. Sie können die Arbeit mit den Daten aus Excel in Access oder anderen Quellen fortsetzen. Zum Erstellen eines Data Mining-Modells oder Ausführen einer Vorhersage benötigen Sie eine aktive Verbindung.  
  
 **Nehmen wir an, dass ich berechtigt, den Server sind nicht?**  
  
 Wenn Sie über keine ausreichenden Berechtigungen verfügen, um Miningmodelle auf dem Server zu speichern, oder die Data Mining-Funktionen ausprobieren und die Arbeit nicht speichern möchten, können Sie die Tabellenanalysetools nutzen, durch die temporäre Datenstrukturen und Modelle erstellt werden. Sie müssen jedoch in der Lage sein, temporäre Modelle auf dem Server zu speichern. Bitten Sie Ihren Administrator, um die Verwendung von *sitzungsminingmodelle* auf dem Server.  
 ...
 **Ich meine Verbindung getrennt, Gehen meine gesamte Arbeit verloren?**  
 ...
 **Ich kann keine Verbindung mit dem Modell mithilfe der Visio-Tools hergestellt**  
 ...
 **Wie können die Nutzung der Verbindung werden überwacht?**  
  
 Die [Ablaufverfolgung &#40;Data Mining-Client für Excel&#41; ](trace-data-mining-client-for-excel.md) Tool erstellt ein Protokoll sämtlicher Aktivitäten zwischen Add-Ins und dem angegebenen Server.  
  
 Zum Aktivieren der Überwachung von sitzungsmodellen wählen die **sitzungsmodelle verwenden** -Option in der **Überwachungstoken** (Dialogfeld).  
 ...
 **Was ist ein temporäres Modell? Wie kann ich ein temporäres Modell speichern?**  
 ...
 Sie können eine temporäre Struktur oder Modell auch explizit erstellen, mit der **Data Mining erweiterten Abfrage-Editor** und eine der DMX-Vorlagen auswählen. Fügen Sie die `USE SESSION MODELS`-Klausel hinzu, um anzugeben, dass Objekte temporär sind.   
  
### <a name="creating-backups-of-mining-models-and-structures"></a>Erstellen von Sicherungen von Miningmodellen und -strukturen  
 Um eine Sicherung eines Modells oder einer Struktur zu erstellen, können Sie ihn mit exportieren [Modelle verwalten &#40;SQL Server Data Mining-Add-ins&#41;](manage-models-sql-server-data-mining-add-ins.md), in der Data Mining-Client für Excel.  
  
 Wenn Sie ein temporäres Miningmodell erstellt haben, weist dieses i. d. R. einen schwer verständlichen Namen auf, beispielsweise Table5_593679_TS_62446. Allerdings können Sie die [Ablaufverfolgung &#40;Data Mining-Client für Excel&#41; ](trace-data-mining-client-for-excel.md) Tool zum Ermitteln der Namen von temporären Strukturen und Modelle, die von den Tabellenanalysetools erstellt wurden, und Sichern sie Sie mithilfe von  **Verwalten von Modellen**.  
  
##### <a name="identify-and-export-a-temporary-model"></a>Identifizieren und Exportieren eines temporären Modells  
  
1.  In der **Verbindungen** Gruppe von Data Mining-Client für Excel verwenden, klicken Sie auf **Ablaufverfolgung**.  
...
## <a name="see-also"></a>Siehe auch  
 [Herstellen einer Verbindung mit Quelldaten &#40;Datamining-Client für Excel&#41;](connect-to-source-data-data-mining-client-for-excel.md)   
