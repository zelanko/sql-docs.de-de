---
title: Benachrichtigungen (Dialogfeld ' Optionen) (Analysis Services – mehrdimensionale Daten) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|**Vom Client initiiert**|Wählen Sie das XML für Analysis (XMLA)-Befehl verwendet `NotifyTableChange`, um Änderungen an den zugrunde liegenden Tabellen für das Objekt zu identifizieren. Diese Option ist normalerweise ausgewählt, wenn Sie die Verwendung eines Client-basierten Benachrichtigungsprozesses planen.|  
