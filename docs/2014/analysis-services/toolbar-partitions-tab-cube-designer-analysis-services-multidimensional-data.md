...
|**Benen**|Klicken Sie auf diese Option, um die ausgewählte Partition umzubenennen.<br /><br /> Hinweis: Diese Option ist nur aktiviert, wenn im Raster **Partitionen** einer Measuregruppe im Bereich **Measuregruppen** eine beliebige Zelle einer Partition ausgewählt ist.|  
