...
# <a name="amo-olap-classes"></a>AMO-OLAP-Klassen
 ...
 Weitere Informationen zum Einrichten der AMO-Programmierumgebung wie zum Herstellen einer Verbindung mit einem Server, den Zugriff auf eine Datenbank oder zum Definieren von Datenquellen und Datenquellensichten finden Sie unter [grundlegende AMO-Klassen](amo-fundamental-classes.md).  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Programmieren AMO OLAP Basic-Objekten](programming-amo-olap-basic-objects.md)   
 [Programmieren AMO-OLAP-von erweiterten Objekten](programming-amo-olap-advanced-objects.md)   
