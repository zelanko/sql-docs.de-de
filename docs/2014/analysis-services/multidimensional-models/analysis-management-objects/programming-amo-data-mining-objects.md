...
# <a name="programming-amo-data-mining-objects"></a>Programmieren von AMO-Data Mining-Objekten
 ...
 Dabei ist zu beachten, dass AMO nicht der Abfrage dient, sondern der Verwaltung und der Administration Ihrer Miningstrukturen und Modelle. Um die Daten abzufragen, verwenden Sie [Entwickeln mit ADOMD.NET](../adomd-net/developing-with-adomd-net.md).  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [AMO-Klassen für Datamining](amo-data-mining-classes.md)   
