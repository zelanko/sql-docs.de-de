 ...
 **HTTP** für HTTP-Verbindungen oder durch einen Aufruf an die Komponente SharePoint PowerPivot Web Service (WS) über die SSAS-datapumpdienst verwendet.  
