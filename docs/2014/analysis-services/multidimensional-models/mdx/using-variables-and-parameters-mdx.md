...
```  
 ...
 Zur Verwendung dieser Funktionen mit OLE DB-verwenden Sie die `ICommandWithParameters` Schnittstelle. Wenn Sie diese Funktionalität mit ADOMD.Net verwenden möchten, verwenden Sie die **AdomdCommand.Parameters** -Auflistung.  
