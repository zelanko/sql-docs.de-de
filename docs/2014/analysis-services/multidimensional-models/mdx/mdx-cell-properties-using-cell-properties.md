...
```  
 ...
 Zelleigenschaften werden nicht für MDX-Abfragen zurückgegeben, die vereinfachte Rowsets zurückgeben. In diesem Fall wird jede Zelle dargestellt, als würde nur die `FORMATTED_VALUE` Zelleneigenschaft zurückgegeben wurden.  
