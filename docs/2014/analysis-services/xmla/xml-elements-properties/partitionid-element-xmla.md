...
ms.locfileid: "36049768"
---
# <a name="partitionid-element-xmla"></a>PartitionID-Element (XMLA)
  Identifiziert eine Partition innerhalb eines übergeordneten Elements, das einen Objektverweis enthält.  
...
|Cardinality|Wenn Vorgänger oder übergeordnetes Element =<br />                        [Source](source-element-xmla.md), [Target](../xml-elements-properties/target-element-xmla.md)<br /><br /> Kardinalität = 1-1: Erforderliches Element, das nur einmal auftritt.<br /><br /> Wenn Vorgänger oder übergeordnetes Element = alle anderen:<br /><br /> Kardinalität = 0-1: Optionales Element, das nur einmal auftreten kann.|  
