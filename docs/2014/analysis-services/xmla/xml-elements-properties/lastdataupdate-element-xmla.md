---
title: LastDataUpdate-Element (XMLA) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="lastdataupdate-element-xmla"></a>LastDataUpdate-Element (XMLA)
  Enthält das Datum und die Zeit des letzten Updates der Daten des Cubes, der vom übergeordneten [Cube](cube-element-olapinfo-xmla.md) -Element dargestellt wird.  
...
|Beziehung|Element|  
|------------------|-------------|  
|Übergeordnete Elemente|[Cube](cube-element-olapinfo-xmla.md)|  
