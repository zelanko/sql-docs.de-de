...
ms.locfileid: "36058569"
---
# <a name="datasourceview-element-xmla"></a>DataSourceView-Element (XMLA)
  Enthält eine Out-of-Line-datenquellensichtbindung für das übergeordnete [Batch](../xml-elements-commands/batch-element-xmla.md) oder [Prozess](../xml-elements-commands/process-element-xmla.md) Element.  
