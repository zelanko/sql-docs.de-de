...
ms.locfileid: "36162347"
---
# <a name="sessionid-element-xmla"></a>SessionID-Element (XMLA)
  Identifiziert eine aktive Sitzung, für das übergeordnete Element ausgeführt ["Abbrechen"](../xml-elements-commands/cancel-element-xmla.md) Element.  
