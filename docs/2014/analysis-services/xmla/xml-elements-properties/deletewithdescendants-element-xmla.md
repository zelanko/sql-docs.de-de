...
## <a name="remarks"></a>Hinweise  
 Die `DeleteWithDescendants` -Element bestimmt, ob die `Drop` Befehl sollte den identifizierten Attributelemente Löschen der [, in dem](where-element-xmla.md) -Element, sondern auch sind, dass die Nachfolger dieser Attributelemente ebenfalls gelöscht werden sollen.  
