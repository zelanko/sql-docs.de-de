...
ms.locfileid: "37151481"
---
# <a name="time-element-xmla"></a>Time-Element (XMLA)
  Gibt die Zeitbegrenzung an, die vom [DesignAggregations](../xml-elements-commands/designaggregations-element-xmla.md) -Befehl verwendet wird, um Aggregationen zu entwerfen.  
