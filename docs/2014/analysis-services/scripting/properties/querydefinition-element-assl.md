...
ms.locfileid: "36050394"
---
# <a name="querydefinition-element-assl"></a>QueryDefinition-Element (ASSL)
  Enthält einen nicht transparenten Ausdruck für eine Abfrage, die zugeordneten eine [DataSource](../objects/datasource-element-assl.md) Element in einer [QueryBinding](../data-type/binding-data-type-assl.md) Element.  
