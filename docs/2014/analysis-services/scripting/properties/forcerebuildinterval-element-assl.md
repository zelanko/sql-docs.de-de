---
title: ForceRebuildInterval-Element (ASSL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="remarks"></a>Hinweise  
 Das Element, das dem übergeordneten entspricht `ForceRebuildInterval` im Objekt Analysis Management Objects (AMO) Modell ist <xref:Microsoft.AnalysisServices.ProactiveCaching>.  
