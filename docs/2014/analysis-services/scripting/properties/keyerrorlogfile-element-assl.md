---
title: KeyErrorLogFile-Element (ASSL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="remarks"></a>Hinweise  
 Das Element, das dem übergeordneten entspricht `KeyErrorLogFile` im Objekt Analysis Management Objects (AMO) Modell ist <xref:Microsoft.AnalysisServices.ErrorConfiguration>.  
