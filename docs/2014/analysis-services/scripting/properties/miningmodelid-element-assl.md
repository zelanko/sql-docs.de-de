---
title: MiningModelID-Element (ASSL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="remarks"></a>Hinweise  
 Das Element, das dem übergeordneten entspricht `MiningModelID` im Objekt Analysis Management Objects (AMO) Modell ist <xref:Microsoft.AnalysisServices.Dimension>.  
