...
## <a name="remarks"></a>Hinweise  
 ...
 Das Element, das das übergeordnete Element des entspricht `Goal` im Objekt Analysis Management Objects (AMO) Modell ist <xref:Microsoft.AnalysisServices.Kpi>.  
  
## <a name="see-also"></a>Siehe auch  
 [Status-Element &#40;ASSL&#41;](status-element-assl.md)   
 [Trend-Element &#40;ASSL&#41;](trend-element-assl.md)   
 [Wert des Elements &#40;ASSL&#41;](value-element-assl.md)   
