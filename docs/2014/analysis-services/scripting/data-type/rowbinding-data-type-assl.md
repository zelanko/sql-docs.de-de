---
title: RowBinding-Datentyp (ASSL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "48203220"
---
# <a name="rowbinding-data-type-assl"></a>RowBinding-Datentyp (ASSL)
  Definiert einen abgeleiteten Datentyp, der eine Bindung, auf die Zeilen einer Tabelle in darstellt eine [DataSourceView](../objects/datasourceview-element-assl.md) Element.  
...
|Untergeordnete Elemente|[TableID](../properties/id-element-assl.md)|  
...
## <a name="remarks"></a>Hinweise  
 ...
 Das entsprechende Element im Analysis Management Objects (AMO)-Objektmodell ist <xref:Microsoft.AnalysisServices.RowBinding>.  
