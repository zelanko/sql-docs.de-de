...
ms.locfileid: "36148923"
---
# <a name="querybinding-data-type-assl"></a>QueryBinding-Datentyp (ASSL)
  Definiert einen abgeleiteten Datentyp, der die Zuordnung von einer [DataSource](../objects/datasource-element-assl.md) Element mit einer [QueryDefinition](../properties/querydefinition-element-assl.md) Element.  
