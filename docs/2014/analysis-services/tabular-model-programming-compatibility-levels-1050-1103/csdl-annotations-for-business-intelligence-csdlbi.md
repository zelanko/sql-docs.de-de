...
-   Unterstützung für Perspektiven.  
 ...
 Ausführliche Informationen zu einzelnen Elemente in CSDLBI-Anmerkungen finden Sie unter [technische Referenz für BI-Anmerkungen zu CSDL](https://docs.microsoft.com/bi-reference/csdl/technical-reference-for-bi-annotations-to-csdl). Informationen zu CSDL-hauptspezifikation finden Sie unter den [CSDL v3-Spezifikation](https://msdn.microsoft.com/en-us/data/jj652004) auf MSDN.  
