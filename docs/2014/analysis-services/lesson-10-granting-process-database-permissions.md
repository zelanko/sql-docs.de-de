...
3.  Ändern Sie im Fenster Eigenschaften die **Namen** -Eigenschaft für diese neue Rolle in `Process Database Objects Role`.  
  
     ![Rollen-Designers](../../2014/tutorials/media/l10-security-1.png "Rollen-Designer")  
