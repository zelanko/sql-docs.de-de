...
-   Zeitreihenmodelle können *stationär* oder *nicht stationär*sein. Bei *stationären Modellen* handelt es sich um solche, die zu einem Mittelpunkt zurückkehren, obwohl Sie möglicherweise Zyklen aufweisen, wohingegen nicht *stationäre* Modelle keinen Fokus auf das Gleichgewicht haben und größere Varianz oder Änderungen unterliegen, die durch *Schocks*oder externe Variablen eingeführt werden.
...
### <a name="detection-of-seasonality"></a>Erkennen der Saisonabhängigkeit
 Sowohl der ARIMA- als auch der ARTXP-Algorithmus unterstützen die Erkennung der Saisonabhängigkeit oder Periodizität. 
