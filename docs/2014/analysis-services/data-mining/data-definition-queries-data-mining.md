...
-   Exportieren oder Importieren von Miningmodellen und Miningstrukturen.  
 ...
 [Erstellen von Daten Definitions Abfragen](#bkmk_Create)  
  
-   [Daten Definitions Abfragen in SQL Server Data Tools](#bkmk_ssdt)  
  
-   [Daten Definitions Abfragen in SQL Server Management Studio](#bkmk_SSMS)  
  
 [Skripterstellung für Daten Definitions Anweisungen](#bkmk_Scripts)  
  
 [Skripterstellung für Daten Definitions Anweisungen](#bkmk_Export)  
  
##  <a name="bkmk_Create"></a>Erstellen von Daten Definitions Abfragen  
...
###  <a name="bkmk_ssdt"></a>Daten Definitions Abfragen in SQL Server Data Tools  
...
###  <a name="bkmk_SSMS"></a>Daten Definitions Abfragen in SQL Server Management Studio  
...
###  <a name="bkmk_Scripts"></a>Skripterstellung für Daten Definitions Anweisungen  
