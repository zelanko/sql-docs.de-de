...
-   Erstellen Sie Berichte, mit denen Benutzer Vorhersagen anfordern, Trends anzeigen oder Modelle vergleichen können.  
 ...
 [Bereitstellen einer relationalen Lösung](#bkmk_RelationalSltn)  
  
 [Bereitstellen einer mehrdimensionalen Lösung](#bkmk_MDSltn)  
  
 [Zugehörige Ressourcen](#bkmk_Resources)  
...
##  <a name="bkmk_Reqs"></a>Anforderungen für die Bereitstellung von Data Mining-Lösungen  
...
###  <a name="bkmk_RelationalSltn"></a>Bereitstellen einer relationalen Lösung  
...
###  <a name="bkmk_MDSltn"></a>Bereitstellen einer mehrdimensionalen Lösung  
