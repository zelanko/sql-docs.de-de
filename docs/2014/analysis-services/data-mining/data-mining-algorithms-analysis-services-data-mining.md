...
||[Beispiele für Zuordnungsmodellabfragen](association-model-query-examples.md)<br /><br /> [Beispiele für Clusteringmodellabfragen](clustering-model-query-examples.md)<br /><br /> [Beispiele für Entscheidungsstruktur-Modellabfragen](decision-trees-model-query-examples.md)<br /><br /> [Beispiele für lineare Regressionsmodellabfrage](linear-regression-model-query-examples.md)<br /><br /> [Logistische Regressionsmodell-Abfragebeispiele](logistic-regression-model-query-examples.md)<br /><br /> [Beispiele für Naive Bayes-Modellabfragen](naive-bayes-model-query-examples.md)<br /><br /> [Beispiele für Abfragen von neuronalen Netzwerkmodellen](neural-network-model-query-examples.md)<br /><br /> [Beispiele für Abfragen von Sequenzclustermodellen](sequence-clustering-model-query-examples.md)<br /><br /> [Abfragebeispiel Zeitreihenmodell](time-series-model-query-examples.md)|  
