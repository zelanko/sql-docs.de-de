...
# <a name="export-and-import-data-mining-objects"></a>Exportieren und Importieren von Data Mining-Objekten
 ...
 Wenn Ihre Datamining-Lösung relationale Daten statt einer multidimensionalen Datenbank verwendet, die Übertragung von Modellen mit `EXPORT` und `IMPORT` ist wesentlich schneller und einfacher als die datenbankwiederherstellung zu verwenden oder eine vollständige Lösung bereitzustellen.  
...
## <a name="importing-data-mining-structures-and-models"></a>Importieren von Data Mining-Strukturen und -Modellen  
 ...
 Sie können eine Miningstruktur oder Miningmodell auch importieren, mit der `Restore` Befehl. Die Modelle oder Strukturen werden in der Datenbank wiederhergestellt, die den gleichen Namen trägt, wie die Datenbank, aus der sie exportiert wurden. Weitere Informationen finden Sie unter [Restore Options](../multidimensional-models/restore-options.md).  
