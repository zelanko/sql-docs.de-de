...
# <a name="configure-powerpivot-service-accounts"></a>Konfigurieren von PowerPivot-Dienstkonten
 ...
 [Aktualisieren eines abgelaufenen Kennworts für SQL Server Analysis Services (PowerPivot)-Instanz](#bkmk_passwordssas)  
 ...
 [Erstellen Sie oder ändern Sie des Anwendungspools für eine PowerPivot-dienstanwendung](#bkmk_appPool)  
...
##  <a name="bkmk_passwordssas"></a> Aktualisieren eines abgelaufenen Kennworts für SQL Server Analysis Services (PowerPivot)-Instanz  
...
##  <a name="bkmk_passwordapp"></a> Aktualisieren eines abgelaufenen Kennworts für die PowerPivot-Dienstanwendung  
...
##  <a name="bkmk_appPool"></a> Erstellen Sie oder ändern Sie des Anwendungspools für eine PowerPivot-dienstanwendung  
...
2.  Wählen Sie **PowerPivot-Konfigurationszeitgeberauftrag**.  
...
## <a name="see-also"></a>Siehe auch  
 [Starten Sie oder beenden Sie eines PowerPivot für SharePoint-Server](start-or-stop-a-power-pivot-for-sharepoint-server.md)   
