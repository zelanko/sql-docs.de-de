...
# <a name="start-or-stop-a-powerpivot-for-sharepoint-server"></a>Starten oder Beenden eines PowerPivot für SharePoint-Servers
 ...
 [Starten oder Abbrechen der Dienste](#startstop)  
  
 [Welche Auswirkungen hat das Beenden eines PowerPivot-Servers?](#effects)  
  
##  <a name="dependencies"></a>Dienst Abhängigkeiten  
...
##  <a name="startstop"></a>Starten oder Abbrechen der Dienste  
...
##  <a name="effects"></a>Auswirkungen des Anhaltens eines Power Pivot-Servers  
...
|Nutzungsdaten|Es werden keine Verwendungsdaten gesammelt, während die Dienste beendet sind.|  
