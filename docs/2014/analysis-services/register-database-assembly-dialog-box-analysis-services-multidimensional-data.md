...
|**AssemblyName**|Hier können Sie per Eingabe den Namen des Assemblyverweises festlegen.<br /><br /> Hinweis: Durch Ändern dieses Werts ändert sich nicht auf den Namen der Assembly, auf den der Assemblyverweis verweist, aber stattdessen ändert den Namen der von der [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] -Instanz oder-Datenbank beim Verweisen auf den der Assemblyverweis verweist.|  
