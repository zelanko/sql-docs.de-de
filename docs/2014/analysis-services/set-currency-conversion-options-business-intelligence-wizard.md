---
title: Legen Sie Optionen für die Währungsumrechnung (Business Intelligence-Assistent) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Geben Sie die pivotwährung**  
 Wählen Sie das Element aus, das als Pivotwährung der Measuregruppe fungiert.  
  
 **Wählen Sie, wie Sie der (Auswählen einer beispielwährung) Wechselkurseingabe**  
 ...
 **X Einheiten der pivotwährung entsprechen 1 beispielwährung**  
 ...
 **X beispielwährung zu 1 pivotwährung**  
