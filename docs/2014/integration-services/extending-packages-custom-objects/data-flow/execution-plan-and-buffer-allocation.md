...
## <a name="understanding-the-execution-plan"></a>Grundlegendes zum Ausführungsplan  
 Ein Ausführungsplan enthält Quell- und Arbeitsthreads. Diese umfassen jeweils Arbeitslisten, die bei Quellthreads Ausgabearbeitslisten und bei Arbeitsthreads Eingabe- und Ausgabearbeitslisten festlegen. Die Quellthreads eines Ausführungs Plans stellen die Quell Komponenten im Datenfluss dar und werden im Ausführungsplan von *sourcethread * * n*identifiziert, wobei *n* die null basierte Nummer des Quellthreads ist.  
 ...
 Ein Arbeits Thread kann sowohl Eingabe-als auch Ausgabe Arbeitslisten enthalten und wird im Ausführungsplan als *Arbeits Thread * * n*identifiziert, wobei *n* die null basierte Nummer des Arbeitsthreads ist. Diese Threads enthalten Ausgabearbeitslisten, wenn das Diagramm eine Komponente mit asynchronen Ausgaben enthält.  
