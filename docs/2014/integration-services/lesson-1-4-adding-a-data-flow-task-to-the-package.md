...
4.  Mit der rechten Maustaste in des Datenflusstasks, klicken Sie auf **Eigenschaften**, und klicken Sie im Eigenschaftenfenster überprüfen, ob die `LocaleID` -Eigenschaftensatz auf **Englisch (Vereinigte Staaten)**.  
