...
> [!NOTE]  
>  Benötigen Sie die Art der Verbindung vom Verbindungs-Manager vor dem Aufruf zurückgegeben `AcquireConnection`. Da für den Skripttask `Option Strict` aktiviert ist, müssen Sie die Verbindung, die als `Object`-Typ zurückgegeben wird, vor ihrer Verwendung in den richtigen Verbindungstyp umwandeln.  
