---
title: Ein Paket zur Verwendung von Transaktionen konfigurieren | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="configuring-a-single-transaction"></a>Konfigurieren einer einzelnen Transaktion  
 Mit dieser Option initiiert das Paket selbst eine einzelne Transaktion. Sie konfigurieren, dass das Paket, um diese Transaktion initiieren, indem Sie die TransactionOption-Eigenschaft des Pakets festlegen `Required`.  
  
 Danach tragen Sie bestimmte Tasks und Container in dieser einzelnen Transaktion ein. Um einen Task oder Container in einer Transaktion einzutragen, legen Sie die TransactionOption-Eigenschaft dieses Tasks oder Containers auf `Supported`.  
...
5.  In der **Eigenschaften** Fenster die TransactionOption-Eigenschaft auf festgelegt `Required`.  
...
7.  In der **Eigenschaften** Fenster die TransactionOption-Eigenschaft auf festgelegt `Supported`.  
...
## <a name="configuring-multiple-transactions"></a>Konfigurieren mehrerer Transaktionen  
 Mit dieser Option unterstützt das Paket selbst Transaktionen, startet jedoch keine Transaktion. Sie konfigurieren, dass das Paket, um Transaktionen zu unterstützen, durch Festlegen der TransactionOption-Eigenschaft des Pakets `Supported`.  
...
5.  In der **Eigenschaften** Fenster die TransactionOption-Eigenschaft auf festgelegt `Supported`.  
...
7.  In der **Eigenschaften** Fenster die TransactionOption-Eigenschaft auf festgelegt `Required`.  
...
9. In der **Eigenschaften** Fenster die TransactionOption-Eigenschaft auf festgelegt `Supported`.  
