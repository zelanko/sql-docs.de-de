...
|----------|-------------|---------|---------|------------|-----------------|  
|Ablaufverfolgung|False|-|-|False|Verfügbare Werte:<br /><br /> **Fall**<br /><br /> **Alarm**<br /><br /> **on**<br /><br /> **abgeschrieben**|  
