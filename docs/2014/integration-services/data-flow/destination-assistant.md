...
## <a name="related-tasks"></a>Related Tasks  
 Anweisungen zum Hinzufügen eines Ziels und eines Verbindungs-Managers mithilfe des Assistenten finden Sie unter [Add a Destination using Destination Assistant](../add-a-destination-using-destination-assistant.md).  
