...
|SqlCommand|Zeichenfolge|Wenn AccessMode ist `SQL Command`, Transact-SQL-Anweisung, die das Excel-Ziel verwendet wird, um die Zielspalten für die Daten angibt.|  
