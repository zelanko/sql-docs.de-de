...
|DefaultCodePage|Integer|Die Codepage, die für Zeichenfolgenspalten verwendet werden soll.<br /><br /> **Hinweis**: Diese Eigenschaft ist nicht verfügbar in der **Ziel-Editor für ODBC-**, jedoch können festgelegt werden, mithilfe der **Erweiterter Editor**.|  
