...
ms.locfileid: "37281936"
---
# <a name="azure-blob-destination"></a>Azure-BLOB-Ziel
  Die Komponente **Azure-Blobziel** ermöglicht einem SSIS-Paket das Schreiben von Daten in ein Azure-Blob. Die unterstützten Dateiformate sind CSV und AVRO. Ziehe **Azure Blob-Ziel** auf die Datenfluss-Designer, und doppelklicken Sie darauf, um den Editor aufzurufen).  
