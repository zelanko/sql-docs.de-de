...
###  <a name="BulkInsert"></a>Massen Einfügungs Task  
...
###  <a name="DataFlow"></a>Datenfluss Task  
...
###  <a name="ExecuteDTS200"></a>DTS 2000-Aufgabe ausführen  
...
###  <a name="FileSystem"></a>Task "Datei System"  
...
###  <a name="SendMail"></a>Task ' Mail senden '  
...
###  <a name="TransferDatabase"></a>Daten Bank Task übertragen  
...
###  <a name="TransferErrorMessages"></a>Task "Fehlermeldungen übertragen"  
...
###  <a name="TransferJobs"></a>Task Aufträge übertragen  
...
###  <a name="TransferMasterStoredProcedures"></a>Task ' Master ' gespeicherte Prozeduren  
...
###  <a name="TransferSQLServerObjects"></a>SQL Server Objekte übertragen (Task)  
...
###  <a name="WebServices"></a>Webdienst (Task)  
...
###  <a name="WMIDataReader"></a>WMI-Daten Leser (Task)  
...
###  <a name="WMIEventWatcher"></a>Task "WMI-Ereignisüberwachung"  
