...
TableName|Gibt den Namen der Zieltabelle an. Wählen Sie entweder einen vorhandenen Tabellennamen aus, oder erstellen Sie einen neuen, indem Sie auswählen **\<New Table ...>** .
