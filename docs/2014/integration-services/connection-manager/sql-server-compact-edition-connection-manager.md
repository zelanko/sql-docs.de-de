...
## <a name="configuration-the-sql-server-compact-edition-connection-manager"></a>Konfiguration des SQL Server Compact Edition-Verbindungs-Managers  
 Beim Hinzufügen einer [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Compact-Verbindungs-Manager einem Paket [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] erstellt einen Verbindungs-Manager, die aufgelöst wird eine [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Compact-Verbindung zur Laufzeit des Verbindungs-Manager-Eigenschaften festlegt, und fügt den Verbindungs-Manager die `Connections` -Auflistung im Paket.  
  
 Die `ConnectionManagerType` des Verbindungs-Managers ist-Eigenschaftensatz auf `SQLMOBILE`.  
...
-   [SQLServer Compact Edition-Verbindungs-Manager-Editor &#40;Seite "Verbindung"&#41;](../sql-server-compact-edition-connection-manager-editor-connection-page.md)  
  
-   [SQLServer Compact Edition-Verbindungs-Manager-Editor &#40;Seite "alle"&#41;](../sql-server-compact-edition-connection-manager-editor-all-page.md)  
