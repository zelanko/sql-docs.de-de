...
##  <a name="Package"></a> Paket  
 ...
 `PackageType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSPackageType` Enumeration.  
...
|SQLDBMaint|6|  
 ...
 `CheckpointUsage` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSCheckpointUsage` Enumeration.  
...
|Always|2|  
 ...
 `PackagePriorityClass` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSPriorityClass` Enumeration.  
...
|Idle|4|  
 ...
 `ProtectionLevel` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSProtectionLevel` Enumeration.  
...
##  <a name="PrecedenceConstraints"></a> Rangfolgeneinschränkungen  
 `EvalOp` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSPrecedenceEvalOp` Enumeration.  
...
|ExpressionOrConstraint|4|  
 ...
 `Value` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSExecResult` Enumeration.  
...
### <a name="foreach-ado-enumerator"></a>Foreach-ADO-Enumerator  
 `Type` -Eigenschaft – Festlegung mithilfe von Werten aus der `ADOEnumerationType` Enumeration.  
...
|DirectInput|2|  
 ...
 `EnumerationType` -Eigenschaft – Festlegung mithilfe von Werten aus der `EnumerationType` Enumeration.  
...
|ElementCollection|3|  
 ...
 `InnerElementType` -Eigenschaft – Festlegung mithilfe von Werten aus der `InnerElementType` Enumeration.  
...
### <a name="analysis-services-execute-ddl-task"></a>DDL ausführen (Analysis Services-Task)  
 `SourceType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DDLSourceType` Enumeration.  
...
### <a name="bulk-insert-task"></a>Masseneinfügungstask  
 `DataFileType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSBulkInsert_DataFileType` Enumeration.  
...
### <a name="execute-sql-task"></a>SQL ausführen (Task)  
 `ResultSetType` -Eigenschaft – Festlegung mithilfe von Werten aus der `ResultSetType` Enumeration.  
...
|ResultSetType_XML|4|  
 ...
 `SqlStatementSourceType` -Eigenschaft – Festlegung mithilfe von Werten aus der `SqlStatementSourceType` Enumeration.  
...
### <a name="file-system-task"></a>Task Dateisystem  
 `Operation` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSFileSystemOperation` Enumeration.  
...
|DeleteDirectoryContent|9|  
 ...
 `Attributes` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSFileSystemAttributes` Enumeration.  
...
### <a name="ftp-task"></a>FTP-Task  
 `Operation` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSFTPOp` Enumeration.  
...
### <a name="message-queue-task"></a>Message Queue Task  
 `MessageType` -Eigenschaft – Festlegung mithilfe von Werten aus der `MQMessageType` Enumeration.  
...
|DTSMQMessagType_StringMessageToVariable|3|  
 ...
 `StringCompareType` -Eigenschaft – Festlegung mithilfe von Werten aus der `MQStringMessageCompare` Enumeration.  
...
|DTSMQStringMessageCompare_Contains|3|  
 ...
 `TaskType` -Eigenschaft – Festlegung mithilfe von Werten aus der `MQType` Enumeration.  
...
### <a name="send-mail-task"></a>Mail senden (Task)  
 `MessageSourceType` -Eigenschaft – Festlegung mithilfe von Werten aus der `SendMailMessageSourceType` Enumeration.  
...
|Variable|2|  
 ...
 `Priority` -Eigenschaft – Festlegung mithilfe von Werten aus der `MailPriority` Enumeration.  
...
### <a name="transfer-database-task"></a>Datenbanken übertragen (Task)  
 `Action` -Eigenschaft – Festlegung mithilfe von Werten aus der `TransferAction` Enumeration.  
...
|Verschieben|1|  
 ...
 `Method` -Eigenschaft – Festlegung mithilfe von Werten aus der `TransferMethod` Enumeration.  
...
### <a name="transfer-error-messages-task"></a>Fehlermeldungen übertragen (Task)  
 `IfObjectExists` -Eigenschaft – Festlegung mithilfe von Werten aus der `IfObjectExists` Enumeration.  
...
|Skip|2|  
 ...
 `LoginsToTransfer` -Eigenschaft – Festlegung mithilfe von Werten aus der `LoginsToTransfer` Enumeration.  
...
### <a name="transfer-sql-server-objects-task"></a>SQL Server-Objekte kopieren (Task)  
 `ExistingData` -Eigenschaft – Festlegung mithilfe von Werten aus der `ExistingData` Enumeration.  
...
### <a name="web-service-task"></a>Webdienst (Task)  
 `OutputType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSOutputType` Enumeration.  
...
### <a name="wmi-data-reader-task"></a>WMI-Datenleser (Task)  
 `OverwriteDestination` -Eigenschaft – Festlegung mithilfe von Werten aus der `OverwriteDestination` Enumeration.  
...
|KeepOriginal|2|  
 ...
 `OutputType` -Eigenschaft – Festlegung mithilfe von Werten aus der `OutputType` Enumeration.  
...
|PropertyNameAndValue|2|  
 ...
 `DestinationType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DestinationType` Enumeration.  
...
|Variable|1|  
 ...
 `WqlQuerySourceType` -Eigenschaft – Festlegung mithilfe von Werten aus der `QuerySourceType` Enumeration.  
...
|LogTheEvent|1|  
 ...
 `ActionAtTimeout` -Eigenschaft – Festlegung mithilfe von Werten aus der `ActionAtTimeout` Enumeration.  
...
|LogTimeout|1|  
 ...
 `AfterEvent` -Eigenschaft – Festlegung mithilfe von Werten aus der `AfterEvent` Enumeration.  
...
|WatchfortheEventAgain|2|  
 ...
 `AfterTimeout` -Eigenschaft – Festlegung mithilfe von Werten aus der `AfterTimeout` Enumeration.  
...
### <a name="xml-task"></a>XML-Task  
 `OperationType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSXMLOperation` Enumeration.  
...
|Variable|1|  
 ...
 `ValidationType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSXMLValidationType` Enumeration.  
...
|XSD|1|  
 ...
 `XPathOperation` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSXMLXPathOperation` Enumeration.  
...
|NodeList|2|  
 ...
 `DiffOptions` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSXMLDiffOptions` Enumeration. Die Optionen in diesem Enumerator schließen sich nicht gegenseitig aus. Stellen Sie eine durch Trennzeichen getrennte Liste der anzuwendenden Optionen bereit, um mehrere Optionen zu verwenden.  
...
|IgnoreDtd|128|  
 ...
 `DiffAlgorithm` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSXMLDiffAlgorithm` Enumeration.  
...
### <a name="all-maintenance-tasks"></a>Alle Wartungstasks  
 ...
 `DatabaseSelectionType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DatabaseSelection` Enumeration.  
...
|Specific|4|  
 ...
 `TableSelectionType` -Eigenschaft – Festlegung mithilfe von Werten aus der `TableSelection` Enumeration.  
...
|Specific|2|  
 ...
 `ObjectTypeSelection` -Eigenschaft – Festlegung mithilfe von Werten aus der `ObjectType` Enumeration.  
...
### <a name="back-up-database-task"></a>Datenbank sichern (Task)  
 `DestinationCreationType` -Eigenschaft – Festlegung mithilfe von Werten aus der `DestinationType` Enumeration.  
...
|Manuell|1|  
 ...
 `ExistingBackupsAction` -Eigenschaft – Festlegung mithilfe von Werten aus der `ActionForExistingBackups` Enumeration.  
...
|Overwrite|1|  
 ...
 `BackupAction` -Eigenschaft – Festlegung mithilfe von Werten aus der `BackupTaskType` Enumeration. Diese Eigenschaft arbeitet mit der `BackupIsIncremental` Eigenschaft, um den Typ der Sicherung zu definieren, der die Aufgabe ausführt.  
...
### <a name="maintenance-cleanup-task"></a>Wartungscleanup (Task)  
 `FileTypeSelected` -Eigenschaft – Festlegung mithilfe von Werten aus der `FileType` Enumeration.  
...
|FileReport|1|  
 ...
 `OlderThanTimeUnitType` -Eigenschaft – Festlegung mithilfe von Werten aus der `TimeUnitType` Enumeration.  
...
##  <a name="CommonProperties"></a> Allgemeine Eigenschaften  
 ...
 `ForceExecutionResult` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSForcedExecResult` Enumeration.  
...
|Completion|2|  
 ...
 `LoggingMode` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSLoggingMode` Enumeration.  
...
|Disabled|2|  
 ...
 `TransactionOption` -Eigenschaft – Festlegung mithilfe von Werten aus der `DTSTransactionOption` Enumeration.  
