...
# <a name="step-5-adding-and-configuring-the-flat-file-source"></a>Schritt 5: Hinzufügen und Konfigurieren der Flatfilequelle
 ...
 Für dieses Lernprogramm konfigurieren Sie die Flatfilequelle zum Verwenden der `Sample Flat File Source Data` Verbindungs-Manager, die Sie zuvor erstellt haben.  
...
5.  In der **Flatfile-Verbindungs-Manager** wählen Sie im `Sample Flat File Source Data`.  
