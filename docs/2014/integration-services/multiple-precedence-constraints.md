---
title: Mehrere Rangfolgeneinschränkungen | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="logicaland-property"></a>LogicalAnd-Eigenschaft  
 ...
 Sie können festlegen, die `LogicalAnd` Eigenschaft mit der **Rangfolgeneinschränkungs-Editor** in [!INCLUDE[ssIS](../includes/ssis-md.md)] -Designer oder im Fenster Eigenschaften, [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] bietet.  
