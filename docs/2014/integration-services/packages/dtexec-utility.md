...
-   **/Com [mandfile]** _Datei Spezifikation_:   
...
-   **/DumpOnError**:   
    ...
    -   Ein Datenwert von 0 gibt an, dass das System die Debugdumpdateien nur dann erstellt **** , wenn Sie die `dtexec` /DumpOnError-Option mit dem Hilfsprogramm verwenden.  
