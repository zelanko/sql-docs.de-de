...
ms.locfileid: "62832631"
---
# <a name="control-flow"></a>Ablaufsteuerung
  Ein Paket besteht aus einer Ablaufsteuerung und optional einem oder mehreren Datenflüssen. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] stellt drei verschiedene Arten von Ablauf Steuerungselementen bereit: Container, die Strukturen in Paketen bereitstellen, Tasks, die Funktionen bereitstellen, und Rang folgen Einschränkungen, mit denen die ausführbaren Dateien, Container und Tasks mit einer geordneten Ablauf Steuerung verbunden werden.  
