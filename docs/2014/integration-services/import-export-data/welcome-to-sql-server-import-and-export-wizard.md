...
ms.locfileid: "37170831"
---
# <a name="welcome-to-sql-server-import-and-export-wizard"></a>Willkommen beim SQL Server-Import/Export-Assistenten
  Verwenden der **SQL Server-Import / Export-Assistenten** kopieren und Transformieren von Daten zwischen unterstützten Datenquellen und Ziele.  
 ...
 **Diese Anfangsseite nicht mehr anzeigen.**  
 Auslassen Sie die Willkommensseite beim nächsten Öffnen des Assistenten.  
