...
description: Informationen Sie zum Importieren oder Exportieren von Excel-Daten mit SQL Server Integration Services (SSIS) zusammen mit erforderlichen Komponenten, bekannte Probleme und Einschränkungen.
ms.date: 04/10/2018
ms.prod: sql
