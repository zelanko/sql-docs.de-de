...
ms.locfileid: "43816956"
---
# <a name="job-propertiesnew-job-steps-page"></a>Auftragseigenschaften: Neuer Auftrag (Seite „Schritte“)
  Mithilfe dieser Seite können Sie Auftragsschritte für einen [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Agentauftrag anzeigen und planen.  
