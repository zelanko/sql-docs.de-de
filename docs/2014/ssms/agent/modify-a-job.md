...
3.  Verwenden Sie im Abfragefenster die folgenden gespeicherten Systemprozeduren, um einen Auftrag zu ändern.  
    ...
    -   Führen Sie [Sp_update_jobstep &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sp-update-jobstep-transact-sql) auf bereits vorhandene Auftragsschritte zu ändern.  
    ...
    -   Weitere gespeicherte Prozeduren zum Ändern von SQL Server-Agent-Masteraufträgen:  
        ...
        -   Führen Sie [Sp_delete_jobserver &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sp-delete-jobserver-transact-sql) So löschen Sie einen Server derzeit mit einem Auftrag zugewiesen ist.  
  
        -   Führen Sie [Sp_add_jobserver &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sp-add-jobserver-transact-sql) , den aktuellen Auftrag einen Server zugeordnet werden soll.  
