...
# <a name="group-rows-in-query-results-visual-database-tools"></a>Gruppieren von Zeilen in Abfrageergebnissen (Visual Database Tools)
 ...
 ![Abfrageergebnisse: Durchschnittspreis gruppiert nach Verleger](../../database-engine/media//dv3w9e1.gif "Query results: average price grouped by publisher")  
...
```  
 ...
 ![Abfrageergebnisse: Preis gruppiert nach Verleger und Typ](../../database-engine/media//dv3w9e2.gif "Query results: price grouped by publisher and type")  
...
5.  Wählen Sie in der Datenblattzelle **Gruppieren nach** der zu aggregierenden Spalte die entsprechende Aggregatfunktion aus.  
     ...
     ![Hinzufügen eines Spaltenalias zum Abfrageresultset](../../database-engine/media//dv3w9e3.gif "Adding a column alias to the query result set")  
