---
title: 'Lektion 2: Schreiben von Transact-SQL | Microsoft-Dokumentation'
ms.custom: ''
ms.date: 06/13/2017
...
> [!NOTE]  
>  In dieser Lektion wird der Schwerpunkt auf die Funktionen des Tools gelegt. Ein Tutorial zum Schreiben von [!INCLUDE[tsql](../../includes/tsql-md.md)] -Anweisungen finden Sie unter [Lernprogramm: Schreiben von Transact-SQL-Anweisungen](../../t-sql/tutorial-writing-transact-sql-statements.md).  
