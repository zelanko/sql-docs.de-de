...
-   Zum Sichern einer sekundären Datenbank ein sekundäres Replikat muss in der Lage, mit dem primären Replikat kommunizieren und muss `SYNCHRONIZED` oder `SYNCHRONIZING`.  
