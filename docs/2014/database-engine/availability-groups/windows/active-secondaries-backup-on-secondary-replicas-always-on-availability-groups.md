...
-   Zum Sichern einer sekundären Datenbank ein sekundäres Replikat muss mit dem primären Replikat kommunizieren und muss `SYNCHRONIZED` oder `SYNCHRONIZING`.  
