...
##  <a name="SupportedAvModes"></a> Unterstützte Verfügbarkeitsmodi  
 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] unterstützt zwei Verfügbarkeit Modi-Modus mit asynchronem Commit und synchronen Commit-Modus wie folgt:  
