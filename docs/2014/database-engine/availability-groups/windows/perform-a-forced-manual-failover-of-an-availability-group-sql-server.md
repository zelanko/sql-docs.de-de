...
1.  Wechseln Sie in das Verzeichnis (`cd`) zu einer Serverinstanz, die ein Replikat hostet, dessen Rolle sich im sekundären Zustand befindet oder in der Verfügbarkeits Gruppe, für die ein Failover ausgeführt werden muss  
...
##  <a name="ExampleRecoveryFromCatastrophy"></a> Beispielszenario: Wiederherstellen nach einem schwerwiegenden Fehler mithilfe eines erzwungenen Failovers  
 ...
 ![Topologie nach einem Fehler im Hauptrechenzentrum](../../media/aoag-failurerecovery-catastrophy.gif "Topologie nach einem Fehler im Hauptrechenzentrum")  
...
###  <a name="FailureResponse"></a> Responding to the Catastrophic Failure of the Main Data Center  
 ...
 ![Schritte zum reagieren auf Fehler des Hauptdaten Rechenzentrum](../../media/aoag-failurerecovery-actions-part1.gif "Schritte zum reagieren auf Fehler des Hauptdaten Rechenzentrum")  
