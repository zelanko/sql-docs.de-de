...
-   **Dedizierte Netzwerkadapter:**  Verwenden Sie einen dedizierten Netzwerkadapter (Netzwerkschnittstellenkarte) für eine optimale Leistung für [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)].  
...
|![Kontrollkästchen](../../media/checkboxemptycenterxtraspacetopandright.gif "Kontrollkästchen")|Die Datenbank muss mindestens über eine vollständige Datenbanksicherung verfügen.<br /><br /> Hinweis: Nachdem eine Datenbank zum vollständigen Wiederherstellungsmodus festgelegt haben, ist eine vollständige Sicherung erforderlich, um die volle-Wiederherstellungs-Protokollkette zu initiieren.|[Erstellen einer vollständigen Datenbanksicherung &#40;SQL Server&#41;](../../../relational-databases/backup-restore/create-a-full-database-backup-sql-server.md)|  
