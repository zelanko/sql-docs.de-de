---
title: Voraussetzungen, Einschränkungen und Empfehlungen für AlwaysOn-Verfügbarkeitsgruppen (SQLServer) | Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
...
> [!IMPORTANT]  
>  Stellen Sie zudem sicher, dass Ihre Umgebung ordnungsgemäß zum Herstellen einer Verbindung mit einer Verfügbarkeitsgruppe konfiguriert wird. Weitere Informationen finden Sie unter [Always On-Clientkonnektivität (SQL Server)](always-on-client-connectivity-sql-server.md).  
...
###  <a name="PermissionsWindows"></a> Berechtigungen (Windows-System)  
 ...
 Weitere Informationen über das Konto zum Verwalten des Clusters finden Sie unter [Anhang A: Failoverclusteranforderungen](http://technet.microsoft.com/library/dd197454\(WS.10\).aspx).  
...
3.  Verwenden Sie die `Get-ClusterResource` Cmdlet, um die Netzwerknamenressource zu suchen, verwenden Sie `Set-ClusterParameter` Cmdlet, um die `HostRecordTTL` -Wert wie folgt:  
...
|![Kontrollkästchen](../../media/checkboxemptycenterxtraspacetopandright.gif "Kontrollkästchen")|Bevor eigenständigen Datenbanken einer verfügbarkeitsgruppe hinzugefügt werden, stellen Sie sicher, dass die `contained database authentication` Option "Server" festgelegt ist, um `1` auf jeder Serverinstanz, die ein verfügbarkeitsreplikat für die verfügbarkeitsgruppe hostet.|[Contained Database Authentication (Serverkonfigurationsoption)](../../configure-windows/contained-database-authentication-server-configuration-option.md)<br /><br /> [Serverkonfigurationsoptionen &#40;SQL Server&#41;](../../configure-windows/server-configuration-options-sql-server.md)|  
...
-   Darüber hinaus verwenden Verfügbarkeitsgruppen nicht freigegebene Threads wie folgt:  
 ...
 Weitere Informationen finden Sie unter [AlwaysON - HADRON-Lernreihe: Nutzung des Arbeitsthreadpools für HADRON-fähige Datenbanken](http://blogs.msdn.com/b/psssql/archive/2012/05/17/alwayson-hadron-learning-series-worker-pool-usage-for-hadron-enabled-databases.aspx) (ein [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] -Technikblog).  
...
##  <a name="ClientConnSupport"></a> Unterstützung für Clientkonnektivität  
 Informationen zu [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] für Clientkonnektivität finden Sie unter [Always On-Clientkonnektivität (SQL Server)](always-on-client-connectivity-sql-server.md).  
...
-   [AlwaysOn-Architekturhandbuch: Erstellen einer Hochverfügbarkeits- und Notfallwiederherstellungslösung mithilfe von Failoverclusterinstanzen und Verfügbarkeitsgruppen](http://technet.microsoft.com/library/jj215886.aspx)  
...
|![Kontrollkästchen](../../media/checkboxemptycenterxtraspacetopandright.gif "Kontrollkästchen")|Vor dem Hinzufügen einer enthaltenen Datenbank zu einer verfügbarkeitsgruppe, sicher, dass die `contained database authentication` Option "Server" festgelegt ist, um `1` auf jedem Server, der als Host-Instanz oder ein verfügbarkeitsreplikat für die verfügbarkeitsgruppe gehostet wird.|[Contained Database Authentication (Serverkonfigurationsoption)](../../configure-windows/contained-database-authentication-server-configuration-option.md)<br /><br /> [Serverkonfigurationsoptionen &#40;SQL Server&#41;](../../configure-windows/server-configuration-options-sql-server.md)|  
