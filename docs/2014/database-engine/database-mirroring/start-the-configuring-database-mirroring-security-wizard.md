...
3.  Klicken Sie mit der rechten Maustaste auf die Datenbank, wählen Sie **Tasks**aus, und klicken Sie dann auf **Spiegeln**. Dadurch wird die [Seite Spiegelung](../../relational-databases/databases/database-properties-mirroring-page.md) des Dialog Felds **Daten Bank Eigenschaften** geöffnet.  
