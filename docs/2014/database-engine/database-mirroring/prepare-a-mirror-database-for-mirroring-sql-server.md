...
-   Eine Datenbank, gehört können nicht gespiegelt ein [AlwaysOn-Verfügbarkeitsgruppen (SQL Server)](../availability-groups/windows/always-on-availability-groups-sql-server.md).  
