...
##  <a name="VisualElement"></a> Asynchrone Datenbankspiegelung (Modus für hohe Leistung)  
...
> [!NOTE]  
>  Die meisten Editionen von [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] unterstützen nur die synchrone Datenbankspiegelung (nur SAFETY FULL). Informationen zu Editionen, die datenbankspiegelung vollständig unterstützen, finden Sie unter "Hohe Verfügbarkeit (AlwaysOn)" in [von den Editionen von SQL Server 2014 unterstützte Funktionen](../../getting-started/features-supported-by-the-editions-of-sql-server-2014.md).  
 ...
 ![Reine Partnerkonfiguration einer Sitzung](../media/dbm-high-performance-mode.gif "Partner-only configuration of a session")  
...
###  <a name="HighSafetyWithOutAutoFailover"></a> Modus für hohe Sicherheit ohne automatisches Failover  
 ...
 ![Partnerkommunikation ohne Zeugen](../media/dbm-high-protection-mode.gif "Partners communicating without a witness")  
...
###  <a name="HighSafetyWithAutoFailover"></a> Modus für hohe Sicherheit mit automatischem Failover  
 ...
 ![Der Zeuge und die zwei Partner einer Sitzung](../media/dbm-high-availability-mode.gif "The witness and two partners of a session")  
