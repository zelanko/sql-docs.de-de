---
title: Zulassen des Netzwerkzugriffs mit einer Datenbank-Spiegelungsendpunkt mithilfe der Windows-Authentifizierung (SQLServer) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
