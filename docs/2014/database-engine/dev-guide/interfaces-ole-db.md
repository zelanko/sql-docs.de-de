...
ms.locfileid: "62781315"
---
# <a name="interfaces-ole-db"></a>Schnittstellen (OLE DB)
  Zusätzlich zu den Kern OLE DB Schnittstellen, die von den Microsoft Data Access Components (MDAC) bereitgestellt [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] werden, implementiert der Native Client OLE DB-Anbieter die folgenden zusätzlichen OLE DB Schnittstellen:  
