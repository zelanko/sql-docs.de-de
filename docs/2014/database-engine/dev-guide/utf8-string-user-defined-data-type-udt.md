---
title: UTF8 String den benutzerdefinierten Typ (UDT) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
10. Kopie [!INCLUDE[tsql](../../includes/tsql-md.md)] -testbefehlsskript in eine Datei, und speichern Sie sie als `test.sql` im Beispielverzeichnis.  
