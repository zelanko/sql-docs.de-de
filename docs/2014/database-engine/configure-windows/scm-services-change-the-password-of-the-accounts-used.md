...
4.  **SQL Server (** \<instancename> Geben Sie im Dialogfeld**Eigenschaften** von SQL Server () auf der Registerkarte Anmelden für das im Feld **Kontoname** angegebene Konto das neue Kennwort in die Felder **Kennwort** und **Kennwort bestätigen** ein, und klicken Sie dann auf **OK**.  
...
3.  Klicken Sie im Detailfenster mit der rechten Maustaste auf **SQL Server-Agent (** \<instancename> **)**, und klicken Sie dann auf **Eigenschaften**.  
  
4.  **SQL Server Agent (** \<instancename> Geben Sie im Dialogfeld**Eigenschaften** von SQL Server-Agent () auf der Registerkarte Anmelden für das im Feld **Kontoname** angegebene Konto das neue Kennwort in die Felder **Kennwort** und **Kennwort bestätigen** ein, und klicken Sie dann auf **OK**.  
