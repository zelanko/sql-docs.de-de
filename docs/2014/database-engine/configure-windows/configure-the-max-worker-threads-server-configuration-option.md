...
-   **Nachverfolgung:**  [Nach dem Konfigurieren der maximalen Arbeitsthreads (Option)](#FollowUp)  
...
##  <a name="FollowUp"></a> Zur Nachverfolgung: Nach dem Konfigurieren der Option Max. Anzahl von Arbeitsthreads  
