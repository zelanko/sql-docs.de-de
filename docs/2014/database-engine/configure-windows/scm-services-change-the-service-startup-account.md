...
4.  Klicken Sie im Dialogfeld **SQL Server \<***instancename***> Eigenschaften** auf die Registerkarte **Anmelden** , und wählen Sie den Typ **Anmelden als** aus.  
