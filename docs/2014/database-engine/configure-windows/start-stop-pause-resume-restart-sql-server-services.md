...
-   Geben Sie an einer Eingabeaufforderung einen der folgenden Befehle ein. Ersetzen *\<instancename>* Sie dies durch den Namen der Instanz, die Sie verwalten möchten.  
