...
1.  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Erweitern Sie in Configuration Manager **SQL Server Netzwerkkonfiguration**, und klicken Sie dann auf **Protokolle für** *\<instance name>* .  
