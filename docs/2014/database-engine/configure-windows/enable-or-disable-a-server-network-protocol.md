...
##  <a name="using-sql-server-configuration-manager"></a><a name="SSMSProcedure"></a>Verwenden von SQL Server-Konfigurations-Manager  
...
2.  Klicken Sie im Konsolen Bereich auf **Protokolle für** *\<instance name>* .  
