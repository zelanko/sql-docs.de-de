...
-   **So aktivieren oder deaktivieren Sie ein Servernetzwerk Protokoll mit:**  
...
2.  Klicken Sie im Konsolen Bereich auf **Protokolle für** * \<Instanzname>*.  
...
##  <a name="PowerShellProcedure"></a>Verwenden von SQL Server PowerShell  
