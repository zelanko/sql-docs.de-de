...
-   **Nachverfolgung:**  [Nach dem konfigurieren wird der Index create Memory-option](#FollowUp)  
...
##  <a name="FollowUp"></a> Zur Nachverfolgung: Nach dem Konfigurieren der Option Speicher für Indexerstellung  
