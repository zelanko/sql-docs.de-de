...
##  <a name="contents"></a><a name="Top"></a>Haus  
...
##  <a name="services-installed-by-ssnoversion"></a><a name="Service_Details"></a>Von installierte Dienste[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
##  <a name="service-properties-and-configuration"></a><a name="Serv_Prop"></a>Dienst Eigenschaften und-Konfiguration  
...
-   <a name="VA_Desc"></a> **Virtual Accounts**  
    ...
    |[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agent-Dienst auf einer [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Instanz von mit dem Namen **Gehalts**|**NT SERVICE\SQLAGENT$PAYROLL**|  
...
##  <a name="service-permissions"></a><a name="Serv_Perm"></a>Dienst Berechtigungen  
...
|---------------------------------------|------------------------------------------------------------|  
|**[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]:**<br /><br /> (Der Pro-Dienst-SID werden alle Rechte gewährt. Standardinstanz: **NT SERVICE\MSSQLSERVER**. Benannte Instanz: **NT SERVICE\MSSQL$** Instanzname.)|**Anmelden als Dienst** (SeServiceLogonRight)<br /><br /> **Token auf Prozessebene ersetzen** (SeAssignPrimaryTokenPrivilege)<br /><br /> **Umgehungs Überprüfung umgehen** ("abchangenotifyprivilege")<br /><br /> **Speicherkontingente für einen Prozess anpassen** (SeIncreaseQuotaPrivilege)<br /><br /> Berechtigung zum Starten von SQL Writer<br /><br /> Berechtigung zum Lesen des Ereignisprotokolldiensts<br /><br /> Berechtigung zum Lesen des Remoteprozeduraufruf-Diensts|  
|Agent: <sup>1</sup> ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **<br /><br /> (Der Pro-Dienst-SID werden alle Rechte gewährt. Standardinstanz: **NT Service\SQLSERVERAGENT**. Benannte Instanz: **NT service\sqlagent $**_instanceName_.)|**Anmelden als Dienst** (SeServiceLogonRight)<br /><br /> **Token auf Prozessebene ersetzen** (SeAssignPrimaryTokenPrivilege)<br /><br /> **Umgehungs Überprüfung umgehen** ("abchangenotifyprivilege")<br /><br /> **Speicherkontingente für einen Prozess anpassen** (SeIncreaseQuotaPrivilege)|  
|**[!INCLUDE[ssAS](../../includes/ssas-md.md)]:**<br /><br /> (Einer lokalen Windows-Gruppe werden alle Rechte gewährt. Standardinstanz: **SQLServerMSASUser$**_ComputerName_**$MSSQLSERVER**. Benannte Instanz: **SQLServerMSASUser$**_ComputerName_**$**_InstanceName_. [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]Instanz: **SQLServerMSASUser $**_Computername_**$**_Power Pivot_.)|**Anmelden als Dienst** (SeServiceLogonRight)<br /><br /> Nur für tabellarisch:<br /><br /> **Arbeitssatz eines Prozesses vergrößern** (SeIncreaseWorkingSetPrivilege)<br /><br /> **Speicherkontingente für einen Prozess anpassen** (SeIncreaseQuotaSizePrivilege)<br /><br /> **Sperren von Seiten im Speicher** (SeLockMemoryPrivilege): Dies ist nur erforderlich, wenn Paging vollständig ausgeschaltet ist.<br /><br /> Nur für Failoverclusterinstallationen:<br /><br /> **Anheben der Zeitplanungspriorität** (SeIncreaseBasePriorityPrivilege)|  
...
|**[!INCLUDE[ssIS](../../includes/ssis-md.md)]:**<br /><br /> (Der Pro-Dienst-SID werden alle Rechte gewährt. Standardinstanz und benannte Instanz: **NT SERVICE\MsDtsServer120**. [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] verfügt über keinen separaten Prozess für eine benannte Instanz.)|**Anmelden als Dienst** (SeServiceLogonRight)<br /><br /> Berechtigung zum Schreiben in das Anwendungsereignisprotokoll<br /><br /> **Umgehungs Überprüfung umgehen** ("abchangenotifyprivilege")<br /><br /> **Annehmen der Clientidentität nach Authentifizierung** (SeImpersonatePrivilege)|  
|**Volltextsuche:**<br /><br /> (Der Pro-Dienst-SID werden alle Rechte gewährt. Standardinstanz: **NT Service\MSSQLFDLauncher**. Benannte Instanz: **NT Service\MSSQLFDLauncher$**_Instanzname_.)|**Anmelden als Dienst** (SeServiceLogonRight)<br /><br /> **Speicherkontingente für einen Prozess anpassen** (SeIncreaseQuotaPrivilege)<br /><br /> **Umgehungs Überprüfung umgehen** ("abchangenotifyprivilege")|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Browser:**<br /><br /> (Einer lokalen Windows-Gruppe werden alle Rechte gewährt. Standardinstanz oder benannte Instanz: **SQLServer2005SQLBrowserUser**_$ComputerName_. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser verfügt über keinen separaten Prozess für eine benannte Instanz.)|**Anmelden als Dienst** (SeServiceLogonRight)|  
...
|Dienstkonto für|Dateien und Ordner|Access|  
|-------------------------|-----------------------|------------|  
...
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]|Berichtsserverkonto des Windows-Diensts|Installieren Sie>\Reporting Services\LogFiles. * \< *|Delete<br /><br /> READ_CONTROL<br /><br /> SYNCHRONIZE<br /><br /> FILE_GENERIC_READ<br /><br /> FILE_GENERIC_WRITE<br /><br /> FILE_READ_DATA<br /><br /> FILE_WRITE_DATA<br /><br /> FILE_APPEND_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_WRITE_EA<br /><br /> FILE_READ_ATTRIBUTES<br /><br /> FILE_WRITE_ATTRIBUTES|  
...
||Berichtsserverkonto des Windows-Diensts|Installieren Sie>\Reporting Services\ReportServer. * \< *|Lesen|  
||Berichtsserverkonto des Windows-Diensts|Installieren Sie>\Reporting services\reportserver\global.asax. * \< *|Vollständig|  
...
||Powerusers|Berichtsserverschlüssel (Instid-Struktur)|Wert abfragen<br /><br /> Wert festlegen<br /><br /> Unterschlüssel erstellen<br /><br /> Unterschlüssel auflisten<br /><br /> Benachrichtigen<br /><br /> Löschen<br /><br /> Lesezugriff|  
  
 <sup>1</sup> Dies ist der Namespace des WMI-Anbieters.  
  
###  <a name="file-system-permissions-related-to-unusual-disk-locations"></a><a name="Unusual_Locations"></a>Datei System Berechtigungen im Zusammenhang mit ungewöhnlichen Speicherorten  
...
###  <a name="database-engine-provisioning"></a><a name="DE_Prov"></a>Datenbank-Engine Bereitstellung  
...
####  <a name="sql-server-per-service-sid-login-and-privileges"></a><a name="Logins"></a>SQL Server pro-Dienst-SID-Anmeldung und-Berechtigungen  
...
####  <a name="sql-server-agent-login-and-privileges"></a><a name="Agent"></a>SQL Server-Agent Anmelde Namen und Berechtigungen  
...
##  <a name="appendix"></a><a name="Appendix"></a>Gers  
