...
-   SC (Self-Configuring) = Selbstkonfigurierende Optionen.  
    ...
    |Konfigurationsoption|Minimalwert|Maximalwert|Standard|  
    |--------------------------|-------------------|-------------------|-------------|  
    ...
    |[Benutzeroptionen](configure-the-user-options-server-configuration-option.md)|0|32767|0|  
