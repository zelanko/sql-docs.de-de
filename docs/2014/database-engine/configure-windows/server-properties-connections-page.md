 ...
 **Verteilte Transaktionen für die Kommunikation zwischen Servern verlangen**  
 Schützt die Aktionen einer Server-zu-Server-Prozedur durch eine [!INCLUDE[msCoName](../../includes/msconame-md.md)] Distributed Transaction Coordinator-Transaktion (MS DTC). Weitere Informationen finden Sie unter [Configure the remote proc trans Server Configuration Option](configure-the-remote-proc-trans-server-configuration-option.md).  
...
## <a name="see-also"></a>Siehe auch  
 [Optionen &#40;Abfragen Abfrageausführung: SQL Server: Seite "Erweitert"&#41;](../options-query-execution-sql-server-advanced-page.md)   
