---
title: Ursachen und Lösungen für Datenbank-Engine-Fehler | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "66065191"
---
# <a name="cause-and-resolution-of-database-engine-errors"></a>Ursachen und Lösungen für Datenbank-Engine-Fehler
  Dieses Thema enthält die Ursache und Auflösungsinformationen für eine Reihe von Fehlern im Zusammenhang mit der [!INCLUDE[ssDE](../includes/ssde-md.md)].  
