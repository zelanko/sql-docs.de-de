...
-   [SQL Server-Überwachung](configure-sql-server-on-a-server-core-installation.md#bkmk_auditing)  
  
-   [Befehlszeilen-Hilfsprogramme](configure-sql-server-on-a-server-core-installation.md#bkmk_cmd)  
  
-   [Verwenden von Tools zur Problembehandlung](configure-sql-server-on-a-server-core-installation.md#bkmk_troubleshoot)  
...
-   [Windows Server 2008 R2: Best Practices für Server Core-Bereitstellungen](http://go.microsoft.com/fwlink/?LinkID=245957) ()http://go.microsoft.com/fwlink/?LinkID=245957)  
...
-   [Installieren von Updates für SQLServer 2014 während einer neuen Installations](configure-sql-server-on-a-server-core-installation.md#bkmk_newinstall)  
  
-   [Installieren von Updates für SQLServer 2014, nachdem es bereits installiert wurde.](configure-sql-server-on-a-server-core-installation.md#bkmk_alreadyinstall)  
