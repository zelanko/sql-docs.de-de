...
-   Aktualisieren einer [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] Instanz des Datenbankmoduls auf [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Treiberdienst [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] setup mithilfe des Installations-Assistenten oder von der Befehlszeile aus.  
...
-   Aktualisieren einer [!INCLUDE[ssASversion2005](../../includes/ssasversion2005-md.md)] auf [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Treiberdienst [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Setup.  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Hardware and Software Requirements for Installing SQLServer 2014](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md)   
