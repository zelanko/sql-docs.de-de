...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/ADDCURRENTUSERASSQLADMIN<br /><br /> **Optional**|Fügt den aktuellen Benutzer der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]`sysadmin` Fixed-Server Rolle hinzu. Der /ADDCURRENTUSERASSQLADMIN-Parameter kann beim Installieren von Express-Editionen oder bei Verwendung von /Role=ALLFeatures_WithDefaults eingesetzt werden. Weitere Informationen finden Sie unter [/ROLE](#Role) unten. Die Verwendung von /ADDCURRENTUSERASSQLADMIN ist optional, aber /ADDCURRENTUSERASSQLADMIN oder /SQLSYSADMINACCOUNTS ist erforderlich. Standardwerte:<br /><br /> True[!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] für Editionen von<br /><br /> False für alle anderen Editionen|  
