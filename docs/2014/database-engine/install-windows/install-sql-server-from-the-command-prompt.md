...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Setupsteuerelement|/INSTALLSHAREDDIR<br /><br /> **Optional**|Gibt ein nicht standardmäßiges Installationsverzeichnis für freigegebene 64-Bit-Komponenten an.<br /><br /> Der Standardwert lautet% Program Files%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> Kann nicht auf% Program Files (x86)%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]festgelegt werden [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Setupsteuerelement|/INSTALLSHAREDWOWDIR<br /><br /> **Optional**|Gibt ein nicht standardmäßiges Installationsverzeichnis für freigegebene 32-Bit-Komponenten an. Wird nur auf 64-Bit-Systemen unterstützt.<br /><br /> Der Standardwert lautet% Program Files (x86)%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> Kann nicht auf% Program Files%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]festgelegt werden [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SECURITYMODE<br /><br /> **Optional**|Gibt den Sicherheitsmodus für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] an. Wenn dieser Parameter nicht angegeben wird, kann die Authentifizierung nur über Windows erfolgen. Unterstützter Wert:<br /><br /> location|  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/ADDCURRENTUSERASSQLADMIN<br /><br /> **Optional**|Fügt den aktuellen Benutzer der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]`sysadmin` Fixed-Server Rolle hinzu. Der /ADDCURRENTUSERASSQLADMIN-Parameter kann beim Installieren von Express-Editionen oder bei Verwendung von /Role=ALLFeatures_WithDefaults eingesetzt werden. Weitere Informationen finden Sie unter [/ROLE](#Role) unten. Die Verwendung von /ADDCURRENTUSERASSQLADMIN ist optional, aber /ADDCURRENTUSERASSQLADMIN oder /SQLSYSADMINACCOUNTS ist erforderlich. Standardwerte:<br /><br /> [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]True{2} für Editionen von {3}<br /><br /> False für alle anderen Editionen|  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Agent|/AGTSVCPASSWORD<br /><br /> [Erforderlich](#Accounts)|Gibt das Kennwort für das [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Agent-Dienstkonto an.|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Agent|/AGTSVCSTARTUPTYPE<br /><br /> **Optional**|Gibt den [Startmodus](#Accounts) für den [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Agent-Dienst an. Unterstützte Werte:<br /><br /> Automatic<br /><br /> Disabled<br /><br /> Manuell|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Browser|/BROWSERSVCSTARTUPTYPE<br /><br /> **Optional**|Gibt den [Start](#Accounts) Modus für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Browser-Dienst an. Unterstützte Werte:<br /><br /> Automatic<br /><br /> Disabled<br /><br /> Manuell|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/ENABLERANU<br /><br /> **Optional**|Aktiviert die "Ausführen als"-Anmeldeinformationen von [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] -Installationen.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/INSTALLSQLDATADIR<br /><br /> **Optional**|Gibt das Datenverzeichnis für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Datendateien an. Standardwerte:<br /><br /> Für den WOW-Modus auf 64-Bit-Version:% Program Files (x86)%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\\<br /><br /> Für alle anderen Installationen:% Program Files%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SAPWD<br /><br /> **Erforderlich, wenn /SECURITYMODE=SQL**|Gibt das Kennwort für das sa-Konto von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] an.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SECURITYMODE<br /><br /> **Optional**|Gibt den Sicherheitsmodus für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] an. Wenn dieser Parameter nicht angegeben wird, kann die Authentifizierung nur über Windows erfolgen. Unterstützter Wert:<br /><br /> location|  
...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/INSTALLSQLDATADIR<br /><br /> **Erforderlich**|Gibt das Datenverzeichnis für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Datendateien an.<br /><br /> Das Datenverzeichnis muss angegeben werden und sich auf einem freigegebenen Clusterdatenträger befinden.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SAPWD<br /><br /> **Erforderlich, wenn /SECURITYMODE=SQL**|Gibt das Kennwort für das sa-Konto von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] an.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SECURITYMODE<br /><br /> **Optional**|Gibt den Sicherheitsmodus für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] an.<br /><br /> Wenn dieser Parameter nicht angegeben wird, kann die Authentifizierung nur über Windows erfolgen. Unterstützte Werte:<br /><br /> location|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLBACKUPDIR<br /><br /> **Optional**|Gibt das Verzeichnis für Sicherungsdateien an. Standardwert:<br /><br /> \<InstallSQLDataDir>\ \<SQLInstanceID>\MSSQL\Backup.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLCOLLATION<br /><br /> **Optional**|Legt die Sortierungseinstellungen für [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]fest.<br /><br /> Der Standardwert basiert auf dem Gebietsschema des Windows-Betriebssystems. Weitere Informationen finden Sie unter [Sortierungseinstellungen im Setup-Programm](https://msdn.microsoft.com/library/ms143508%28v=sql.105%29.aspx).|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLSYSADMINACCOUNTS<br /><br /> **Erforderlich**|Verwenden Sie diesen Parameter, um Anmeldenamen für Mitglieder der sysadmin-Rolle bereitzustellen.|  
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/SQLTEMPDBDIR<br /><br /> **Optional**|Gibt das Verzeichnis für die Datendateien für tempdb an. Standardwert:<br /><br /> \<InstallSQLDataDir>\ \<SQLInstanceID>\MSSQL\Data.|  
...
|location||Installiert [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)], Replikation, Volltext und [!INCLUDE[ssDQSServer](../../includes/ssdqsserver-md.md)].|  
...
||SSMS|Installiert [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Verwaltungs Tools-Basic. Dazu gehören:<br /><br /> [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] Unterstützung für die [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)], [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)], das **sqlcmd** -Hilfsprogramm und den [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] PowerShell-Anbieter|  
...
||LocalDB<sup>1</sup>|Installiert LocalDB [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] , einen Ausführungsmodus von , der speziell für Programmentwickler konzipiert wurde.|  
...
-   RS-Instanz-ID: MSRS12.\<InstanceId >  
 ...
 % Der Programmdateien%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\\< sqlinstanceid\>  
  
 % Der Programmdateien%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\\< asinstanceid\>  
  
 % Der Programmdateien%\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\\< rsinstanceid\>  
...
## <a name="see-also"></a>Siehe auch  
 [Installieren Sie SQL Server 2014 über den Installations &#40;-&#41; Assistenten](install-sql-server-from-the-installation-wizard-setup.md)   
