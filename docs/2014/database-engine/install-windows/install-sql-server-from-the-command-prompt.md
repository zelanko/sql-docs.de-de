...
|[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]|/ADDCURRENTUSERASSQLADMIN<br /><br /> **Optional**|Fügt den aktuellen Benutzer auf die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] `sysadmin` -Serverrolle sein. Der /ADDCURRENTUSERASSQLADMIN-Parameter kann beim Installieren von Express-Editionen oder bei Verwendung von /Role=ALLFeatures_WithDefaults eingesetzt werden. Weitere Informationen finden Sie unter [/ROLE](#Role) unten. Die Verwendung von /ADDCURRENTUSERASSQLADMIN ist optional, aber /ADDCURRENTUSERASSQLADMIN oder /SQLSYSADMINACCOUNTS ist erforderlich. Standardwerte:<br /><br /> True für Editionen von [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]<br /><br /> 
