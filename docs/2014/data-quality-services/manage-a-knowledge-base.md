...
4.  Im Kontextmenü können Sie folgende Schritte ausführen:  
    ...
    6.  **Eigenschaften:** Klicken Sie auf diese Option, um die Eigenschaften für die Datenbank im schreibgeschützten Modus anzuzeigen.  
        ...
        2.  **Status**: Gibt an, ob die Wissensdatenbank **In Arbeit** und bestimmt, wann es zuletzt geschlossen wurde in einer bestimmten wissensverwaltungsaktivität befindet. Die Wissensdatenbank kann den Status **In Arbeit**haben – in dem Fall ist sie in einer Wissensverwaltungssitzung, jedoch nicht in einer bestimmten Aktivität geöffnet -, oder sie kann sich im Status **In Arbeit** sowie in einer Wissensverwaltungsaktivität befinden. In dem Fall ist die Wissensdatenbank in einer Wissensverwaltungssitzung und in einer bestimmten Aktivität geöffnet.  
  
        3.  **Ist gesperrt,**: **"True"** , wenn die Wissensdatenbank gesperrt wurde, **"false"** andernfalls  
...
##  <a name="FollowUp"></a>Nächster Schritt: Nach dem Verwalten einer Wissensdatenbank  
