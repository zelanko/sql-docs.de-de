...
##  <a name="BusinessNeed"></a>Die geschäftliche Notwendigkeit für DQS  
...
-   **Datenbereinigung:** Änderungen, entfernen oder Anreicherungen von Daten, die falsch oder unvollständig sind und sowohl computergestützte als auch interaktive Prozesse verwenden. Weitere Informationen finden Sie unter [Data Cleansing](../../2014/data-quality-services/data-cleansing.md).  
  
-   Abgleich **:** die Identifikation semantischer Duplikate in einem regelbasierten Prozess, mit dem Sie bestimmen können, was eine Übereinstimmung ausmacht und eine Deduplizierung ausführt. Weitere Informationen finden Sie unter [Data Matching](../../2014/data-quality-services/data-matching.md).  
  
-   **Verweis Data Services:** Überprüfen der Qualität Ihrer Daten mithilfe der Dienste eines Verweis Datenanbieters. Mithilfe von Verweis Datendiensten von Azure Marketplace datamarket können Sie Daten problemlos bereinigen, überprüfen, abgleichen und erweitern. Weitere Informationen finden Sie unter [Reference Data Services in DQS](../../2014/data-quality-services/reference-data-services-in-dqs.md).  
  
-   **Profilerstellung:** die Analyse einer Datenquelle, um Einblick in die Qualität der Daten in jeder Phase der Wissens Ermittlung, Domänen Verwaltung, Abgleich und Daten Bereinigungs Prozesse bereitzustellen. Die Profilerstellung ist ein leistungsstarkes Tool in einer DQS-Data Quality-Lösung. Sie können eine Data Quality-Lösung erstellen, in der die Profilerstellung so wichtig wie die Wissensverwaltung, der Abgleich oder die Datenbereinigung ist. Weitere Informationen finden Sie unter [Data Profiling and Notifications in DQS](../../2014/data-quality-services/data-profiling-and-notifications-in-dqs.md).  
  
-   **Überwachung:** das Nachverfolgen und Ermitteln des Status von Data Quality-Aktivitäten. Mit der Überwachungsfunktion können Sie sicherstellen, dass Ihre Data Quality-Lösung sich entsprechend verhält. Weitere Informationen finden Sie unter [DQS Administration](../../2014/data-quality-services/dqs-administration.md).  
  
-   **Wissensdatenbank:** Data Quality Services ist eine Wissensorientierte Lösung, die Daten basierend auf dem Wissen analysiert, das Sie mit DQS erstellt haben. Dies ermöglicht es Ihnen, Data Quality-Prozesse zu erstellen, wodurch die Informationen über Ihre Daten kontinuierlich erweitert werden und somit die Qualität Ihrer Daten verbessert wird.  
