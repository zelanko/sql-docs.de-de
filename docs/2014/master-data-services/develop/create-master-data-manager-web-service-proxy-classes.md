...
2.  Suchen Sie `mdsWsHttpBehavior` den Abschnitt unter ** \<Service Verhaltensweisen>**. Legen Sie für das Element ** \<serviceMetadata>** den `true`Wert auf fest `httpGetEnabled` .  
