...
|Einstellungen: Protokollierung|Ausführliche Protokollierung aktivieren|Aktivieren der Protokollierung für den Prozess des Ladens von Masterdaten aus MDS in das Excel-Add-in, die das Ergebnis jedes Befehls im Dienst protokolliert wird.|  
