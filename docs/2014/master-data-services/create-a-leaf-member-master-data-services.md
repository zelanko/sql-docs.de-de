...
ms.locfileid: "36163158"
---
# <a name="create-a-leaf-member-master-data-services"></a>Erstellen eines Blattelements (Master Data Services)
  In [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)], erstellen Sie ein Blattelement, wenn Sie dem System Masterdaten hinzufügen möchten und keine Stagingtabellen oder [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] [!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)] zum Importieren von Daten.  
...
-   Sie benötigen mindestens **Update** Berechtigung für das blattmodellobjekt für die Entität, die Sie ein Element hinzufügen.  
