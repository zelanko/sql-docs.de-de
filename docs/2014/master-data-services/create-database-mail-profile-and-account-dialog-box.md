...
|**SMTP-Server**|Geben Sie den Namen oder die IP-Adresse des SMTP-Servers ein, der von diesem Konto zum Senden von E-Mails verwendet wird. Ein Beispiel für das SMTP- `smtp.` Server Format ist *<COMPANY_NAME>* `.com`. Informationen hierzu erhalten Sie von Ihrem E-Mail-Administrator.|  
