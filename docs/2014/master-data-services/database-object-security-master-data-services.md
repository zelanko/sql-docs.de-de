...
-   [Staging von Daten](#Staging)  
  
-   [Validieren von Daten anhand von Geschäftsregeln](#rules)  
  
-   [Löschen von Versionen](#Versions)  
  
-   [Sofortiges Anwenden von Hierarchie Element Berechtigungen](#Hierarchy)  
  
-   [Ändern des Systemadministratorkontos](#SysAdmin)  
  
-   [Konfigurieren von System Einstellungen](#SysSettings)  
  
##  <a name="Staging"></a>Staging von Daten  
...
|Action|Sicherungsfähige Elemente|Berechtigungen|  
|------------|----------------|-----------------|  
...
##  <a name="rules"></a>Validieren von Daten anhand von Geschäftsregeln  
  
|Action|Sicherungsfähiges Element|Berechtigungen|  
|------------|---------------|-----------------|  
...
##  <a name="Hierarchy"></a>Sofortiges Anwenden von Hierarchie Element Berechtigungen  
...
##  <a name="SysAdmin"></a>Ändern des System Administrator Kontos  
...
##  <a name="SysSettings"></a>Konfigurieren von System Einstellungen  
