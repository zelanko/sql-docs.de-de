...
##  <a name="ErrorTypes"></a>Fehlertypen, die zu einem automatischen Seiten Reparaturversuch führen  
...
##  <a name="UnrepairablePageTypes"></a>Seiten Typen, die nicht automatisch repariert werden können  
...
##  <a name="PrimaryIOErrors"></a>Behandeln von e/a-Fehlern in der Prinzipal Datenbank/primären Datenbank  
...
##  <a name="SecondaryIOErrors"></a>Behandeln von e/a-Fehlern in der Spiegel Datenbank/sekundären Datenbank  
...
##  <a name="DevBP"></a>Bewährte Methoden für Entwickler  
...
##  <a name="ViewAPRattempts"></a>Vorgehensweise: Anzeigen von automatischen Seiten Reparaturversuchen  
