---
title: Änderungen am Verhalten von ' syslockinfo ' und ' sp_lock ' | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="changes-to-behavior-in-syslockinfo-and-splock"></a>Änderungen am Verhalten von 'syslockinfo' und 'sp_lock'
 ...
 Um den Zugriff auf Informationen aus **Syslockinfo** oder führen Sie **Sp_lock** erfordert die VIEW SERVER STATE-Berechtigung auf dem Server.  
  
## <a name="component"></a>Komponente  
 [!INCLUDE[ssDE](../../includes/ssde-md.md)]  
  
## <a name="description"></a>Description  
 In [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)], **Rsc_objid** und **Rsc_indid** Spalten in **Syslockinfo** und **Objid** und **Indid**  Spalten in **Sp_lock** einheitlich die Objekt-ID und index-ID In [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] kann der Wert 0 (null) zurückgegeben werden.  
