---
title: Bereitstellungstopologien für SQL Server BI-Funktionen in SharePoint | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
-   [Beispiel für Bereitstellungstopologien mit SharePoint 2013](#bkmk_example_deployments_2013)  
    ...
    -   [PowerPivot für SharePoint 2013-Bereitstellung auf zwei Server](#bkmk_powerpivot_sharepoint2013_2server)  
  
    -   [PowerPivot für SharePoint 2013-Bereitstellung auf drei Server](#bkmk_powerpivot_sharepoint2013_3server)  
...
###  <a name="bkmk_bi_Sharepoint2013_3tier"></a> PowerPivot für SharePoint 2013 und Reporting Services-Bereitstellung auf drei Servern  
 In der folgenden drei Server-Bereitstellung, die SQL Server-Datenbankmodul [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Server im SharePoint-Modus und SharePoint zu jedem Durchlauf auf einem separaten Server ausgeführt wird. Die [!INCLUDE[ssGeminiShortvnext](../../includes/ssgeminishortvnext-md.md)] 2013-Installationspaket (**spPowerPivot.msi**) muss auf dem SharePoint-Server ausgeführt werden.  
...
|**(2)**|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Dienstanwendung. Der Standardname lautet **PowerPivot-Standarddienstanwendung**.|  
|**(3)**|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]-Dienstanwendung.|  
...
|**(5)**|Führen Sie die **spPowerPivot.msi** Datenanbieter, installieren die [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Konfigurationstool, [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Katalog und datenaktualisierungen zu planen.|  
...
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a> PowerPivot für SharePoint 2013-Bereitstellung auf einem Server  
 ...
 Das folgende Diagramm veranschaulicht die Komponenten, die Teil eines einzelnen Servers [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Bereitstellung.  
...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a> PowerPivot für SharePoint 2013-Bereitstellung auf zwei Server  
 In der folgenden zwei-Server-Bereitstellung, die SQL Server-Datenbankmodul und [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] im SharePoint-Modus auf einem anderen Server als SharePoint ausgeführt. Für SharePoint 2013 die [!INCLUDE[ssGeminiLongvnext](../../includes/ssgeminilongvnext-md.md)] Installer-Paket (**spPowerPivot.msi**) auf dem SharePoint-Server installiert ist.  
  
 [!INCLUDE[ssGeminiShortvnext](../../includes/ssgeminishortvnext-md.md)] Erweitert SharePoint Server 2013 um serverseitige datenaktualisierungen verarbeiten, Datenanbieter, [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Katalog und verwaltungsunterstützung für [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] und Excel-Arbeitsmappen mit erweiterten Datenmodellen.  
  
 Das Installationspaket ist als Teil des [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Feature Packs verfügbar. Das Feature Pack kann heruntergeladen werden, aus der [!INCLUDE[msCoName](../../includes/msconame-md.md)] Downloadcenter unter [Microsoft® SQL Server® 2014 PowerPivot® für Microsoft® SharePoint®](http://go.microsoft.com/fwlink/?LinkID=296473) (HYPERLINK "http://go.microsoft.com/fwlink/?LinkID=296473" \t "_blank" http://go.microsoft.com/fwlink/?LinkID=296473).  
  
 ![SSAS PowerPivot-Modus-2-Serverbereitstellung](../../../2014/analysis-services/media/as-powerpivot-mode-2server-deployment.gif "SSAS PowerPivot-Modus-2-Serverbereitstellung")  
  
|||  
|-|-|  
|**(1)**|Excel Service-Anwendung. Die Dienstanwendung wird als Teil der SharePoint-Installation erstellt.|  
|**(2)**|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Dienstanwendung. Der Standardname lautet **PowerPivot-Standarddienstanwendung**.|  
|**(3)**|Führen Sie die **spPowerPivot.msi** Datenanbieter, installieren die [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Konfigurationstool, [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] -Katalog und datenaktualisierungen zu planen.|  
|**(4)**|Ein [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]-Server im SharePoint-Modus. Konfigurieren Sie die **Datenmodelleinstellungen** der Excel Services-Anwendung für die Verwendung dieses Servers.|  
|**(5)**|Inhalts-, Konfigurations- und Dienstanwendungs-Datenbanken von SharePoint.|  
  
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a> PowerPivot für SharePoint 2013-Bereitstellung auf drei Server  
 In der folgenden drei Server-Bereitstellung, die SQL Server-Datenbankmodul [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Server im SharePoint-Modus und SharePoint zu jedem Durchlauf auf einem separaten Server ausgeführt wird. Das Installationspaket für [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 2013 (spPowerPivot.msi) muss auf dem SharePoint-Server installiert werden.  
  
 ![ALS PowerPivot-Mode3 Serverbereitstellung](../../../2014/sql-server/install/media/as-powerpivot-mode-3server-deployment.gif "als PowerPivot Mode3-Server-Bereitstellung")  
...
##  <a name="bkmk_sharepoint2010_scaleserver"></a> Bereitstellung von drei Ebenen mit horizontaler Skalierung  
 ...
 Wenn Sie eine Multiserverfarm bereitstellen, sollten Sie die Anweisungen in diesem SharePoint-Artikel befolgen: [Mehrere Server für eine Farm mit drei Ebenen (SharePoint Server 2010)](http://go.microsoft.com/fwlink/?linkID=219834).  
