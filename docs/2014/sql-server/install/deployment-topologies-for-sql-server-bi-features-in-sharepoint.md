...
###  <a name="bkmk_bi_Sharepoint2013_3tier"></a> PowerPivot für SharePoint 2013 und Reporting Services-Bereitstellung auf drei Servern  
 In der folgenden Bereitstellung auf drei Servern, die SQL Server-Datenbank-Engine [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Server im SharePoint-Modus und SharePoint, jede Ausführung auf einem separaten Server ausführen. Die [!INCLUDE[ssGeminiShortvnext](../../includes/ssgeminishortvnext-md.md)] 2013-Installationspaket (**spPowerPivot.msi**) muss auf dem SharePoint-Server ausgeführt werden.  
...
###  <a name="bkmk_powerpivot_sharepoint2013_2server"></a> PowerPivot für SharePoint 2013-Bereitstellung von zwei Servern  
 In der folgenden Bereitstellung auf zwei Servern, die SQL Server-Datenbank-Engine und [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] im SharePoint-Modus auf einem anderen Server als SharePoint ausgeführt. Für SharePoint 2013 werden die [!INCLUDE[ssGeminiLongvnext](../../includes/ssgeminilongvnext-md.md)] Installer-Paket (**spPowerPivot.msi**) auf dem SharePoint-Server installiert ist.  
...
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a> PowerPivot für SharePoint 2013-Bereitstellung von drei Servern  
 In der folgenden Bereitstellung auf drei Servern, die SQL Server-Datenbank-Engine [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Server im SharePoint-Modus und SharePoint, jede Ausführung auf einem separaten Server ausführen. Das Installationspaket für [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 2013 (spPowerPivot.msi) muss auf dem SharePoint-Server installiert werden.  
...
##  <a name="bkmk_sharepoint2010_1server"></a> Bereitstellungen mit einem Server  
 ...
 Um alle Funktionen auf einem einzelnen Server zu installieren, installieren Sie [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] und [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] sequenziell auf dem gleichen physischen Server. Anweisungen in einer eigenständigen Serverkonfiguration finden Sie [Bereitstellungsprüfliste: Reporting Services, Power View und PowerPivot für SharePoint](deployment-checklist-reporting-services-power-view-power-pivot-for-sharepoint.md).  
