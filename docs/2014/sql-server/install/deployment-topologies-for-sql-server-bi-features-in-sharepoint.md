...
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a>PowerPivot für SharePoint 2013-Bereitstellung auf einem Server  
 ...
 ![PowerPivot für SharePoint Bereitstellung eines einzelnen Servers](../../../2014/sql-server/install/media/as-powerpivot-mode-1server-deployment.gif "PowerPivot für SharePoint Bereitstellung auf einem Server")  
...
###  <a name="bkmk_powerpivot_sharepoint2013_3server"></a>PowerPivot für SharePoint 2013 3-Server Bereitstellung  
 ...
 ![As Power Pivot Mode3-Server Bereitstellung](../../../2014/sql-server/install/media/as-powerpivot-mode-3server-deployment.gif "als Power Pivot Mode3-Server Bereitstellung")  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>PowerPivot für SharePoint 2013 und Reporting Services Bereitstellung auf einem Server  
 ...
 ![SSAS und SSRS im SharePoint-Modus 1 Server Bereitstellung](../../../2014/sql-server/install/media/as-and-rs-1server-deployment.gif "SSAS und SSRS SharePoint-Modus 1 Server Bereitstellung")  
...
##  <a name="bkmk_example_deployments_2010"></a>Beispiel für Bereitstellungstopologien in SharePoint 2010  
 ...
 Logisches ![Architektur Diagramm Diagramm]der(../../../2014/sql-server/install/media/sql11bisetup.gif "logischen") Architektur  
...
##  <a name="bkmk_sharepoint2010_scaleserver"></a>Bereitstellung für horizontales Skalieren mit drei Ebenen  
 ...
 Wenn Sie eine Multiserverfarm bereitstellen, befolgen Sie die Anweisungen in diesem SharePoint-Artikel: [Mehrere Server für eine dreistufige Farm (SharePoint Server 2010)](https://go.microsoft.com/fwlink/?linkID=219834).  
  
 ![5-Server toplogie](../../../2014/sql-server/install/media/sql11bisetup-5server.gif "5-Server Topologie")  
