...
## <a name="options"></a>Tastatur  
 ...
 Verwenden Sie bei der Installation von Failoverclustern den gleichen Product Key für jeden Failoverclusterknoten. Wenn Sie einen Product Key aus einer anderen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Edition verwenden, tritt ein Fehler auf.  
