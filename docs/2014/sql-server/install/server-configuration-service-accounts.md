---
title: Serverkonfiguration – Dienstkonten | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
 ...
 **Konfigurieren Sie [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Dienstkonten einzeln (empfohlen)**  
