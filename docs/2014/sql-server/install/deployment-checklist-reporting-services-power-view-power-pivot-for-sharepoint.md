...
3.  
  [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] Reporting Services und Reporting Services-Add-In  
...
|Überprüfen Sie, ob die Farm betriebsbereit ist.|Starten Sie zuerst die Zentraladministration, und vergewissern Sie sich, dass diese verfügbar ist. Öffnen Sie als nächstes die Team Website, http://localhostindem Sie eingeben.  Es sollte eine SharePoint-Teamwebsite angezeigt werden.|  
...
|Überprüfen Sie, ob der Reporting Services betriebsbereit ist.|[Überprüfen einer Installation von Reporting Services](../../reporting-services/install-windows/verify-a-reporting-services-installation.md)|  
