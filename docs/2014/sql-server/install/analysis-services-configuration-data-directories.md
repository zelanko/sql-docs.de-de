...
|Temp-Verzeichnis|C:\Programme\Microsoft SQL server\msas12. \<InstanceId> \OLAP\Temp\|platzieren Sie das temporäre Verzeichnis im Hochleistungsspeicher Subsystem.|  
