---
title: Installieren Sie den Analysis Services OLE DB-Anbieter auf SharePoint-Servern | Microsoft Docs
ms.custom: ''
ms.date: 03/07/2017
...
##  <a name="bkmk_vers"></a> Versionen von PowerPivot-Datenzugriff unterstützen OLE DB-Anbieter  
...
##  <a name="bkmk_sql11"></a> Installieren von SQL Server 2012 OLE DB-Anbieter auf einem Excel Services-Server mithilfe von SQL Server-Setup  
 ...
 Verwenden Sie diese Anweisungen zum Installieren des aktuellen Analysis Services OLE DB-Anbieters und zum Hinzufügen der **Microsoft.AnalysisServices.Xmla.dll** der globalen Assembly.  
...
3.  Wählen Sie auf der Seite Installationstyp **führen Sie eine Neuinstallation von SQL Server 2012**.  
  
4.  Wählen Sie auf der Seite Setuprolle **SQL Server-Funktionsinstallation**.  
  
5.  Auf der **Funktionsauswahl** auf **Konnektivität der Clienttools**. Diese Option installiert **Microsoft.AnalysisServices.Xmla.dll**  
  
     Wählen Sie keine weiteren Funktionen aus.  
  
6.  Klicken Sie auf **Weiter** beenden Sie den Assistenten, und klicken Sie dann auf **installieren** zum Ausführen von Setup.  
...
4.  Zeigen Sie die Dateiversionsinformationen an. Die Version sollte 11.00. enthält. \<Buildnumber >.  
...
##  <a name="bkmk_install2012_from_sppowerpivot_msi"></a> Installieren von SQL Server 2012 OLE DB-Anbieter mithilfe des PowerPivot für SharePoint-Installationspakets ("spPowerPivot.msi")  
 Installieren der [!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)] OLE DB-Anbieters auf und Excel Services-Server mithilfe der [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] Installationspaket **(spPowerPivot.msi)**.  
...
1.  Auf der [Downloadseite für SQL Server 2008 R2 Feature Pack](http://go.microsoft.com/fwlink/?LinkId=159570), suchen Sie Microsoft Analysis Services OLE DB-Anbieter für Microsoft SQL Server 2008 R2.  
...
1.  Verwenden Sie das Hilfsprogramm "regasm.exe", um die Datei zu registrieren. Wenn Sie regasm.exe zuvor noch nicht ausgeführt haben, fügen Sie diesem übergeordneten Ordner, C:\Windows\Microsoft.NET\Framework64\v4.0.30319\\, um die Systemvariable Path.  
