...
-   Überprüfen Sie die Anforderungen und Überlegungen unter [Planen einer SQL Server-Installation](../../../2014/sql-server/install/planning-a-sql-server-installation.md), einschließlich der [Hardware and Software Requirements for Installing SQL Server 2014](hardware-and-software-requirements-for-installing-sql-server.md).  
...
## <a name="get-sql-server-2014"></a>SQL Server 2014 herunterladen  
 Um eine Evaluierungsversion von SQL Server 2014 herunterzuladen [klicken Sie hier](https://www.microsoft.com/en-us/evalcenter/evaluate-sql-server-2014).  
