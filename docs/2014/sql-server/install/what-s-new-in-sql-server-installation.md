...
# <a name="what39s-new-in-sql-server-installation"></a>Neuigkeiten in der SQL Server-Installation
 ...
 In [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] wird SysPrep für alle [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Installationen unterstützt. SysPrep unterstützt jetzt Failoverclusterinstallationen. Weitere Informationen finden Sie unter [Überlegungen zum Installieren von SQL Server mit SysPrep](../../database-engine/install-windows/considerations-for-installing-sql-server-using-sysprep.md) und [installieren SQL Server 2014 mit SysPrep](../../database-engine/install-windows/install-sql-server-using-sysprep.md).  
 ...
 Ab [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] verfügt die Datenbank-Engine in der Standard Edition über eine Speicherkapazität von 128 GB. In [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], die Datenbank-Engine in der Standard Edition haben eine Speicherkapazität von 64 GB.  
