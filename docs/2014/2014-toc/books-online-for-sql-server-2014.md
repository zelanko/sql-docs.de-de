...
SQL Server 2016 und spätere Versionen sind [hier](https://docs.microsoft.com/sql/sql-server/index)dokumentiert. SQL Server 2012 und ältere Versionen sind [hier](#previous-versions-gm2014)dokumentiert. <!-- ?view= defaults to the latest GA version, to resolve the https '/index' address ambiguity. So '2014' will always be too old to be the default. -->
 ...
 **SQL Server Web Websites**  
  
-   [SQL Server auf Microsoft.com](https://go.microsoft.com/fwlink/?linkid=8504)  
