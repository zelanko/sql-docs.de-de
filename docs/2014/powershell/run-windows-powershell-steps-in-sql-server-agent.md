...
2.  Verwenden Sie einen eingabeaufforderungs-Auftragsschritt, um PowerShell.exe auszuführen, und geben Sie ein Skript, das importiert die `sqlps` Modul.  
