---
title: Dialogfeld „Filtern und Sortieren“
description: In diesem Artikel erfahren Sie, wie Sie die Daten modifizieren, die in SQL Server Data Tools in einer Tabelle oder Sicht angezeigt werden. Des Weiteren wird erläutert, wie die Anzahl der Zeilen, die Sortierreihenfolge sowie weitere Faktoren angepasst werden.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords:
...
-   Einschränkungen für die Anzeige von Spalten.  
  
-   Sortierreihenfolge der Spalten.  
