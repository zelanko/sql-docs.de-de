---
title: DAC-Frameworkkompatibilität | Microsoft-Dokumentation
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
...
Sie können eine neuere SSDT-Version von [Installieren der aktuellen SQL Server Data Tools](https://docs.microsoft.com/sql/ssdt/download-sql-server-data-tools-ssdt)herunterladen.  
