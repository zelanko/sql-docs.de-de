...
description: In diesem Artikel erfahren Sie, wie SQL Server Data Tools mit verbundenen Datenbanken verwendet werden kann. Sie erfahren außerdem, wie Sie Entitäten durchsuchen, Tabellen entwerfen, Skripts bearbeiten und weitere Aufgaben durchführen.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords:
