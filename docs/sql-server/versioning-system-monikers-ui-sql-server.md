...
- _2016 und höher:_ &nbsp; Das Versionierungssystem ist für SQL Server 2016 und höhere Versionen vollständig implementiert.
    - [Willkommen bei der Dokumentation für SQL Server 2016 and höhere Versionen](/sql/sql-server/sql-server-technical-documentation?view=sql-server-2016)
