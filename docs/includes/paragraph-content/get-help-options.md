...
- [DBA Stack Exchange (Tag SQL-Server): Fragen SQL Server](https://dba.stackexchange.com/questions/tagged/sql-server)
- [Stack Overflow (Tag SQL-Server): Antworten auf Fragen zur SQL-Entwicklung](https://stackoverflow.com/questions/tagged/sql-server) 
- [Reddit: Allgemeine Erörterung von SQL Server](https://www.reddit.com/r/SQLServer/)
- [Lizenzbedingungen und-Informationen Microsoft SQL Server](https://www.microsoft.com/download/details.aspx?id=39299)
