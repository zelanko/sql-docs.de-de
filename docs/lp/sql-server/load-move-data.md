...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Migrieren, Laden und Verschieben von Daten</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                            <li class="fullSpan">
                                ...
                                <h2>Migrieren von Datenbanken zu SQL</h2>
                            </li>
                                                         <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ermöglicht nahtlose Migrationsvorgänge von mehreren Datenbankquellen zu Azure-Datenplattformen mit minimaler Ausfallzeit.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Datenbankmigrations-Assistent (DMA)</h3>
                                                    <p>Erkennt Kompatibilitätsprobleme, empfiehlt Verbesserungen für die Zielumgebung und verschiebt Datenbank und Daten.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Automatisiert die Datenbankmigration von Microsoft Access, DB2, MySQL, Oracle und SAP ASE zu SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BCP</h3>
                                                    <p>Massenkopieren von Daten zwischen einer Datendatei in einem von Ihnen angegebenen Format und der SQL-Datenbank.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Assistent zum Importieren von Flatfiles</h3>
                                                    <p>Mit dem Assistenten können Daten mühelos aus einer Flatfile (CSV, TXT) in Ihre SQL-Datenbank kopiert werden. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Mit dem Assistenten können Daten mühelos aus einer Vielzahl von Quellen in Ihre SQL-Datenbank kopiert werden. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
