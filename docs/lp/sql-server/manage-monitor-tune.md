...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Überwachung, Verwaltung und Optimierung</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Datenbank-Lebenszyklusverwaltung</h3>
                                                    <p>Ein umfassender Ansatz zur Verwaltung des Datenbankschemas sowie der Daten und Metadaten für eine Datenbankanwendung</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Datenkomprimierung</h3>
                                                    <p>Ein Feature von SQL Server, das die Komprimierung Ihrer Daten ermöglicht, sodass sie weniger Speicherplatz auf Datenträgern beanspruchen. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Datenbank-E-Mail</h3>
                                                    <p>Eine Unternehmenslösung zum Senden von E-Mail-Nachrichten über die SQL Server-Datenbank-Engine. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Richtlinienbasierte Verwaltung</h3>
                                                    <p>Ein richtlinienbasiertes System zum Verwalten einer oder mehrerer Instanzen von SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wartungspläne</h3>
                                                    <p>Konfigurieren Sie automatisierte Pläne zum Verwalten von SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ein Feature von SQL Server, das geplante administrative Tasks ausführt. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erweiterte Ereignisse</h3>
                                                    <p>Ein allgemeines Ereignisverarbeitungssystem für SQL Server-Systeme.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>Ein universelles Hilfsprogramm zum Sammeln von Protokollen und Daten aus SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>Erstellt, verwaltet, analysiert und ersetzt Ablaufverfolgungen von SQL Server-Aktivitäten. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automatische Optimierung</h3>
                                                    <p>Ein neues Feature von SQL 2017, das potenzielle Leistungsprobleme automatisch erkennt. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hilft bei der Analyse von Workloads und bietet Empfehlungen zur Leistungsverbesserung.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Kardinalitätsschätzung</h3>
                                                    <p>Schätzt für die Ausführungsplanerstellung, wie viele Zeilen von einer Abfrage zurückgegeben und verwendet werden.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Indizes</h3>
                                                    <p>Eine Struktur auf dem Datenträger, die einer Tabelle oder einer Sicht zugeordnet ist und durch die das Abrufen von Daten beschleunigt wird.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Eine Option der Leistungsoptimierung, bei der ganze Tabellen im Arbeitsspeicher verbleiben.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Partitionen</h3>
                                                    <p>Ermöglicht das Verteilen von Daten auf Einheiten wie beispielsweise Dateigruppen. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Planhinweislisten</h3>
                                                    <p>Ein Feature von SQL Server, das die manuelle Eingabe eines Ausführungsplans für eine bestimmte Abfrage ermöglicht.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gibt Begrenzungen für die Mengen von CPU, IO und Arbeitsspeicher an, die von Anwendungsanforderungen verwendet werden können. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Statistik</h3>
                                                    <p>Teilt der SQL Server-Engine für die Erstellung von Ausführungsplänen mit, wie die Daten verteilt und verwendet werden.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
