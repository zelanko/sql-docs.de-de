...
|Editor|Der **Skripttask-Editor** hat drei Seiten: **Allgemein**, **Skript** und **Ausdrücke**. Nur die Eigenschaften **ReadOnlyVariables** und **ReadWriteVariables** und **ScriptLanguage** wirken sich direkt auf den Code aus, den Sie schreiben können.|Der **Transformations-Editor für Skripterstellung**  hat vier Seiten: **Eingabespalten**, **Eingaben und Ausgaben**, **Skript** sowie **Verbindungs-Manager**. Die Metadaten und Eigenschaften, die Sie auf diesen Seiten konfigurieren, legen die Member der Basisklassen fest, die für Sie bei der Codierung automatisch generiert werden.|  
