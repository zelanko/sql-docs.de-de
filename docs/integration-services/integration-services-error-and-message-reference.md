---
description: Fehler- und Meldungsreferenz von Integration Services
...
>|0xC0047048|-1073450936|DTS_E_CANTCREATESPOOLFILE|Der Puffer-Manager kann in keinem Pfad der BufferTempStoragePath-Eigenschaft eine temporäre Speicherdatei erstellen. Der Dateiname ist falsch, die entsprechende Berechtigung fehlt, oder der Speicherplatz an den Pfaden ist voll.|  
...
>|0xC004704D|-1073450931|DTS_E_VIRTUALNOTSEQUENTIAL|Die Puffer-ID %1!d! unterstützt andere virtuelle Puffer und kann nicht in den sequenziellen Modus versetzt werden. IDTSBuffer100.SetSequentialMode wurde in einem Puffer aufgerufen, der virtuelle Puffer unterstützt.|  
...
>|0xC004707D|-1073450883|DTS_E_EXPREVALBINARYOPNUMERICOVERFLOW|Das Ergebnis der binären Operation "%1" für die Datentypen %2 und %3 überschreitet die maximal zulässige Größe für numerische Datentypen. Eine implizite Typumwandlung der Operandentypen in ein numerisches Ergebnis (DT_NUMERIC) war ohne Verlust der Genauigkeit oder der Dezimalstellen nicht möglich. Für diesen Vorgang müssen einer oder beide der Operanden explizit mit einem Umwandlungsoperator umgewandelt werden.|  
...
>|0xC004708C|-1073450868|DTS_E_EXPREVALFNSUBSTRINGINVALIDSTARTINDEX|Der Startindex "%1!d!" ist für die %2-Funktion ungültig. Der Startindexwert muss eine ganze Zahl größer als 0 (null) sein. Der Startindex ist einsbasiert und nicht nullbasiert.|  
...
>|0xC0049041|-1073442751|DTS_E_EXPREVALSTATIC_FNSUBSTRINGINVALIDSTARTINDEX|Der Startindex war für die SUBSTRING-Funktion ungültig. Der Startindexwert muss eine ganze Zahl größer als 0 (null) sein. Der Startindex ist einsbasiert und nicht nullbasiert.|  
...
>|0xC020801C|-1071611876|DTS_E_CANNOTACQUIRECONNECTIONFROMCONNECTIONMANAGER|SSIS-Fehlercode DTS_E_CANNOTACQUIRECONNECTIONFROMCONNECTIONMANAGER.  Fehler beim Aufrufen der AcquireConnection-Methode über den Verbindungs-Manager „%1“ (Fehlercode: 0x%2!8.8X!).  Möglicherweise wurden bereits Fehlermeldungen veröffentlicht, die weitere Informationen zum Fehler beim Aufrufen der AcquireConnection-Methode beinhalten.|  
...
>|0xC0208305|-1071611131|DTS_E_TXFUZZYLOOKUP_NO_JOIN_COLUMNS|Es waren keine Eingabespalten mit einem gültigen Join zu einer Verweistabellenspalte vorhanden.  Stellen Sie sicher, dass mindestens ein Join definiert ist, der die Eingabespalteneigenschaften JoinToReferenceColumn und JoinType verwendet.|  
>|0xC0208306|-1071611130|DTS_E_TXFUZZYLOOKUP_INDEX_DOES_NOT_CONTAIN_COLUMN|Der angegebene bereits vorhandene Übereinstimmungsindex "%1" wurde ursprünglich nicht mit Fuzzyübereinstimmungsinformationen für die Spalte "%2" erstellt.  Er muss neu erstellt werden, um die Informationen aufzunehmen. Dieser Fehler tritt auf, wenn der Index erstellt wurde, ohne dass die Spalte eine Fuzzyjoinspalte ist.|  
...
>|0xC020902A|-1071607766|DTS_E_INDUCEDTRANSFORMFAILUREONTRUNCATION|Fehler bei "%1", weil Daten abgeschnitten wurden. Die Abschneidezeilendisposition in "%2" gibt einen Fehler beim Abschneiden an. Es wurde ein Abschneidefehler im angegebenen Objekt der angegebenen Komponente festgestellt.|  
>|0xC020902B|-1071607765|DTS_E_TXSPLITEXPRESSIONEVALUATEDTONULL|Der Ausdruck "%1" in "%2" ergab NULL, aber für "%3" ist ein boolesches Ergebnis erforderlich. Ändern Sie die Fehlerzeilendisposition in der Ausgabe, um das Ergebnis als „False“ (Fehler ignorieren) zu behandeln oder um die Zeile an die Fehlerausgabe umzuleiten (Zeile umleiten).  Für bedingtes Teilen müssen die Ausdrucksergebnisse boolesche Werte sein.  Das Ausdrucksergebnis NULL ist ein Fehler.|  
...
>|0xC02090D8|-1071607592|DTS_E_TXAGG_TOOMANYCOUNTDISTINCTVALUES|Die Aggregatkomponente hat beim Berechnen des COUNT DISTINCT-Aggregats zu viele unterschiedliche Werte erkannt. Es sind nicht mehr als %1!u! unterschiedliche Werte möglich. Beim Berechnen der COUNT DISTINCT-Aggregation waren mehr als ULONG_MAX verschiedene Werte vorhanden.|  
...
>|0xC02090FA|-1071607558|DTS_E_XMLSRC_INDUCEDTRANSFORMFAILUREONTRUNCATION|Fehler bei "%1", weil Daten abgeschnitten wurden. Die Abschneidezeilendisposition in "%2" bei "%3" gibt einen Fehler beim Abschneiden an. Es wurde ein Abschneidefehler im angegebenen Objekt der angegebenen Komponente festgestellt.|  
>|0xC02090FB|-1071607557|DTS_E_XMLSRC_INDUCEDTRANSFORMFAILUREONERROR|Fehler bei "%1" (Fehlercode: 0x%2!8.8X!). Die Fehlerzeilendisposition in "%3" bei "%4" gibt an, dass der Vorgang bei einem Fehler fehlschlägt. Es wurde ein Abschneidefehler im angegebenen Objekt der angegebenen Komponente festgestellt.|  
...
>|0x8001931C|-2147380452|DTS_W_ADOCONNECTIONDATATYPECOMPATCHANGE|Die DataTypeCompatibility-Eigenschaft des ADO-Typ-Verbindungs-Managers „%1“ wurde aus Gründen der Abwärtskompatibilität auf 80 festgelegt.|  
>|0x8001C004|-2147368956|DTS_W_FILEENUMEMPTY|Der For Each File-Enumerator ist leer. Der Foreach-Datei-Enumerator hat keine Dateien gefunden, die mit dem Dateimuster übereinstimmen, oder das angegebene Verzeichnis war leer.|  
...
>|0x80208376|-2145352842|DTS_W_XMLSRCOUTPUTCOLUMNDATATYPEMAPPEDTOSTRING|%1 verweist auf den externen Datentyp %2, der keinem SSIS-Datenflusstask-Datentyp zugeordnet werden kann.  Der SSIS-Datenflusstask-Datentyp DT_WSTR mit einer Länge von %3!d! wird stattdessen verwendet.|  
...
>|0x802092AB|-2145348949|DTS_W_ADODESTNOROWSINSERTED|In das Ziel wurden keine Zeilen erfolgreich eingefügt. Dies liegt möglicherweise an einem Datentypenkonflikt zwischen Spalten oder daran, dass ein Datentyp verwendet wurde, der nicht von Ihrem ADO.NET-Anbieter unterstützt wird. Da die Fehlerdisposition für diese Komponente nicht „Fehler bei Komponente“ ist, werden Fehlermeldungen hier nicht angezeigt. Legen Sie die Fehlerdisposition auf „Fehler bei Komponente“ fest, um Fehlermeldungen hier anzuzeigen.|  
...
>|0x802092AE|-2145348946|DTS_W_ADODESTEXTERNALCOLNOTEXIST|%1 ist nicht in der Datenbank vorhanden. Das Element wurde möglicherweise entfernt oder umbenannt. Verwenden Sie den erweiterten Editor, um die verfügbaren Zielspalten bei Bedarf zu aktualisieren.|  
