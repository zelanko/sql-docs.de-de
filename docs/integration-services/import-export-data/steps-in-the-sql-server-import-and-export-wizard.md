...
|**Konfigurieren des Ziels** (optionale Schritte)<br /><br /> – Erstellen Sie eine neue Zieldatenbank.<br />– Wenn Sie Daten in eine Textdatei kopieren, konfigurieren Sie zusätzliche Einstellungen.|[Create Database](../../integration-services/import-export-data/create-database-sql-server-import-and-export-wizard.md)<br /><br />[Konfigurieren eines Flatfileziels](../../integration-services/import-export-data/configure-flat-file-destination-sql-server-import-and-export-wizard.md)|  
