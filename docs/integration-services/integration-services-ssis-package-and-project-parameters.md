---
description: Integration Services-Paket- und Projektparameter (SSIS)
title: Paket- und Projektparameter | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
### <a name="set-server-defaults-with-ssms-object-explorer"></a>Festlegen von Serverstandardwerten mit dem Objekt-Explorer von SSMS  
