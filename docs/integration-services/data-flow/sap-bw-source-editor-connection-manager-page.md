---
description: Quellen-Editor für SAP BW (Seite Verbindungs-Manager)
 ...
 **Neu**  
 ...
 Weitere Informationen zu diesem Dialogfeld finden Sie unter [SAP BW Connection Manager Editor](../connection-manager/sap-bw-connection-manager.md).  
