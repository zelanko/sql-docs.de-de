...
|Verbindungs-Manager|Wählen Sie einen vorhandenen Verbindungs-Manager aus, oder klicken Sie auf **\<New>** , um einen neuen Verbindungs-Manager zu erstellen.|  
