 ...
 **Konfigurieren der Fehlerausgabe**  
 Im Dialogfeld [Fehlerausgabe konfigurieren](../error-handling-in-data.md) können Sie für die Transformation verfügbare Optionen zur Fehlerbehandlung angeben.  
