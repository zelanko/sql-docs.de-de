...
![Screenshot: Projektmappen-Explorer mit den Ordnern im Projekt](media/ssis-solution-explorer.png)
...
3.  Wählen Sie im Dialogfeld **Neues Projekt** die Option **Business Intelligence** und dann die Vorlage **Integration Services-Projekt** aus.  
  ...
  ![Screenshot: Dialogfeld „Neues Projekt“ mit hervorgehobener Vorlage „Integration Services-Projekt – Business Intelligence“](media/ssis-ssdt-new-project.png)
