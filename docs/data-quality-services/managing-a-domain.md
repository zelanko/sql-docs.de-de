---
description: Verwalten einer Domäne
title: Verwalten einer Domäne
ms.date: 07/31/2012
ms.prod: sql
...
|Abschließen, Schließen oder Abbrechen der Domänenverwaltungsaktivität|[Beenden der Domänenverwaltungsaktivität](/previous-versions/sql/sql-server-2016/hh510411(v=sql.130))|  
