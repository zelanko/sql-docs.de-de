...
## <a name="implementation-of-the-microsoft-logistic-regression-algorithm"></a>Implementierung des Microsoft Logistic Regression-Algorithmus  
 ...
 ![Daten mithilfe der logistischen Regression modellierte](../../analysis-services/data-mining/media/logistic-regression.gif "Daten modelliert werden, mithilfe der logistischen Regression")  
...
### <a name="modeling-flags"></a>Modellierungsflags  
 ...
 Bedeutet, dass die Spalte zwei mögliche Statuswerte haben kann behandelt werden: **Fehlende** und **vorhandenen**. Ein NULL-Wert ist ein fehlender Wert.  
