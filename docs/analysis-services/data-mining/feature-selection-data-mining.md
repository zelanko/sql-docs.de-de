...
-   Wenn das Dataset viele Dimensionen umfasst, erfordern die meisten Data Mining-Algorithmen ein viel größeres Trainingsdataset.  
 ...
 ![Engineering-Prozess und Auswahl von Features](../../analysis-services/data-mining/media/ssdm-featureselectionprocess.png "engineering-Prozess und Auswahl von Features")  
...
#### <a name="bayesian-with-k2-prior"></a>Bayes-Methode mit K2-A-priori-Verteilung  
 ...
 Der K2-Algorithmus zum Lernen von Bayes-Netzwerken wurde von Cooper und Herskovits entwickelt und wird häufig im Data Mining eingesetzt. Er ist skalierbar und kann mehrere Variablen analysieren, erfordert jedoch eine Sortierung der als Eingabe verwendeten Variablen. Weitere Informationen finden Sie in [Learning Bayesian Networks](http://research.microsoft.com/en-us/um/people/heckerman/hgc94uai.pdf) von Chickering, Geiger, und Heckerman.  
...
#### <a name="bayesian-dirichlet-equivalent-with-uniform-prior"></a>Bayes-Dirichlet-Äquivalent mit uniformer A-priori-Verteilung  
 ...
 Weitere Informationen zu Bayes-Netzwerken und der Implementierung dieser Bewertungsmethoden finden Sie in [Learning Bayesian Networks](http://research.microsoft.com/en-us/um/people/heckerman/hgc94uai.pdf).  
  
### <a name="feature-selection-methods-per-algorithm"></a>Featureauswahlmethoden pro Algorithmus  
