...
- [Technische Referenz](https://docs.microsoft.com/bi-reference/)

#### <a name="see-also"></a>Siehe auch

[Dokumentation zu Azure Analysis Services](https://docs.microsoft.com/azure/analysis-services/)
[SQL Server-Dokumentation](../sql-server/sql-server-technical-documentation.md)
