...
Berechnungsgruppen erheblich weniger redundante Measures durch Gruppieren von allgemeinen Measureausdrücke als *Berechnung Elemente*. Berechnungsgruppen werden in tabellarischen Modellen von SQL Server Analysis Services 2019 1470 und höher unterstützt [Kompatibilitätsgrad](compatibility-level-for-tabular-models-in-analysis-services.md). Modelle mit Kompatibilitätsgrad 1470 sind derzeit in **Vorschau**.  
