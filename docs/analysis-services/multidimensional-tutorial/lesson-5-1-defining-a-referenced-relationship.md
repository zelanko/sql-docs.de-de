...
3.  Ziehen Sie aus der **Geography** -Dimension im Metadatenbereich die benutzerdefinierte **Geography** -Hierarchie in den **Bereich zum Ablegen von Zeilenfeldern** des Datenbereichs.  
    ...
    ![Reseller Sales-Sales Amount-Measure dimensioniert](../media/l5-referencedrelationship-1.gif "dimensioniert Reseller Sales-Sales Amount-Measure")  
...
8.  Klicken Sie auf die Schaltfläche mit den Auslassungspunkten (**...** ) in der **vollständigen Namen** Zelle am Schnittpunkt der der **Kunden** Dimension und die **Internetverkäufe** Measuregruppe.  
    ...
    ![Das Dialogfeld Beziehung definieren](../media/l5-referencedrelationship-4.gif "Dialogfeld Beziehung definieren")  
...
3.  Erweitern Sie im Metadatenbereich die **Reseller Geography**-Cubedimension, klicken Sie mit der rechten Maustaste auf **Geographies**und anschließend auf **Zu Zeilenbereich hinzufügen**.  
    ...
    ![Das Dialogfeld Beziehung definieren](../media/l5-referencedrelationship-5.gif "Dialogfeld Beziehung definieren")  
