...
5.  Erweitern Sie die **Sales Territory** -Dimension, und ziehen Sie die benutzerdefinierte **Sales Territories** -Hierarchie in Zeilenbezeichnungen.  
    ...
    ![Sales Territory-Cubedimension](../media/l5-granularity-2.gif "Sales Territory-Cubedimension")  
...
7.  Wählen Sie in der PivotTable-Feldliste die benutzerdefinierte **Sales Territories** -Hierarchie aus, und klicken Sie anschließend auf der rechten Seite auf den nach unten weisenden Pfeil.  
    ...
    ![Sales Territories-Hierarchie in der Feldliste](../media/l5-granularity-1a.png "Sales Territories-Hierarchie in der Feldliste")  
...
8.  Klicken Sie im Filter auf das Kontrollkästchen **Alles auswählen**, um die Auswahl aller Optionen aufzuheben, und wählen Sie anschließend nur „North America“ aus.  
    ...
    ![Filterbereich für die Auswahl von Nordamerika](../media/l5-granularity-1b.png "Filterbereich für die Auswahl von Nordamerika")  
...
11. Klicken Sie auf der PivotTable auf den nach unten weisenden Pfeil neben Zeilenbezeichnungen. Löschen Sie alle Jahre außer **FY 2008**.  
    ...
    ![Werte für Sales Amount Quota](../media/l5-granularity-3.png "Werte für Sales Amount Quota")  
...
8.  Erweitern Sie **FY 2008**, **H1 FY 2008**und anschließend **Q1 FY 2008**.  
    ...
    ![Sales Quota-Measuregruppe ordnungsgemäß dimensioniert](../media/l5-granularity-7.gif "ordnungsgemäß dimensionierte Sales Quota-Measuregruppe")  
...
[Definieren einer regulären Beziehung und von Eigenschaften einer regulären Beziehung](../multidimensional-models/define-a-regular-relationship-and-regular-relationship-properties.md)  
