...
1. [Datenquellen unterstützt in SQL Server Analysis Services-Tabellenmodelle 1400](tabular-models/data-sources-supported-ssas-tabular-1400.md)
2. [Tabellarische Modellierung (Kompatibilitätsgrad 1400)](tutorial-tabular-1400/as-adventure-works-tutorial.md)
3. [Erstellen von Partitionen](tutorial-tabular-1400/as-lesson-10-create-partitions.md)
4. [Erstellen von Rollen](tutorial-tabular-1400/as-lesson-11-create-roles.md)
5. [In Excel analysieren](tutorial-tabular-1400/as-lesson-12-analyze-in-excel.md)
6. [Bereitstellen](tutorial-tabular-1400/as-lesson-13-deploy.md)
7. [Erstellen Sie ein Projekt für tabellarische Modelle](tutorial-tabular-1400/as-lesson-1-create-a-new-tabular-model-project.md)
8. [Abrufen von Daten](tutorial-tabular-1400/as-lesson-2-Get-data.md)
9. [Als Datumstabelle markieren](tutorial-tabular-1400/as-lesson-3-mark-as-date-table.md)
10. [Erstellen von Beziehungen](tutorial-tabular-1400/as-lesson-4-create-relationships.md)
11. [Erstellen von berechneten Spalten](tutorial-tabular-1400/as-lesson-5-create-calculated-columns.md)
12. [Erstellen von measures](tutorial-tabular-1400/as-lesson-6-create-measures.md)
13. [Erstellen von Leistungskennzahlen](tutorial-tabular-1400/as-lesson-7-create-key-performance-indicators.md)
14. [Erstellen von Perspektiven](tutorial-tabular-1400/as-lesson-8-create-perspectives.md)
15. [Erstellen von Hierarchien](tutorial-tabular-1400/as-lesson-9-create-hierarchies.md)
16. [Ergänzende Lektion – Detailzeilen](tutorial-tabular-1400/as-supplemental-lesson-detail-rows.md)
17. [Ergänzende Lektion – Dynamische Sicherheit](tutorial-tabular-1400/as-supplemental-lesson-dynamic-security.md)
18. [Ergänzende Lektion – Unregelmäßige Hierarchien](tutorial-tabular-1400/as-supplemental-lesson-ragged-hierarchies.md)
