---
title: Währungsumrechnungen in Analysis Services | Microsoft-Dokumentation
ms.date: 05/09/2019
ms.prod: sql
...
ms.locfileid: "65527404"
---
# <a name="currency-conversions-in-analysis-services"></a>Währungsumrechnungen in Analysis Services

[!INCLUDE[ssas-appliesto-sqlas-aas](../includes/ssas-appliesto-sqlas-aas.md)]

 Analysis Services verwendet eine Kombination von Funktionen, die durch MDX-Skripts (Multidimensional Expressions), um währungsumrechnungen Cubes, die mehrere Währungen unterstützen bereitzustellen.  
  
## <a name="currency-conversion-terminology"></a>Terminologie zur Währungsumrechung  

 Die folgende Terminologie wird verwendet, um Funktionen der währungsumrechnung zu beschreiben:  
  
 **Pivot-Währung** -ist die Währung, die für die Wechselkurse in der Wechselkurs-Measuregruppe eingegeben werden.  
  
 **Lokale Währung** -ist die Währung, die zum Speichern von Transaktionen für die umzurechnenden Measures basieren.  
  
Lokaler Währung kann durch eine identifiziert werden:  
...
**Berichtswährung** -ist die Währung, die in den Transaktionen aus der pivotwährung konvertiert werden.  
  
> [!NOTE]  
>  Bei m:1-Währungsumrechnungen sind die Pivotwährung und die Berichtswährung identisch.  
  
 **Currency-Dimension** -einer Datenbankdimension, die mit den folgenden Einstellungen definiert:  
...
**Wechselkurs-Measuregruppe** -einer Measuregruppe in einem Cube mit den folgenden Einstellungen definiert:  
...
**Currency-Dmension** -ist die Dimension, die vom Business Intelligence-Assistenten nach dem Definieren einer währungsumrechnung, die die berichtswährungen für diese währungsumrechnung enthält. Die Berichtswährungsdimension basiert auf einer benannten Abfrage aus der Dimensionshaupttabelle der Währungsdimension. Diese Abfrage ist in der Datenquellensicht definiert, auf der die zur Wechselkurs-Measuregruppe zugeordnete Währungsdimension basiert. Die Dimension wird durch die folgenden Einstellungen definiert:  
...
### <a name="conversion-types"></a>Umrechnungstyp  
...
### <a name="currency-conversion-in-multidimensional-models-by-using-business-intelligence-wizard"></a>Währungsumrechnung in mehrdimensionalen Modellen mithilfe von Business Intelligence-Assistent  
