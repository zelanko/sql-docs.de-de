...
ms.locfileid: "38981892"
---
# <a name="batch-element-xmla"></a>Batch-Element (XMLA)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Führt eine oder mehrere XML für Analysis (XMLA) Befehle als Batchvorgang entweder sequentiell oder parallel auf einer Instanz von Analysis Services.  
...
>  Command/Execute/Statement wird in einem Batchvorgang derzeit nicht unterstützt.  
 ...
 Weitere Informationen zum Durchführen von Batchvorgängen in XMLA finden Sie unter [Ausführen von Batchvorgängen &#40;XMLA&#41;](../../../analysis-services/multidimensional-models-scripting-language-assl-xmla/performing-batch-operations-xmla.md).  
