...
ms.locfileid: "37979118"
---
# <a name="xml-elements---objects---executeresponse"></a>XML-Elemente – Objekte – ExecuteResponse
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  Enthält die Informationen von einer Instanz von Analysis Services als Reaktion auf eine [Execute](../../analysis-services/xmla/xml-elements-methods-execute.md) Methodenaufruf.  
...
|Untergeordnete Elemente|[zurück](../../analysis-services/xmla/xml-elements-properties/return-element-xmla.md)|  
