...
> [!NOTE]
> Die Verwendung von Azure Synapse Analytics (Azure SQL DW) wurde mit diesem Connector nicht getestet. Obwohl die Verwendung möglicherweise funktioniert, kann sie unbeabsichtigte Auswirkungen haben.
