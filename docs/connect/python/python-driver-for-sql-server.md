...
* [Erstellen einer Python-Web-App mithilfe von DJango und SQL-Datenbank in Azure-Websites](https://github.com/Microsoft/PTVS/wiki/Django-and-SQL-Database-on-Azure)
