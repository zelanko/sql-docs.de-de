---
title: Konformität und rechtliche Hinweise zum JDBC-SQL-Treiber | Microsoft-Dokumentation
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
---
# <a name="jdbc-specification-compliance"></a>Konformität mit der JDBC-Spezifikation
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

 Auf dieser Seite werden Informationen zur JDBC-Konformität des JDBC-Treibers aufgelistet.
