...
## <a name="requirements"></a>Anforderungen  
 ...
 Erstellen Sie in der [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal_md.md)]-Beispieldatenbank die folgende Tabelle mit den folgenden Beispieldaten:  
