---
description: setBoolean-Methode (SQLServerPreparedStatement)
title: setBoolean-Methode (SQLServerPreparedStatement) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
