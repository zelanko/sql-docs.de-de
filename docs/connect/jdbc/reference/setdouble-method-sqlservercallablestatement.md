---
title: setDouble-Methode (SQLServerCallableStatement) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "68213686"
---
# <a name="setdouble-method-sqlservercallablestatement"></a>setDouble-Methode (SQLServerCallableStatement)
