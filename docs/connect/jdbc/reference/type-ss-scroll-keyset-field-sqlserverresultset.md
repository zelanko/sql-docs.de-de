---
title: TYPE_SS_SCROLL_KEYSET-Feld (SQLServerResultSet)
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "38020068"
---
# <a name="typessscrollkeyset-field-sqlserverresultset"></a>TYPE_SS_SCROLL_KEYSET-Feld (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Dient zum Angeben eines Keysetcursortyps für [!INCLUDE[ssNoVersion](../../../includes/ssnoversion_md.md)].  
