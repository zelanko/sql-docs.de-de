---
title: updateFloat-Methode (java.lang.String, float) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "80927857"
---
# <a name="updatefloat-method-javalangstring-float"></a>updateFloat-Methode (java.lang.String, float)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Aktualisiert die angegebene Spalte mit einem **Gleitkommawert** unter Berücksichtigung des Spaltennamens.  
