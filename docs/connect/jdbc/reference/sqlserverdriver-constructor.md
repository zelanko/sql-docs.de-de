---
title: SQLServerDriver-Konstruktor () | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "67971265"
---
# <a name="sqlserverdriver-constructor-"></a>SQLServerDriver-Konstruktor ()
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Initialisiert eine neue Instanz der [SQLServerDriver](../../../connect/jdbc/reference/sqlserverdriver-class.md)-Klasse.  
