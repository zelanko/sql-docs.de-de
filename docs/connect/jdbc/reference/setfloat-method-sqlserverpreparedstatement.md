...
## <a name="remarks"></a>Bemerkungen  
 Diese setFloat-Methode wird von der setFloat-Methode in der java.sql.PreparedStatement-Schnittstelle angegeben.  
