---
title: GetMaxIndexLength-Methode (SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Ruft die maximale Anzahl von Bytes, die dieser Datenbank für einen Index, einschließlich alle Teile des Indexes zulässig.  
