---
title: supportsmixedcasequotedidentifier-Methode | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Bemerkungen  
 Diese supportsmixedcasequotedidentifier-Methode wird von der supportsmixedcasequotedidentifier-Methode in der Java. SQL. DatabaseMetaData-Schnittstelle angegeben.  
