 ...
 **TRUE**, wenn sich der Cursor in der ersten Zeile befindet. **FALSE**, wenn sich der Cursor an einer anderen Position befindet, oder wenn das Resultset keine Zeilen enthält.  
