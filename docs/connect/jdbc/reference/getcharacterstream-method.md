---
title: getcharakteristream-Methode () | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "67953194"
---
# <a name="getcharacterstream-method-"></a>getCharacterStream-Methode ()
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Gibt die **CLOB**-Daten als Readerobjekt oder als Zeichendatenstrom zurück.  
...
## <a name="return-value"></a>Rückgabewert  
 Ein Readerobjekt, das die **CLOB**-Daten enthält.  
