---
title: getcolumntypame-Methode (SQLServerResultSetMetaData) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Diese getcolumntypame-Methode wird von der getcolumntypame-Methode in der Java. SQL. ResultSetMetaData-Schnittstelle angegeben.  
