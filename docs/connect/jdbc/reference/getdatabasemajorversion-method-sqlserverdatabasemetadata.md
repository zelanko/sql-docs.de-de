---
description: getDatabaseMajorVersion-Methode (SQLServerDatabaseMetaData)
title: getDatabaseMajorVersion-Methode (SQLServerDatabaseMetaData) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
