...
## <a name="return-value"></a>Rückgabewert  
 Gibt ein DateTimeOffset-Objekt zurück, das den Zeitpunkt darstellt, der vom Java. SQL. Timestamp-Objekt am angegebenen Offset (in Minuten) von GMT angegeben wird.  
