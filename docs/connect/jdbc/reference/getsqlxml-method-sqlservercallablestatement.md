---
title: gezqlxml-Methode (SQLServerCallableStatement) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|----------|-----------------|  
|[gezqlxml- &#40;Methode int&#41;](../../../connect/jdbc/reference/getsqlxml-method-int.md)|Ruft den Wert des angegebenen Parameters unter Berücksichtigung des Parameterindexes als SQLXML-Objekt ab.|  
