---
description: TRANSACTION_SNAPSHOT-Feld (SQLServerConnection)
...
ms.locfileid: "88431462"
---
# <a name="transaction_snapshot-field-sqlserverconnection"></a>TRANSACTION_SNAPSHOT-Feld (SQLServerConnection)
