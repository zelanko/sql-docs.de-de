...
Sie sollten das Kennwort nicht zusammen mit der Verbindungs-URL im Quellcode der Anwendung speichern. Speichern Sie es stattdessen in einer separaten Datei mit eingeschränktem Zugriff. Der Zugriff auf diese Datei kann dem Kontext gewährt werden, in dem die Anwendung ausgeführt wird.
