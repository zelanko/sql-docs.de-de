...
|--------------|-----------------|  
|[GitHub-Repository für den JDBC-Treiber für SQL Server](https://github.com/microsoft/mssql-jdbc)|Dieses Repository enthält den Quellcode für den JDBC-Treiber für SQL Server. Über diese Website können Sie direkt mit Mitgliedern des JDBC-Treiberteams in Kontakt treten. Dort können Sie Issues melden, Feedback geben und direkt zum Treiber beitragen.|
