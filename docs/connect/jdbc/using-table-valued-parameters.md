...
| Öffentliche SQLServerMetaData (Zeichenfolge ColumnName, SqlType von Int, Int Length)                                                                                                                        | Initialisiert eine neue Instanz der SQLServerMetaData verwenden den Namen der Spalte, die Sql-Typ und die Länge (für Zeichenfolgendaten). Die Länge wird verwendet, um großen Zeichenfolgen von Zeichenfolgen mit Länge weniger als 4000 Zeichen zu unterscheiden. In der Version 7.2 von JDBC Driver eingeführt.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Öffentliche SQLServerMetaData (SQLServerMetaData SqlServerMetaData)                                                                                                                    | Initialisiert eine neue Instanz der SQLServerMetaData aus einem anderen SQLServerMetaData-Objekt.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| public String getColumName()                                                                                                                                                     | Ruft den Namen der Spalte ab.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| public int getSqlType()                                                                                                                                                          | Ruft die Java-Sql-Typ ab.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| public boolean useServerDefault()                                                                                                                                                | Gibt zurück, ob die Spalte den Standardserverwert verwendet.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| public boolean next();                                  | Wechselt zur nächsten Zeile. Gibt True zurück, wenn die Verschiebung erfolgreich ist, und andernfalls eine nächste Zeile, die "false ist". |
...
| Öffentliche endgültige "void" SetStructured (ParatemeterName der Zeichenfolge, Zeichenfolge TvpName ISQLServerDataRecord TvpDataRecord) | Füllt ein Tabellenwertparameter an eine gespeicherte Prozedur mit einem ISQLServerDataRecord-Objekt übergeben. ISQLServerDataRecord wird zum Streamen von Daten verwendet, und der Benutzer entscheidet, wie Sie es verwenden. ParatemeterName ist der Name des Parameters, TvpName ist der Name des Tabellenwertparameter-Typs und TvpDataRecord ist ein ISQLServerDataRecord-Objekt. |
