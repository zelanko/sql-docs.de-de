---
title: Programmierhandbuch für JDBC-Treiber | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
* [Verwenden von Massenkopieren mit dem JDBC Driver](../../connect/jdbc/using-bulk-copy-with-the-jdbc-driver.md)
* [Verwenden von „Immer verschlüsselt“ mit dem JDBC-Treiber](../../connect/jdbc/using-always-encrypted-with-the-jdbc-driver.md)
* [Verwenden von Tabellenwertparametern](../../connect/jdbc/using-table-valued-parameters.md)
* [Internationale Funktionen des JDBC-Treibers](../../connect/jdbc/international-features-of-the-jdbc-driver.md)
