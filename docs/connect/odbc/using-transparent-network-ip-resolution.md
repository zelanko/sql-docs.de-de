...
ms.locfileid: "87244999"
---
# <a name="using-transparent-network-ip-resolution-with-the-odbc-driver"></a>Verwenden der transparenten Netzwerk-IP-Adressauflösung mit dem ODBC-Treiber
