...
Weitere Informationen zum Festlegen dieser Eigenschaften finden Sie in der Dokumentation zur [SqlConnection.ConnectionString-Eigenschaft](https://docs.microsoft.com/dotnet/api/microsoft.data.sqlclient.sqlconnection.connectionstring). 
...
[AppContext-Klasse](https://docs.microsoft.com/dotnet/api/system.appcontext?view=netcore-3.1)
