...
* **Microsoft Jet 4.0-Datenbankmodul:** ab Version 2.6 enthält MDAC mehr Jet-Komponenten. Das heißt, MDAC 2.6, 2.7, 2.8 enthalten keine Microsoft Jet, Microsoft Jet OLE DB-Anbieter, die ODBC-Desktop-Datenbanktreiber oder Jet Datenzugriffsobjekte (DAO). 
  ...
  Anstelle von Microsoft Jet, Microsoft empfiehlt die Verwendung [Microsoft SQL Server Express Edition](https://www.microsoft.com/sql-server/sql-server-editions-express) beim Entwickeln von neuen, nicht Microsoft Access - Anwendungen, die einen relationalen Datenspeicher erfordern. Dieser neuen oder konvertierte Jet-Anwendungen können weiterhin Jet, die mit dem Ziel mithilfe von Microsoft Office 2003 und früheren Dateien ("mdb" und ".xls") nicht primären Datenspeicher verwenden. Allerdings sollten für diese Anwendungen Sie planen, Migrieren von Jet zu Microsoft Access Database Engine. Sie können [Herunterladen der Microsoft Access Database Engine](https://www.microsoft.com/download/details.aspx?id=54920), können Sie Lese- und Schreibzugriff auf bereits vorhandene Dateien in Office 2003 ("mdb" und ".xls") oder die Office 2007 (*.accdb, *.xlsm, *.xlsx und *.xlsb)-Dateiformate.
