---
title: Verwenden erweiterter Datums- und Uhrzeitfeatures (OLE DB-Treiber)
description: Erfahren Sie, wie Sie die date/time-Features date, time, datetime2 und datetimeoffset verwenden, um Befehle auszuführen und Rowsetergebnisse im OLE DB-Treiber für SQL Server abzurufen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
