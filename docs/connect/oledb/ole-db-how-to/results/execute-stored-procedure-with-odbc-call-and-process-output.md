...
description: Erfahren Sie, wie Rückgabecodes und Ausgabeparameter im OLE DB-Treiber für SQL Server verarbeitet werden, die nach der Freigabe des Rowsets im endgültigen Paket empfangen werden.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
