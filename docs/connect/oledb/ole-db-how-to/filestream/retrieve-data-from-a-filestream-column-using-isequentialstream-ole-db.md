...
description: Erfahren Sie, wie eine ISequentialStream-Schnittstelle in einer ICommandText-Schnittstelle verwendet wird, um im OLE DB-Treiber für SQL Server einen Datensatz aus einer Filestream-Spalte abzurufen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
