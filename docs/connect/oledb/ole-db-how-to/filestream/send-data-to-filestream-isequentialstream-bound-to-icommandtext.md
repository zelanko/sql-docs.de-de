...
description: In diesem Beispiel erfahren Sie, wie die ISequentialStream-Schnittstelle, die an einen ICommandText-Parameter gebunden ist, verwendet wird, um Daten von 4 MB bis 4 GB in eine Filestream-Spalte zu übertragen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
