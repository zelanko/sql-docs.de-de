...
description: Erfahren Sie, wie Sie eine FILESTREAM-Spalte über die IBCPSession-Schnittstelle im OLE DB-Treiber für SQL Server in eine Datei einlesen und anhand dieses Beispiels eine Formatdatei schreiben.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
