...
description: Erfahren Sie, wie Sie mit der IRow::GetColumns-Methode im OLE DB-Treiber für SQL Server Spalten abrufen können. In diesem Beispiel wird jeweils eine Spalte aus einer Zeile abgerufen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
