...
description: Erfahren Sie anhand dieses Beispiels, wie OLE DB verwendet wird, um das Kennwort eines Benutzerkontos mit SQL Server-Authentifizierung zu ändern.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
