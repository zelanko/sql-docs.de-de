...
description: Erfahren Sie anhand dieses Beispiels, wie Sie Spalten- und Katalogmetadaten für Sparsespalten im OLE DB-Treiber für SQL Server anzeigen und katalogisieren können.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
