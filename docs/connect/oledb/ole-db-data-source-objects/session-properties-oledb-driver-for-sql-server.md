...
description: Erfahren Sie, wie der OLE DB-Treiber für SQL Server OLE DB-Sitzungseigenschaften, einschließlich eines anbieterspezifischen Eigenschaftensatzes, interpretiert.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
