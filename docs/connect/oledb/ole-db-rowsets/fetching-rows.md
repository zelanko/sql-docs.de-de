---
title: Abrufen von Zeilen (OLE DB-Treiber) | Microsoft-Dokumentation
description: Erfahren Sie, wie Consumer im OLE DB-Treiber für SQL Server die IRowset-Schnittstelle verwenden, um Zeilen abzurufen, Daten aus Zeilen abzurufen und Zeilen zu verwalten.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
