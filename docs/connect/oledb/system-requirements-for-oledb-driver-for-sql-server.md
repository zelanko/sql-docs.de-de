...
## <a name="operating-system-requirements"></a>Betriebssystemanforderungen  
 ...
 Wenn Sie die Azure Active Directory-Authentifizierungsmethoden mit dem OLE DB-Treiber verwenden, stellen Sie sicher, dass die [Active Directory-Authentifizierungsbibliothek für SQL Server](https://go.microsoft.com/fwlink/?LinkID=513072) installiert wurde. ADAL ist für die anderen Authentifizierungsmethoden oder OLE DB-Vorgänge nicht erforderlich.
