...
description: Erfahren Sie, wie der OLE DB-Treiber für SQL Server SQL Serverdaten in Rowsets und als Parameterwerte darstellt, indem er die von OLE DB definierten Datentypen verwendet.
ms.custom: ''
ms.date: 02/21/2020
ms.prod: sql
