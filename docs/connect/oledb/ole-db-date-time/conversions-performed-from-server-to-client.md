...
description: Erfahren Sie mehr über date/time-Konvertierungen, die zwischen SQL Server und einer mit dem OLE DB-Treiber für SQL Server geschriebenen Clientanwendung durchgeführt werden.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
