...
description: Informieren Sie sich über die Vergleiche, die IRowsetFind für date/time-Typen im OLE DB-Treiber für SQL Server unterstützt. Für andere Vergleiche wird DB_E_BADCOMPAREOP zurückgegeben.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
