...
description: Erfahren Sie, wie der OLE DB-Treiber für SQL Server die Konvertierung zwischen datetime- und datetimeoffset-Werten vornimmt. Es gibt mehrere allgemeine Konvertierungsregeln.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
