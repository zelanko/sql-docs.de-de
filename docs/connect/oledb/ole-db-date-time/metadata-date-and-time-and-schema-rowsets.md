...
description: Erfahren Sie mehr über die Datums- und Uhrzeitverbesserungen von OLE DB in Bezug auf die Rowsets COLUMNS und PROCEDURE_PARAMETERS im OLE DB-Treiber für SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
