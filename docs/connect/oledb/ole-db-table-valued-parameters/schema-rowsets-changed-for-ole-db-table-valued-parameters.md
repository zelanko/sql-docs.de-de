...
description: Erfahren Sie mehr über die Schemarowsets, die geändert oder hinzugefügt wurden, um Parameter mit Tabellenwerten im OLE DB-Treiber für SQL Server zu unterstützen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
