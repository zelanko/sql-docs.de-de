...
description: Erfahren Sie mehr über OLE DB-Standardmethoden, die Parameter mit Tabellenwerten im OLE DB-Treiber für SQL Server unterstützen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
