...
description: Erfahren Sie, wie Sie im OLE DB-Treiber für SQL Server ein spezialisiertes Rowsetobjekt für Parameter mit Tabellenwerten erstellen.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
