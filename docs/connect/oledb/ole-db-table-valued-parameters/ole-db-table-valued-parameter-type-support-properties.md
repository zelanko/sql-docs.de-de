...
description: Erfahren Sie mehr über OLE DB-Eigenschaften und -Eigenschaftssätze, die im OLE DB-Treiber für SQL Server mit Rowsetobjekten mit Parametern mit Tabellenwerten verknüpft sind.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
