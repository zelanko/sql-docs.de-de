...
description: 'Verwenden von IBCPSession2:: bcpsetbulkmode zum Erstellen eines Massen Kopiervorgangs aus einer Abfrage oder einer Tabelle'
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
