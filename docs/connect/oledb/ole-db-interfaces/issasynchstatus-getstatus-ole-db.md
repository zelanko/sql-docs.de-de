---
title: ISSAsynchStatus::GetStatus (OLE DB-Treiber) | Microsoft-Dokumentation
description: Erfahren Sie, wie die ISSAsynchStatus::GetStatus-Methode den Status eines im OLE DB-Treiber für SQL Server asynchron ausgeführten Vorgangs zurückgibt.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
