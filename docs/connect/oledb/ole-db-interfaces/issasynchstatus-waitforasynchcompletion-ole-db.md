...
description: Erfahren Sie, wie die ISSAsynchStatus::WaitForAsynchCompletion-Methode im OLE DB-Treiber für SQL Server wartet, bis ein asynchroner Vorgang abgeschlossen ist oder das Zeitlimit erreicht wird.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
