---
title: IBCPSession::BCPDone (OLE DB-Treiber) | Microsoft-Dokumentation
description: Erfahren Sie, wie die IBCPSession::BCPDone-Methode die restlichen an SQL Server zu sendenden Zeilen im OLE DB-Treiber für SQL Server festlegt.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
