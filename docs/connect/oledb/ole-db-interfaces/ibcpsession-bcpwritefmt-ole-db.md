...
description: 'Verwenden von IBCPSession:: bcpschreitefmt zum Speichern der Format Dateien entweder im XML-Format oder im Textformat (OLE DB)'
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
