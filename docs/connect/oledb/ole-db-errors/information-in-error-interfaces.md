---
title: Informationen in Fehler Schnittstellen | Microsoft-Dokumentation
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
 ...
 Der OLE DB-Treiber für SQL Server unterstützt **IErrorInfo** -Element Funktionen wie folgt.  
...
|**GetSource**|Zeichenfolge „Microsoft OLE DB-Treiber für SQL Server“.|  
 ...
 Der OLE DB-Treiber für SQL Server unterstützt vom Consumer verfügbare **IErrorRecords** -Member-Funktionen wie folgt.  
...
|**GetRecordCount**|Anzahl der verfügbaren Fehlerdatensätze.|  
 ...
 Der OLE DB-Treiber für SQL Server unterstützt **ISQLErrorInfo:: gezqlinfo** -Parameter wie folgt.  
  
|Parameter|und Beschreibung|  
|---------------|-----------------|  
|*pbstrSQLState*|Gibt einen SQLSTATE-Wert für den Fehler zurück. SQLSTATE-Werte werden in SQL-92, ODBC und ISO SQL sowie der API-Spezifikation definiert. Weder [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] noch der OLE DB Treiber für SQL Server definierte Implementierungs spezifische SQLSTATE-Werte.|  
|*plNativeError*|Gibt die [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]-Fehlernummer von **master.dbo.sysmessages** zurück, sofern verfügbar. Native Fehler sind nach einem erfolgreichen Versuch verfügbar, einen OLE DB Treiber für SQL Server Datenquelle zu initialisieren. Vor dem Versuch gibt der OLE DB Treiber für SQL Server immer 0 (null) zurück.|  
