---
title: Abrufen von Fehlerinformationen (OLE DB-Treiber)
description: In diesem Beispiel werden Informationen aus den verschiedenen Fehlerschnittstellen abgerufen, die vom OLE DB-Treiber für SQL Server verfügbar gemacht werden.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
