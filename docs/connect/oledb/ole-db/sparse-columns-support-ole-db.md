...
description: Erfahren Sie mehr über die Unterstützung des OLE DB-Treibers für SQL Server für Sparsespalten, d. h. Spalten, die für die Speicherung von NULL-Werten optimiert sind.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
