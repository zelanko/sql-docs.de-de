...
description: Erfahren Sie mehr über die Verschlüsselung ohne Überprüfung für SQL Server-Verbindungen. Der OLE DB-Treiber für SQL Server unterstützt die Verschlüsselung ohne Überprüfung.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
