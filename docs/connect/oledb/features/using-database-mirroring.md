...
description: Der OLE DB-Treiber für SQL Server unterstützt die Datenbankspiegelung. Entwickler müssen keine weiteren Schritte unternehmen, nachdem die Spiegelung für die Datenbank konfiguriert wurde.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
