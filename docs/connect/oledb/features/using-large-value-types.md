...
description: Erfahren Sie, wie der OLE DB-Treiber für SQL Server Datentypen mit umfangreichen Werten unter Verwendung der varchar(max)-, varbinary(max)- und nvarchar(max)-Typen unterstützt.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
