...
description: Erfahren Sie mehr über XML-Datentypen in Verbindung mit dem OLE DB-Treiber für SQL Server, mit denen Sie XML-Dokumente und -Fragmente in einer SQL Server-Datenbank speichern können.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
