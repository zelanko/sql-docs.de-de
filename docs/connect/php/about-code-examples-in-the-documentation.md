---
title: Informationen zu Code Beispielen in der-Dokumentation | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
-   In fast allen Beispielen wird davon ausgegangen, dass SQL Server 2008 oder höher und die AdventureWorks-Datenbank auf dem lokalen Computer installiert sind.  
    ...
    Informationen zum herunterladen und Installieren der AdventureWorks-Datenbank finden Sie auf der [Seite "AdventureWorks" im GitHub-Repository "SQL Server Samples](https://github.com/Microsoft/sql-server-samples/tree/master/samples/databases/adventure-works)".
...
-   Obwohl Beispiele dafür vorgesehen sind, von der Befehlszeile ausgeführt zu werden, kann jedes Beispiel auch ausgeführt werden, indem Sie es in einem Browser aufrufen, ohne Änderungen am Skript vorzunehmen. Um die Ausgabe zu formatieren, ersetzen Sie in jedem Beispiel jedes\<"\n" durch "\/br >", bevor Sie es in einem Browser aufrufen.  
