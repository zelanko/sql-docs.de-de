...
|[Vorgehensweise: Senden und Abrufen von ASCII-Daten in Linux und macOS](../../connect/php/how-to-send-and-retrieve-ascii-data-in-linux-mac.md)|Hier wird erläutert, wie die Unterstützung von [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)] für ASCII-Daten unter Linux oder macOS verwendet wird.<br /><br />Unterstützung für ASCII-Zeichen in Umgebungen außerhalb von Windows wurde in der Version 5.2 von [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)] hinzugefügt.|
