...
Falls Sie den PDO_SQLSRV-Treiber verwenden, können Sie auf der [PDO](https://php.net/manual/book.pdo.php)-Webseite weitere Informationen zu Fehlern und Fehlerbehandlung finden.  
