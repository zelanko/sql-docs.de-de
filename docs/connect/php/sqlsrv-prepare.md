...
*$conn:* Hierbei handelt es sich um die Verbindungsressource, die mit der erstellten Anweisung verknüpft ist.  
  
*$tsql:* Hierbei handelt es sich um den Transact-SQL-Ausdruck, der der erstellten Anweisung entspricht.  
...
|ReturnDatesAsStrings|**true** oder **false**<br /><br />Der Standardwert ist **false**.|Konfiguriert die Anweisung zum Abrufen von Datums- und Uhrzeittypen als Zeichenfolgen (**true**). Weitere Informationen finden Sie unter [Vorgehensweise: Abrufen von Datums- und Uhrzeittypen als Zeichenfolgen mit dem SQLSRV-Treiber](../../connect/php/how-to-retrieve-date-and-time-type-as-strings-using-the-sqlsrv-driver.md).
