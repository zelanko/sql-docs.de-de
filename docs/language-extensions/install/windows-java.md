---
title: Installieren von Java-Sprachenerweiterungen für SQL Server unter Windows
titleSuffix: ''
description: Erfahren Sie, wie Sie das Feature Java-Sprachenerweiterungen durch Ausführen des SQL Server-Setup-Assistenten auf einer SQL Server-Instanz unter Windows installieren.
author: cawrites
ms.author: chadam
ms.date: 09/17/2020
ms.topic: conceptual
...
ms.locfileid: "92155561"
---
# <a name="install-sql-server-language-java-extensions-on-windows"></a>Installieren von SQL Server-Java-Sprachenerweiterungen unter Windows
...
> [!NOTE]
> Dieser Artikel behandelt die Installation von SQL Server-Spracherweiterungen unter Windows. Informationen für Linux finden Sie unter [Installieren von SQL Server 2019-Spracherweiterungen (Java) unter Linux](../../linux/sql-server-linux-setup-language-extensions-java.md).
...
2. Öffnen Sie in der Systemsteuerung **System und Sicherheit** und anschließend **System** , und wählen Sie dann **Erweiterte Systemeigenschaften** aus.
