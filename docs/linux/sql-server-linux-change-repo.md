...
::: zone pivot="ld2-rhel"
Dieser Artikel beschreibt, wie Sie die richtige Repository für SQL Server 2017 und 2019 für SQL Server-Installationen und Upgrades unter Linux konfigurieren. Im oberen Bereich die aktuelle Auswahl ist **Red hatte (RHEL)**.
::: zone-end
