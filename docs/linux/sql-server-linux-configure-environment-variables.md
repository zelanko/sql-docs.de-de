...
Sie können mehrere verschiedene Umgebungsvariablen verwenden, um SQL Server 2019 (Vorschauversion) unter Linux zu konfigurieren. Diese Variablen werden in zwei Szenarien verwendet:
