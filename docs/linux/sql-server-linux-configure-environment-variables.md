...
Sie können mehrere verschiedene Umgebungsvariablen verwenden, so konfigurieren Sie SQL Server 2019 CTP 2.0 unter Linux. Diese Variablen werden in zwei Szenarien verwendet:
