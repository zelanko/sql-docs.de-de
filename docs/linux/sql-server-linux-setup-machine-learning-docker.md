...
+ [Python-Tutorial: Bereitstellen eines linearen Regressionsmodells in SQL Server Machine Learning Services](../advanced-analytics/tutorials/python-ski-rental-linear-regression.md)
