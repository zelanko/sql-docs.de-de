...
- [Pacemaker – Manuelles Verschieben von Ressourcen](https://clusterlabs.org/doc/en-US/Pacemaker/1.1-pcs/html/Clusters_from_Scratch/_move_resources_manually.html)
