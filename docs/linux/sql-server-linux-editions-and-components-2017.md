...
- [Neuigkeiten in SQL Server für Linux](sql-server-linux-whats-new.md)

Eine Liste der SQL Server-Funktionen, die unter Linux nicht verfügbar sind, finden Sie unter [Nicht unterstützte Funktionen und Services](sql-server-linux-release-notes.md#Unsupported).
