...
## <a name="enable-sql-server-agent"></a><a id="enablesqlagent"></a> Aktivieren des SQL Server-Agents

Aktivieren Sie den SQL Server-Agent und dieser startet automatisch mit SQL Server.
...
## <a name="troubleshooting"></a><a id="troubleshooting"></a> Problembehandlung
