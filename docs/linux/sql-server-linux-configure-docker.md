...
Gesamte Dokumentation zu SQL Server Linux-containerimages zeigen Sie auf der Ubuntu-basierte Container. Ab SQL Server-2019 Preview können Sie Container basierend auf Red Hat Enterprise Linux (RHEL) verwenden. Ändern Sie das containerrepository von **mcr.microsoft.com/mssql/server:2019-CTP2.4-ubuntu** zu **mcr.microsoft.com/mssql/rhel/server:2019-CTP2.4** in all Ihre Docker-Befehle.
