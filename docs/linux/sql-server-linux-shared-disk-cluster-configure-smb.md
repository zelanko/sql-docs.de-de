---
title: Konfigurieren Sie die Instanz failoverclusterspeicher SMB – SQL Server unter Linux
description: ''
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
...
1. System o. Datenbanken gespeichert, die am Standardspeicherort für die Daten gehen Sie folgendermaßen vor. Andernfalls fahren Sie mit Schritt 5 fort. 
   ...
   1. Starten Sie SqlServer. Wenn alles richtig kopiert wurde und angewendeten Sicherheitsfunktionen ordnungsgemäß SQL Server zeigen sollte, wie gestartet.
