---
title: Erste Schritte mit SQL Server in der Cloud | Microsoft-Dokumentation
...
ms.locfileid: "46713172"
---
# <a name="quickstart-run-the-sql-server-in-the-cloud"></a>Schnellstart: Ausführen des SQL Server in der cloud
