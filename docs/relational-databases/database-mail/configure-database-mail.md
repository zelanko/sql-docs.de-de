 ...
 **Problembehandlung**  
 Klicken Sie, um die Onlinedokumentation für das Thema [Problembehandlung bei Datenbank-E-Mail](/previous-versions/sql/sql-server-2008-r2/ms188663(v=sql.105))zu öffnen.  
