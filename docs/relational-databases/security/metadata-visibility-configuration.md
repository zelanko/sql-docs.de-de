...
description: Hier erfahren Sie, wie Sie die Sichtbarkeit von Metadaten für sicherungsfähige Elemente konfigurieren, die ein Benutzer besitzt oder für die ein Benutzer die Berechtigung in SQL Server besitzt.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
