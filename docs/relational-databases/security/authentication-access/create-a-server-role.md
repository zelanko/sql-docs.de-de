...
4.  Geben Sie im Dialogfeld **Neue Serverrolle –**_server\_role\_name_ auf der Seite **Allgemein** einen Namen für die neue Serverrolle in das Feld **Serverrollenname** ein.  
