...
Geben Sie zum Deaktivieren von Always Encrypted für eine Datenbankverbindung `Column Encryption Setting=Disabled` an, oder entfernen Sie die Einstellung **Spaltenverschlüsselungseinstellung** von der Registerkarte **Zusätzliche Eigenschaften** im Dialogfeld **Verbindung mit Server herstellen** (der Standardwert ist **Deaktiviert**).   
...
#### <a name="permissions-for-querying-against-encrypted-columns"></a>Berechtigungen zum Abfragen auf verschlüsselten Spalten
...
### <a name="permissions-for-dac-upgrade-if-always-encrypted-is-set-up"></a>Berechtigungen für das DAC-Upgrade, wenn Always Encrypted eingerichtet ist
...
### <a name="permissions-for-database-migration-using-sql-server-import-and-export-wizard"></a>Berechtigungen für die Datenbankmigration mithilfe Export-Assistent des SQL Server-Import/Export-Assistenten
