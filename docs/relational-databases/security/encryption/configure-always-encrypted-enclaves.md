...
3. [SQL Server PowerShell-Module](../../../powershell/download-sql-server-ps-module.md) Version 21.5 oder höher.
...
### <a name="provisioning-enclave-enabled-keys--azure-key-vault"></a>Bereitstellen von Enclave-fähigen Schlüsseln – Azure Key Vault
