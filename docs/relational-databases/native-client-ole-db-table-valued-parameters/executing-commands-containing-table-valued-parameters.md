---
description: Ausführen von SQL Server Native Client Befehlen mit Table-Valued Parametern
title: Befehle mit Table-Valued-Parametern
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "97419052"
---
# <a name="executing-sql-server-native-client-commands-containing-table-valued-parameters"></a>Ausführen von SQL Server Native Client Befehlen mit Table-Valued Parametern
