...
ms.locfileid: "87246705"
---
# <a name="schema-rowsets-changed-for-ole-db-table-valued-parameters-in-sql-server-native-client"></a>Schemarowsets Geändert für OLE DB Tabellenwert Parameter in SQL Server Native Client
