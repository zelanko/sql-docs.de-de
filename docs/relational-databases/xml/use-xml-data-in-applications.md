...
description: Erfahren Sie mehr über die Optionen, die Ihnen bei der Arbeit mit dem xml-Datentyp in Ihren Anwendungen zur Verfügung stehen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
