...
description: In diesem Artikel wird ein Beispiel zum Umbenennen eines XML-Zeilenelements veranschaulicht, indem ein optionales Argument im RAW-Modus in der FOR XML-Klausel angegeben wird.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
