...
description: Hier erfahren Sie, wie Sie ein Rowset mit XML-Werten in einer SQL-Abfrage mithilfe der value()-Methode und der nodes()-Methode oder mithilfe der OpenXML()-Methode extrahieren.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
