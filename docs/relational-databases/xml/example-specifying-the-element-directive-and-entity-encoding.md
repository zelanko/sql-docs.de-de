...
description: Hier erfahren Sie, wie Sie die ELEMENT-Anweisung in einer SQL-Abfrage angeben, damit das Abfrageergebnis entitätscodiert ist.
ms.date: 03/01/2017
ms.prod: sql
