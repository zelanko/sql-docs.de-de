...
description: Sehen Sie sich ein Beispiel für die Verwendung von geschachtelten FOR XML-Abfragen zum Gestalten des resultierenden XML-Codes an.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
