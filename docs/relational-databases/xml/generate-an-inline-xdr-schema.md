...
description: Hier finden Sie Informationen zum Generieren eines XDR-Inlineschemas und die Veraltung der XMLDATA-Anweisung in der FOR XML-Klausel.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
