...
description: Erfahren Sie, wie Sie auf die integrierte XML-Schemaauflistung (sys) verweisen, die für jede von Ihnen erstellte Datenbank vordefiniert ist.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
