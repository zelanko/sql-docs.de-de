...
description: Hier erfahren Sie mehr über die Vorteile und Einschränkungen des XML-Datentyps zum Speichern von XML-Daten in SQL Server.
ms.custom: ''
ms.date: 05/17/2019
ms.prod: sql
