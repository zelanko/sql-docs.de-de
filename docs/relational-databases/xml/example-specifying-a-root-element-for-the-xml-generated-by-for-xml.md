...
description: In diesem Artikel wird eine Beispielabfrage veranschaulicht, die die ROOT-Option der FOR XML-Klausel angibt, um ein einzelnes Element auf der obersten Ebene im resultierenden XML-Code anzufordern.
ms.date: 03/01/2017
ms.prod: sql
