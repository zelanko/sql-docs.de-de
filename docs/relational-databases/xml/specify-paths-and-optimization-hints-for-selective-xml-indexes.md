...
description: Erfahren Sie, wie beim Erstellen oder Ändern selektiver XML-Indizes Knotenpfade und Optimierungshinweise angegeben werden.
ms.date: 03/14/2017
ms.prod: sql
