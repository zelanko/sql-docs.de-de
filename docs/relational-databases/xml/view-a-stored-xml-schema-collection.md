...
description: Erfahren Sie, wie Sie mithilfe der XQuery-Funktion xml_schema_namespace() eine gespeicherte XML-Schemaauflistung anzeigen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
