...
description: Erfahren Sie mehr über die Unterstützung für das W3C XSD redefine-Element und das Aktualisieren eines XML-Schemas oder der zugehörigen Komponenten.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
