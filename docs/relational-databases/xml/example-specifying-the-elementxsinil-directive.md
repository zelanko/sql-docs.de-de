...
description: Hier erfahren Sie, wie Sie die ELEMENTXSINIL-Anweisung in SQL angeben, um XML-Elemente für NULL-Werte zu generieren, die das Attribut xsi:nil mit dem Wert TRUE aufweisen.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
