...
description: Hier erfahren Sie anhand eines Beispiels, das eine einstufige FOR XML-Abfrage mit einer geschachtelten FOR XML-Abfrage vergleicht, mehr über die Vorteile geschachtelter FOR XML-Abfragen.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
