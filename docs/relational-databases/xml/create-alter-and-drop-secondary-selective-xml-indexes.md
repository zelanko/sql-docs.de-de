...
description: Erfahren Sie, wie ein neuer sekundärer, selektiver XML-Index erstellt bzw. ein vorhandener sekundärer, selektiver XML-Index geändert oder gelöscht wird.
ms.date: 03/03/2017
ms.prod: sql
