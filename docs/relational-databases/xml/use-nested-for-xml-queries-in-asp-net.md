...
description: Erfahren Sie, wie geschachtelte FOR XML-Abfragen in einer ASP.NET-Anwendung zum Generieren von elementzentrischem XML verwendet werden.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
