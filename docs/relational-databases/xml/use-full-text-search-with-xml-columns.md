...
description: Hier erfahren Sie, wie Sie mit SQL einen Volltextindex für XML-Spalten erstellen und eine Volltextsuche nach XML-Werten durchführen.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
