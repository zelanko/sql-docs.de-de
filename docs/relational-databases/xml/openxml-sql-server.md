...
description: Erfahren Sie mehr über die OPENXML-Anweisung in SQL Server, die eine Rowsetansicht der internen Darstellung eines XML-Dokuments bereitstellt.
ms.custom: ''
ms.date: 05/11/2020
ms.prod: sql
