...
description: Sehen Sie sich ein Beispiel an, das XSINIL mit der ELEMENTS-Anweisung angibt, um elementzentrierte XML-Daten aus dem Abfrageergebnis zu generieren.
ms.date: 03/01/2017
ms.prod: sql
