---
title: Anforderungen und Einschränkungen (XML-Schemasammlungen) | Microsoft-Dokumentation
description: Erfahren Sie mehr über die Anforderungen und Einschränkungen zum Ändern der XML-Schemaauflistungen in SQL Server.
ms.date: 03/14/2017
ms.prod: sql
...
|Thema|BESCHREIBUNG|  
|-----------|-----------------|  
|[Kanonische Formen und Musterbeschränkungen](../../relational-databases/xml/canonical-forms-and-pattern-restrictions.md)|Beschreibt kanonische Formen und Musterbeschränkungen.|  
...
|[Enumerationsfacets](../../relational-databases/xml/enumeration-facets.md)|Beschreibt die Einschränkung hinsichtlich der Enumerationsfacets.|  
|[Mixed-Datentyp und simple-Inhalt](../../relational-databases/xml/mixed-type-and-simple-content.md)|Beschreibt die Einschränkung beim Beschränken eines gemischten Typs auf einfachen Inhalt.|  
