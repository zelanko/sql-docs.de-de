...
description: 'Erfahren Sie, wie Sie die SQL: zugeordnete Anmerkung verwenden, um ein Element im XSD-Schema zu erstellen, das keiner Datenbanktabelle (Sicht) oder Spalte zugeordnet ist.'
ms.date: 03/17/2017
ms.prod: sql
