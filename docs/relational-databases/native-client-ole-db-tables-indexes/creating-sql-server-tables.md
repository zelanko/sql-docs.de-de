---
title: Erstellen von SQL Server Tabellen (Native Client OLE DB Provider) | Microsoft-Dokumentation
description: Erfahren Sie, wie der SQL Server Native Client OLE DB-Anbieter die Funktionen verfügbar macht, mit denen Consumer SQL Server Tabellen erstellen können.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
