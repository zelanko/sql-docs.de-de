...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 " **Kreatetable** " gibt DB_E_BADTABLEID zurück, wenn der *eKind* -Member des Parameters " *pTableID* " nicht DBKIND_NAME angibt.  
...
> [!NOTE]  
>  " **Kreatetable** " gibt DB_E_BADTYPE zurück, wenn der Consumer entweder den *pTypeInfo* -oder den *pclsid* -Member festlegt, um den Spaltendatentyp anzugeben.  
  
 Der Consumer gibt dne Spaltennamen im *pwszName*-Element der *uName*-Union des DBCOLUMNDESC *dbcid*-Elements an. Der Spaltenname wird als Unicode-Zeichenfolge angegeben. Das *eKind*-Element von *dbcid* muss DBKIND_NAME sein. " **Kreatetable** " gibt DB_E_BADCOLUMNID zurück, wenn " *eKind* " ungültig ist, " *pwszName* " NULL ist oder der Wert von " *pwszName* " kein gültiger [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Bezeichner ist.  
  
 Alle Spalteneigenschaften sind in allen für die Tabelle definierten Spalten verfügbar. " **Kreatetable** " kann DB_S_ERRORSOCCURRED oder DB_E_ERRORSOCCURRED zurückgeben, wenn Eigenschaftswerte in Konflikt festgelegt sind. " **Anatetable** " gibt einen Fehler zurück, wenn ungültige Spalten Eigenschafts Einstellungen zu Fehlern bei Tabellenerstellung führen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
