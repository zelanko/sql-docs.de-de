---
description: Spalte zu SQL Server Tabelle hinzufügen (Native Client-OLE DB Anbieter)
title: Spalte zu SQL Server Tabelle hinzufügen (Native Client OLE DB Provider) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97475981"
---
# <a name="adding-a-column-to-a-table-in-sql-server-native-client"></a>Hinzufügen einer Spalte zu einer Tabelle in SQL Server Native Client
