...
# <a name="dropping-a-sql-server-index"></a>Löschen eines SQL Server-Index
  ...
  Der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] native Client-OLE-DB-Anbieter macht die **Funktion IIndexDefinition::DropIndex** verfügbar. Mit dieser Funktion können Consumer einen Index aus einer [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Tabelle entfernen.  
