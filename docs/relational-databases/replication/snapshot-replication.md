...
description: Die Momentaufnahmereplikation verteilt Daten so, wie sie zu einem bestimmten Zeitpunkt angezeigt werden. Updates werden nicht überwacht. Eine Momentaufnahme wird generiert und an Abonnenten gesendet.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
