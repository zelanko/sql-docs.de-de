...
description: In diesem Artikel werden die Tabellen und sonstigen Datenbankobjekte zusammengefasst, die Sie zur Replikation in SQL Server veröffentlichen können.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
