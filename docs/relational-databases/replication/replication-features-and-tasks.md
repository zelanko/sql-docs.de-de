...
ms.locfileid: "52511228"
---
# <a name="replication-features-and-tasks"></a>Replikationsfunktionen und -tasks
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  Suchen Sie nach den Informationen, die am Entwurf und der Implementierung von Replikationslösungen beteiligte Personen – Designer, Entwickler, Analysten oder Administratoren – benötigen.  
