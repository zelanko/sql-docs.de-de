---
title: Überprüfen von Partitionsinformationen (Merge)
description: Hier wird beschrieben, wie Partitionsinformationen für einen Mergeabonnenten in SQL Server überprüft werden.
