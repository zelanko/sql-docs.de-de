---
description: Verlegerinformationen, Überwachungsliste für Abonnements (Transaktion)
title: Verlegerinformationen, Überwachungsliste für Abonnements (Transaktion) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
