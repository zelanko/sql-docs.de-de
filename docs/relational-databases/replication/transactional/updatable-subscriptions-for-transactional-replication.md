---
title: Aktualisierbare Abonnements (transaktional)
description: Hier wird das Feature für aktualisierbare Abonnements beschrieben, das für die Transaktionsreplikation in SQL Server verfügbar ist.
