...
description: Hier erfahren Sie, wie Sie Dateien in Dateitabellen in SQL Server laden und migrieren, wenn diese auf unterschiedliche Weise gespeichert werden. Informieren Sie sich über Massenladevorgänge.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
