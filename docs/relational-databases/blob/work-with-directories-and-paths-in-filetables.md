...
description: Das Feature FileTables verwendet eine Verzeichnisstruktur zum Speichern von Dateien. Erfahren Sie, wie Sie mit dessen Verzeichnissen, Pfaden, Einschränkungen und Semantik arbeiten.
ms.custom: ''
ms.date: 08/26/2016
ms.prod: sql
