...
description: Hier erfahren Sie mehr über FILESTREAM, ein SQL Server-Feature, das Daten im Dateisystem speichert. Sie erfahren, wie das Feature Daten speichert, sichert und den Zugriff auf diese gewährt.
ms.custom: ''
ms.date: 01/11/2018
ms.prod: sql
