...
description: Erfahren Sie, wie Sie die Transact-SQL-Anweisungen INSERT, UPDATE und DELETE verwenden, um auf FILESTREAM-Daten zuzugreifen und diese zu verwalten.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
