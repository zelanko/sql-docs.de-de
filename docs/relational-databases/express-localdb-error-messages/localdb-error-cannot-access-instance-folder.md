...
|Meldungstext|Lokale Datenbank instanzordner kann nicht zugegriffen werden: %%LOCALAPPDATA%%\Microsoft\Microsoft SQL Server lokale DB\Instances\\< Instanzname\>.|  
