...
|**stream_blob_columns**|**bit**|Gibt an, wenn eine datenstromoptimierung beim Replizieren von BLOB-Spalten verwendet wird. **1** bedeutet, dass die Optimierung versucht wird.|  
