...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Ab unterstützt XML-typisierte Daten mithilfe des XML-Datentyps. **** [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Dieses Thema enthält Informationen darüber, wie SQLXML 4,0 Instanzen des **XML** -Datentyps erkennt und Unterstützung für Sie implementiert.  
