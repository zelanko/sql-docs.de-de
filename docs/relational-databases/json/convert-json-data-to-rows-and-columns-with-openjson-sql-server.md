---
description: Analysieren und Transformieren von JSON-Daten mit OPENJSON (SQL Server)
title: Analysieren und Transformieren von JSON-Daten mit OPENJSON
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
