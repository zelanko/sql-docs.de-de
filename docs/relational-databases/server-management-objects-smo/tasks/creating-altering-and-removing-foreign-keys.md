...
## <a name="sample-foreign-keys-primary-keys-and-unique-constraint-columns"></a>Beispiel: Fremdschlüssel, Primärschlüssel und eindeutige Einschränkungs Spalten  
