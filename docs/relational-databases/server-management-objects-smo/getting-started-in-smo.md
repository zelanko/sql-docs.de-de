...
[Programmiersprachen](../../relational-databases/server-management-objects-smo/smo-programming-languages.md) beschreiben die Programmierumgebung und enthalten ausführliche Verfahren, um mit dem Schreiben eines SMO C#-Programms in zu beginnen.  
