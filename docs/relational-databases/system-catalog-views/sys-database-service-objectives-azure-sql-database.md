...
Gibt ggf. die Edition (Dienst Ebene), das Dienst Ziel (Tarif) und den Namen des elastischen Pools für eine Azure SQL-Datenbank oder eine Azure SQL Data Warehouse zurück. Wenn Sie bei der Master-Datenbank auf einem Azure SQL-Datenbankserver angemeldet sind, werden Informationen zu allen Datenbanken zurückgegeben. Für Azure SQL Data Warehouse müssen Sie mit der Master-Datenbank verbunden sein.  
 ...
 Informationen zu den Preisen finden [Sie unter Optionen und Leistung von SQL-Datenbank: Preis](https://azure.microsoft.com/pricing/details/sql-database/) -und [SQL Data Warehouse Preise](https://azure.microsoft.com/pricing/details/sql-data-warehouse/)für SQL-Datenbank.  
...
|-----------------|---------------|-----------------|  
|database_id|ssNoversion|Die ID der Datenbank, die innerhalb einer Instanz von Azure SQL-Datenbankserver eindeutig ist. Joinfähig mit [sys. Datenbanken &#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).|  
