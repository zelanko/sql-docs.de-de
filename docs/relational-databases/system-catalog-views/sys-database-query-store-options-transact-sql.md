...
|**max_storage_size_mb**|**bigint**|Maximale Datenträger Größe für die Abfragespeicher in Megabyte (MB). Der Standardwert ist **100** MB.<br />Der [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)] Standardwert für die Premium Edition ist 1 GB [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)] , und bei Basic Edition beträgt der Standardwert 10 MB.<br /><br /> Ändern Sie mithilfe der `ALTER DATABASE <database> SET QUERY_STORE (MAX_STORAGE_SIZE_MB = <size>)` -Anweisung.|  
...
|**query_capture_mode_desc**|**nvarchar(60)**|Textbeschreibung des tatsächlichen Aufzeichnungsmodus Abfragespeicher:<br /><br /> Alle (Standardeinstellung [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]für)<br /><br /> **Auto** (Standardeinstellung [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]für)<br /><br /> Keine|  
