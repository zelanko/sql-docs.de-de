...
|-----------------|---------------|-----------------|  
|**\<Columns inherited from sys.events>**|Nicht zutreffend|Erbt die Spalten **object_id**, **type**, **type_desc** von [sys.events](../../relational-databases/system-catalog-views/sys-events-transact-sql.md).|  
