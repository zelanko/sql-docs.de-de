...
|**Mit einfacher Genauigkeit**|**tinyint**|Genauigkeit des Parameters, wenn dieser auf Nummern basiert; andernfalls 0.|  
|**Skalieren**|**tinyint**|Skalierung des Parameters, wenn dieser auf Nummern basiert; andernfalls 0.|  
