---
description: Katalogsichten für erweiterte Ereignisse (Transact-SQL)
title: Katalog Sichten für erweiterte Ereignisse (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "88455301"
---
# <a name="extended-events-catalog-views-transact-sql"></a>Katalogsichten für erweiterte Ereignisse (Transact-SQL)
[!INCLUDE[sqlserver](../../includes/applies-to-version/sqlserver.md)]

  Dieser Abschnitt enthält die folgenden Katalogsichten für erweiterte SQL Server-Ereignisse.  
