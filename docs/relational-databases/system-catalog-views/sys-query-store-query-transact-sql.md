...
|-----------------|---------------|-----------------|  
|**query_id**|**BIGINT**|Primärschlüssel|  
...
|**context_settings_id**|**BIGINT**|Fremdschlüssel. Joins mit [sys. query_context_settings &#40;Transact-SQL-&#41;](../../relational-databases/system-catalog-views/sys-query-context-settings-transact-sql.md).<br/>**Hinweis:** Azure SQL Data Warehouse gibt immer 0 (null) zurück.|  
|**object_id**|**BIGINT**|ID des Datenbankobjekts, zu dem die Abfrage gehört (gespeicherte Prozedur, Auslösung, CLR-UDF/UDAgg usw.). 0, wenn die Abfrage nicht als Teil eines Datenbankobjekts (Ad-hoc-Abfrage) ausgeführt wird.<br/>**Hinweis:** Azure SQL Data Warehouse gibt immer 0 (null) zurück.|  
|**batch_sql_handle**|**varbinary (64)**|ID des Anweisungs Batches, zu dem die Abfrage gehört. Wird nur aufgefüllt, wenn die Abfrage auf temporäre Tabellen oder Tabellen Variablen verweist.<br/>**Hinweis:** Azure SQL Data Warehouse gibt immer *null*zurück.|  
...
|**query_parameterization_type**|**tinyint**|Art der Parametrisierung:<br /><br /> 0 - Keine<br /><br /> 1-Benutzer<br /><br /> 2: einfach<br /><br /> 3-erzwungene<br/>**Hinweis:** Azure SQL Data Warehouse gibt immer 0 (null) zurück.|  
|**query_parameterization_type_desc**|**nvarchar (60)**|Die Textbeschreibung für den parameterisierungstyp.<br/>**Hinweis:** Azure SQL Data Warehouse wird immer *None*zurückgegeben.|  
