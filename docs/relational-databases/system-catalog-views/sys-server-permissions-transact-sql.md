...
|**Typ**|**char (4)**|Typ der Serverberechtigung. Eine Liste der Berechtigungstypen finden Sie in der folgenden Tabelle.|  
...
|Berechtigungstyp|Berechtigungs Name|Betroffenes sicherungsfähiges Element|  
|---------------------|---------------------|--------------------------|  
