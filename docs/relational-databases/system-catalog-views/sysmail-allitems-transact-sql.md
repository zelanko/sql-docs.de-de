...
## <a name="remarks"></a>Hinweise  
 Verwenden Sie die **sysmail_allitems** -Ansicht, um den Status aller Nachrichten anzuzeigen, die von Datenbank-E-Mail verarbeitet werden. Wenn Sie Probleme mit der Datenbank-E-Mail behandeln, kann diese Sicht Ihnen helfen, die Ursache des Problems zu identifizieren, da sie die Attribute der gesendeten Nachrichten im Vergleich zu den Attributen der ungesendeten Nachrichten anzeigt.  
