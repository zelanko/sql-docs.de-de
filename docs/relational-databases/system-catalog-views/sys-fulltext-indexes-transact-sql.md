...
> [!NOTE]  
>  Für das Codebeispiel, das diesem Volltextindex erstellt wird, finden Sie im Abschnitt "Beispiele" [CREATE FULLTEXT INDEX &#40;Transact-SQL&#41;](../../t-sql/statements/create-fulltext-index-transact-sql.md).  
