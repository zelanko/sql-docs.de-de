...
|**property_list_id**|**int**|ID der diesem Volltextindex zugeordneten Sucheigenschaftenliste. NULL gibt an, dass dem Volltextindex keine Sucheigenschaftenliste zugeordnet ist. Weitere Informationen zu dieser Such Eigenschaften Liste erhalten Sie, wenn Sie die [sys.registered_search_property_lists &#40;Transact-SQL-&#41;](../../relational-databases/system-catalog-views/sys-registered-search-property-lists-transact-sql.md) -Katalog Sicht verwenden.|  
