---
title: Always On-Verfügbarkeitsgruppen-Katalogsichten (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
> [!NOTE]  
>  Weitere Informationen zu verknüpften verfügbarkeitsdatenbanken finden Sie unter den **Replica_id** und **Group_database_id** Spalten in [sys.databases (Transact-SQL);](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).  
...
## <a name="see-also"></a>Siehe auch  
 ...
 [Always On-Verfügbarkeitsgruppen dynamische Verwaltungssichten und-Funktionen (Transact-SQL)](../system-dynamic-management-views/always-on-availability-groups-dynamic-management-views-functions.md)  
