---
title: system_objects (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|schema_id|**int**|Die ID des Schemas, in dem das Objekt enthalten ist.<br /><br /> Für alle Schemas als Bereiche, die in enthaltenen Systemobjekte [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], diesen Wert werden immer in (schema_id('sys'), schema_id('information_schema')) enthalten|  
