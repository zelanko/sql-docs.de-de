...
|collation_name|**sysname**|Name der Sortierung der Spalte, wenn Zeichen basiert; andernfalls NULL.|  
...
|generated_always_type|**tinyint**|**Gilt für**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] und höher [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)].<br /><br /> Gibt an, wann der Spaltenwert generiert wird (für Spalten in Systemtabellen immer 0):<br /><br /> 0 = NOT_APPLICABLE<br /><br /> 1 = AS_ROW_START<br /><br /> 2 = AS_ROW_END<br /><br /> Weitere Informationen finden Sie unter [relationale &#40;Tabellen relationale Datenbanken&#41;](../../relational-databases/tables/temporal-tables.md).|  
