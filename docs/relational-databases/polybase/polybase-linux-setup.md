---
title: Installieren von PolyBase unter Linux | Microsoft-Dokumentation
...
### <a name="supported-external-data-sources-on-linux"></a>Unterstützte externe Datenquellen unter Linux
