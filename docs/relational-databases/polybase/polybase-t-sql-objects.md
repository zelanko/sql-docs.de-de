...
description: Erstellen Sie externe Tabellen für Ihre externen Daten in Hadoop, Azure Blob Storage, Azure Data Lake Storage, SQL Server, Oracle, Teradata und MongoDB, um PolyBase zu verwenden.
ms.date: 09/24/2018
ms.prod: sql
...
Gilt für: SQL Server (ab 2016), Azure Synapse Analytics, Parallel Data Warehouse
...
**2.** Erstellen einer externen Datenquelle, um auf Azure Data Lake Storage Gen 1 oder 2 zu verweisen**  
