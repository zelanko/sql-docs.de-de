...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  Eine [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] native Client-OLE-DB-Anbietersitzung stellt [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]eine einzelne Verbindung zu einer Instanz von dar.  
 ...
 Im folgenden Beispiel wird [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] veranschaulicht, wie Sie den [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] nativen Client-OLE-DB-Anbieter zum Herstellen einer Verbindung mit einer Datenbank verwenden:  
...
```  
 ...
 Das [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Verbinden von Sitzungsobjekten des nativen Client-OLE-DB-Anbieters mit einer Instanz von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] kann erheblichen Overhead für Anwendungen generieren, die kontinuierlich Sitzungsobjekte erstellen und freigeben. Der Overhead kann minimiert [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] werden, indem Sitzungsobjekte des nativen Client-OLE-DB-Anbieters effizient verwaltet werden. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Native Client-OLE-DB-Anbieteranwendungen können die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Verbindung eines Sitzungsobjekts aktiv halten, indem ein Verweis auf mindestens eine Schnittstelle des Objekts beibehalten wird.  
