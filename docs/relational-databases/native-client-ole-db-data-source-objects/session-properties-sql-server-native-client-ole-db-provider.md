...
ms.locfileid: "37415529"
---
# <a name="session-properties---sql-server-native-client-ole-db-provider"></a>Sitzungseigenschaften: SQL Server Native Client OLE DB-Anbieter
