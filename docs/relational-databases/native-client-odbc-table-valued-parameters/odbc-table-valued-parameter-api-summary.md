---
description: Zusammenfassung der ODBC-Tabellenwertparameter-API
title: ODBC-Table-Valued Parameter-API-Zusammenfassung | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
