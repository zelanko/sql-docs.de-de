...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 > Weitere Informationen, die sich auf vorherige Versionen von SQL Server beziehen, finden Sie unter [Lektion 1: Herstellen einer Verbindung mit der Datenbank-Engine](https://msdn.microsoft.com/library/ms345332(SQL.120).aspx).
