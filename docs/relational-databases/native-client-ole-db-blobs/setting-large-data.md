---
description: Festlegen großer Daten in SQL Server Native Client
...
ms.locfileid: "88328326"
---
# <a name="setting-large-data-in-sql-server-native-client"></a>Festlegen großer Daten in SQL Server Native Client
