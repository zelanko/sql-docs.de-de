...
|**execution_count**|**bigint**|Die Anzahl der Fälle, in denen die gespeicherte Prozedur, seit ausgeführt wurde der letzten Kompilierung.|  
...
|**min_worker_time**|**bigint**|Die minimale CPU-Zeit in Mikrosekunden hat, dass diese gespeicherte Prozedur immer eine einzelne Ausführung verbraucht. <sup>1</sup>|  
...
|**max_physical_reads**|**bigint**|Die maximale Anzahl physischer Lesevorgänge, dass diese gespeicherte Prozedur eine einzelne Ausführung bisherige.<br /><br /> Ist immer 0, wenn eine speicheroptimierte Tabelle abgefragt wird.|  
...
|**last_logical_writes**|**bigint**|Die Anzahl der pufferpoolseiten verschmutzte der letzten Ausführung des Plans. Wenn eine Seite bereits modifiziert (geändert) wurde, werden keine Schreibvorgänge gezählt.<br /><br /> Ist immer 0, wenn eine speicheroptimierte Tabelle abgefragt wird.|  
...
|**total_elapsed_time**|**bigint**|Die insgesamt verstrichene Zeit in Mikrosekunden, die für abgeschlossene Ausführungen dieser gespeicherten Prozedur.|  
