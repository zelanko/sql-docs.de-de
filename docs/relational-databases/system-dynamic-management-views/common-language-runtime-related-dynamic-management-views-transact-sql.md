---
description: Mit CRL (Common Language Runtime) verbundene dynamische Verwaltungssichten Transact-SQL)
title: Dynamische Verwaltungs Sichten im Zusammenhang mit der Common Language Runtime (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "88460476"
---
# <a name="common-language-runtime-related-dynamic-management-views-transact-sql"></a>Mit CRL (Common Language Runtime) verbundene dynamische Verwaltungssichten Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  Dieser Abschnitt enthält die folgenden dynamischen Verwaltungssichten.  
