...
|object_name|**nvarchar(256)**|Der Name des Objekts, zu dem diese Spalte gehört. Es gibt eine n:1-Beziehung mit sys.dm_xe_objects.id. Lässt keine NULL-Werte zu.|  
