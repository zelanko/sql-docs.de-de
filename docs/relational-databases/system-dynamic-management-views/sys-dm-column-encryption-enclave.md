...
## <a name="see-also"></a>Siehe auch  
 [Konfigurieren Sie den Enclave-Typ für Always Encrypted Server Konfigurations Option.](../../database-engine/configure-windows/configure-column-encryption-enclave-type.md)
