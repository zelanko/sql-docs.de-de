...
| **ist\_ausführbare\_Aktion** | **bit** | 1 = die Empfehlung ausgeführt werden kann, für die Datenbank über [!INCLUDE[tsql_md](../../includes/tsql_md.md)] Skript.<br />0 = die Empfehlung kann nicht für die Datenbank ausgeführt werden (z. B.: Informationen nur oder wiederhergestellten Empfehlung) |
