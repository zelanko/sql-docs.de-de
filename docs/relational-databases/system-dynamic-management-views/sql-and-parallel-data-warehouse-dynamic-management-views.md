---
title: SQL und parallele Data Warehouse dynamische Verwaltungs Sichten | Microsoft-Dokumentation
ms.custom: ''
ms.date: 11/05/2019
ms.prod: sql
...
In diesem Thema werden die [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] und [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] dynamischen Verwaltungs Sichten (DMVs) aufgelistet.  
  
 Alle [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] und [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] DMVs beginnen mit **sys. dm_pdw**.  
  
## <a name="includesssdwincludessssdw-mdmd-and-includesspdwincludessspdw-mdmd-dynamic-management-views"></a>dynamische Verwaltungs Sichten [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] und [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
...
## <a name="includesssdwincludessssdw-mdmd-dynamic-management-views"></a>dynamische Verwaltungs Sichten [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] 
 Die folgenden dynamischen Verwaltungs Sichten gelten nur für [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]:
...
## <a name="includesspdwincludessspdw-mdmd-dynamic-management-views"></a>dynamische Verwaltungs Sichten [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
 Die folgenden dynamischen Verwaltungs Sichten gelten nur für [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]:  
