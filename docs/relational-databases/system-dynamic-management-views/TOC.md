# [Übersicht](system-dynamic-management-views.md)  
...
## [sys.dm_operation_status (Azure SQL-Datenbank)](sys-dm-operation-status-azure-sql-database.md)  
...
# [Georeplikation (Azure SQL-Datenbank)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
...
# [E/A](i-o-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [Speicheroptimierte Tabelle](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [Sicherheitsbezogen](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [Serverbezogen](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL Data Warehouse und Parallel Data Warehouse](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
