...
> - Um dies aus [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] oder [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]aufzurufen, verwenden Sie den Namen **sys. dm_pdw_nodes_exec_query_stats**.    
...
|**last_clr_time**|**bigint**|Zeit in Mikrosekunden (aber nur auf Millisekunden genau), die während der letzten Ausführung dieses Plans von der Ausführung innerhalb [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] CLR-Objekte beansprucht wurden. Die CLR-Objekte können gespeicherte Prozeduren, Funktionen, Trigger, Typen und Aggregate sein.|  
