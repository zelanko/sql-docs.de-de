...
|-----------------|---------------|-----------------|  
|**object_id**|**wartenden**|ID der zugrunde liegenden Tabelle.|  
|**index_id**|**wartenden**|ID dieses columnstore--Indexes für *object_id* Tabelle.|  
|**partition_number**|**wartenden**|ID der Tabellen Partition, die *row_group_id*enthält. Sie können partition_number verwenden, um diese DMV mit sys.partitions zu verknüpfen.|  
|**row_group_id**|**wartenden**|ID dieser Zeilen Gruppe. Bei partitionierten Tabellen ist value innerhalb der Partition eindeutig.<br /><br /> -1 für einen in-Memory-Tail.|  
...
|**Land**|**tinyint**|Die *state_description*zugeordnete ID-Nummer.<br /><br /> 0 = INVISIBLE<br /><br /> 1 = OPEN<br /><br /> 2 = CLOSED<br /><br /> 3 = COMPRESSED<br /><br /> 4 = Tombstone<br /><br /> Die Komprimierung ist der einzige Status, der für Tabellen im Arbeitsspeicher gilt.|  
...
|**total_rows**|**bigint**|Die Anzahl von Zeilen, die in der Zeilengruppe physisch gespeichert sind. Für komprimierte Zeilen Gruppen. Schließt die Zeilen ein, die als gelöscht markiert sind.|  
