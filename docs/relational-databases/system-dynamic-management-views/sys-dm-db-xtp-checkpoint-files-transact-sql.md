...
##  <a name="sssql15-and-later"></a><a name="bkmk_2016"></a>[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] und höher  
 In der folgenden Tabelle werden die Spalten `sys.dm_db_xtp_checkpoint_files`für, beginnend **[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]** mit, beschrieben.  
...
##  <a name="sssql14"></a><a name="bkmk_2014"></a> [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]  
 In der folgenden Tabelle werden die Spalten `sys.dm_db_xtp_checkpoint_files`für, **[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]** für beschrieben.  
