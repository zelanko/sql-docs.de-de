...
|**softnuma_configuration_desc**|**nvarchar(60)**|**Gilt für:** [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] bis [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> OFF = Soft-NUMA-Funktion ist deaktiviert<br /><br /> ON = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] bestimmt automatisch die NUMA-Knoten-Größen für Soft-NUMA<br /><br /> MANUELL = manuell konfigurierten Soft-NUMA|
|**process_physical_affinity**|**nvarchar(3072)** |**Gilt für:** ab [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)].<br /><br />Informationen noch bereitgestellt. |
