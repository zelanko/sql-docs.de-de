...
description: Hier erfahren Sie, wie Sie mithilfe von SQL Server Management Studio oder Transact-SQL den Resource Governor aktivieren. Sie müssen die Berechtigung „CONTROL SERVER“ besitzen.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
ms.reviewer: ''
