...
description: Hier erfahren Sie, wie Sie mithilfe von SQL Server Management Studio oder Transact-SQL Ressourcenpooleinstellungen ändern. Sie müssen die Berechtigung „CONTROL SERVER“ besitzen.
ms.custom: ''
ms.date: 03/17/2016
ms.prod: sql
ms.reviewer: ''
