---
description: SQL Server Native Client Spalten-und Katalog Metadaten für sparsespalten anzeigen (OLE DB).
title: Metadaten für sparsespalten (OLE DB)
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.locfileid: "97469471"
---
# <a name="sql-server-native-client-display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a>SQL Server Native Client Spalten-und Katalog Metadaten für sparsespalten anzeigen (OLE DB).
