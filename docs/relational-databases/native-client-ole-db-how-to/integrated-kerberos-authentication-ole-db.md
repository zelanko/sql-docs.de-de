---
description: Integrierte Kerberos-Authentifizierung (Native Client OLE DB-Anbieter)
title: Integrierte Kerberos-Authentifizierung (Native Client OLE DB-Anbieter) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97481101"
---
# <a name="integrated-kerberos-authentication-native-client-ole-db-provider"></a>Integrierte Kerberos-Authentifizierung (Native Client OLE DB-Anbieter)
