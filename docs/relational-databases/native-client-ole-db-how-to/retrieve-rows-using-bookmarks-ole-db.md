---
description: Abrufen von Zeilen mithilfe von Lesezeichen (Native Client OLE DB-Anbieter)
title: Abrufen von Zeilen mithilfe von Lesezeichen (Native Client OLE DB-Anbieter)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97483211"
---
# <a name="retrieve-rows-using-bookmarks-native-client-ole-db-provider"></a>Abrufen von Zeilen mithilfe von Lesezeichen (Native Client OLE DB-Anbieter)
