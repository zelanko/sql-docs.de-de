---
description: Verwenden erweiterter Datums-und Uhrzeit Funktionen in SQL Server Native Client (OLE DB)
title: Verwenden erweiterter Datums-und Uhrzeit Funktionen (Native Client OLE DB-Anbieter)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88407976"
---
# <a name="use-enhanced-date-and-time-features-in-sql-server-native-client-ole-db"></a>Verwenden erweiterter Datums-und Uhrzeit Funktionen in SQL Server Native Client (OLE DB)
