---
description: Senden von Daten an eine FILESTREAM-Spalte mithilfe von IRowsetFastUpload SQL Server Native Client (OLE DB)
...
ms.locfileid: "88455732"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-sql-server-native-client-ole-db"></a>Senden von Daten an eine FILESTREAM-Spalte mithilfe von IRowsetFastUpload SQL Server Native Client (OLE DB)
