---
description: Senden von Daten an FileStream in SQL Server Native Client-ISequentialStream, der an ICommandText gebunden ist
title: Daten FileStream, ISequentialStream ICommandText
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97481111"
---
# <a name="send-data-to-filestream-in-sql-server-native-client---isequentialstream-bound-to-icommandtext"></a>Senden von Daten an FileStream in SQL Server Native Client-ISequentialStream, der an ICommandText gebunden ist
