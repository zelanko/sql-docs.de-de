---
description: Abrufen von Daten aus einer FILESTREAM-Spalte mithilfe von ISequentialStream in SQL Server Native Client (OLE DB)
title: FileStream mithilfe von ISequentialStream (OLE DB)
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
...
ms.locfileid: "88455731"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-in-sql-server-native-client-ole-db"></a>Abrufen von Daten aus einer FILESTREAM-Spalte mithilfe von ISequentialStream in SQL Server Native Client (OLE DB)
