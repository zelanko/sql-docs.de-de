---
description: Lesen einer FILESTREAM-Spalte in eine Datei mithilfe von IBCPSession in SQL Server Native Client (OLE DB)
...
ms.locfileid: "97464901"
---
# <a name="read-a-filestream-column-to-file-using-ibcpsession-in-sql-server-native-client-ole-db"></a>Lesen einer FILESTREAM-Spalte in eine Datei mithilfe von IBCPSession in SQL Server Native Client (OLE DB)
