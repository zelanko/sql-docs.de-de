...
1.  Rufen Sie optional [SQLSetStmtAttr](../../../relational-databases/native-client-odbc-api/sqlsetstmtattr.md) mit SQL_ROW_ARRAY_SIZE auf, um die Anzahl der Zeilen (R) im Rowset zu ändern.  
