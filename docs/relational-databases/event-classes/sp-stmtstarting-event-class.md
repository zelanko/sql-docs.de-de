...
|EventClass|**ssNoversion**|Ereignistyp = 44.|27|Nein|  
...
|Status|**ssNoversion**|Zeigt an, ob die Ausführung der Anweisung nach einer Neukompilierung erfolgt.<br /><br /> 1 = Erneut kompiliert|30|Ja|  
