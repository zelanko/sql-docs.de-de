...
|EventClass|**ssNoversion**|Ereignistyp = 51.|27|Nein|  
...
|IndexID|**ssNoversion**|Der Index, der gescannt wird (falls es sich um einen Index handelt).|24|Ja|  
...
|ObjectID|**ssNoversion**|Vom System zugewiesene ID des gescannten Objekts.|22|Ja|  
