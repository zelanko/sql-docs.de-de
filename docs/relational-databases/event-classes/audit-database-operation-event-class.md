...
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = CHECKPOINT<br /><br /> 2 = SUBSCRIBE QUERY NOTIFICATIONS|21|Benutzerkontensteuerung|  
