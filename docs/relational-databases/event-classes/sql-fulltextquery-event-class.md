...
|Fehler|**ssNoversion**|Die Fehlermeldungsnummer.|31|Ja|  
|EventClass|**ssNoversion**|Typ des aufgezeichneten Ereignisses = 123.|27|Nein|  
...
|IntegerData|**ssNoversion**|Die Anzahl der zurückgegebenen Zeilen. Wenn die Abfrage einen Fehler zurückgibt, ist der Wert NULL. Wenn die Abfrage keine Zeilen zurückgibt, ist der Wert 0.|25|Ja|  
...
|ObjectID|**ssNoversion**|Vom System zugewiesene ID des Ziels.|22|Ja|  
