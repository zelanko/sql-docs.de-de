...
|**IndexID**|**ssNoversion**|Die ID für den Index-/Statistikeintrag des Objekts, das von dem Ereignis betroffen ist. Um die Index-ID für ein Objekt zu ermitteln, verwenden Sie die **index_id** -Spalte der Katalogsicht **sys.indexes** .|24|Ja|  
|**IntegerData**|**ssNoversion**|Anzahl von Statistikauflistungen, die erfolgreich aktualisiert wurden|25|Ja|  
...
|**Success**|**ssNoversion**|0 = Fehler<br /><br /> 1 = Erfolg<br /><br /> 2 = Aufgrund von Servereinschränkung ausgelassen (MSDE)|23|Ja|  
