...
|EventSubClass|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Einzelner Durchlauf. Als die Sortiertabelle auf den Datenträger geschrieben wurde, war für die sortierte Ausgabe nur ein einzelner zusätzlicher Datendurchlauf erforderlich.<br /><br /> 2 = Mehrere Durchläufe. Als die Sortiertabelle auf den Datenträger geschrieben wurde, waren für die sortierte Ausgabe mehrere Datendurchläufe erforderlich.|21|Benutzerkontensteuerung|  
...
|IsSystem|**int**|Gibt an, ob das Ereignis bei einem Systemprozess oder einem Benutzerprozess aufgetreten ist. 1 = System, NULL = Benutzer.|60|Benutzerkontensteuerung|  
