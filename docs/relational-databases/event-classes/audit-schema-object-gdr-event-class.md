...
|**ColumnPermissions**|**int**|Zeigt an, ob eine Spaltenberechtigung festgelegt wurde. Analysieren Sie den Text der Anweisung, um genau zu ermitteln, welche Berechtigungen auf welche Spalten angewendet wurden. 1=Ja, 0=Nein.|44|Benutzerkontensteuerung|  
...
|**ObjectName**|**nvarchar**|Name des Objekts, das das Ziel der Anweisung GRANT, REVOKE oder DENY ist.|34|Benutzerkontensteuerung|  
