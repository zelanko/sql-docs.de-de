...
|**ObjectID**|**ssNoversion**|Assembly-ID|22|Ja|  
...
|**Success**|**ssNoversion**|Gibt an, ob der Assemblyladevorgang erfolgreich ausgeführt wurde (1) oder ob ein Fehler gemeldet wurde (0)|23|Ja|  
