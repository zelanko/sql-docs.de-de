...
|**DatabaseName**|**nvarchar**|Name der Datenbank, in der die Anwendungsrolle geändert wird.|35|Benutzerkontensteuerung|  
...
|**RoleName**|**nvarchar**|Name der Anwendungsrolle.|38|Benutzerkontensteuerung|  
