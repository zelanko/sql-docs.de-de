...
|**EventClass**|**ssNoversion**|Typ des aufgezeichneten Ereignisses = 75.|27|Nein|  
|**EventSequence**|**ssNoversion**|Sequenz der **CursorRecompile** -Ereignisklasse im Batch.|51|Nein|  
...
|**RequestID**|**ssNoversion**|Die Anforderungs-ID, von der der Cursor erneut kompiliert wurde.|49|Ja|  
