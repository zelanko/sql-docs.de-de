...
|**EventClass**|**ssNoversion**|Typ des aufgezeichneten Ereignisses = 94.|27|Nein|  
|**EventSequence**|**ssNoversion**|Die Sequenz der Ereignisklasse im Batch.|51|Nein|  
...
|**IntegerData**|**ssNoversion**|Die Anzahl an 8-KB-Seiten, um die die Datei verkleinert wurde.|25|Ja|  
