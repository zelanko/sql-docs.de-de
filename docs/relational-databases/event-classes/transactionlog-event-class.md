...
|ClientProcessID|**int**|Die ID, die der Hostcomputer dem Prozess zuweist, in dem die Clientanwendung ausgeführt wird. Diese Datenspalte wird aufgefüllt, wenn der Client den Clientprozess bereitstellt.|9|Benutzerkontensteuerung|  
|DatabaseID|**int**|ID der Datenbank, in der die Daten protokolliert werden.|3|Benutzerkontensteuerung|  
...
|EventSubClass|**int**|Der Typ der Ereignisunterklasse.|21|Benutzerkontensteuerung|  
