...
|**EventClass**|**ssNoversion**|Der Typ der aufgezeichneten Ereignisklasse. Für **Broker:Message Ack** lautet der Typ immer **149**.|27|Nein|  
...
|**IntegerData**|**ssNoversion**|Die Fragmentnummer der Nachricht, die die Bestätigung enthält.|25|Nein|  
|**IntegerData2**|**ssNoversion**|Die Fragmentnummer der Nachricht, die bestätigt wird.|55|Nein|  
...
|**StarvationElevation**|**ssNoversion**|Die Nachricht wurde mit einer höheren Priorität gesendet als die Priorität, die für die Konversation konfiguriert wurde: 0 = FALSE, 1 = TRUE.|33|Ja|  
