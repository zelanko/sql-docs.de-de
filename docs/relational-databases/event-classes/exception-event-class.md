...
|Fehler|**int**|Die Fehlernummer des Ereignisses.|31|Benutzerkontensteuerung|  
...
|Status|**int**|Der Status des Servers.|30|Benutzerkontensteuerung|  
