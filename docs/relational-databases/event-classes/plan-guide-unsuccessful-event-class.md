...
|EventClass|**ssNoversion**|Ereignistyp = 218.|27|Nein|  
...
|ObjectID|**ssNoversion**|Objekt-ID des Moduls, das kompiliert wurde, als die Planhinweisliste angewendet wurde. Falls die Planhinweisliste auf kein Modul angewendet wurde, wird diese Spalte auf NULL festgelegt.|22|Ja|  
