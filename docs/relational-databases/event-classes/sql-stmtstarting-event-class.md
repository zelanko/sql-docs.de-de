...
|NestLevel|**int**|Die Schachtelungsebene der gespeicherten Prozedur, wenn die SQL-Anweisung innerhalb einer gespeicherten Prozedur ausgeführt wurde.|29|Benutzerkontensteuerung|  
...
|TextData|**ntext**|Der Text der Anweisung, die ausgeführt werden soll.|1|Benutzerkontensteuerung|  
