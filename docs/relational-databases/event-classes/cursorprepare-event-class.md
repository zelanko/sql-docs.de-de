...
|**EventClass**|**ssNoversion**|Typ des aufgezeichneten Ereignisses = 70.|27|Nein|  
|**EventSequence**|**ssNoversion**|Sequenznummer der **CursorPrepare** -Ereignisklasse in einem Batch.|51|Nein|  
|**GroupID**|**ssNoversion**|ID der Arbeitsauslastungsgruppe, in der das SQL-Ablaufverfolgungsereignis ausgelöst wird.|66|Ja|  
|**Handle**|**ssNoversion**|Handle der Ereignisklasse.|33|Ja|  
...
|**RequestID**|**ssNoversion**|ID der Anforderung, die den Cursor vorbereitet hat.|49|Ja|  
