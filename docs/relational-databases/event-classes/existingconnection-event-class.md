---
description: ExistingConnection (Ereignisklasse)
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Audit Login (Ereignisklasse)](../../relational-databases/event-classes/audit-login-event-class.md)  
