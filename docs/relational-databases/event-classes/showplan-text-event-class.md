...
|Ereignisklasse|**ssNoversion**|Ereignistyp = 96.|27|Nein|  
...
|LineNumber|**ssNoversion**|Zeigt die Nummer der Zeile an, die den Fehler enthält|5|Ja|  
...
|NestLevel|**ssNoversion**|Ganze Zahl, die die von @@NESTLEVEL zurückgegebenen Daten darstellt.|29|Ja|  
...
|ObjectType|**ssNoversion**|Der Wert, der den Typ des am Ereignis beteiligten Objekts darstellt. Dieser Wert entspricht der type-Spalte in sys.objects. Weitere Werte finden Sie unter [ObjectType (Spalte für Ablaufverfolgungsereignisse)](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Ja|  
|RequestID|**ssNoversion**|Die Anforderungs-ID, von der die Volltextabfrage initiiert wurde.|49|Ja|  
