...
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Standarddatenbank geändert<br /><br /> 2 = Standardsprache geändert<br /><br /> 3 = Name geändert<br /><br /> 4 = Anmeldeinformationen geändert<br /><br /> 5 = Richtlinie wurde geändert<br /><br /> 6 = Ablauf geändert|21|Benutzerkontensteuerung|  
