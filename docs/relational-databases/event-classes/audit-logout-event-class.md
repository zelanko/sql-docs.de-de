...
|**CPU**|**ssNoversion**|CPU-Zeit (in Millisekunden), die vom Benutzer während der Verbindung verwendet wurde.|18|Ja|  
...
|**EventClass**|**ssNoversion**|Ereignistyp = 15.|27|Nein|  
