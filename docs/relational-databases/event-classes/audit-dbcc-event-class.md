...
|**ColumnPermissions**|**int**|Zeigt an, ob eine Spaltenberechtigung festgelegt wurde. Analysieren Sie den Text der Anweisung, um genau zu ermitteln, welche Berechtigungen auf welche Spalten angewendet wurden.|44|Benutzerkontensteuerung|  
...
||||||  
||||||  
|**TextData**|**ntext**|SQL-Text des DBCC-Befehls.|1|Benutzerkontensteuerung|  
