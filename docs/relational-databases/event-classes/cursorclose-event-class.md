...
|**EventClass**|**ssNoversion**|Typ des aufgezeichneten Ereignisses = 78.|27|Nein|  
|**EventSequence**|**ssNoversion**|Sequenz der **CursorClose** -Ereignisklasse im Batch.|51|Nein|  
