...
|**Handle**|**int**|Das Handle des Objekts, auf das im Ereignis verwiesen wird.|33|Benutzerkontensteuerung|  
...
|**RequestID**|**int**|Die Anforderungs-ID, von der der Cursor geschlossen wurde.|49|Benutzerkontensteuerung|  
