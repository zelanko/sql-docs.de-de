...
|EventClass|**ssNoversion**|Ereignistyp = 71.|27|Nein|  
...
|Handle|**ssNoversion**|Handle der vorbereiteten [!INCLUDE[tsql](../../includes/tsql-md.md)] -Anweisung.|33|Ja|  
