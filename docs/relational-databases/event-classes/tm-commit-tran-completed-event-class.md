...
## <a name="tm-commit-tran-completed-event-class-data-columns"></a>TM: Commit Tran Completed-Ereignisklasse (Datenspalten)  
...
|EventClass|**ssNoversion**|Ereignistyp = 186.|27|Nein|  
|EventSequence|**ssNoversion**|Die Sequenz eines bestimmten Ereignisses innerhalb der Anforderung.|51|Nein|  
|EventSubClass|**ssNoversion**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Commit<br /><br /> 2 = Commit und Start|21|Ja|  
