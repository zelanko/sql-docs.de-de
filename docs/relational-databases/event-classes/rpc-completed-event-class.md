...
|CPU|**ssNoversion**|Die CPU-Zeit, die vom Ereignis verwendet wurde. In Mikrosekunden ab [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]. In früheren Versionen in Millisekunden.|18|Ja|  
...
|Fehler|**ssNoversion**|Fehlernummer eines bestimmten Ereignisses.<br /><br /> 0 = OK<br /><br /> 1 = Fehler<br /><br /> 2 = Abbruch<br /><br /> 3 = Ausgelassen|31|Ja|  
|EventClass|**ssNoversion**|Ereignistyp = 10.|27|Nein|  
