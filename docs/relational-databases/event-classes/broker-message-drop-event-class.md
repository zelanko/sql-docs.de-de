...
|**EventClass**|**ssNoversion**|Der Typ der aufgezeichneten Ereignisklasse. Für **Broker:MessageUndeliverable** lautet der Typ immer **160**.|27|Nein|  
...
|**IntegerData**|**ssNoversion**|Die Fragmentnummer der unzustellbaren Nachricht.|25|Nein|  
|**IntegerData2**|**ssNoversion**|Die Nachrichtenfragmentnummer, die die unzustellbare Nachricht bestätigen sollte.|55|Nein|  
...
|**Severity**|**ssNoversion**|Schweregradnummer für den Text im Ereignis.|29|Nein|  
