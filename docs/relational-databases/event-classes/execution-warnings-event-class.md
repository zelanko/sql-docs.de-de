...
|Duration|**bigint**|Wartezeit der Abfrage (in Millisekunden) bis zur Verfügbarkeit des erforderlichen Arbeitsspeichers. Dies gilt nur, wenn EventSubClass = 1 (Abfragewartezeit).|13|Benutzerkontensteuerung|  
|Fehler|**int**|Wird nicht verwendet.|31|Benutzerkontensteuerung|  
...
|EventSubClass|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1=Abfragewartezeit<br /><br /> 2=Abfragetimeout|21|Benutzerkontensteuerung|  
