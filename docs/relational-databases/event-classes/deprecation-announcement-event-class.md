...
|EventClass|**ssNoversion**|Ereignistyp = 125.|27|Nein|  
...
|IntegerData2|**ssNoversion**|Endoffset (in Bytes) der Anweisung, die gerade ausgeführt wird.|55|Ja|  
...
|ObjectID|**ssNoversion**|Die ID der veralteten Funktion.|22|Ja|  
