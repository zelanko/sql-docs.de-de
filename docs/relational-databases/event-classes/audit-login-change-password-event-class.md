...
ms.locfileid: "47686891"
---
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password-Ereignisklasse
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Die **Audit Login Change Password** -Ereignisklasse tritt auf, wenn ein Benutzer sein Anmeldekennwort für [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ändert.  
...
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Kennwort automatisch geändert<br /><br /> 2 = Kennwort geändert<br /><br /> 3 = Kennwort automatisch zurückgesetzt<br /><br /> 4 = Kennwort zurückgesetzt<br /><br /> 5 = Kennwortsperre aufgehoben<br /><br /> 6 = Kennwort muss geändert werden|21|Benutzerkontensteuerung|  
