...
|CPU|**ssNoversion**|CPU-Zeit (in Millisekunden), die vom Batch benötigt wird.|18|Ja|  
...
|Fehler|**ssNoversion**|Die Fehlernummer des Ereignisses.<br /><br /> 0 = OK<br /><br /> 1 = Fehler<br /><br /> 2 = Abbruch|31|Ja|  
|EventClass|**ssNoversion**|Ereignistyp = 12.|27|Nein|  
