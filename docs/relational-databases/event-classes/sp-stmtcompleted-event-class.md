...
|CPU|**ssNoversion**|Die CPU-Zeit (in Millisekunden), die vom Ereignis verwendet wurde.|18|Ja|  
...
|EventClass|**ssNoversion**|Ereignistyp = 45.|27|Nein|  
...
|LineNumber|**ssNoversion**|Die Zeilennummer der Anweisung, die gerade ausgeführt wird.|5|Ja|  
...
|SourceDatabaseID|**ssNoversion**|Die ID der Datenbank, in der das Objekt vorhanden ist.|62|Ja|  
