...
|EventClass|**ssNoversion**|Der Typ der aufgezeichneten Ereignisklasse. Für Broker:Forwarded Message Dropped lautet der Typ immer 191.|27|Nein|  
...
|ObjectID|**ssNoversion**|Der Gültigkeitsdauerwert der weitergeleiteten Nachricht.|22|Nein|  
...
|Schweregrad|**ssNoversion**|Schweregradnummer für den Text im Ereignis.|29|Nein|  
...
|Success|**ssNoversion**|Die Zeitdauer, für die die Nachricht gültig war. Wenn dieser Wert größer oder gleich der Gültigkeitsdauer ist, wird die Nachricht gelöscht.|23|Nein|  
