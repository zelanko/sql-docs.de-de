...
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse.<br /><br /> 1=Beginn des Überlaufs<br /><br /> 2=Ende des Überlaufs|21|Benutzerkontensteuerung|  
...
|**LoginSid**|**image**|Sicherheits-ID (SID) des angemeldeten Benutzers. Sie finden diese Informationen in der **syslogins** -Tabelle der **master** -Datenbank. Die SID ist für jede Anmeldung beim Server eindeutig.|41|Benutzerkontensteuerung|  
...
|**ObjectID**|**int**|Vom System zugewiesene ID des Objekts. Entspricht der Knoten-ID in Showplans.|22|Benutzerkontensteuerung|  
