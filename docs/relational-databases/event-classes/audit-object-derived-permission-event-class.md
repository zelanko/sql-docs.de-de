...
|**ObjectName**|**nvarchar**|Name des Objekts, das erstellt, geändert oder gelöscht wird|34|Benutzerkontensteuerung|  
...
|**OwnerName**|**nvarchar**|Datenbank-Benutzername des Objektbesitzers des Objekts, das erstellt, geändert oder gelöscht wird|37|Benutzerkontensteuerung|  
