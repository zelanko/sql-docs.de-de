...
|**EventClass**|**ssNoversion**|Typ des aufgezeichneten Ereignisses = 53.|27|Nein|  
|**EventSequence**|**ssNoversion**|Die Sequenz der **CursorOpen** -Ereignisklasse im Batch.|51|Nein|  
|**GroupID**|**ssNoversion**|ID der Arbeitsauslastungsgruppe, in der das SQL-Ablaufverfolgungsereignis ausgelöst wird.|66|Ja|  
|**Handle**|**ssNoversion**|Eine ganze Zahl, die von ODBC, OLE DB oder DB-Library zum Koordinieren der Ausführung mit dem Server verwendet wird.|33|Ja|  
|**HostName**|**nvarchar**|Der Name des Computers, auf dem der Client ausgeführt wird. Diese Datenspalte wird aufgefüllt, wenn der Hostname vom Client bereitgestellt wird. Der Hostname kann mithilfe der HOST_NAME-Funktion bestimmt werden.|8|Ja|  
|**IntegerData**|**ssNoversion**|Cursortyp. Die Werte sind:<br /><br /> 1 = Keyset<br /><br /> 2 = Dynamisch<br /><br /> 4 = Vorwärtscursor<br /><br /> 8 = Statisch<br /><br /> 16 = Schneller Vorlauf|25|Ja|  
...
|**RequestID**|**ssNoversion**|Die Anforderungs-ID, von der der Cursor geöffnet wurde.|49|Ja|  
