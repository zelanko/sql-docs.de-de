...
ms.locfileid: "68125126"
---
# <a name="tm-promote-tran-completed-event-class"></a>TM: Promote Tran Completed (Ereignisklasse)
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Die TM: Die Promote Tran Completed-Ereignisklasse zeigt an, dass eine PROMOTE TRANSACTION-Anforderung abgeschlossen wurde. Die Anforderung wird vom Client über die Schnittstelle für die Transaktionsverwaltung gesendet.  
  
## <a name="tm-promote-tran-completed-event-class-data-columns"></a>TM: Promote Tran Completed-Ereignisklasse – Datenspalten  
