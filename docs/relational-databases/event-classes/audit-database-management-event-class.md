...
|**EventSubClass**|**ssNoversion**|Der Typ der Ereignisunterklasse.<br /><br /> 1 = Erstellen<br /><br /> 2 = Ändern<br /><br /> 3 = Löschen<br /><br /> 4 = Sichern<br /><br /> 11 = Laden|21|Ja|  
...
|**ObjectType**|**ssNoversion**|Der Wert, der den Typ des am Ereignis beteiligten Objekts darstellt. Dieser Wert entspricht der type-Spalte in der **sysobjects** -Tabelle. Weitere Werte finden Sie unter [ObjectType (Spalte für Ablaufverfolgungsereignisse)](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Ja|  
...
|**Success**|**ssNoversion**|1 = Erfolg 0 = Fehler. Beispielsweise gibt der Wert 1 den Erfolg einer Berechtigungsüberprüfung und 0 einen Fehler bei dieser Überprüfung an.|23|Ja|  
