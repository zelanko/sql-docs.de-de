...
|EventSubClass|**nvarchar**|Der Typ der Ereignisunterklasse, der weitere Informationen zu jeder Ereignisklasse liefert. Diese Spalte kann die folgenden Werte enthalten:<br /><br /> **Subscription registered** (Abonnement registriert): Gibt an, ob das Abfragebenachrichtigungsabonnement erfolgreich in der Datenbank registriert wurde.<br /><br /> **Subscription rewound** (Abonnementduplikat): Gibt an, ob [!INCLUDE[ssDE](../../includes/ssde-md.md)] eine Abonnementanforderung erhält, die genau mit einem bereits vorhandenen Abonnement übereinstimmt. In diesem Fall legt [!INCLUDE[ssDE](../../includes/ssde-md.md)] für den Timeoutwert des vorhandenen Abonnements den in der neuen Abonnementanforderung festgelegten Timeoutwert fest.<br /><br /> **Subscription fired** (Abonnement ausgelöst): Gibt an, ob ein Benachrichtigungsabonnement eine Benachrichtigungsmeldung auslöst.<br /><br /> **Firing failed with broker error** (Ausführung mit einem Brokerfehler fehlgeschlagen): Gibt an, ob eine Benachrichtigungsmeldung aufgrund eines [!INCLUDE[ssSB](../../includes/sssb-md.md)]-Fehlers nicht ausgeführt werden konnte.<br /><br /> **Firing failed without broker error** (Ausführung ohne Brokerfehler fehlgeschlagen): Gibt an, ob eine Benachrichtigungsmeldung nicht ausgeführt werden kann, aber kein [!INCLUDE[ssSB](../../includes/sssb-md.md)]-Fehler aufgetreten ist.<br /><br /> **Broker error intercepted** (Brokerfehler abgefangen): Gibt an, dass [!INCLUDE[ssSB](../../includes/sssb-md.md)] in der von der Abfragebenachrichtigung verwendeten Konversation einen Fehler übermittelt hat.<br /><br /> **Subscription deletion attempt** (Abonnementlöschversuch): Gibt an, dass [!INCLUDE[ssDE](../../includes/ssde-md.md)] versucht hat, ein abgelaufenes Abonnement zu löschen, um Ressourcen freizugeben.<br /><br /> **Subscription deletion failed** (Fehler beim Löschen des Abonnements): Gibt an, dass beim Löschen eines abgelaufenen Abonnements ein Fehler aufgetreten ist. Die Löschung des Abonnements wird in [!INCLUDE[ssDE](../../includes/ssde-md.md)] automatisch erneut geplant, um Ressourcen frei zu geben.<br /><br /> **Subscription destroyed** (Abonnement gelöscht): Gibt an, dass [!INCLUDE[ssDE](../../includes/ssde-md.md)] erfolgreich ein abgelaufenes Abonnement gelöscht hat.|21|Ja|  
