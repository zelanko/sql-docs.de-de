...
|**BinaryData**|**image**|Der Nachrichtentext der Nachricht.|2|Benutzerkontensteuerung|  
...
|**IntegerData**|**int**|Die Fragmentnummer dieser Nachricht.|25|Benutzerkontensteuerung|  
...
|**TextData**|**ntext**|Beschreibung der erkannten Beschädigung|1|Benutzerkontensteuerung|  
