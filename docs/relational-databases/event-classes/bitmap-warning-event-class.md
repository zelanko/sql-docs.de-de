...
|**EventSubClass**|**int**|Der Typ der Ereignisunterklasse. 0 = Bitmapfilter ist deaktiviert.|21|Benutzerkontensteuerung|  
...
|**LoginName**|**nvarchar**|Anmeldename des Benutzers ( [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Sicherheitsanmeldung oder Windows-Anmeldeinformationen im Format *DOMAIN\Benutzername*).|11|Benutzerkontensteuerung|  
...
|**ObjectID**|**int**|Die Knoten-ID des Stammes vom an der Neupartition beteiligten Hashteam. Entspricht der Knoten-ID im Showplan.|22|Benutzerkontensteuerung|  
