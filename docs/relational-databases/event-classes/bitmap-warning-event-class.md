...
|**EventClass**|**ssNoversion**|Ereignistyp = 212.|27|Nein|  
|**EventSequence**|**ssNoversion**|Sequenz eines bestimmten Ereignisses innerhalb der Anforderung.|51|Nein|  
|**EventSubClass**|**ssNoversion**|Der Typ der Ereignisunterklasse. 0 = Bitmapfilter ist deaktiviert.|21|Ja|  
...
|**ObjectID**|**ssNoversion**|Die Knoten-ID des Stammes vom an der Neupartition beteiligten Hashteam. Entspricht der Knoten-ID im Showplan.|22|Ja|  
