...
|ObjectName|**nvarchar**|Der Name des Parameters, auf den verwiesen wird|34|Benutzerkontensteuerung|  
...
|TextData|**ntext**|Ausgabeparameterwerte des Remoteprozeduraufrufs|1|Benutzerkontensteuerung|  
