...
|IntegerData|**int**|Die Ereignissequenznummer des korrespondierenden Begin-Ereignisses. Diese Spalte ist nur für den Commit- und Rollback-Typ der Ereignisunterklasse verfügbar.|25|Benutzerkontensteuerung|  
...
|ObjectID2|**bigint**|Die Partitionsfunktions-ID beim Ändern des Partitionsschemas, die Warteschlangen-ID beim Ändern des Dienstes, oder die Sammlungsschema-ID beim Ändern des XML-Schemas.|56|Benutzerkontensteuerung|  
...
|RequestID|**int**|Die ID der Batchanforderung, die die Anweisung enthält.|49|Benutzerkontensteuerung|  
