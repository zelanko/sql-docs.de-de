...
|**Success**|**int**|1 = Erfolg 0 = Fehler. Der Wert 1 gibt z. B. den Erfolg einer Berechtigungsüberprüfung und der Wert 0 einen Fehlschlag bei dieser Überprüfung an.|23|Benutzerkontensteuerung|  
