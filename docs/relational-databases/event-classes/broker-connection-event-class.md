...
|**Fehler**|**ssNoversion**|Die Nachrichten-ID-Nummer in **sys.messages** für den Text des Ereignisses. Wenn dieses Ereignis einen Fehler meldet, ist dies die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Fehlernummer.|31|Nein|  
|**EventClass**|**ssNoversion**|Der Typ der aufgezeichneten Ereignisklasse. Für **Broker:Connection** lautet der Typ immer **138**.|27|Nein|  
...
|**IntegerData**|**ssNoversion**|Die Angabe, wie oft diese Verbindung geschlossen wurde.|25|Ja|  
