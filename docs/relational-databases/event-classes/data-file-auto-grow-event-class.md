...
|**EventClass**|**ssNoversion**|Ereignistyp = 92.|27|Nein|  
...
|**IntegerData**|**ssNoversion**|Die Anzahl von 8-KB-Seiten, um die die Datei vergrößert wurde.|25|Ja|  
