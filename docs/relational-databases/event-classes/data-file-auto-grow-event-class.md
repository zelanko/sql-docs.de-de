...
|**Dauer**|**bigint**|Die erforderliche Zeitdauer (in Millisekunden), um die Datei zu vergrößern.|13|Benutzerkontensteuerung|  
|**EndTime**|**datetime**|Der Zeitpunkt, zu dem die automatische Vergrößerung der Datendatei beendet wurde.|18|Benutzerkontensteuerung|  
|**EventClass**|**int**|Ereignistyp = 92.|27|nein|  
|**EventSequence**|**int**|Die Sequenz der **CursorClose** -Ereignisklasse im Stapel.|51|nein|  
|**Filename**|**nvarchar**|Der logische Name der zu vergrößernden Datei.|36|Benutzerkontensteuerung|  
...
|**IntegerData**|**int**|Die Anzahl von 8-KB-Seiten, um die die Datei vergrößert wurde.|25|Benutzerkontensteuerung|  
...
|**NTDomainName**|**nvarchar**|[!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows-Domäne, zu der der Benutzer gehört.|7|Benutzerkontensteuerung|  
