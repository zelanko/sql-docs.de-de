...
|Code Zugriffssicherheit|Nur ausführen|Ausführen + Zugriff auf externe Ressourcen|Unrestricted|  
...
## <a name="see-also"></a>Siehe auch  
 Sicherheits  für die [CLR-Integration](../../relational-databases/clr-integration/security/clr-integration-security.md)  
