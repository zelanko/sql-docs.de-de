...
|**Eventlogberechtigung**|**Verwalten:** Folgende Aktionen sind zulässig: Erstellen einer Ereignis Quelle, lesen vorhandener Protokolle, Löschen von Ereignis Quellen oder Protokollen, reagieren auf Einträge, Löschen eines Ereignis Protokolls, lauschen auf Ereignisse und Zugreifen auf eine Auflistung aller Ereignisprotokolle.|  
...
|**Networkinformationberechtigung**|**Zugriff:** Pingen ist zulässig.|  
