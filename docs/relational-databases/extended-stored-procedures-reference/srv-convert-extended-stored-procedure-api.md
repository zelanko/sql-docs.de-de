...
description: Erfahren Sie, wie srv_convert in der API für erweiterte gespeicherte Prozeduren Daten von einem Datentyp in einen anderen ändern.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
