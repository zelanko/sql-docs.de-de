...
description: Erfahren Sie, wie srv_parammaxlen die maximale Daten Länge eines Aufrufparameters für eine remote gespeicherte Prozedur zurückgibt.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
