...
description: Erfahren Sie, wie die Datenbank-Engine erweiterten gespeicherten Prozeduren eine serverbasierte Anwendungsprogrammierschnittstelle (Application Programming Interface, API) zum Erweitern SQL Server Funktionen bereitstellen.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
:::row:::
    :::column:::
        [Datentypen](../../relational-databases/extended-stored-procedures-reference/data-types-extended-stored-procedure-api.md)
    :::column-end:::
    :::column:::
