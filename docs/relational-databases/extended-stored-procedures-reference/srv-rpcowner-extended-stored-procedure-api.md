...
description: Erfahren Sie, wie srv_rpcowner in der API für erweiterte gespeicherte Prozeduren die Besitzer Komponente für die aktuelle remote gespeicherte Prozedur zurückgibt.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
