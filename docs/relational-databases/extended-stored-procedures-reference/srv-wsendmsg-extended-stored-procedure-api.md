...
description: Erfahren Sie, wie srv_wsendmsg in der API für erweiterte gespeicherte Prozeduren eine Unicode-Nachricht an den Client senden kann.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
