...
description: Erfahren Sie, wie srv_paramname in der API für erweiterte gespeicherte Prozeduren den Namen eines Aufrufparameters für eine remote gespeicherte Prozedur zurückgibt.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
