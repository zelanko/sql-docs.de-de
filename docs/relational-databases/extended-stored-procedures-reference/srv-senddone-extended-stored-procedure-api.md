...
description: Erfahren Sie, wie srv_senddone in der API für erweiterte gespeicherte Prozeduren eine Ergebnis Abschluss Meldung an den Client sendet.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
