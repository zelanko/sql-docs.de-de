---
title: Auslassen eines Datenfelds mithilfe einer Formatdatei
description: Sie können eine Formatdatei mit einer Datendatei verwenden, die mehr Felder als Tabellenspalten enthält. Diese ordnet die Tabellenspalten den entsprechenden Datenfeldern zu und ignoriert alle übrigen Felder.
ms.date: 09/19/2016
ms.prod: sql
...
### <a name="creating-a-non-xml-format-file"></a><a name="nonxml_format_file"></a>Erstellen einer Nicht-XML-Formatdatei 
...
## <a name="importing-data-with-a-format-file-to-skip-a-data-field"></a>Importieren von Daten mithilfe einer Formatdatei zum Überspringen eines Datenfelds<a name="import_data"></a>
