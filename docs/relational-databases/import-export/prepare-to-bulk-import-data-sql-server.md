...
description: Der BCP-Befehl, die BULK INSERT-Anweisung oder die OPENROWSET(BULK)-Funktion kann nur für den Massenimport von Daten aus einer Datendatei verwendet werden.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
