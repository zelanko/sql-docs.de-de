...
description: Mithilfe von Feld- und Zeilenabschlusszeichen erkennen Datendatei lesende Programme, wo ein Feld oder eine Zeile endet und ein anderes Feld oder eine andere Zeile beginnt.
ms.custom: ''
ms.date: 07/26/2018
ms.prod: sql
