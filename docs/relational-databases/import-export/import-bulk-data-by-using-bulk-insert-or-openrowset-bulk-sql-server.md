...
description: Hier erfahren Sie, wie Sie mit Transact-SQL-Anweisungen einen Massenimport von Daten aus einer Datei in eine SQL Server- oder Azure SQL-Datenbank-Tabelle ausführen und erhalten zudem Informationen zur Sicherheit bei der Verwendung dieser Funktionen.
ms.prod: sql
