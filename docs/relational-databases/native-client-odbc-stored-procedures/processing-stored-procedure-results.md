---
title: Verarbeiten der Ergebnisse gespeicherter Prozeduren | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
-   Die Prozedur kann einen ganzzahligen Rückgabecode besitzen.  
 ...
 Anwendungen müssen alle diese Ausgaben gespeicherter Prozeduren verarbeiten können. Die CALL-Anweisung bzw. die EXECUTE-Anweisung sollte Parametermarkierungen für den Rückgabecode und die Ausgabeparameter enthalten. Verwenden Sie [SQLBindParameter,](../../relational-databases/native-client-odbc-api/sqlbindparameter.md) um sie [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] alle als Ausgabeparameter zu binden, und der native Client ODBC-Treiber überträgt die Ausgabewerte an die gebundenen Variablen. Ausgabeparameter und Rückgabecodes sind die letzten [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Elemente, die vom Client an den Client zurückgegeben werden. Sie werden erst an die Anwendung zurückgegeben, [wenn SQLMoreResults](../../relational-databases/native-client-odbc-api/sqlmoreresults.md) SQL_NO_DATA zurückgibt.  
