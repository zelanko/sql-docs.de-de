...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  Der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC-Treiber und [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] erzwingen die folgenden Datentypen:  
  
|Datentyp|Einschränkung|  
|---------------|----------------|  
|Datumsliterale|Datums Literale, die in einer SQL_TYPE_TIMESTAMP Spalte ([!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Datentypen **DateTime** oder **smalldatetime**) gespeichert sind, haben den Uhrzeitwert 12:00:00.000 Uhr.|  
|**Money** und **smallmoney**|Nur die ganzzahligen Teile der Datentypen **Money** und **smallmoney** sind von Bedeutung. Wenn der dezimale Teil von SQL- **Money** -Daten während der Datentyp Konvertierung abgeschnitten wird, gibt der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC-Treiber eine Warnung und keinen Fehler zurück.|  
...
|Zeitliterale|Zeit Literale, die in einer SQL_TIMESTAMP Spalte ([!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Datentypen **DateTime** oder **smalldatetime**) gespeichert sind, haben einen Datumswert vom 1. Januar 1900.|  
|**timestamp**|Nur ein NULL-Wert kann manuell in eine **Zeitstempel** -Spalte eingefügt werden. Da **Zeitstempel**-Spalten jedoch automatisch durch [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]aktualisiert werden, wird ein NULL-Wert überschrieben.|  
