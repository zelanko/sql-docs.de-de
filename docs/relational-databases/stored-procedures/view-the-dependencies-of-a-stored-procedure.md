...
description: Erfahren Sie, wie Sie die Abhängigkeiten einer gespeicherte Prozedur in SQL Server 2019 (15.x) mithilfe von SQL Server Management Studio oder Transact-SQL anzeigen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
