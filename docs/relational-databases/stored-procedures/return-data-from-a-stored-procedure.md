...
description: Erfahren Sie, wie Sie Daten mithilfe von Resultsets, Ausgabeparametern und Rückgabecodes aus einer Prozedur eines aufrufenden Programms zurückgeben.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
