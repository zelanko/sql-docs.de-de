...
description: Erfahren Sie, wie Sie Werte an Parameter übergeben und wie die einzelnen Parameterattribute während eines Prozeduraufrufs verwendet werden.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
> [!NOTE] 
> Standardparameter werden in Azure Synapse Analytics oder Parallel Data Warehouse nicht unterstützt. 
