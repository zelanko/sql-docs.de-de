...
description: Erfahren Sie, wie Sie eine gespeicherte Prozedur mithilfe von SQL Server Management Studio oder Transact-SQL in SQL Server 2019 (15.x) ausführen.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
