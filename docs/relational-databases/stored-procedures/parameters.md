...
description: Hier erfahren Sie, wie Sie Parameter zum Austauschen von Daten zwischen gespeicherten Prozeduren oder Funktionen und der Anwendung oder dem Tool verwenden, von der bzw. dem die gespeicherte Prozedur oder Funktion aufgerufen wurde.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
