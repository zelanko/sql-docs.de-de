...
Im folgenden Beispiel wird der `IX_Employee_OrganizationalLevel_OrganizationalNode`-Index für die `HumanResources.Employee`-Tabelle in der AdventureWorks-Datenbank neu organisiert.
