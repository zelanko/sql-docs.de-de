...
> [!NOTE]
> [!INCLUDE[ssManStudio](../../includes/ssManStudio-md.md)] kann nicht verwendet werden, um die Fragmentierung von Columnstore-Indizes zu berechnen. Verwenden Sie das [unten angegebene](#TsqlProcedureFrag) [!INCLUDE[tsql](../../includes/tsql-md.md)]-Beispiel.
...
6. Wählen Sie unter **Seite auswählen**die Option **Fragmentierung**aus.
   ...
   **Durchschnittliche Zeilengröße**     
   Die durchschnittliche Größe einer Zeile auf Blattebene.

   **Tiefe**     
   Die Anzahl von Ebenen im Index, einschließlich der Blattebene.
   ...
   **Zeilen auf Blattebene**     
   Die Anzahl von Zeilen auf Blattebene.
