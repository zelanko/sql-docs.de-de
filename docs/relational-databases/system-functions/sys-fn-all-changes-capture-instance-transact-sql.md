 ...
 *start_time*  
 ...
 Im Resultset sind nur Zeilen in der Tabelle cdc. < capture_instance > _CT Änderung Änderungs Tabelle enthalten, die eine zugeordnete comdtzeit aufweisen, die größer als *start_time* ist.  
...
-   @closed_high_end_point = 1  
     ...
     Im Resultset sind nur Zeilen im Resultset enthalten, < die capture_instance > _CT Änderungs Tabelle Änderungs Tabelle mit zugeordneter comend_time dtzeit liegen.  
...
|Spaltenname|Spaltentyp|und Beschreibung|  
|-----------------|-----------------|-----------------|  
