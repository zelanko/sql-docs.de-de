...
|response_rows |**bigint** | **Gilt für**: Azure SQL-Datenbank |  
|affected_rows |**bigint** | **Gilt für**: Azure SQL-Datenbank |  
|connection_id |GUID | **Gilt für**: Azure SQL-Datenbank |
|data_sensitivity_information |nvarchar(4000) | **Gilt für**: Azure SQL-Datenbank |
