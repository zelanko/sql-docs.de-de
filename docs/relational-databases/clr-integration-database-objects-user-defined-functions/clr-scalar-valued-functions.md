...
description: Eine Skalarwertfunktion gibt einen einzelnen Wert zurück. In SQL Server CLR-Integration können Sie benutzerdefinierte Skalarwertfunktionen in verwaltetem Code schreiben.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Übersicht über benutzerdefinierte Attribute der CLR-Integration](../clr-integration/database-objects/clr-integration-custom-attributes-for-clr-routines.md)   
