---
title: Tools für erweiterte Ereignisse
description: Diese Tools erstellen und verwalten Sitzungen für erweiterte Ereignisse in SQL Server. Zusätzlich zu Sitzungen, die Sie erstellen, ist auf dem Server eine standardmäßige Systemintegritätssitzung vorhanden.
ms.date: 03/17/2017
ms.prod: sql
...
|[sys.server_event_session_events &#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/sys-server-event-session-events-transact-sql.md)|Gibt eine Zeile für jedes Ereignis in einer Ereignissitzung zurück.|  
...
|[sys.dm_xe_session_targets &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-xe-session-targets-transact-sql.md)|Gibt Informationen zu Sitzungszielen zurück.|  
...
## <a name="see-also"></a>Weitere Informationen  
 ...
 [Tabellen für erweiterte Ereignisse von SQL Server &#40;Transact-SQL&#41;](../system-tables/system-tables-transact-sql.md)   
