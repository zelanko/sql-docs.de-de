...
description: Sie können erweiterte SQL Server-Ereignisse mithilfe des SQL Server PowerShell-Anbieters verwalten. In diesem Artikel finden Sie Beispiele für das Erstellen, Ändern und Verwalten von Sitzungen.
ms.date: 03/14/2017
ms.prod: sql
