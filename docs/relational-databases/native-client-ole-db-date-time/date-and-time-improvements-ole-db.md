...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 Stellt Informationen zu [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] OLE DB-Typen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (Native Client) bereit, die Datums- und Uhrzeitdatentypen unterstützen.  
 ...
 [Neue Datums- und Uhrzeitfeatures mit früheren SQL Server-Versionen &#40;OLE DB&#41;](../../relational-databases/native-client-ole-db-date-time/new-date-and-time-features-with-previous-sql-server-versions-ole-db.md)  
