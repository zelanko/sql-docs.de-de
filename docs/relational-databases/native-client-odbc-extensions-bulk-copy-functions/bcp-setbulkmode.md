...
|BCP_OUT_NATIVE_MODE|Gibt systemeigene Datenbanktypen an.<br /><br /> Entspricht der Option-n in bcp. EXE und bcp_setcolfmt, wobei **BCP_FMT_TYPE** -Eigenschaft auf den Standardwert festgelegt ist.|  
