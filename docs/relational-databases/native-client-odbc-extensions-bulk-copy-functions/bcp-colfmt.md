 ...
 *eUserDataType*  
 ...
 Bei einem Massen Kopiervorgang aus [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] in eine Datei, wenn *eUserDataType* auf SqlDecimal oder SQLNUMERIC festgelegt ist:  
