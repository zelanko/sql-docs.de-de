...
description: In SQL Server CLR-Integration ermöglicht die Current-Eigenschaft der System. Transactions. Transaction-Klasse den Zugriff auf die aktuelle Transaktion.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
