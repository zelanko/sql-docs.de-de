...
-   Die Funktion der erweiterten gespeicherten Prozedur wird im Sicherheitskontext [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]ausgeführt.  
...
-  
 ...
 Nachdem die dll der erweiterten gespeicherten Prozedur geladen wurde, bleibt die dll im Adressraum des Servers geladen, bis [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] beendet wird, oder der Administrator entlädt die dll explizit mithilfe von DBCC *DLL_Name* (Free).  
