---
title: XTP-Transaktionsprotokoll für SQL Server | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "32950645"
---
# <a name="sql-server-xtp-transaction-log"></a>XTP-Transaktionsprotokoll für SQL Server
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

  Das Leistungsobjekt „SQL Server-XTP-Transaktionsprotokoll“ enthält Leistungsindikatoren für die In-Memory-OLTP-Transaktionsprotokollaktivität in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
