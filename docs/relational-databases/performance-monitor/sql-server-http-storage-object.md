...
description: Hier lernen Sie das „SQLServer:HTTP-Speicher“-Leistungsobjekt kennen, das Leistungsindikatoren enthält, mit denen ein Azure-Speicherkonto überwacht wird.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
