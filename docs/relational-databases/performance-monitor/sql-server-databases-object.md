...
description: Hier lernen Sie das „SQLServer:Datenbanken“-Objekt kennen, das Leistungsindikatoren für Massenkopiervorgänge, den Durchsatz von Sicherungs- und Wiederherstellungsvorgängen sowie Transaktionsprotokollaktivitäten bereitstellt.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
