...
description: Verwenden von Systemmonitor, um die Leistung von SQL Server-Objekten, Leistungsindikatoren und das Verhalten anderer Objekte wie Prozessoren und Arbeitsspeicher zu messen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
