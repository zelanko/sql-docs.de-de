...
ms.locfileid: "81300267"
---
# <a name="sqlfetch"></a>SQLFetch
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  SQLFetch unterstützt erweiterte Datums- und Uhrzeitfunktionen.  
  
 Informationen dazu, wie Ergebnisspaltenwerte von Datums-/Uhrzeittypen konvertiert werden, finden Sie unter [Konvertierungen von SQL in C](../../relational-databases/native-client-odbc-date-time/datetime-data-type-conversions-from-sql-to-c.md).  
