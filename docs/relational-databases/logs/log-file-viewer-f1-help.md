...
description: Hier erhalten Sie Anleitungen von der F1-Hilfe für häufig angezeigte Spalten, Berechtigungen und andere Optionen für den Protokolldatei-Viewer in SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
