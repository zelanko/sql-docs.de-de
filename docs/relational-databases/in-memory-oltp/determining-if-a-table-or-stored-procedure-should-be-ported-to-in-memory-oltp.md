...
description: Verwenden Sie den Bericht zur Transaktionsleistungsanalyse in SQL Server Management Studio, um auszuwerten, ob In-Memory OLTP die Leistung der Datenbankanwendung verbessern kann.
