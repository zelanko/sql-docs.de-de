...
description: Hier erfahren Sie, wie Sie Variablen von speicheroptimierten Tabellen in datenbankübergreifenden Abfragen verwenden, um Daten von einer Datenbank in speicheroptimierte Tabellen einer anderen Datenbank in SQL Server zu migrieren.
ms.custom: ''
ms.date: 08/04/2016
ms.prod: sql
