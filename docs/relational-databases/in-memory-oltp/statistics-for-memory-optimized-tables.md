...
description: Hier erfahren Sie, wie der Abfrageoptimierer Statistiken zu Spalten in speicheroptimierten Tabellen verwendet, um Abfragepläne zu erstellen, die die Abfrageleistung für In-Memory OLTP verbessern.
ms.custom: ''
ms.date: 10/23/2016
ms.prod: sql
