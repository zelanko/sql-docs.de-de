...
description: Erfahren Sie mehr über BEGIN ATOMIC, das zum ANSI SQL-Standard gehört. SQL Server unterstützt atomische Blöcke in nativen Prozeduren.
ms.custom: ''
ms.date: 10/26/2017
ms.prod: sql
