...
4.  Klicken Sie im Navigationsbereich des Hilfsprogramm-Explorers auf ![](../../relational-databases/manage/media/connect-to-utility.gif "Connect_to_Utility")**Mit Hilfsprogramm verbinden**.  
