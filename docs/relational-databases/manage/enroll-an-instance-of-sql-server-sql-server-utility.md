...
description: Beginnen Sie mit der Überwachung der Leistung und der Konfiguration einer Instanz von SQL Server, indem Sie sie in einem vorhandenen SQL Server-Hilfsprogramm registrieren.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
-   Bei der zu registrierenden [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-Instanz darf es sich nicht um eine Azure SQL-Datenbank-Instanz handeln.  
