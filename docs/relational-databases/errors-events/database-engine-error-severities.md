...
description: Anhand der in diesem Artikel enthaltenen Liste können Sie die Art von Problem nachvollziehen, das bei SQL Server aufgetreten ist, wenn die SQL Server-Datenbank-Engine einen Fehler meldet.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
