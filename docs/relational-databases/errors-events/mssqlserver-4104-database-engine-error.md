...
description: Der angegebene mehrteilige Bezeichner konnte keiner vorhandenen Entität zugeordnet werden. Hier finden Sie eine Erläuterung des Fehlers sowie mögliche Lösungen.
ms.custom: ''
ms.date: 04/04/2017
ms.prod: sql
ms.reviewer: ''
