...
description: Ein Abfragefehler in SQL Server in Bezug auf einen ungültigen Spaltennamen. Hier finden Sie eine Erläuterung des Fehlers sowie mögliche Lösungen.
ms.custom: ''
ms.date: 04/04/2017
ms.prod: sql
ms.reviewer: ''
