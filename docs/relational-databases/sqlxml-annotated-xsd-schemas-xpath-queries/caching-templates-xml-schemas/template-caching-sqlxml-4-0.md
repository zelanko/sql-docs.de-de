...
description: Erfahren Sie, wie Sie die Leistung beim Ausführen von Vorlagen mit Vorlagen Caching in SQLXML 4,0 erheblich verbessern.
ms.date: 03/04/2017
ms.prod: sql
