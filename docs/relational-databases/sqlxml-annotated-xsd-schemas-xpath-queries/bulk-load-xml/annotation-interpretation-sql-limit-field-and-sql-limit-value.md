...
description: 'Erfahren Sie, wie Sie die SQLXML-Anmerkungen "SQL: limit-field" und "SQL: limit-value" verwenden, um Daten bei Verwendung von XML-Massen laden zu filtern.'
ms.date: 03/14/2017
ms.prod: sql
