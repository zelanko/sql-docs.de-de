...
description: Erfahren Sie, wie die expliziten Konvertierungs Funktionen String () und Number () in SQLXML 4,0 XPath-Abfragen angegeben werden.
ms.date: 03/17/2017
ms.prod: sql
