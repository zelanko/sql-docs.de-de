...
description: Die Datensammlung stellt einen Bericht für alle Systemdaten-Sammlungssätze zum Überwachen der Systemkapazität und der Systemleistung in SQL Server bereit.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
