...
description: Hier erfahren Sie, wie Sie die Größe der ausgewählten SQL Server-Datenbanken mithilfe des Tasks „Datenbank verkleinern“ verringern.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
