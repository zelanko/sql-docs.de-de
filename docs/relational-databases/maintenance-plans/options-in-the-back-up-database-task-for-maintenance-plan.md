...
description: Hier erfahren Sie, wie Sie mithilfe des Tasks „Datenbank sichern“ einen Sicherungstask zu einem Wartungsplan in SQL Server hinzufügen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
