...
description: Hier erfahren Sie, wie Sie SQL Server-Informationen zu den Daten in Tabellen und Indizes aktualisieren, indem Sie den Task „Statistiken aktualisieren“ verwenden.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
