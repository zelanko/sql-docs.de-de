...
description: Verwenden Sie den Task „Datenbankintegrität überprüfen“, um die Zuordnung und strukturelle Integrität von Benutzern, Systemtabellen sowie Indizes in einer SQL Server-Datenbank zu überprüfen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
