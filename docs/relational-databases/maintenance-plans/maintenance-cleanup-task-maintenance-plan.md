...
description: Erfahren Sie, wie Sie mit dem Task „Wartungscleanup“ alte Dateien für Wartungspläne entfernen, u. a. Textberichte für Wartungspläne und Datenbanksicherungsdateien.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
