...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 Wenn eine Datenbankverbindung ** \@ \@** geöffnet wird, wird TEXTSIZE standardmäßig auf -1 ("unbegrenzt") gesetzt.  
...
## <a name="querying-for-filestream-columns"></a>Abfragen von FILESTREAM-Spalten  
 ...
 Katalogfunktionen wie SQLColumns in ODBC melden nicht, ob eine Spalte eine FILESTREAM-Spalte ist.  
...
## <a name="down-level-compatibility"></a>Kompabilität mit früheren Versionen  
 Wenn Ihr Client mit der [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Version von Native [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]Client kompiliert [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)]wurde, die in enthalten war, [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]und die Anwendung eine Verbindung mit herstellt, ist **das Varbinary(max)-Verhalten** mit kompatibel. Das heißt, die Maximalgröße der zurückgegebenen Daten ist auf 2 GB beschränkt. Ergebniswerte, die größer als 2 GB sind, werden abgeschnitten, und es wird die Warnung „Zeichenfolgendaten werden rechts abgeschnitten“ zurückgegeben.  
 ...
 Für Clients, die SQLOLEDB oder andere Anbieter [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] verwenden, die vor der Version von [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client freigegeben wurden, wird **varbinary(max)** dem Image zugeordnet.  
