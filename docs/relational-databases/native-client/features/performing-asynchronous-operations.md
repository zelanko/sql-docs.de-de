...
description: Ermöglicht es Anwendungen, asynchrone Daten Bank Vorgänge mit dem SQL Server Native Client alten DB-Anbieter auszuführen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "87247629"
---
# <a name="performing-asynchronous-operations-in-sql-server-native-client"></a>Ausführen von asynchronen Vorgängen in SQL Server Native Client
