---
title: Unterstützung für sparsespalten SQL Native Client in
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client unterstützt Sparsespalten. Weitere Informationen zu sparsespalten [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]in finden Sie unter [Verwenden von sparsespalten](../../../relational-databases/tables/use-sparse-columns.md) und [Verwenden von Spalten Sätzen](../../../relational-databases/tables/use-column-sets.md).  
...
## <a name="bulk-copy-bcp-support-for-sparse-columns"></a>Massenkopierunterstützung (BCP) für Spalten mit geringer Dichte  
 ...
 Bei **queryout**-Vorgängen gibt es keine Änderungen in der Behandlung von Spalten, auf die explizit verwiesen wird. **column_set** Spalten das gleiche Verhalten aufweisen wie XML-Spalten, und die sparsespalte hat keine Auswirkung auf die Behandlung von benannten sparsespalten.  
