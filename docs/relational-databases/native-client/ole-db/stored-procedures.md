---
description: Gespeicherte Prozeduren in SQL Server Native Client
...
ms.locfileid: "97467521"
---
# <a name="stored-procedures-in-sql-server-native-client"></a>Gespeicherte Prozeduren in SQL Server Native Client
