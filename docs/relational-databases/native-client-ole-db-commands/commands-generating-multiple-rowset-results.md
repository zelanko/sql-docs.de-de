...
## <a name="batches"></a>Batches  
 Der [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] native Client-OLE-DB-Anbieter erkennt das Semikolonzeichen als Batchtrennzeichen für SQL-Anweisungen:  
