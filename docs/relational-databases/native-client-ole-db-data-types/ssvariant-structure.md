...
|dDateVal|DBTYPE_DATE|**DBDate fest**|**VT_SS_DATE**|Unterstützt den **Date** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Datentyp.|  
...
|tsDateTimeVal|DBTYPE_DBTIMESTAMP|**DBTIMESTAMP**|**VT_SS_DATETIME2**|Unterstützt den **datetime2** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Datentyp.<br /><br /> Beinhaltet die folgenden Member:<br /><br /> " *tdatatimeval* " (DBTIMESTAMP)<br /><br /> *bScale* (**Byte**) gibt die Skalierung für den Wert " *tdatatimeval* " an.|  
