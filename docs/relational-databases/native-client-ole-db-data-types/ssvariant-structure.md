---
description: SSVARIANT-Struktur in SQL Server Native Client
title: SSVARIANT-Struktur (Native Client OLE DB-Anbieter)
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.locfileid: "88448491"
---
# <a name="ssvariant-structure-in-sql-server-native-client"></a>SSVARIANT-Struktur in SQL Server Native Client
