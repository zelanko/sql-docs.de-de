...
description: Erfahren Sie, wie Sie mit SQL Server Management Studio Ausführungspläne im XML-Format speichern und für die Anzeige öffnen können. Sie müssen über die geeigneten Berechtigungen verfügen.
ms.custom: ''
ms.date: 08/21/2017
ms.prod: sql
