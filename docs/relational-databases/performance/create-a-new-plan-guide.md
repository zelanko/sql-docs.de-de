...
description: Hier erfahren Sie, wie Sie mithilfe von SQL Server Management Studio oder Transact-SQL eine Planhinweisliste erstellen. Eine Planhinweisliste wendet einen festen Abfrageplan und Abfragehinweise auf eine Abfrage an.
ms.custom: ''
ms.date: 08/02/2016
ms.prod: sql
ms.reviewer: ''
