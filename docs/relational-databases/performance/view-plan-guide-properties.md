...
description: Erfahren Sie, wie Sie mithilfe von SQL Server Management Studio oder Transact-SQL die Eigenschaften einer Planhinweisliste in SQL Server anzeigen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
