...
description: Erfahren Sie, wie Sie den Datenbankoptimierungsratgeber für die Problembehandlung verwenden, eine große Menge von Abfragen optimieren, Entwurfsänderungen analysieren und Speicherplatz in SQL Server verwalten.
ms.custom: ''
ms.date: 01/09/2017
ms.prod: sql
ms.reviewer: ''
