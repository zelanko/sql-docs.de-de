...
description: SQL Server-Abfragespeicher speichert abfragebezogene Daten in internen Tabellen und zeigt sie Benutzern mittels mehrerer Sichten an.
ms.custom: ''
ms.date: 11/29/2018
ms.prod: sql
