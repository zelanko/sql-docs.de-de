...
description: Erfahren Sie, wie Sie geschätzte grafische Ausführungspläne mithilfe von SQL Server Management Studio generieren. Ein geschätzter Ausführungsplan enthält keine Laufzeitinformationen.
ms.custom: ''
ms.date: 11/21/2018
ms.prod: sql
