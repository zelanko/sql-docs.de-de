...
description: Eine verzögerte Transaktion in SQL Server Enterprise tritt auf, wenn für das Rollback erforderliche Daten offline sind. Erfahren Sie, wie Sie diesen verzögerten Zustand auflösen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
