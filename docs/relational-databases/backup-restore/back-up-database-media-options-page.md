...
description: In SQL Server können Sie Medienoptionen im Dialogfeld „Datenbank sichern“ verwenden, um Medienoptionen anzuzeigen/zu ändern, einschließlich der Möglichkeit zum Überschreiben von Medien, Zuverlässigkeit und Transaktionsprotokollen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
