...
description: In SQL Server steuert ein Wiederherstellungsmodell, wie Transaktionen protokolliert werden, ob das Transaktionsprotokoll gesichert werden muss und welche Arten von Wiederherstellungsvorgängen verfügbar sind.
ms.custom: ''
ms.date: 07/16/2016
ms.prod: sql
