...
description: In diesem Artikel erfahren Sie, wie Sie das Ablaufdatum für eine Sicherungskopie in SQL Server mithilfe von SQL Server Management Studio oder Transact-SQL festlegen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
