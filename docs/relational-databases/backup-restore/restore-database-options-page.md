...
description: Verwenden Sie bei der Wiederherstellung einer Datenbank in SQL Server die Seite „Optionen“ des Dialogfelds „Datenbank wiederherstellen“, um das Verhalten und das Ergebnis des Wiederherstellungsvorgangs zu ändern.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
