...
description: In diesem Artikel wird erläutert, wie Sie eine vollständige SQL Server-Datenbanksicherung mithilfe von Transact-SQL im einfachen Wiederherstellungsmodell wiederherstellen.
