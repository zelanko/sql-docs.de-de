...
description: SQL Server unterstützt die Spiegelung von Mediensätzen. Dies erhöht die Sicherungszuverlässigkeit, indem der Einfluss von Fehlfunktionen beim Sicherungsmedium minimiert wird.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
