...
description: In SQL Server erfasst eine differenzielle Sicherung nur Daten, die seit der letzten vollständigen Sicherung geändert wurden. Dies ist dann die Basis der differenziellen Sicherung.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
