---
title: Wiederherstellen von Datenbanken bis zu einer markierten Transaktion
description: Wenn Sie verknüpfte Updates für zwei oder mehr verknüpfte Datenbanken ausführen, verwenden Sie in SQL Server Transaktionsmarkierungen, um diese Datenbanken auf dem Stand an einem logisch konsistenten Punkt wiederherzustellen.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
