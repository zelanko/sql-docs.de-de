...
description: In diesem Artikel erfahren Sie, wie Sie ein logisches Sicherungsmedium für ein Bandlaufwerk in SQL Server mithilfe von SQL Server Management Studio oder Transact-SQL definieren.
