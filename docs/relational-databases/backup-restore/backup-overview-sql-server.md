...
description: In diesem Artikel erhalten Sie Informationen zur Sicherungskomponente in SQL Server, einschließlich Sicherungstypen und -einschränkungen, sowie zu Sicherungsgeräten und Sicherungsmedien.
ms.custom: ''
ms.date: 07/15/2016
ms.prod: sql
