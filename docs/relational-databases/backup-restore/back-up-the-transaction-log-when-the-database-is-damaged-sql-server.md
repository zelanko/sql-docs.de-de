...
description: In diesem Thema wird beschrieben, wie ein Transaktionsprotokoll mithilfe von SQL Server Management Studio oder Transact-SQL gesichert wird, wenn die Datenbank in SQL Server beschädigt wird.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
