---
description: Abrufen von Fehlerinformationen (Native Client OLE DB-Anbieter)
title: Abrufen von Fehlerinformationen (Native Client OLE DB-Anbieter)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97473451"
---
# <a name="retrieving-error-information-native-client-ole-db-provider"></a>Abrufen von Fehlerinformationen (Native Client OLE DB-Anbieter)
