---
title: sql_variant Support für Datums- und Uhrzeittypen | Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 Die neuen Typen SQL_SS_TIME2 und SQL_SS_TIMESTAMPOFFSET können von SQLColAttribute festgelegt werden. SQL_CA_SS_VARIANT_SQL_TYPE kann von SQLGetDescField zurückgegeben werden.  
...
|SQL_C_BINARY|time|SQL_CA_SS_VARIANT_SQL_TYPE = SQL_SS_TIME2<br /><br /> Skalierung wird auf SQL_DESC_PRECISION (der *DecimalDigits-Parameter* von **SQLBindParameter)** festgelegt.|  
|SQL_C_BINARY|datetimeoffset|SQL_CA_SS_VARIANT_SQL_TYPE = SQL_SS_TIMESTAMPOFFSET<br /><br /> Skalierung wird auf SQL_DESC_PRECISION (der *DecimalDigits-Parameter* von **SQLBindParameter)** festgelegt.|  
...
|SQL_C_TYPE_TIMESTAMP|datetime2|Skalierung wird auf SQL_DESC_PRECISION (der *DecimalDigits-Parameter* von **SQLBindParameter)** festgelegt.|  
|SQL_C_NUMERIC|Decimal|Die Genauigkeit ist auf SQL_DESC_PRECISION (der *ColumnSize-Parameter* von **SQLBindParameter)** festgelegt.<br /><br /> Skalieren Sie auf SQL_DESC_SCALE (den *Parameter DecimalDigits* von SQLBindParameter).|  
