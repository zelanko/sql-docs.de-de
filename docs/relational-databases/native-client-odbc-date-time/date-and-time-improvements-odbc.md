...
## <a name="in-this-section"></a>In diesem Abschnitt  
 ...
 [sql_variant-Unterstützung für Datums- und Uhrzeittypen](../../relational-databases/native-client-odbc-date-time/sql-variant-support-for-date-and-time-types.md)  
