...
description: Sie müssen einen UDT registrieren, bevor Sie ihn in SQL Server installieren. Sie müssen die Assembly registrieren und den Typ in der Datenbank erstellen, in der Sie Sie verwenden möchten.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
