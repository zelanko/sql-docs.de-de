---
description: SetStringValue-Methode (SqlServiceAdvancedProperty-Klasse)
title: SetStringValue-Methode (SqlServiceAdvancedProperty-Klasse)
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
