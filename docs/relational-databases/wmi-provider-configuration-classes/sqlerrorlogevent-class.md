...
## <a name="comments"></a>Kommentare  
 Wenn *instanceName* oder *filename* nicht in der WQL-Anweisung angegeben wird, gibt die Abfrage Informationen für die Standard Instanz und die aktuelle [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Protokolldatei zurück. Beispielsweise werden mit der folgenden WQL-Anweisung alle Protokollereignisse aus der aktuellen Protokolldatei (ErrorLog) auf der Standard Instanz (MSSQLSERVER) zurückgegeben.  
