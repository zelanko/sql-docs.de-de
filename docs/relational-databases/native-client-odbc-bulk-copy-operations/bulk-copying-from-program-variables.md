...
```  
 ...
 Eine Anwendung kann mithilfe der [Bcp_colptr](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-colptr.md) Funktion jedes Mal, wenn die Adresse der ursprünglich in angegebenen Datenvariable ändern muss die **Bcp_bind** _pData_ Parameter. Eine Anwendung kann mithilfe der [Bcp_collen](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-collen.md) Funktion jedes Mal, wenn die ursprünglich angegebene Datenlänge ändern muss die **Bcp_bind**_CbData_ Parameter.  
