...
1.  Ruft [bcp_init](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-init.md) auf, um das Massen kopieren (Set BCP_OUT) aus einer Tabelle oder Sicht in eine Datendatei anzugeben.  
...
1.  Geben Sie **bcp_init** an, um das Massen kopieren anzugeben, geben Sie jedoch NULL für den Tabellennamen an.  
  
2.  Ruft [bcp_control](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md) auf, wenn *eOption* auf BCPHINTS festgelegt und *iValue* auf einen Zeiger auf eine SQLTCHAR-Zeichenfolge festgelegt ist, die die Transact-SQL-Anweisung enthält.  
...
3.  Rufen Sie **bcp_exec** auf, um den Massenkopiervorgang auszuführen.  
 ...
 Wenn Sie den Massen Kopiervorgang und die Verwendung von **bcp_colfmt**durchführen, können Sie problemlos eine Format Datei erstellen, die die Datendatei beschreibt, die Sie durch Aufrufen von [bcp_writefmt](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-writefmt.md) nach dem letzten Aufruf von **bcp_colfmt**erstellt haben.  
