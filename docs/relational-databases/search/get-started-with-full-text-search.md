---
description: Erste Schritte mit der Volltextsuche
...
##  <a name="choose-options-for-a-full-text-index"></a><a name="options"></a> Wählen Sie Optionen für einen Volltextindex aus 
