---
description: Konfigurieren und Verwalten von Wörtertrennungen und Wortstammerkennungen für die Suche (SQL Server)
...
##  <a name="get-the-list-of-registered-word-breakers"></a><a name="register"></a> Anzeigen der Liste der registrierten Wörtertrennungen
...
##  <a name="choose-the-language-for-an-indexed-column"></a><a name="lang"></a> Auswählen der Sprache für eine indizierte Spalte  
...
##  <a name="troubleshoot-word-breaking-time-out-errors"></a><a name="tshoot"></a> Behebung von Timeoutfehlern bei der Wörtertrennung  
...
##  <a name="understand-the-impact-of-updated-word-breakers"></a><a name="impact"></a> Auswirkungen der aktualisierten Wörtertrennungen  
