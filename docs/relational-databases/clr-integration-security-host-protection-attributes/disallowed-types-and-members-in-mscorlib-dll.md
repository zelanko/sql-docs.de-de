---
title: Unzulässige Typen und Member in mscorlib.dll | Microsoft Docs
description: Die SQL Server CLR-Programmierung lässt einen Typ oder Member mit einigen Werten für die HostProtectionResource-Enumerumere nicht zu. In diesem Artikel werden nicht zulässige Werte von mscorlib.dll aufgeführt.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
