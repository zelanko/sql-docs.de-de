...
description: Der Common Language Runtime (CLR) bietet einen Mechanismus, um verwaltete Anwendungs Programmierschnittstellen (APIs) zu kommentieren, die Teil des .NET Framework mit bestimmten Attributen sind.
