...
description: Die SQL Server CLR-Programmierung lässt einen Typ oder Member mit bestimmten Werten für die HostProtectionResource-Enumerumere nicht zu. In diesem Artikel werden nicht zulässige Werte von System.dll aufgeführt.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
