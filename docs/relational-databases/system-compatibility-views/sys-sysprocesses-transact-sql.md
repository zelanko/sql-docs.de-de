...
|memusage|**int**|Anzahl der Seiten im Prozedurcache, die derzeit an diesem Prozess zugeordnet sind. Eine negative Anzahl gibt an, dass der Prozess Arbeitsspeicher freigibt, der von einem anderen Prozess zugeordnet wurde.|  
...
|net_library|**NCHAR(12)**|Spalte, in der die Netzwerkbibliothek des Clients gespeichert wird. Jeder Clientprozess wird über eine Netzwerkverbindung übertragen. Netzwerkverbindungen haben eine Netzwerkbibliothek zugeordnet, die sie zum Herstellen die Verbindung ermöglicht.|  
...
|sql_handle|**Binary(20)**|Stellt den zurzeit ausgeführten Batch oder das zurzeit ausgeführte Objekt dar.<br /><br /> **Beachten Sie** dieser Wert wird vom Batch oder der Arbeitsspeicher des Objekts abgeleitet. Der Wert wird nicht mit dem hashbasierten Algorithmus von [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] berechnet.|  
...
|page_resource |**binary(8)** |**Gilt für:** [!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)] <br /><br /> Eine 8-Byte-hexadezimale Darstellung der Ressource für die Seite "Wenn die `waitresource` Spalte enthält eine Seite. |  
