...
|**Stammverzeichnis**|**Binary(6)**|Für **Indid** > = 1, **Stamm** ist der Zeiger auf die Stammseite.<br /><br /> Nicht verwendet, wenn **indid** = 0.<br /><br /> NULL = Index ist partitioniert, wenn **Indid** > 1.<br /><br /> NULL = Tabelle ist partitioniert, wenn **indid** gleich 0 oder 1.|  
