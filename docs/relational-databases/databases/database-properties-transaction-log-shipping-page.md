...
description: Verwenden Sie die Registerkarte „Transaktionsprotokollversand“ im Dialogfeld „Datenbankeigenschaften“, um eine Datenbank als primäre Datenbank für den Protokollversand zu aktivieren und deren Optionen festzulegen.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
