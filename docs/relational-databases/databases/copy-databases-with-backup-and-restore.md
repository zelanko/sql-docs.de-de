...
description: In SQL Server können Sie eine neue Datenbank erstellen, indem Sie die Sicherung einer Benutzerdatenbank wiederherstellen, die in einer früheren Version erstellt wurde.
ms.custom: ''
ms.date: 07/15/2016
ms.prod: sql
