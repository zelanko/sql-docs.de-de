...
description: Erfahren Sie, wie Sie eine Daten- oder Protokolldatei in SQL Server mithilfe von SQL Server Management Studio oder Transact-SQL verkleinern.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
