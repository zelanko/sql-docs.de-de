...
7.  Wechseln Sie zurück zum **Assistenten**, und öffnen Sie die Seite **Übertragungsmethode auswählen**:  Überprüfen und verwalten Sie die Standardwerte.  Klicken Sie auf **Weiter**.
...
12. Seite **Paket konfigurieren**:  Geben Sie `SalesFromServer1toServer2_Move` in das Textfeld **Paketname:** ein.  Aktivieren Sie das Feld **Übertragungsprotokolle speichern?** .  Wählen Sie in der Dropdownliste **Protokollierungsoptionen** die Option **Textdatei**aus.  Beachten Sie den **Pfad der Fehlerprotokolldatei**, und ändern Sie ihn nach Bedarf.  Klicken Sie auf **Weiter**.  
...
15. Seite **Vorgang wird ausgeführt**: Wenn der Vorgang erfolgreich ausgeführt wird, klicken Sie auf **Schließen**.  Wenn der Vorgang nicht erfolgreich ausgeführt wurde, überprüfen Sie das Fehlerprotokoll, und klicken Sie möglicherweise zur weiteren Überprüfung auf **Zurück** .  Klicken Sie andernfalls auf **Schließen**.
...
6.  Seite **Select a Transfer Method** (Übertragungsmethode auswählen):  Überprüfen und verwalten Sie die Standardwerte.  Klicken Sie auf **Weiter**.
...
9.  Seite **Paket konfigurieren**:  Geben Sie `SalesCopy Weekly Refresh` in das Textfeld **Paketname:** ein.  Aktivieren Sie das Feld **Übertragungsprotokolle speichern?** .  Klicken Sie auf **Weiter**.

10. Seite **Zeitplan für Paket**:  Klicken Sie auf das Optionsfeld **Zeitplan:** und dann auf die Schaltfläche **Zeitplan ändern**. 
 
    1. Seite **Neuer Auftragszeitplan**: Geben Sie `Weekly on Sunday` in das Textfeld **Name** ein. 
...
13. Seite **Vorgang wird ausgeführt**: Wenn der Vorgang erfolgreich ausgeführt wird, klicken Sie auf **Schließen**.  Wenn der Vorgang nicht erfolgreich ausgeführt wurde, überprüfen Sie das Fehlerprotokoll, und klicken Sie möglicherweise zur weiteren Überprüfung auf **Zurück** .  Klicken Sie andernfalls auf **Schließen**.
