...
description: In diesem Artikel werden verschiedene Datenbankzustände vorgestellt, z. B. ONLINE, OFFLINE oder SUSPECT. Außerdem erfahren Sie, wie Sie den aktuellen Zustand einer Datenbank überprüfen.
ms.custom: ''
ms.date: 07/14/2016
ms.prod: sql
