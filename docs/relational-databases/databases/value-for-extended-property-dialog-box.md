...
ms.locfileid: "68127112"
---
# <a name="value-for-extended-property-dialog-box"></a>Wert für erweiterte Eigenschaft (Dialogfeld)
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Mithilfe des Dialogfelds **Wert für** _\<Eigenschaftsname>_ können Sie einen Wert eingeben oder anzeigen. Dies ist ein häufig verwendetes Dialogfeld, das von verschiedenen Positionen aus geöffnet werden kann.  
