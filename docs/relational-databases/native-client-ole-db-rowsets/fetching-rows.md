---
description: Abrufen von Zeilen (Native Client OLE DB-Anbieter)
title: Abrufen von Zeilen (Native Client OLE DB-Anbieter) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88448363"
---
# <a name="fetching-rows-native-client-ole-db-provider"></a>Abrufen von Zeilen (Native Client OLE DB-Anbieter)
