...
`[ @loginame = ] 'login'`Der Name des Windows-Benutzers oder der Windows-Gruppe, aus dem der Zugriff widerrufen werden soll. die *Anmeldung* muss den Domänen Namen enthalten, z. b. **[ADVWKS\sylvester1]**. *Login* ist vom **Datentyp vom Datentyp sysname**und hat keinen Standardwert.  
