...
## <a name="remarks"></a>Hinweise  
 Um ein Profil öffentlich zu machen, geben **@principal_id** Sie einen von **0** oder einen **@principal_name** von **Public**an. Ein öffentliches Profil ist für alle Benutzer der **msdb** -Datenbank verfügbar. Allerdings müssen diese Benutzer auch Mitglieder von **DatabaseMailUserRole** sein, wenn sie **sp_send_dbmail**ausführen können sollen.  
