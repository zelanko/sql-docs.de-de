...
||**0**|Verwendet für die Websynchronisierung die Standardauthentifizierung.<br /><br /> Hinweis: Die websynchronisierung erfordert einer SSL-Verbindungs an den Webserver.|  
