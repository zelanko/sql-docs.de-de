...
>  Nur **Sysmessages** Fehler, die das Microsoft Windows-Anwendungsprotokoll können dazu führen, dass eine Warnung gesendet werden.  
 ...
 [  **@delay_between_responses =** ] *Delay_between_responses*  
 Die Wartezeit zwischen Antworten auf die Warnung in Sekunden. *Delay_between_responses*ist **Int**, hat den Standardwert **0**, was bedeutet, dass keine Wartezeit zwischen Antworten besteht (jedes Vorkommen der Warnung generiert eine Antwort). Die Reaktion kann in einer oder beiden der folgenden Formen erfolgen:  
