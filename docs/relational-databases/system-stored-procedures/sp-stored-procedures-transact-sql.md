...
`[ @sp_name = ] 'name'` Ist der Name der Prozedur verwendet, um Kataloginformationen zurückzugeben. *name* ist vom Datentyp **nvarchar(390)** und hat den Standardwert NULL. Mustervergleiche mit Platzhalterzeichen werden unterstützt.  
