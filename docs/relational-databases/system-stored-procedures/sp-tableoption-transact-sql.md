...
## <a name="remarks"></a>Remarks  
 ...
 Wenn die Option Text in row aktiviert ist, können Benutzer mit dem @OptionValue-Parameter die maximale Größe angeben, die in einer Zeile für ein BLOB gespeichert werden soll. Der Standardwert ist 256 Bytes. Gültige Werte sind 24 bis 7000 Bytes.  
...
-   Die Länge der Zeichenfolge ist kürzer als der in angegebene Grenzwert @OptionValue  
