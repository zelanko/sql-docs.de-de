# [Übersicht](system-stored-procedures-transact-sql.md)  

# Aktive Georeplikation
## [sp_wait_for_database_copy_sync](active-geo-replication-sp-wait-for-database-copy-sync.md)  
# [Räumlichkeitsindizes](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# [Katalog](catalog-stored-procedures-transact-sql.md)  
...
# [Datensammler](data-collector-stored-procedures-transact-sql.md)  
...
## [sp_execute_remote (Azure SQL-Datenbank)](sp-execute-remote-azure-sql-database.md)  
...
# [Datenbank-E-Mail](database-mail-stored-procedures-transact-sql.md)  
...
# [Verteilte Abfragen](distributed-queries-stored-procedures-transact-sql.md)  
...
# [Filestream und Filetable](filestream-and-filetable-system-stored-procedures.md)
...
# [Firewallregeln (Azure SQL-Datenbank)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (Azure SQL-Datenbank)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (Azure SQL-Datenbank)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (Azure SQL-Datenbank)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (Azure SQL-Datenbank)](sp-delete-database-firewall-rule-azure-sql-database.md)  

# [Volltextsuche und semantische Suche](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [Allgemeine erweiterte](general-extended-stored-procedures-transact-sql.md)  
...
# [Protokollversand](log-shipping-stored-procedures-transact-sql.md)  
...
# [Verwaltete Sicherung](managed-backup-stored-procedures-transact-sql.md)  
...
# [Verwaltungs-Data Warehouse](management-data-warehouse-stored-procedures-transact-sql.md)  
...
# [OLE-Automatisierung](ole-automation-stored-procedures-transact-sql.md)  
## [Objekthierarchiesyntax](object-hierarchy-syntax-transact-sql.md)  
...
# [Richtlinienbasierte Verwaltung](policy-based-management-stored-procedures-transact-sql.md)  
...
# [Abfragespeicher](query-store-stored-procedures-transact-sql.md)  
...
# [Replikation](replication-stored-procedures-transact-sql.md)  
