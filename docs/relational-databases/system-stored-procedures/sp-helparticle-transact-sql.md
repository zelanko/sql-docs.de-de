...
|**Synchronisierungs Objekt**|**nvarchar(257)**|Name der Sicht, die den veröffentlichten Artikel definiert.|  
...
|**Pfad für Erstellungs Skript**|**nvarchar(255)**|Pfad und Name eines Artikelschemaskripts, mit dem Zieltabellen erstellt werden.|  
|**vertikale Partition**|**bit**|Gibt an, ob die vertikale Partitionierung für den Artikel aktiviert ist. der Wert **1** bedeutet, dass die vertikale Partitionierung aktiviert ist.|  
...
|**schema_option**|**binary(8)**|Bitmuster der Option zur Schemaerstellung für den angegebenen Artikel. Eine umfassende Liste der **schema_option** -Werte finden Sie [unter &#40;sp_addarticle Transact-&#41;SQL](../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md).|  
