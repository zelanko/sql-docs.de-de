...
> [!IMPORTANT]  
> [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]Verwenden Sie die dynamische Verwaltungs Sicht [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] [sys. dm_tran_locks](../../relational-databases/system-dynamic-management-views/sys-dm-tran-locks-transact-sql.md) , um Informationen zu Sperren in zu erhalten.  
...
## <a name="result-sets"></a>Resultsets  
 Das **sp_lock** Resultset enthält eine Zeile für jede Sperre, die von den Sitzungen in ** \@** den Parametern spid1 und ** \@SPID2** gespeichert wird. Wenn weder ** \@spid1** noch ** \@SPID2** angegeben ist, meldet das Resultset die Sperren für alle Sitzungen, die derzeit in der Instanz [!INCLUDE[ssDE](../../includes/ssde-md.md)]von aktiv sind.  
