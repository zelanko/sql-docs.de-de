...
> [!NOTE]  
>  Die folgenden Aktionen werden in einer zukünftigen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Version von entfernt: **clean_up**, **connect_timeout**, **data_timeout**und **resource_usage**. Vermeiden Sie die Verwendung dieser Aktionen bei neuen Entwicklungsarbeiten, und planen Sie die Änderung von Anwendungen, die diese Aktionen zurzeit verwenden.  
  
|Action|Datentyp|BESCHREIBUNG|  
|------------|---------------|-----------------|  
