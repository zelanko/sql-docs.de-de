...
`[ @funcname = ] 'procedure'`Der Name der erweiterten gespeicherten Prozedur, für die Informationen gemeldet werden. *Procedure* ist vom **Datentyp vom Datentyp sysname**und hat den Standardwert NULL.  
