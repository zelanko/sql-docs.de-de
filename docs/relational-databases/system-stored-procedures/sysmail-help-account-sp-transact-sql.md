...
`[ @account_name = ] 'account_name'`Der Name des Kontos, für das Informationen aufgelistet werden sollen. *account_name* ist vom **Datentyp vom Datentyp sysname**und hat den Standardwert NULL.  
