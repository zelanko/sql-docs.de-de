...
`[ @value = ] value` Ist die Anzahl der Tage, die Richtlinie der richtlinienbasierten Verwaltung Verlauf erhalten bleibt. *Wert* ist **Sqlvariant**.  
