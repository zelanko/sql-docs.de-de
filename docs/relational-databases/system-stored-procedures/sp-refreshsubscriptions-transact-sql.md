...
`[ @publication = ] 'publication'` Ist die Veröffentlichung, für die Abonnements aktualisiert. *Veröffentlichung* ist **Sysname**, hat keinen Standardwert.  
