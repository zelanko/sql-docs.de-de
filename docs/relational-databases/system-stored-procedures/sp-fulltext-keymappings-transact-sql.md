...
> [!NOTE]  
>  Die Beispiele in diesem Abschnitt verwenden die `Production.ProductReview` Tabelle mit den [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)] -Beispieldatenbank. Sie können diesen Index erstellen, durch Ausführen der im Beispiel für die `ProductReview` -Tabelle [CREATE FULLTEXT INDEX &#40;Transact-SQL&#41;](../../t-sql/statements/create-fulltext-index-transact-sql.md).  
