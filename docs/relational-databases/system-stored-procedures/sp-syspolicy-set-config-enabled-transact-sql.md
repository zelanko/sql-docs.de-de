...
`[ @value = ] value` Bestimmt, ob die Richtlinie der richtlinienbasierten Verwaltung aktiviert ist. *Wert* ist **Sqlvariant**, und kann einen der folgenden Werte:  
