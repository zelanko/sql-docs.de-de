...
`[ @rolename = ] 'role'`Der Name der Anwendungs Rolle. *Role* ist vom **Datentyp vom Datentyp sysname**und hat keinen Standardwert. die *Rolle* muss in der aktuellen Datenbank vorhanden sein.  
