...
`[ @agent_type = ] 'agent_type'` Der Typ des protokollversandauftrags. 0 = Sichern, 1 = Kopieren, 2 = Wiederherstellen. *agent_type* ist vom Datentyp **tinyint** und kann nicht NULL sein.  
