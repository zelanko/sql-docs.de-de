...
> [!IMPORTANT]  
>  Sie sollten diese Prozedur nicht manuell ausführen müssen. **sp_replflush** sollte nur zur Problembehandlung bei der Replikation verwendet werden, wie von einem erfahrenen Supportmitarbeiter unterstützt.  
 ...
 **sp_replflush** wird bei der Transaktions Replikation verwendet.  
 ...
 Auf jede Datenbank kann nur eine Clientverbindung Protokolllesezugriff haben. Wenn ein Client über Protokoll Lesezugriff auf eine Datenbank verfügt, bewirkt das Ausführen von **sp_replflush** , dass der Client seinen Zugriff freigibt. Andere Clients können dann das Transaktionsprotokoll mithilfe von **sp_replcmds** oder **sp_replshowcmds**scannen.  
