...
`[ @server_name = ] 'server'` Der Name der zu synchronisierenden Serverobjekts. *server* ist vom Datentyp **sysname**und hat keinen Standardwert. Mit **ALL** werden alle Zielserver neu synchronisiert.  
