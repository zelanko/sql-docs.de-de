...
`[ @profile_name = ] 'profile_name'`Der Name des zu aktualisierenden Profils oder der neue Name für das Profil. *profile_name* ist vom **Datentyp vom Datentyp sysname**und hat den Standardwert NULL. Mindestens eine *profile_id* oder *profile_name* muss angegeben werden. Werden beide Werte angegeben, wird der Name des Profils geändert.  
