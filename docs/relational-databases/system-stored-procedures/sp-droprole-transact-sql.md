...
> [!IMPORTANT]  
>  In [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]wurde **sp_droprole** durch die DROP ROLE-Anweisung ersetzt. **sp_droprole** ist nur aus Gründen der Kompatibilität mit früheren Versionen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] von enthalten und wird in einer zukünftigen Version möglicherweise nicht mehr unterstützt.  
...
`[ @rolename = ] 'role'`Der Name der Daten Bank Rolle, die aus der aktuellen Datenbank entfernt werden soll. *Role* ist vom **Datentyp vom Datentyp sysname**und hat keinen Standardwert. die *Rolle* muss in der aktuellen Datenbank bereits vorhanden sein.  
