...
`[ @plan_id = ] 'plan\_id'` Gibt die ID des Wartungsplans gelöscht werden soll. *plan_id* ist vom Datentyp **uniqueidentifier**und muss eine gültige ID sein.  
