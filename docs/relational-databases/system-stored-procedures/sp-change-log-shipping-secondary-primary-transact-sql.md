...
`[ @file_retention_period = ] 'file_retention_period'`Der Zeitraum in Minuten, in dem der Verlauf beibehalten wird. *history_retention_period* ist vom Datentyp **int**und hat den Standardwert NULL. Der Wert 14420 wird verwendet, falls kein anderer Wert angegeben wird.  
