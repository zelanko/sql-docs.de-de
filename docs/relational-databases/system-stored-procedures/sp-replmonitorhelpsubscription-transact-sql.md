...
|**7**|Gibt nur Abonnements zurück, für die zurzeit keine Synchronisierung im Gange ist.|  
 ...
 [ **@exclude_anonymous** =] *Exclude_anonymous*  
 Gibt an, ob anonyme Pullabonnements aus dem Resultset ausgeschlossen werden. *Exclude_anonymous* ist **Bit**, hat den Standardwert **0**; Wert **1** bedeutet, dass anonyme Abonnements ausgeschlossen werden und der Wert des **0**  bedeutet, dass sie enthalten sind.  
