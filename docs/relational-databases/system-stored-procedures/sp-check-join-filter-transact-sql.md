...
`[ @join_table = ] 'join_table'`Der Name einer Tabelle, die mit *filtered_table*verknüpft wird. *join_table* ist vom Datentyp **nvarchar (400)** und hat keinen Standardwert.  
 ...
 **sp_check_join_filter** kann für alle verknüpften Tabellen ausgeführt werden, auch wenn Sie nicht veröffentlicht werden. Mit dieser gespeicherten Prozedur kann eine Joinfilterklausel überprüft werden, bevor ein Joinfilter zwischen zwei Artikeln definiert wird.  
