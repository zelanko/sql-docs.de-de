...
|Wert|Beschreibung|  
|-----------|-----------------|  
|System eigen vorgegebene|Erstellt eine Massenkopierprogramm-Ausgabe aller Tabellen im einheitlichen Modus.|  
|**character**|Erstellt eine Massenkopierprogramm-Ausgabe aller Tabellen im Zeichenmodus. Erforderlich, um [!INCLUDE[msCoName](../../includes/msconame-md.md)] und nicht-[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Abonnenten zu unterstützen [!INCLUDE[ssEW](../../includes/ssew-md.md)] .|  
...
`[ @replicate_ddl = ] replicate_ddl`Gibt an, ob die Schema Replikation für die Veröffentlichung unterstützt wird. *replicate_ddl* ist vom Datentyp **int**und hat den Standardwert 1. **1** gibt an, dass DDL-Anweisungen (Data Definition Language), die auf dem Verleger ausgeführt werden, repliziert werden, und **0** bedeutet, dass DDL-Anweisungen nicht repliziert werden Weitere Informationen finden Sie unter [Vornehmen von Schemaänderungen in Veröffentlichungsdatenbanken](../../relational-databases/replication/publish/make-schema-changes-on-publication-databases.md).  
 ...
 Der *@replicate_ddl* -Parameter wird berücksichtigt, wenn eine DDL-Anweisung eine Spalte hinzufügt. Der *@replicate_ddl* -Parameter wird ignoriert, wenn eine DDL-Anweisung aus den folgenden Gründen eine Spalte ändert oder löscht.  
...
|Wert|Version|  
|-----------|-------------|  
|**Tag** vorgegebene|Die Beibehaltungsdauer wird in Tagen angegeben.|  
...
`[ @automatic_reinitialization_policy = ] automatic_reinitialization_policy`Gibt an, ob Änderungen vom Abonnenten vor einer automatischen erneuten Initialisierung hochgeladen werden, die für eine Änderung an der Veröffentlichung erforderlich ist , bei der der **@force_reinit_subscription** Wert 1 für angegeben wurde. *automatic_reinitialization_policy* ist vom Typ Bit. der Standardwert ist 0. **1** bedeutet, dass Änderungen vom Abonnenten hochgeladen werden, bevor eine automatische Neuinitialisierung erfolgt.  
 ...
 **sp_addmergepublication** wird bei der Mergereplikation verwendet.  
 ...
 Um Veröffentlichungs Objekte mithilfe des **@add_to_active_directory** -Parameters für die Active Directory aufzulisten, muss das [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] -Objekt bereits in der Active Directory erstellt werden.  
 ...
 Für [!INCLUDE[ssEW](../../includes/ssew-md.md)] -Abonnenten wird der Wert von *alternate_snapshot_folder* nur verwendet, wenn der Wert von *snapshot_in_default_folder* **false**ist.  
