...
`[ @name = ] 'name'`Der Name der Zielserver Gruppe, für die Informationen zurückgegeben werden sollen. *Name ist vom Datentyp* **vom Datentyp sysname**und hat den Standardwert NULL.  
