...
|**sync_method**|**tinyint**|Synchronisierungsmethode:<br /><br /> **1** = Massenkopieren von Zeichen.<br /><br /> **4** = Concurrent_c, dies bedeutet, dass das Massenkopieren von Zeichen wird verwendet, aber Tabellen werden während der Momentaufnahme nicht gesperrt.|  
...
|**immediate_sync_ready**|**bit**|Gibt an, ob die Synchronisierungsdateien verfügbar, in denen sind **1** bedeutet, dass sie verfügbar sind. *Nicht unterstützt für nicht - SQL-Verleger.*|  
