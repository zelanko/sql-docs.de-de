...
|**type**|**tinyint**|Zeigt den Typ des Artikels vom Typ schema only an, der einen der folgenden Werte annehmen kann:<br /><br /> **0 x 20** = gespeicherte Prozedur Schema only-Artikel.<br /><br /> **0 x 40** = View Schema only-Artikel oder indizierten Sicht Schema only-Artikel.|  
