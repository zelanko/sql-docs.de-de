...
|**monitor_server**|**sysname**|Der Name der [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] -Instanz, die als Überwachungsserver in der Protokollversandkonfiguration verwendet wird|  
