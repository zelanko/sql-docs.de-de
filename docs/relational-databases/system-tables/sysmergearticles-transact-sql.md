...
|**Typ**|**tinyint**|Gibt den Artikeltyp an, der einen der folgenden Werte aufweisen kann:<br /><br /> **10** = Tabelle.<br /><br /> **32** = gespeicherte Prozedur (nur Schema).<br /><br /> **64** = Sicht oder indizierte Sicht (nur Schema).<br /><br /> **128** = benutzerdefinierte Funktion (nur Schema).<br /><br /> **160** = Synonym (nur Schema).|  
...
|**schema_option**|**binary(8)**|Die unterstützten Werte *schema_option*finden Sie unter [sp_addmergearticle &#40;Transact-SQL&#41;](../../relational-databases/system-stored-procedures/sp-addmergearticle-transact-sql.md).|  
