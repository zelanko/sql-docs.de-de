...
|-----------------|---------------|-----------------|  
|request_id|**wartenden**|Identifiziert einen Konflikt Konfigurations Anforderungs Eintrag in der [MSpeer_conflictdetectionconfigrequest](../../relational-databases/system-tables/mspeer-conflictdetectionconfigrequest-transact-sql.md) Tabelle.|  
...
|conflict_detection_enabled|**trate**|Gibt an, ob die Konflikterkennung für die Topologie aktiviert ist.|  
...
|peer_conflict_retention|**wartenden**|Zeitraum in Tagen, für den Metadaten in Konflikttabellen gespeichert werden.|  
|peer_subscriptions|**Basi**|Informationen über den Knoten, der auf die Anforderung reagiert hat.|  
