...
|-----------------|---------------|-----------------|  
|**alert_job_id**|**uniqueidentifier**|Die [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent-Auftrags-ID des warnungsauftrags für den Protokollversand.|  
