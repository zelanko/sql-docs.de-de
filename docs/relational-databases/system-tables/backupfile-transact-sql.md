...
|**file_size**|**numerisch (20, 0)**|Länge der gesicherten Datei in Bytes. Kann den Wert NULL haben.|  
...
|**create_lsn**|**numerisch (25, 0)**|Protokollfolgenummer, bei der die Datei erstellt wurde.|  
|**drop_lsn**|**numerisch (25, 0)**|Protokollfolgenummer, bei der die Datei gelöscht wurde. Kann den Wert NULL haben.<br /><br /> Wurde die Datei nicht gelöscht, ist dieser Wert NULL.|  
|**file_guid**|**uniqueidentifier**|Der eindeutige Bezeichner der Datei.|  
|**read_only_lsn**|**numerisch (25, 0)**|Protokollfolgenummer, bei der die Dateigruppe mit der Datei von Lesen/Schreiben zu Schreibgeschützt geändert wurde (letzte Änderung). Kann den Wert NULL haben.|  
|**read_write_lsn**|**numerisch (25, 0)**|Protokollfolgenummer, bei der die Dateigruppe mit der Datei von Nur Lesen zu Schreibgeschützt geändert wurde (letzte Änderung). Kann den Wert NULL haben.|  
|**differential_base_lsn**|**numerisch (25, 0)**|Basis-LSN für differenzielle Sicherungen. Eine differenzielle Sicherung enthält nur Datenblöcke, die eine Protokoll Folge Nummer aufweisen, die größer oder gleich **differential_base_lsn**ist.<br /><br /> Bei anderen Sicherungstypen ist der Wert NULL.|  
...
|**backup_size**|**numerisch (20, 0)**|Größe der Sicherung dieser Datei in Bytes.|  
