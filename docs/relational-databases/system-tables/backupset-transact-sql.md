---
title: Backupset (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
|**database_backup_lsn**|**numeric(25,0)**|Protokollsequenznummer der neuesten vollständigen Datenbanksicherung. Kann den Wert NULL haben.<br /><br /> **Database_backup_lsn** ist der "startprüfpunkt", die beim Starten der Sicherung ausgelöst wird. Dieser LSN stimmt mit **First_lsn** , wenn die Sicherung erstellt wird, wenn die Datenbank im Leerlauf befindet und keine Replikation konfiguriert ist.|  
...
|**Codepage**|**smallint**|Codepage des Servers, der den Sicherungsvorgang durchführt. Kann den Wert NULL haben. Weitere Informationen zu Codepages finden Sie unter [Collation and Unicode Support](../../relational-databases/collations/collation-and-unicode-support.md).|  
...
|**backup_size**|**numeric(20,0)**|Größe des Sicherungssatzes in Bytes. Kann den Wert NULL haben. Bei VSS-Sicherungen ist Backup_size einen geschätzten Wert.|  
...
|**fork_point_lsn**|**numeric(25,0)**|Wenn **First_recovery_fork_guid** ist nicht gleich **Last_recovery_fork_guid**, dies ist die protokollfolgenummer des verzweigungspunkts. Andernfalls ist der Wert NULL.|  
...
|**differential_base_lsn**|**numeric(25,0)**|Basis-LSN für differenzielle Sicherungen. Für eine einzelne Sicherung auf differenzieller Basis; Änderungen mit LSNs, die größer als oder gleich **Differential_base_lsn** in der differenziellen Sicherung enthalten sind.<br /><br /> Bei einer differenziellen, der Wert ist NULL, und die Basis-LSN muss auf Dateiebene bestimmt werden (siehe [Backupfile &#40;Transact-SQL&#41;](../../relational-databases/system-tables/backupfile-transact-sql.md)).<br /><br /> Bei nicht differenziellen Sicherungstypen ist der Wert immer NULL.|  
