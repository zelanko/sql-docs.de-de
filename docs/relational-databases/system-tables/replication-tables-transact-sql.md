...
description: Replikationssystem Tabellen unterstützen eine Replikations Topologie. Bei der Replikation werden einer als Verleger oder Abonnent konfigurierten Datenbank Systemtabellen hinzugefügt.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
