...
-   Die XQuery-Prolog enthält eine Namespace-Präfixdeklaration (AWMI), `(namespace AWMI="http://schemas.microsoft.com/sqlserver/2004/07/adventure-works/ProductModelManuInstructions";`.  
